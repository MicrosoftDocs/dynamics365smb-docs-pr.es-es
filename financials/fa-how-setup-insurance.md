---
title: Configurar el seguro de los activos fijos | Documentos de Microsoft
description: "Describe cómo configurar el sistema para el seguro de los activos fijos."
...
1. En la esquina superior derecha, seleccione el icono **Buscar página o informe** ![Buscar página o informe](media/ui-search/search_small.png "Icono Buscar página o informe"), especifique **Configuración A/F** y elija el vínculo relacionado.  
...
1. En la esquina superior derecha, seleccione el icono **Buscar página o informe** ![Buscar página o informe](media/ui-search/search_small.png "Icono Buscar página o informe"), especifique **Tipos seguros** y elija el vínculo relacionado.  
...
1. En la esquina superior derecha, seleccione el icono **Buscar página o informe** ![Buscar página o informe](media/ui-search/search_small.png "Icono Buscar página o informe"), especifique **Libros diario seguros** y elija el vínculo relacionado.  
2. Rellene los campos según sea necesario.
