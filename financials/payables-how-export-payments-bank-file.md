---
title: "Exportación de pagos a un archivo bancario | Documentos de Microsoft"
description: "Exportación de pagos a un archivo de banco"
...
3. Rellene los campos de las líneas del diario de pagos según sea necesario. [!INCLUDE[tooltip-inline-tip](includes/tooltip-inline-tip_md.md)]
    ...
    **Nota**: Si utiliza EFT, debe seleccionar **Pago electrónico** o **Pago electrónico-IAT** en el campo **Tipo pago por banco**.
...
6. En la ventana **Guardar como**, especifique la ubicación a la que se exporta el archivo y, a continuación, seleccione **Guardar**.
    ...
    **Nota**: Si utiliza EFT, guarde el formulario de remesa de proveedor resultante como documento de Word o seleccione que se envíe por correo electrónico directamente al proveedor. Los pagos ahora se agregarán a la ventana **Generar archivo EFT** desde donde se pueden generar varias órdenes de pago conjuntas para ahorrar el coste de transmisión. Para obtener más información, vea los pasos siguientes:
...
**Precaución**: Las líneas de diario de pagos resultantes no se pueden registrar, borrar o anular.
...
**Nota**: Los archivos EFT exportados no se muestran en la ventana **Registros de transferencia de crédito** y no se pueden volver a exportar.

1. En la esquina superior derecha, seleccione el icono **Buscar página o informe** ![Buscar página o informe](media/ui-search/search_small.png "Icono Buscar página o informe"), especifique **Registros de transferencia de crédito** y elija el vínculo relacionado.
