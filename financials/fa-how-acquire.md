...
description: "Describe cómo crear y adquirir un activo fijo."
...
**Nota:** Puede registrar los costes como abonos. En ese caso, recuerde que el valor del campo **Coste con IVA** debe tener el símbolo menos que indica un abono.
...
6. En la esquina superior derecha, seleccione el icono **Buscar página o informe** ![Buscar página o informe](media/ui-search/search_small.png "Icono Buscar página o informe"), especifique **Configuración de activos fijos** y elija el vínculo relacionado.
...
**Nota:** Puede registrar los costes como abonos. En ese caso, recuerde que el valor del campo **Importe** debe tener el símbolo menos que indica un abono.

1. En la esquina superior derecha, seleccione el icono **Buscar página o informe** ![Buscar página o informe](media/ui-search/search_small.png "Icono Buscar página o informe"), especifique **Diarios generales A/F** y elija el vínculo relacionado.
...
**Sugerencia:** Si rellena el campo **N. º seguro** del diario general de activos en el momento de registrar un coste, [!INCLUDE[d365fin](includes/d365fin_md.md)] también registrará el coste del activo en los movimientos de seguros. Para obtener más información, vea [Procedimiento: Asegurar activos fijos](fa-how-insure.md).
...
**Importante:** No puede usar la función **Transacciones inversas** para los movimientos de un activo fijo.

1. En la esquina superior derecha, seleccione el icono **Buscar página o informe** ![Buscar página o informe](media/ui-search/search_small.png "Icono Buscar página o informe"), especifique **Cancelar movs. A/F** y elija el vínculo relacionado.
