---
title: Procesar oportunidades de ventas | Documentos de Microsoft
description: Describe el proceso para las oportunidades de ventas en Financials
...
## <a name="view-opportunities"></a>Permite ver las oportunidades
...
| --- | --- |
| Todos los vendedores y contactos |En la esquina superior derecha, seleccione el icono **Buscar página o informe** ![Buscar página o informe](media/ui-search/search_small.png "Icono Buscar página o informe"), especifique **Lista oportunidad** y elija el vínculo relacionado. |
| Un vendedor específico |En la esquina superior derecha, seleccione el icono **Buscar página o informe** ![Buscar página o informe](media/ui-search/search_small.png "Icono Buscar página o informe"), especifique **Vendedores** y elija el vínculo relacionado. Seleccione el vendedor, seleccione la acción **Oportunidades** y, a continuación, seleccione la acción **Lista**. |
| Un contacto específico |En la esquina superior derecha, seleccione el icono **Buscar página o informe** ![Buscar página o informe](media/ui-search/search_small.png "Icono Buscar página o informe"), especifique **Contactos** y elija el vínculo relacionado. Seleccione el contacto de la lista y, a continuación, seleccione la acción **Oportunidades**. |
...
1. En la esquina superior derecha, seleccione el icono **Buscar página o informe** ![Buscar página o informe](media/ui-search/search_small.png "Icono Buscar página o informe"), especifique **Borrar oportunidades** y elija el vínculo relacionado.
