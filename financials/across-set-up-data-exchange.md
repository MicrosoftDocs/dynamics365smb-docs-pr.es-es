...
|Configure dos servicios preconfigurados para tipos de cambio actualizados para obtener los últimos tipos de cambio en la ventana **Divisa**.|[Actualizar tipos cambio divisa](finance-how-update-currencies.md)|  
