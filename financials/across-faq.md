...
Si tiene alguna pregunta sobre [!INCLUDE[d365fin](includes/d365fin_md.md)] cuya respuesta no encuentre en esta documentación, puede preguntar a la comunidad de Finance and Operations, Business edition. Para obtener más información, consulte [Comunidad de Dynamics 365 for Finance and Operations, Business edition](https://community.dynamics.com/business). Además, nuestro equipo publica consejos y trucos. Para obtener más información, consulte [Blog de asistencia de Dynamics 365 for Finance and Operations, Business edition](https://blogs.msdn.microsoft.com/dyn365finsupport).  
