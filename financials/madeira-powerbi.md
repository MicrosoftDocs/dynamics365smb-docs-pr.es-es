...
Los paquetes de contenido están configurados previamente para trabajar con los datos de ventas y los datos financieros de la empresa de demostración que aparecerá al registrarse para [!INCLUDE[d365fin_long](includes/d365fin_long_md.md)].  
...
Esto significa que debe obtener 3 tipos de información de Financials: la URL de OData y la clave de acceso al servicio web para su cuenta de usuario.  
...
En este ejemplo, *mybusiness* es el nombre del servicio de Financials y *CRONUS US* el de la empresa de demostración con *%20* que representa el espacio del nombre.   
...
En el panel de [!INCLUDE[d365fin](includes/d365fin_md.md)] se muestran los informes más habituales que tendrá que usar para realizar el seguimiento de la empresa. Los datos se recuperan de su empresa de [!INCLUDE[d365fin](includes/d365fin_md.md)] usando los servicios web para leer los datos activos. En [!INCLUDE[d365fin](includes/d365fin_md.md)], en la ventana **Servicios web**, se enumera la lista de servicios web que se han configurado, incluidos los que se consumen por el paquete de contenido en Power BI:  
