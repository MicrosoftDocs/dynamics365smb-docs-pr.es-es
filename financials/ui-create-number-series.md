...
description: "Obtenga información sobre cómo crear nuevas series numéricas en Dynamics 365 for Financials."
documentationcenter: 
...
1. En la esquina superior derecha, seleccione el icono **Buscar página o informe** ![Buscar página o informe](media/ui-search/search_small.png "Icono Buscar página o informe"), especifique **Nos. serie** y elija el vínculo relacionado.
...
1. En la esquina superior derecha, seleccione el icono **Buscar página o informe** ![Buscar página o informe](media/ui-search/search_small.png "Icono Buscar página o informe"), especifique **Ventas y cobros** y elija el vínculo relacionado.
