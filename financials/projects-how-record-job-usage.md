---
title: Registro del uso para proyectos| Documentos de Microsoft
description: "Describe cómo registrar el uso de los productos o de recursos en proyectos."
...
**Nota**: Para ello es necesario que la casilla **Aplicar vínculo uso** se haya seleccionado para el proyecto, o sea el valor predeterminado para todos los proyectos de su organización. Para obtener más información, vea [Configuración de proyectos](projects-how-setup-jobs.md).  
