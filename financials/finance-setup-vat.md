...
* Configurar grupos de registro de IVA de negocio para definir las tasas de IVA para los mercados en los que opera. Los asigna a clientes y proveedores.  
* Configurar grupos de registro de IVA de producto para definir las tasas de IVA para los productos o servicios que compra o vende.  
   ...
   > [!NOTE]  
>   Los conceptos de los grupos de registro de IVA de negocio y de producto son parecidos a los grupos de registro generales. Para obtener más información, consulte [Configuraciones de grupos de registro](finance-posting-groups.md).
...
* Asignar grupos de registro de IVA de producto a las cuentas de contabilidad que usa para ventas, compras, productos y recursos.  
   ...
   > [!NOTE]  
>   Para configurar el IVA para los recursos, debe permitir la experiencia del usuario **Conjunto de aplicaciones** en la empresa. Para obtener más información, consulte [Personalizar la experiencia de Dynamics 365 for Financials](ui-experiences.md).
