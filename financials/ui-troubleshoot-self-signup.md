...
description: "Obtenga información sobre los motivos más habituales por los que es posible que no pueda realizar el registro a Finance and Operations, Business edition y formas de solucionarlos."
...
## <a name="what-email-address-can-i-use-with-finance-and-operations-business-edition"></a>¿Qué dirección de correo electrónico puedo usar con Finance and Operations, Business edition?
