...
ms.locfileid: "7606498"
---
# <a name="achieve-some-task-or-get-the-overview-in-max-100-characters"></a>Realice alguna tarea u obtenga la descripción general en un máx. de de 100 caracteres.

Presentación elegante de la capacidad con muchas palabras de moda. Use [!INCLUDE [prod_short](includes/prod_short.md)] para el nombre del producto y escriba en oraciones activas, como "Haga el trabajo más rápido" y "Con esta capacidad, puede X".  
