...
## Para configurar una UA  

1. Elija el icono ![Bombilla que abre la característica Dígame](media/ui-search/search_small.png "Dígame qué desea hacer"), , escriba **Unidades de almacenamiento**, y luego elija el vínculo relacionado.  
...
Una vez configurada la primera UA para un producto, se selecciona la casilla **Existe ud. de almacenam.** de la pestaña **Producto**.  

Para crear varias UA para un producto, utilice el proceso **Crear ud. de almacenan.**. Para obtener más información sobre trabajos por lotes, vaya a [Utilice las colas de trabajos para programar tareas](admin-job-queues-schedule-tasks.md).  
