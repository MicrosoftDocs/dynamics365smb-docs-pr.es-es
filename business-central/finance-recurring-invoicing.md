...
## <a name="register-revenue-with-a-recurring-general-journal" />Registrar ingresos con un diario general periódico
...
## <a name="create-multiple-invoices-based-on-a-recurring-job-journal" />Crear varias facturas basadas en un diario periódico de proyecto
...
## <a name="create-multiple-invoices-based-on-recurring-sales-lines" />Crear varias facturas de venta basadas en líneas de ventas periódicas
...
## <a name="recurring-invoices-with-service-contract" />Facturas periódicas con contrato de servicio
...
## <a name="related-features" />Características relacionadas
Hay varias capacidades relacionadas en [!INCLUDE[prod_short](includes/prod_short.md)].

### <a name="blanket-sales-orders" />Pedidos abiertos de venta
...
### <a name="recurring-orders-norway" />Pedidos periódicos (Noruega)
...
### <a name="recurring-revenue-and-subscription-billing-by-other-providers" />Ingresos periódicos y facturación de suscripción por otros proveedores
