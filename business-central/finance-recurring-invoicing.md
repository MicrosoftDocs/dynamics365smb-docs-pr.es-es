...
---
# <a name="work-with-recurring-revenue-in-"></a>Trabajar con ingresos recurrentes en [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="create-multiple-invoices-based-on-a-recurring-project-journal"></a>Crear varias facturas basadas en un diario periódico de proyecto
...
### <a name="why-use-this-option-1"></a>Por qué usar esta opción
...
### <a name="why-use-this-option-2"></a>Por qué usar esta opción
...
### <a name="why-use-this-option-3"></a>Por qué usar esta opción
...
#### <a name="why-use-this-option-4"></a>Por qué usar esta opción
...
#### <a name="why-use-this-option-5"></a>Por qué usar esta opción
