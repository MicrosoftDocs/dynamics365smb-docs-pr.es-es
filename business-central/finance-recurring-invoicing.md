...
ms.author: andreipa
---
# <a name="work-with-recurring-revenue-in-"></a><a name="work-with-recurring-revenue-in-"></a>Trabajar con ingresos recurrentes en [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="register-revenue-with-a-recurring-general-journal"></a><a name="register-revenue-with-a-recurring-general-journal"></a>Registrar ingresos con un diario general periódico
...
### <a name="why-use-this-option"></a><a name="why-use-this-option"></a>Por qué usar esta opción
...
## <a name="create-multiple-invoices-based-on-a-recurring-job-journal"></a><a name="create-multiple-invoices-based-on-a-recurring-job-journal"></a>Crear varias facturas basadas en un diario periódico de proyecto
...
### <a name="why-use-this-option-1"></a><a name="why-use-this-option-1"></a>Por qué usar esta opción
...
## <a name="create-multiple-invoices-based-on-recurring-sales-lines"></a><a name="create-multiple-invoices-based-on-recurring-sales-lines"></a>Crear varias facturas de venta basadas en líneas de ventas periódicas
...
### <a name="why-use-this-option-2"></a><a name="why-use-this-option-2"></a>Por qué usar esta opción
...
## <a name="recurring-invoices-with-service-contract"></a><a name="recurring-invoices-with-service-contract"></a>Facturas periódicas con contrato de servicio
...
### <a name="why-use-this-option-3"></a><a name="why-use-this-option-3"></a>Por qué usar esta opción
...
## <a name="related-features"></a><a name="related-features"></a>Características relacionadas
Hay varias capacidades relacionadas en [!INCLUDE[prod_short](includes/prod_short.md)].

### <a name="blanket-sales-orders"></a><a name="blanket-sales-orders"></a>Pedidos abiertos de venta
...
#### <a name="why-use-this-option-4"></a><a name="why-use-this-option-4"></a>Por qué usar esta opción
...
### <a name="recurring-orders-norway"></a><a name="recurring-orders-norway"></a>Pedidos periódicos (Noruega)
...
#### <a name="why-use-this-option-5"></a><a name="why-use-this-option-5"></a>Por qué usar esta opción
...
### <a name="recurring-revenue-and-subscription-billing-by-other-providers"></a><a name="recurring-revenue-and-subscription-billing-by-other-providers"></a>Ingresos periódicos y facturación de suscripción por otros proveedores
