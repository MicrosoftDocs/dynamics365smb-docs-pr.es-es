...
ms.author: edupont
---
# <a name="define-user-tasks"></a><a name="define-user-tasks"></a><a name="define-user-tasks"></a><a name="define-user-tasks"></a>Definir tareas de usuario
...
## <a name="managing-user-tasks"></a><a name="managing-user-tasks"></a><a name="managing-user-tasks"></a><a name="managing-user-tasks"></a>Gestionar tareas de usuario
...
### <a name="picking-up-user-tasks"></a><a name="picking-up-user-tasks"></a><a name="picking-up-user-tasks"></a><a name="picking-up-user-tasks"></a>Selección de tareas de usuario
...
### <a name="deleting-user-tasks"></a><a name="deleting-user-tasks"></a><a name="deleting-user-tasks"></a><a name="deleting-user-tasks"></a>Eliminar tareas de usuario
