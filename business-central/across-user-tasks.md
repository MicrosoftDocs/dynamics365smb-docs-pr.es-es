...
ms.author: edupont
---
# <a name="define-user-tasks" />Definir tareas de usuario
...
## <a name="managing-user-tasks" />Gestionar tareas de usuario
...
### <a name="picking-up-user-tasks" />Selección de tareas de usuario
...
### <a name="deleting-user-tasks" />Eliminar tareas de usuario
