...
ms.author: bholtorf
---
# <a name="integrating-with-dynamics-365-sales"></a><a name="integrating-with-dynamics-365-sales"></a><a name="integrating-with-dynamics-365-sales"></a>Integración con Dynamics 365 Sales
...
## <a name="integrating-through-dataverse"></a><a name="integrating-through-dataverse"></a><a name="integrating-through-dataverse"></a>Integración a través de Dataverse
...
## <a name="integration-settings-that-are-specific-to-a--integration"></a><a name="integration-settings-that-are-specific-to-a--integration"></a><a name="integration-settings-that-are-specific-to-a--integration"></a>Configuración de integración específica de una integración de [!INCLUDE[crm_md](includes/crm_md.md)]
...
## <a name="permissions-and-security-roles-for-user-accounts-in-sales"></a><a name="permissions-and-security-roles-for-user-accounts-in-sales"></a><a name="permissions-and-security-roles-for-user-accounts-in-sales"></a>Permisos y roles de seguridad para cuentas de usuario en Sales
...
### <a name="connection-settings-in-the-setup-guide"></a><a name="connection-settings-in-the-setup-guide"></a><a name="connection-settings-in-the-setup-guide"></a>Configuración de conexión en la Guía de configuración
...
### <a name="connection-settings-on-the-microsoft-dynamics-365-connection-setup-page"></a><a name="connection-settings-on-the-microsoft-dynamics-365-connection-setup-page"></a><a name="connection-settings-on-the-microsoft-dynamics-365-connection-setup-page"></a>Configuración de conexión en la página de configuración de conexión de Microsoft Dynamics 365
...
### <a name="standard-sales-entity-mapping-for-synchronization"></a><a name="standard-sales-entity-mapping-for-synchronization"></a><a name="standard-sales-entity-mapping-for-synchronization"></a>Asignación de entidad de Sales estándar para la sincronización
...
### <a name="mapping-items-and-resources-to-products"></a><a name="mapping-items-and-resources-to-products"></a><a name="mapping-items-and-resources-to-products"></a>Asignación de elementos y recursos a productos
...
### <a name="synchronization-rules"></a><a name="synchronization-rules"></a><a name="synchronization-rules"></a>Reglas de sincronización
...
### <a name="synchronization-jobs-for-a-sales-integration"></a><a name="synchronization-jobs-for-a-sales-integration"></a><a name="synchronization-jobs-for-a-sales-integration"></a>Trabajos de sincronización para una integración de ventas
...
### <a name="default-synchronization-job-queue-entries"></a><a name="default-synchronization-job-queue-entries"></a><a name="default-synchronization-job-queue-entries"></a>Movimientos de la cola de proyectos de sincronización predeterminados
...
## <a name="connecting-to-on-premises-versions-of-business-central-2019-release-wave-1-and-microsoft-dynamics-nav-2018"></a><a name="connecting-to-on-premises-versions-of-business-central-2019-release-wave-1-and-microsoft-dynamics-nav-2018"></a><a name="connecting-to-on-premises-versions-of-business-central-2019-release-wave-1-and-microsoft-dynamics-nav-2018"></a>Conexión con las versiones locales de Business Central 2019, lanzamientos de versiones 1 y Microsoft Dynamics NAV 2018
...
### <a name="to-connect-business-central-2019-release-wave-1-and-dynamics-nav-2018"></a><a name="to-connect-business-central-2019-release-wave-1-and-dynamics-nav-2018"></a><a name="to-connect-business-central-2019-release-wave-1-and-dynamics-nav-2018"></a>Para conectar Business Central 2019 lanzamiento de versiones 1 y Dynamics NAV 2018
