...
ms.author: edupont
---
# <a name="batch-post-output-and-run-times" />Registrar por lotes el resultado y los tiempos de ejecución
...
## <a name="to-post-output-quantities-andor-register-run-times-for-one-or-more-production-order-lines" />Para registrar cantidades de salida y/o registrar tiempos de ejecución en una o varias líneas de la orden de producción
