...
ms.author: edupont
---
# <a name="reconcile-inventory-costs-with-the-general-ledger" />Conciliar costes de inventario con la contabilidad general
...
## <a name="to-post-inventory-costs-manually" />Para registrar los costes de inventario de forma manual
...
## <a name="reporting-costs-and-reconciling-with-the-general-ledger" />Creación de informes de costes y conciliación con la contabilidad
