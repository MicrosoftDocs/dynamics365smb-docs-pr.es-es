...
1. Elija el icono ![Bombilla que abre la función Dígame](media/ui-search/search_small.png "Dígame qué desea hacer"), escriba **Registrar variación inventario en contabilidad** y luego elija el enlace relacionado.
