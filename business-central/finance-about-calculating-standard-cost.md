...
ms.author: edupont
---
# <a name="about-calculating-standard-cost"></a><a name="about-calculating-standard-cost"></a>Acerca del cálculo de coste estándar
...
## <a name="setting-up-standard-costs"></a><a name="setting-up-standard-costs"></a>Configuración de los costes estándar
...
### <a name="material-costs"></a><a name="material-costs"></a>Costes materiales
...
### <a name="capacity-costs"></a><a name="capacity-costs"></a>Costes de capacidad
...
### <a name="subcontractor-costs"></a><a name="subcontractor-costs"></a>Costes de los subcontratistas
...
## <a name="updating-standard-costs"></a><a name="updating-standard-costs"></a>Actualización de los costes estándar
