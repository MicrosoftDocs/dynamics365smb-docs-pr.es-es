...
### <a name="material-costs"></a>Costes materiales
...
## <a name="use-batch-jobs-to-update-standard-costs"></a>Usar trabajos por lotes para actualizar los costes estándar
Las siguientes secciones describen los trabajos por lotes que puede utilizar para actualizar los costes estándar.
### <a name="suggest-item-standard-cost"></a>Sugerir coste estándar prod.
...
### <a name="suggest-workmach-ctr-std-cost"></a>Sugerir coste estánd. c. trab./máq.
...
### <a name="post-inventory-cost-to-gl"></a>Regis. variación existencias
...
### <a name="roll-up-standard-cost"></a>Distribuir coste estándar
...
### <a name="implement-standard-cost-change"></a>Implementar cambio coste estándar
