...
ms.author: bholtorf
---
# <a name="set-up-a-loaner-program"></a><a name="set-up-a-loaner-program"></a><a name="set-up-a-loaner-program"></a>Configurar un programa de productos prestados
...
## <a name="to-set-up-a-loaner"></a><a name="to-set-up-a-loaner"></a><a name="to-set-up-a-loaner"></a>Para configurar un producto prestado
