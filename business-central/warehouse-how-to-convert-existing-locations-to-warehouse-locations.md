...
ms.author: edupont
---
# <a name="convert-existing-locations-to-warehouse-locations" />Convertir los almacenes existentes en ubicaciones de almacén
...
## <a name="to-enable-an-existing-location-to-operate-as-a-warehouse-location" />Para activar una ubicación para que funcione como una ubicación de almacén
