...
ms.author: edupont
---
# <a name="design-details-assembly-order-posting"></a><a name="design-details-assembly-order-posting"></a>Detalles de diseño: Registro de pedidos de ensamblado
...
## <a name="posting-sequence"></a><a name="posting-sequence"></a>Secuencia de registro
...
## <a name="cost-adjustment"></a><a name="cost-adjustment"></a>Ajuste de coste
...
### <a name="performing-the-adjustment"></a><a name="performing-the-adjustment"></a>Realizar el ajuste
...
### <a name="posting-dates"></a><a name="posting-dates"></a>Fechas de registro
