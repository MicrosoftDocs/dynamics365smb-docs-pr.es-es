...
ms.author: edupont
---
# <a name="design-details-assembly-order-posting" />Detalles de diseño: Registro de pedidos de ensamblado
...
## <a name="posting-sequence" />Secuencia de registro
...
## <a name="cost-adjustment" />Ajuste de coste
...
### <a name="performing-the-adjustment" />Realizar el ajuste
...
### <a name="posting-dates" />Fechas de registro
