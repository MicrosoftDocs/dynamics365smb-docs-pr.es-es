...
ms.author: jswymer
---
# <a name="create-sales-opportunities" />Crear oportunidades de ventas
...
## <a name="to-create-an-opportunity-from-a-salesperson" />Para crear una oportunidad a partir de un vendedor
...
## <a name="to-create-an-opportunity-from-a-contact" />Para crear una oportunidad a partir de un contacto
