...
### <a name="what-is-expected-of-users-while-using-e-documents-matching-assistance"></a>¿Qué se espera de los usuarios al utilizar la asistencia para la concordancia de documentos electrónicos?
...
### <a name="what-is-expected-of-administrators-and-users-when-operating-e-documents-matching-assistance"></a>¿Qué se espera de los administradores y usuarios cuando operan la asistencia para la concordancia de documentos electrónicos?
