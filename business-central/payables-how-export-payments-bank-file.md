...
4. En la ventana **Exportar pagos electrónicos**, rellene los campos según sea necesario.
...
5. En la ventana **Guardar como**, especifique la ubicación a la que se exporta el archivo y, a continuación, seleccione **Guardar**.
...
6. En la ventana **Diario de pagos**, seleccione la acción **Generar archivo EFT**.
...
8. En la ventana **Guardar como**, especifique la ubicación a la que se exporta el archivo y, a continuación, seleccione **Guardar**.
