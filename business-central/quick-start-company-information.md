...
# <a name="company-information-quick-start"></a><a name="company-information-quick-start"></a><a name="company-information-quick-start"></a>Inicio rápido Información empresa
...
## <a name="to-set-up-company-information"></a><a name="to-set-up-company-information"></a><a name="to-set-up-company-information"></a>Para configurar la información de la empresa
