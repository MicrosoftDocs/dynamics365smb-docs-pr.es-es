...
ms.author: edupont
---
# <a name="legacy-import-and-export-custom-report-layouts" />(Versión heredada) Importar y exportar diseños de informe personalizados
...
### <a name="to-export-a-report-layout-to-a-file" />Para exportar un diseño de informe a un archivo
...
### <a name="to-import-a-report-layout-file" />Para importar un archivo de diseño de informe
