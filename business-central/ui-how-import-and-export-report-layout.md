...
ms.author: edupont
---
# <a name="legacy-import-and-export-custom-report-layouts"></a><a name="legacy-import-and-export-custom-report-layouts"></a><a name="legacy-import-and-export-custom-report-layouts"></a><a name="legacy-import-and-export-custom-report-layouts"></a>(Versión heredada) Importar y exportar diseños de informe personalizados
...
### <a name="to-export-a-report-layout-to-a-file"></a><a name="to-export-a-report-layout-to-a-file"></a><a name="to-export-a-report-layout-to-a-file"></a><a name="to-export-a-report-layout-to-a-file"></a>Para exportar un diseño de informe a un archivo
...
### <a name="to-import-a-report-layout-file"></a><a name="to-import-a-report-layout-file"></a><a name="to-import-a-report-layout-file"></a><a name="to-import-a-report-layout-file"></a>Para importar un archivo de diseño de informe
