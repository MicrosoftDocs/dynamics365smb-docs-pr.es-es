...
# <a name="getting-business-central-on-your-mobile-device"></a><a name="getting-business-central-on-your-mobile-device"></a><a name="getting-business-central-on-your-mobile-device"></a>Obtener Business Central en el dispositivo móvil
...
## <a name="get-the-app-on-my-mobile-device"></a><a name="get-the-app-on-my-mobile-device"></a><a name="get-the-app-on-my-mobile-device"></a>Obtener la aplicación en mi dispositivo móvil
...
## <a name="use-business-central-on-premises"></a><a name="use-business-central-on-premises"></a><a name="use-business-central-on-premises"></a>¿Desea usar Business Central local?
