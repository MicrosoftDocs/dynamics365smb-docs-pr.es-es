...
ms.author: jswymer
---
# <a name="get-business-central-desktop-app" />Obtener la aplicación de escritorio Business Central
...
## <a name="why-use-the-app" />¿Por qué usar la aplicación?
...
## <a name="install-the-app-for-business-central-online" />Instalar la aplicación para Business Central Online
...
### <a name="from-microsoft-store" />Desde Microsoft Store
...
### <a name="from-the-browser" />Desde el navegador
...
## <a name="install-the-app-for-business-central-on-premises" />Instalar la aplicación para Business Central de forma local
