...
ms.author: edupont
---
# <a name="setting-up-cost-accounting" />Configuración de contabilidad de costes

Antes de empezar a trabajar con la contabilidad de costes, debe realizar tareas de configuración.

## <a name="balances-between-cost-type-cost-center-and-cost-object" />Saldos entre el tipo de coste, centro de coste y objeto de coste
...
## <a name="setting-up-cost-types" />Configuración de tipos de coste
...
### <a name="to-transfer-the-general-ledger-chart-of-accounts-to-the-chart-of-cost-types" />Para transferir el plan de cuentas de contabilidad al plan de tipos de coste
...
### <a name="to-set-up-new-cost-types-in-the-chart-of-cost-types-page" />Configurar nuevos tipos de coste en la página Tipos centros coste
...
### <a name="to-update-cost-types" />Para actualizar tipos de coste
...
## <a name="defining-the-relationship-between-cost-types-and-general-ledger-accounts" />Definición de la relación entre los tipos de coste y las cuentas de contabilidad
...
### <a name="relationship-between-general-ledger-accounts-and-cost-types" />Relación entre las cuentas de contabilidad y los tipos de coste
...
### <a name="cost-types-without-a-relationship-to-the-general-ledger" />Tipos de coste sin una relación con la contabilidad
...
## <a name="setting-up-cost-centers" />Configuración de centros de coste
...
### <a name="to-transfer-dimension-values-in-the-general-ledger-to-the-chart-of-cost-centers" />Para transferir los valores de dimensión en la contabilidad al plan de centros de coste
...
### <a name="to-create-new-cost-centers-in-the-chart-of-cost-centers-page" />Crear nuevos centros de coste en la página Plan centros coste
...
## <a name="setting-up-cost-objects" />Configuración de objetos de coste
...
### <a name="to-transfer-dimension-values-from-the-general-ledger-to-the-chart-of-cost-objects" />Para transferir valores de dimensión de la contabilidad al plan de objetos de coste
...
### <a name="to-create-new-cost-objects-in-the-chart-of-cost-objects-page" />Crear nuevos objetos de coste en la página Plan objetos coste
...
## <a name="defining-cost-centers-and-cost-objects-for-chart-of-accounts" />Definición de centros de coste y de objetos de coste para el plan de cuentas
...
### <a name="defining-default-dimension-values-for-general-ledger-accounts" />Definición de los valores de dimensión predeterminados para cuentas de contabilidad
...
### <a name="defining-dimension-values-for-overhead-costs-and-direct-costs" />Definición de valores de dimensión para costes generales y costes directos
...
## <a name="see-related-microsoft-training" />Consultar la [formación de Microsoft](/training/modules/cost-accounting-dynamics-365-business-central/) relacionada
