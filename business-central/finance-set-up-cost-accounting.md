...
1. Configure una dimensión para que sea la dimensión del centro de coste en la página **Configuración de contabilidad de costes**. Sólo los valores de esta dimensión se transfieren.
Tu puedes elegir **Comportamiento** > **Funciones** > **Actualizar dimensiones de contabilidad de costos** para actualizar las dimensiones de la contabilidad de costos.
1. Elija el icono ![Bombilla que abre la característica Dígame 2.](media/ui-search/search_small.png "Dígame qué desea hacer") , escriba **Plan centros coste** y luego elija el enlace relacionado.  
1. En la pestaña **Acciones**, en el grupo **Funciones**, seleccione **Traer centros de coste de dimensión** para transferir los valores de dimensión al plan de centros de coste. La función transfiere los valores de dimensión que definió en el paso 1.  
...
## <a name="setting-up-cost-objects"></a>Configuración de objetos de coste
