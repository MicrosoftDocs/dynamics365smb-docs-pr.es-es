...
ms.author: edupont
---
# <a name="track-packages"></a><a name="track-packages"></a>Hacer un seguimiento de los paquetes
...
## <a name="to-track-a-package"></a><a name="to-track-a-package"></a>Para hacer el seguimiento de un paquete
