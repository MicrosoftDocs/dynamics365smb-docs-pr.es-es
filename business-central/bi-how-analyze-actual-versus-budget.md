...
ms.author: edupont
---
# <a name="analyze-actual-amounts-versus-budgeted-amounts" />Analizar importes reales frente a importes presupuestados
...
## <a name="view-a-gl-budget" />Ver un presupuesto contable
...
## <a name="view-actual-and-budgeted-amounts-for-all-accounts" />Ver los importes reales y presupuestados de todas las cuentas
...
## <a name="to-view-actual-and-budgeted-amounts-for-several-periods" />Para ver los importes reales y presupuestados de varios periodos
...
## <a name="see-related-training-at-microsoft-learnlearnmodulesbudgets-exchange-rates-dynamics-365-business-centralindex" />Consulte la formación relacionada en [Microsoft Learn](/learn/modules/budgets-exchange-rates-dynamics-365-business-central/index)
