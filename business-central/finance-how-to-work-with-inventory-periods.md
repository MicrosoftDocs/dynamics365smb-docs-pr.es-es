...
ms.author: edupont
---
# <a name="work-with-inventory-periods"></a><a name="work-with-inventory-periods"></a><a name="work-with-inventory-periods"></a><a name="work-with-inventory-periods"></a>Trabajar con periodos de inventario
...
## <a name="to-create-an-inventory-period"></a><a name="to-create-an-inventory-period"></a><a name="to-create-an-inventory-period"></a><a name="to-create-an-inventory-period"></a>Para crear un periodo de inventario
...
## <a name="closing-inventory-periods"></a><a name="closing-inventory-periods"></a><a name="closing-inventory-periods"></a><a name="closing-inventory-periods"></a>Cerrar periodos del inventario
...
### <a name="to-close-an-inventory-period"></a><a name="to-close-an-inventory-period"></a><a name="to-close-an-inventory-period"></a><a name="to-close-an-inventory-period"></a>Para cerrar un periodo de inventario
...
## <a name="reopening-inventory-periods"></a><a name="reopening-inventory-periods"></a><a name="reopening-inventory-periods"></a><a name="reopening-inventory-periods"></a>Volver a abrir periodos del inventario
...
### <a name="to-reopen-an-inventory-period"></a><a name="to-reopen-an-inventory-period"></a><a name="to-reopen-an-inventory-period"></a><a name="to-reopen-an-inventory-period"></a>Para volver a abrir un periodo de inventario
1. Elija el icono ![Bombilla que abre la función Dígame.](media/ui-search/search_small.png "Dígame qué desea hacer") , escriba **Periodos inventario** y luego elija el enlace relacionado.  
