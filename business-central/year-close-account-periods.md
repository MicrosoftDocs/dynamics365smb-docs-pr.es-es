...
ms.author: jswymer
---
# <a name="close-accounting-periods"></a><a name="close-accounting-periods"></a>Cerrar periodos contables

Cuando finaliza un ejercicio, debe cerrar los periodos que lo forman.

## <a name="to-close-accounting-periods"></a><a name="to-close-accounting-periods"></a>Para cerrar periodos contables
