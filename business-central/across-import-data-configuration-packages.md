...
ms.author: edupont
---
# <a name="import-business-data-from-other-finance-systems" />Importar datos de empresa de otros sistemas financieros
...
## <a name="work-with-data-in-excel" />Trabajar con datos en Excel
...
## <a name="import-data-from-configuration-packages" />Importar datos desde los paquetes de configuración
...
### <a name="tables-in-the-default-configuration-package" />Tablas del paquete de configuración predeterminado
