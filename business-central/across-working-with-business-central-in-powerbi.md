...
ms.author: jswymer
---
# <a name="work-with--data-in-power-bi"></a><a name="work-with--data-in-power-bi"></a><a name="work-with--data-in-power-bi"></a><a name="work-with--data-in-power-bi"></a>Trabajar con datos de [!INCLUDE [prod_short](includes/prod_short.md)] en Power BI
...
## <a name="get-the-latest-data"></a><a name="get-the-latest-data"></a><a name="get-the-latest-data"></a><a name="get-the-latest-data"></a>Obtener los datos más recientes
...
### <a name="refresh-manually"></a><a name="refresh-manually"></a><a name="refresh-manually"></a><a name="refresh-manually"></a>Actualizar manualmente
...
### <a name="schedule-a-refresh"></a><a name="schedule-a-refresh"></a><a name="schedule-a-refresh"></a><a name="schedule-a-refresh"></a>Programe una actualización
...
## <a name="upload-reports-from-files"></a><a name="upload-reports-from-files"></a><a name="upload-reports-from-files"></a><a name="upload-reports-from-files"></a><a name="upload"></a>Cargar informes desde archivos
...
## <a name="share-reports-with-others"></a><a name="share-reports-with-others"></a><a name="share-reports-with-others"></a><a name="share-reports-with-others"></a><a name="share"></a>Compartir informes con otros
