...
|Flecha hacia la derecha|En la misma fila, desplazarse al siguiente campo accionable de la derecha.| En la misma fila, desplazarse al siguiente mosaico de la derecha. |No pertenece a la lista que se puede modificar.|
|Flecha izquierda|En la misma fila, desplazarse al campo anterior de la izquierda. | En la misma fila, desplazarse al mosaico anterior de la izquierda. |No pertenece a la lista que se puede modificar.|
|Inicio<br />(Fn+flecha izquierda)|Desplazarse al primer campo en una fila.|Desplazarse al primer mosaico en una fila.||
|Fin<br />(Fn+flecha derecha)|Desplazarse al último campo accionable en una fila.|Desplazarse al último mosaico en una fila.||
|Re. pág.<br />(Fn+flecha arriba)|En la misma columna, desplazarse a la fila superior más visible.|En la misma columna, desplazarse a la fila superior más visible.||
|Av. Pág.<br />(Fn+flecha abajo)|En la misma columna, desplazarse a la fila inferior más visible.|En la misma columna, desplazarse a la fila inferior más visible.||
...
|Ctrl+Inicio<br />(Fn+Ctrl+Flecha izquierda)|Seleccione la primera fila de la lista; el enfoque se mueve al primer campo accionable de la fila|Desplazarse al mosaico de la primera fila de una lista||
|Ctrl+Fin<br />(Fn+Ctrl + Flecha derecha)|Seleccione la última fila de la lista; el enfoque se mueve al primer campo accionable de la fila|Desplazarse al primer mosaico de la última fila de una lista||
...
|Ctrl+Barra espaciadora<br />(Ctrl+Cmd+espacio)|Extienda la selección de filas para incluir la fila enfocada.|No aplicable|Puede usar esto después de usar Ctrl + Flecha arriba o Ctrl + Arriba/abajo para expandir su selección.|
