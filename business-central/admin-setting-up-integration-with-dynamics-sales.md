...
ms.author: bholtorf
---
# <a name="setting-up-user-accounts-for-integrating-with-microsoft-dataverse-via-data-sync"></a>Configuración de cuentas de usuario para la integración con Microsoft Dataverse
