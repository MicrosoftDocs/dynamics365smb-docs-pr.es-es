...
---
# <a name="introduction-to--and-power-bi"></a><a name="introduction-to--and-power-bi"></a>Introducción a [!INCLUDE[prod_short](includes/prod_short.md)] y Power BI
...
## <a name="what-you-can-do-with-power-bi-and-"></a><a name="what-you-can-do-with-power-bi-and-"></a>¿Qué puede hacer con Power BI y [!INCLUDE[prod_short](includes/prod_short.md)]?
...
## <a name="get-ready-to-use-power-bi"></a><a name="get-ready-to-use-power-bi"></a>Prepararse para usar Power BI
...
## <a name="track-your-business-kpis-with-power-bi-metrics"></a><a name="track-your-business-kpis-with-power-bi-metrics"></a>Realice un seguimiento de los KPI de su negocio con métricas de Power BI
