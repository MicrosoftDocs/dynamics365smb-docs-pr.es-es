...
# <a name="view-the-status-of-synchronization-jobs" />Ver el estado de los proyectos de sincronización
...
## <a name="to-view-and-resolve-synchronization-errors-for-coupled-records" />Para ver y resolver los errores de sincronización de los registros emparejados
...
## <a name="to-view-the-synchronization-log-for-a-specific-manually-synchronized-record" />Para ver el registro de sincronización de un registro específico (sincronizado manualmente)
...
## <a name="remove-couplings-between-records" />Eliminar acoplamientos entre registros
