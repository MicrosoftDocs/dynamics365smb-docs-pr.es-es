...
ms.author: soalex
---
# <a name="manage-user-settings-and-preferences" />Administrar configuraciones y preferencias de usuario
...
## <a name="types-of-user-settings" />Tipos de configuraciones de usuario
...
## <a name="overview-of-all-user-specific-changes" />Resumen de todos los cambios específicos del usuario
...
## <a name="to-review-or-delete-user-personalizations" />Para revisar o eliminar personalizaciones de usuarios
