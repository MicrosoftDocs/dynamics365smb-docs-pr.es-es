...
ms.author: jswymer
---
# <a name="closing-the-books"></a><a name="closing-the-books"></a><a name="closing-the-books"></a><a name="closing-the-books"></a>Cerrar los libros
...
## <a name="closing-book-process"></a><a name="closing-book-process"></a><a name="closing-book-process"></a><a name="closing-book-process"></a>Cerrar procesos de libros
...
## <a name="what-happens-when-you-close"></a><a name="what-happens-when-you-close"></a><a name="what-happens-when-you-close"></a><a name="what-happens-when-you-close"></a>Consecuencias del cierre
