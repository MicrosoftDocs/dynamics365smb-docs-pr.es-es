...
ms.author: jswymer
---
# <a name="closing-the-books" />Cerrar los libros
...
## <a name="closing-book-process" />Cerrar procesos de libros
...
## <a name="what-happens-when-you-close" />Consecuencias del cierre
