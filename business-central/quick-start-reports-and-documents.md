...
# <a name="basic-reports-and-documents-output-quick-start" />Inicio rápido de salida de documentos e informes básicos
...
## <a name="add-your-company-logo-to-documents" />Agregar el logotipo de su empresa a documentos
...
## <a name="run-reports" />Ejecutar informes
...
## <a name="save-reports-as-pdf-excel-or-word-documents" />Guardar los informes como documentos PDF, Excel o Word
...
### <a name="change-report-and-document-layouts" />Modificar los diseños de los informes y documentos
