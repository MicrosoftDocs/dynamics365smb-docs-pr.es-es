...
# <a name="basic-reports-and-documents-output-quick-start"></a><a name="basic-reports-and-documents-output-quick-start"></a>Inicio rápido de salida de documentos e informes básicos
...
## <a name="add-your-company-logo-to-documents"></a><a name="add-your-company-logo-to-documents"></a>Agregar el logotipo de su empresa a documentos
...
## <a name="run-reports"></a><a name="run-reports"></a>Ejecutar informes
...
## <a name="save-reports-as-pdf-excel-or-word-documents"></a><a name="save-reports-as-pdf-excel-or-word-documents"></a>Guardar los informes como documentos PDF, Excel o Word
...
### <a name="change-report-and-document-layouts"></a><a name="change-report-and-document-layouts"></a>Modificar los diseños de los informes y documentos
...
## <a name="see-related-training-at-microsoft-learn"></a><a name="see-related-training-at-microsoft-learn"></a>Consulte la formación relacionada en [Microsoft Learn](/learn/modules/work-with-reports/)
