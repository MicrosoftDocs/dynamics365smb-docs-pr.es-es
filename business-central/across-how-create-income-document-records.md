...
ms.author: edupont
---
# <a name="create-incoming-document-records" />Crear registros de documento entrantes
...
## <a name="approve-or-reject-an-incoming-document" />Para aprobar o rechazar un documento entrante
...
## <a name="create-an-incoming-document-record-by-taking-a-photo" />Para crear un registro de documento entrante tomando una foto
...
## <a name="attach-an-image-to-an-incoming-document-record-by-taking-a-photo" />Para adjuntar una imagen en un registro de documento entrante
...
## <a name="create-an-incoming-document-record-manually" />Para crear un registro de documento entrante manualmente
