...
# <a name="business-intelligence-quick-start" />Inicio rápido de inteligencia empresarial
...
## <a name="get-insights-on-your-key-points-of-interest" />Obtener información sobre sus puntos clave de interés
...
## <a name="set-up-power-bi-integration" />Configurar integración de Power BI
...
## <a name="see-related-training-at-microsoft-learnlearnpathsuse-power-bi" />Consulte la formación relacionada en [Microsoft Learn](/learn/paths/use-power-bi)
