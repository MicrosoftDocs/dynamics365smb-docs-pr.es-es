...
ms.author: bholtorf
---
# <a name="finding-pages-and-information-with-tell-me" />Búsqueda de páginas e información con Dígame
...
## <a name="find-an-action-on-the-current-page" />Encontrar una acción en la página actual
...
## <a name="find-a-page-or-a-task" />Encontrar una página o una tarea
...
## <a name="find-a-report-or-archived-information" />Encontrar un informe o información archivada
...
## <a name="find-information-in-the-help" />Encontrar información en la ayuda
...
## <a name="get-more-functionality-from-apps" />Obtenga más funcionalidad de las aplicaciones
...
## <a name="search-for-data" />Buscar datos
...
## <a name="questions" />¿Tiene alguna pregunta?
...
## <a name="see-related-microsoft-trainingtrainingmodulesuser-interface-dynamics--business-centralindex" />Consultar la [formación de Microsoft](/training/modules/user-interface-dynamics-365-business-central/index) relacionada
