...
Debe descargar la aplicación Field Service Integration desde [AppSource](https://go.microsoft.com/fwlink/?linkid=2277917) e instalarla en [!INCLUDE [prod_short](includes/prod_short.md)].
...
* Descargue e instale la aplicación Field Service Integration desde [AppSource](https://go.microsoft.com/fwlink/?linkid=2277917). Luego, en la página **Administración de extensiones**, busque la aplicación Field Service Integration y elija la acción **Configurar** para Ejecute la configuración asistida guía.
