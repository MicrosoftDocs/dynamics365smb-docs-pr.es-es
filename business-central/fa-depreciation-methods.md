...
ms.author: edupont
---
# <a name="depreciation-methods-for-fixed-assets" />Métodos de amortización de activos fijos
...
## <a name="straight-line-depreciation" />Amortización lineal
...
### <a name="depreciation-period" />Periodo de amortización
...
### <a name="fixed-yearly-percentage" />Porcentaje fijo anual
...
### <a name="fixed-yearly-amount" />Importe fijo anual
...
### <a name="example---straight-line-depreciation" />Ejemplo: amortización lineal
...
## <a name="half-year-convention-depreciation" />Amortización de convenio de medio año
...
### <a name="example---half-year-convention-depreciation" />Ejemplo - Amortización de convenio de medio año
...
## <a name="duplicating-entries-to-more-depreciation-books" />Duplicación de movimientos en más libros de amortización
