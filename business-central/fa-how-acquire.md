...
## <a name="to-create-a-fixed-asset-and-acquire-it-automatically" />Para crear un activo y adquirirlo automáticamente
...
## <a name="to-cancel-an-acquisition-cost-posting-for-one-fixed-asset" />Para anular un coste del registro de un activo
...
## <a name="to-post-the-salvage-value-together-with-the-acquisition-cost" />Para registrar el valor residual junto con el coste
