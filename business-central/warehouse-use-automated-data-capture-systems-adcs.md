...
---
# <a name="use-automated-data-capture-systems-adcs"></a><a name="use-automated-data-capture-systems-adcs"></a><a name="use-automated-data-capture-systems-adcs"></a>Utilice el sistema de captura de datos automatizado (ADCS)
...
## <a name="to-enable-web-services-for-adcs"></a><a name="to-enable-web-services-for-adcs"></a><a name="to-enable-web-services-for-adcs"></a>Para habilitar los servicios web para ADCS

Para usar el Sistema Automatizado de Captura de Datos, debe habilitar el servicio web ADCS.  

## <a name="to-enable-and-publish-the-adcs-web-service"></a><a name="to-enable-and-publish-the-adcs-web-service"></a><a name="to-enable-and-publish-the-adcs-web-service"></a>Para habilitar y publicar el servicio web ADCS
...
## <a name="to-set-up-a-warehouse-to-use-adcs"></a><a name="to-set-up-a-warehouse-to-use-adcs"></a><a name="to-set-up-a-warehouse-to-use-adcs"></a>Para configurar un almacén para utilizar ADCS (sistema de captura de datos automatizado)
...
## <a name="to-specify-an-item-to-use-adcs"></a><a name="to-specify-an-item-to-use-adcs"></a><a name="to-specify-an-item-to-use-adcs"></a>Para especificar que un producto utilice ADCS
...
## <a name="to-add-an-adcs-user"></a><a name="to-add-an-adcs-user"></a><a name="to-add-an-adcs-user"></a>Para agregar a un usuario de un ADCS
...
### <a name="to-specify-that-a-warehouse-employee-is-an-adcs-user"></a><a name="to-specify-that-a-warehouse-employee-is-an-adcs-user"></a><a name="to-specify-that-a-warehouse-employee-is-an-adcs-user"></a>Para especificar que un empleado del almacén es usuario de un ADCS
...
## <a name="to-create-and-customize-miniforms"></a><a name="to-create-and-customize-miniforms"></a><a name="to-create-and-customize-miniforms"></a>Para crear y personalizar miniformularios
...
### <a name="to-create-a-miniform-for-adcs"></a><a name="to-create-a-miniform-for-adcs"></a><a name="to-create-a-miniform-for-adcs"></a>Para crear un miniformulario para un ADCS
...
### <a name="to-customize-miniform-functions"></a><a name="to-customize-miniform-functions"></a><a name="to-customize-miniform-functions"></a>Para personalizar las funciones del miniformulario
