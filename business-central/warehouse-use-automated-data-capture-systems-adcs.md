...
## Para configurar un almacén para utilizar ADCS (sistema de captura de datos automatizado)  
...
## Para especificar que un producto utilice ADCS  
...
## Para agregar a un usuario de un ADCS  
...
### Para especificar que un empleado del almacén es usuario de un ADCS  
...
## Para crear y personalizar miniformularios
...
### Para crear un miniformulario para un ADCS  
...
### Para personalizar las funciones del miniformulario
