...
ms.author: edupont
---
# <a name="set-up-purchasers"></a><a name="set-up-purchasers"></a><a name="set-up-purchasers"></a><a name="set-up-purchasers"></a>Configurar compradores
...
## <a name="to-set-up-purchasers"></a><a name="to-set-up-purchasers"></a><a name="to-set-up-purchasers"></a><a name="to-set-up-purchasers"></a>Para configurar compradores
...
## <a name="to-assign-purchasers-to-vendors"></a><a name="to-assign-purchasers-to-vendors"></a><a name="to-assign-purchasers-to-vendors"></a><a name="to-assign-purchasers-to-vendors"></a>Para asignar compradores a proveedores
