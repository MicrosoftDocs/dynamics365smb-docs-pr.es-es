...
ms.author: edupont
---
# <a name="set-up-purchasers" />Configurar compradores
...
## <a name="to-set-up-purchasers" />Para configurar compradores
...
## <a name="to-assign-purchasers-to-vendors" />Para asignar compradores a proveedores
