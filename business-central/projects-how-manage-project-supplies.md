...
ms.author: edupont
---
# <a name="manage-job-supplies"></a><a name="manage-job-supplies"></a>Administración de suministros de proyecto
...
## <a name="to-purchase-items-or-services-for-a-job"></a><a name="to-purchase-items-or-services-for-a-job"></a>Para comprar productos o servicios para un proyecto
...
## <a name="to-view-the-value-of-purchases-for-a-job"></a><a name="to-view-the-value-of-purchases-for-a-job"></a>Para ver el valor de compras de un proyecto
...
## <a name="to-post-a-job-related-expense"></a><a name="to-post-a-job-related-expense"></a>Para registrar un gasto relacionado con el proyecto
