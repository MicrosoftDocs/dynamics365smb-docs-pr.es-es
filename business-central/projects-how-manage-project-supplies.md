...
ms.author: edupont
---
# <a name="manage-job-supplies" />Administración de suministros de proyecto
...
## <a name="to-purchase-items-or-services-for-a-job" />Para comprar productos o servicios para un proyecto
...
## <a name="to-view-the-value-of-purchases-for-a-job" />Para ver el valor de compras de un proyecto
...
## <a name="to-post-a-job-related-expense" />Para registrar un gasto relacionado con el proyecto
