...
ms.author: edupont
---
# <a name="reconcile-payments-that-cannot-be-applied-automatically" />Conciliar pagos que no se pueden liquidar automáticamente
...
## <a name="to-reconcile-payments-that-cannot-be-applied-automatically" />Para conciliar pagos que no se pueden liquidar automáticamente
