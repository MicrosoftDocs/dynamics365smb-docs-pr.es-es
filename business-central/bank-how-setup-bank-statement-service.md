...
El servicio Envestnet Yodlee Bank Feeds está instalado como una extensión de [!INCLUDE[prod_short](includes/prod_short.md)] en línea y está listo para ser activado en los países y regiones admitidos. Para obtener más información, consulte [Personalizar [!INCLUDE[prod_short](includes/prod_short.md)] mediante extensiones](ui-extensions.md).
