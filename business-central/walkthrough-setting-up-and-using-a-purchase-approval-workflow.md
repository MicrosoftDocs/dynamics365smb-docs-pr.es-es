...
---
# <a name="walkthrough-set-up-and-use-a-purchase-approval-workflow"></a>Tutorial: Configuración y uso de un flujo de trabajo de aprobación de compra
...
## <a name="create-the-approval-workflow"></a>Creación del flujo de aprobación
