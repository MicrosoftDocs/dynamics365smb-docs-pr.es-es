...
ms.author: edupont
---
# <a name="walkthrough-setting-up-and-using-a-purchase-approval-workflow" />Tutorial: Configuración y uso de un flujo de trabajo de aprobación de compra
...
### <a name="setting-up-approval-users" />Configurar usuarios de aprobación
...
#### <a name="to-set-up-yourself-and-alicia-as-approval-users" />Para configurarse a usted y a Alicia como usuarios de aprobación
...
### <a name="setting-up-notifications" />Configuración de notificaciones
...
#### <a name="to-set-up-how-and-when-you-are-notified" />Para configurar cómo y cuándo recibirá notificaciones
...
## <a name="creating-the-approval-workflow" />Creación del flujo de aprobación
...
### <a name="to-create-and-enable-a-purchase-order-approval-workflow" />Para crear y activar un flujo de trabajo de aprobación de pedido de compra
...
## <a name="use-the-approval-workflow" />Usar el flujo de trabajo de aprobación
...
### <a name="to-request-approval-of-a-purchase-order-as-alicia" />Para solicitar aprobación de un pedido de compra como Alicia
...
### <a name="to-approve-the-purchase-order-as-sean" />Para aprobar el pedido de compra como Pedro
