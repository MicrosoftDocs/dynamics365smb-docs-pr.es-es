...
ms.author: bholtorf
---
# <a name="work-with-vat-on-sales-and-purchases"></a><a name="work-with-vat-on-sales-and-purchases"></a><a name="work-with-vat-on-sales-and-purchases"></a>Trabajar con el IVA por ventas y compras
...
## <a name="calculating-and-displaying-vat-amounts-on-sales-and-purchase-documents"></a><a name="calculating-and-displaying-vat-amounts-on-sales-and-purchase-documents"></a><a name="calculating-and-displaying-vat-amounts-on-sales-and-purchase-documents"></a>Calcular y mostrar los importes del IVA en documentos de ventas y compras
...
### <a name="including-or-excluding-vat-in-prices-and-line-amounts"></a><a name="including-or-excluding-vat-in-prices-and-line-amounts"></a><a name="including-or-excluding-vat-in-prices-and-line-amounts"></a>Inclusión o exclusión del IVA en precios e importes de línea
...
#### <a name="using-vat-business-posting-groups-and-customer-price-groups"></a><a name="using-vat-business-posting-groups-and-customer-price-groups"></a><a name="using-vat-business-posting-groups-and-customer-price-groups"></a>Usar Grupos contables de IVA de negocio y grupos de precio de cliente
...
## <a name="working-with-vat-date"></a><a name="working-with-vat-date"></a><a name="working-with-vat-date"></a>Trabajar con la fecha del IVA

### <a name="vat-date-in-documents"></a><a name="vat-date-in-documents"></a><a name="vat-date-in-documents"></a>Fecha de IVA en documentos
...
### <a name="modifying-the-vat-date-in-posted-entries"></a><a name="modifying-the-vat-date-in-posted-entries"></a><a name="modifying-the-vat-date-in-posted-entries"></a>Modificar la fecha de IVA en los movimientos registrados
...
## <a name="correcting-vat-amounts-manually-on-sales-and-purchase-documents"></a><a name="correcting-vat-amounts-manually-on-sales-and-purchase-documents"></a><a name="correcting-vat-amounts-manually-on-sales-and-purchase-documents"></a>Corrección manual de los importes del IVA en los documentos de ventas y compras
...
### <a name="to-set-the-system-up-for-manual-vat-entry-in-sales-documents"></a><a name="to-set-the-system-up-for-manual-vat-entry-in-sales-documents"></a><a name="to-set-the-system-up-for-manual-vat-entry-in-sales-documents"></a>Para configurar el sistema para el movimiento de IVA manual en documentos de ventas
...
### <a name="to-adjust-vat-for-a-sales-document"></a><a name="to-adjust-vat-for-a-sales-document"></a><a name="to-adjust-vat-for-a-sales-document"></a>Para ajustar el IVA de un documento de venta
...
## <a name="calculating-vat-manually-using-journals"></a><a name="calculating-vat-manually-using-journals"></a><a name="calculating-vat-manually-using-journals"></a>Cálculo manual del IVA mediante los diarios
...
### <a name="to-set-the-system-up-for-manual-vat-entry-in-a-general-journals"></a><a name="to-set-the-system-up-for-manual-vat-entry-in-a-general-journals"></a><a name="to-set-the-system-up-for-manual-vat-entry-in-a-general-journals"></a>Para configurar el sistema para el movimiento de IVA manual en un diario general
...
### <a name="to-set-the-system-up-for-manual-vat-entry-in-a-sales-and-purchase-journals"></a><a name="to-set-the-system-up-for-manual-vat-entry-in-a-sales-and-purchase-journals"></a><a name="to-set-the-system-up-for-manual-vat-entry-in-a-sales-and-purchase-journals"></a>Para configurar el sistema para el movimiento de IVA manual en un diario de ventas y compras
...
## <a name="posting-import-vat-with-purchase-invoices"></a><a name="posting-import-vat-with-purchase-invoices"></a><a name="posting-import-vat-with-purchase-invoices"></a>Registro del IVA de importación con facturas de compra
En lugar de utilizar diarios para registrar las facturas de IVA de importación, puede utilizar facturas de compra.  

### <a name="to-set-up-purchasing-for-posting-import-vat-invoices"></a><a name="to-set-up-purchasing-for-posting-import-vat-invoices"></a><a name="to-set-up-purchasing-for-posting-import-vat-invoices"></a>Procedimiento para configurar la compra para registrar facturas de IVA de importación
...
## <a name="processing-certificates-of-supply"></a><a name="processing-certificates-of-supply"></a><a name="processing-certificates-of-supply"></a>Procesamiento de certificados de oferta
...
### <a name="to-view-certificate-of-supply-details"></a><a name="to-view-certificate-of-supply-details"></a><a name="to-view-certificate-of-supply-details"></a>Para ver detalles de un certificado de suministro
...
### <a name="to-print-a-certificate-of-supply"></a><a name="to-print-a-certificate-of-supply"></a><a name="to-print-a-certificate-of-supply"></a>Para imprimir certificado de suministro
...
### <a name="to-update-the-status-of-a-certificate-of-supply-for-a-shipment"></a><a name="to-update-the-status-of-a-certificate-of-supply-for-a-shipment"></a><a name="to-update-the-status-of-a-certificate-of-supply-for-a-shipment"></a>Para actualizar el estado de un certificado de suministro para un envío
...
### <a name="to-update-the-status-of-a-group-of-certificates-of-supply"></a><a name="to-update-the-status-of-a-group-of-certificates-of-supply"></a><a name="to-update-the-status-of-a-group-of-certificates-of-supply"></a>Para actualizar el estado de un grupo de certificados de suministro
