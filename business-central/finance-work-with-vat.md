...
ms.author: bholtorf
---
# <a name="work-with-vat-on-sales-and-purchases" />Trabajar con el IVA por ventas y compras
...
## <a name="calculating-and-displaying-vat-amounts-on-sales-and-purchase-documents" />Calcular y mostrar los importes del IVA en documentos de ventas y compras
...
### <a name="including-or-excluding-vat-in-prices-and-line-amounts" />Inclusión o exclusión del IVA en precios e importes de línea
...
#### <a name="using-vat-business-posting-groups-and-customer-price-groups" />Usar Grupos contables de IVA de negocio y grupos de precio de cliente
...
## <a name="working-with-vat-date" />Trabajar con la fecha del IVA

### <a name="vat-date-in-documents" />Fecha de IVA en documentos
...
### <a name="modifying-the-vat-date-in-posted-entries" />Modificar la fecha de IVA en los movimientos registrados
...
## <a name="correcting-vat-amounts-manually-on-sales-and-purchase-documents" />Corrección manual de los importes del IVA en los documentos de ventas y compras
...
### <a name="to-set-the-system-up-for-manual-vat-entry-in-sales-documents" />Para configurar el sistema para el movimiento de IVA manual en documentos de ventas
...
### <a name="to-adjust-vat-for-a-sales-document" />Para ajustar el IVA de un documento de venta
...
## <a name="calculating-vat-manually-using-journals" />Cálculo manual del IVA mediante los diarios
...
### <a name="to-set-the-system-up-for-manual-vat-entry-in-a-general-journals" />Para configurar el sistema para el movimiento de IVA manual en un diario general
...
### <a name="to-set-the-system-up-for-manual-vat-entry-in-a-sales-and-purchase-journals" />Para configurar el sistema para el movimiento de IVA manual en un diario de ventas y compras
...
## <a name="posting-import-vat-with-purchase-invoices" />Registro del IVA de importación con facturas de compra
En lugar de utilizar diarios para registrar las facturas de IVA de importación, puede utilizar facturas de compra.  

### <a name="to-set-up-purchasing-for-posting-import-vat-invoices" />Procedimiento para configurar la compra para registrar facturas de IVA de importación
...
### <a name="to-create-a-new-invoice-for-the-import-authority-vendor-once-you-have-completed-the-setup" />Para crear una factura nueva para la autoridad de importación una vez haya finalizado la configuración
...
## <a name="processing-certificates-of-supply" />Procesamiento de certificados de oferta
...
### <a name="to-view-certificate-of-supply-details" />Para ver detalles de un certificado de suministro
...
### <a name="to-print-a-certificate-of-supply" />Para imprimir certificado de suministro
...
### <a name="to-update-the-status-of-a-certificate-of-supply-for-a-shipment" />Para actualizar el estado de un certificado de suministro para un envío
...
### <a name="to-update-the-status-of-a-group-of-certificates-of-supply" />Para actualizar el estado de un grupo de certificados de suministro
