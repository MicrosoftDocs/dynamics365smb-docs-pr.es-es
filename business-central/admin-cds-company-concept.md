...
# <a name="data-ownership-models" />Modelos de propiedad de datos
...
## <a name="team-ownership" />Propiedad de equipo
...
## <a name="choosing-a-different-business-unit" />Elegir una unidad de negocio diferente
...
## <a name="person-ownership" />Propiedad de persona
