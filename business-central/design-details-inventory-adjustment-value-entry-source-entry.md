...
# <a name="posting-date-on-adjustment-value-entry-compared-to-the-source-entry"></a><a name="posting-date-on-adjustment-value-entry-compared-to-the-source-entry"></a>Fecha de registro en el movimiento de valor de ajuste en comparación con el movimiento de origen
...
## <a name="revaluation-scenario"></a><a name="revaluation-scenario"></a>Ejemplo de revaluación
...
### <a name="to-test-the-scenario"></a><a name="to-test-the-scenario"></a>Para probar el ejemplo
...
### <a name="conclusion"></a><a name="conclusion"></a>Conclusión
...
## <a name="item-charge-scenario"></a><a name="item-charge-scenario"></a>Ejemplo cargos producto
...
### <a name="to-test-the-scenario-1"></a><a name="to-test-the-scenario-1"></a>Para probar el ejemplo
