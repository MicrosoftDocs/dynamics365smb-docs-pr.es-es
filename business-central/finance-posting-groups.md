...
ms.author: bholtorf
---
# <a name="set-up-posting-groups"></a><a name="set-up-posting-groups"></a><a name="set-up-posting-groups"></a>Configurar los grupos contables de activos
...
## <a name="general-posting-groups"></a><a name="general-posting-groups"></a><a name="general-posting-groups"></a>Grupos contables
...
## <a name="specific-posting-groups"></a><a name="specific-posting-groups"></a><a name="specific-posting-groups"></a>Grupos contables concretos
...
## <a name="tax-posting-groups"></a><a name="tax-posting-groups"></a><a name="tax-posting-groups"></a>Grupos contables de impuestos
...
## <a name="example-of-linking-posting-groups"></a><a name="example-of-linking-posting-groups"></a><a name="example-of-linking-posting-groups"></a>Ejemplo de grupos contables de vinculación
...
## <a name="copying-posting-setup-lines"></a><a name="copying-posting-setup-lines"></a><a name="copying-posting-setup-lines"></a>Copiar líneas de configuración de grupos contables
...
## <a name="set-up-posting-groups-on-the-go"></a><a name="set-up-posting-groups-on-the-go"></a><a name="set-up-posting-groups-on-the-go"></a>Configurar grupos contables sobre la marcha
...
## <a name="troubleshooting-posting-group-errors"></a><a name="troubleshooting-posting-group-errors"></a><a name="troubleshooting-posting-group-errors"></a>Solución de problemas de errores de grupos de publicación
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Consultar la [formación de Microsoft](/training/modules/posting-groups-dynamics-365-business-central/) relacionada
