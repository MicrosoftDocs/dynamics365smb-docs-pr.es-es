...
ms.author: bholtorf
---
# <a name="set-up-posting-groups" />Configurar los grupos contables de activos
...
## <a name="general-posting-groups" />Grupos contables
...
## <a name="specific-posting-groups" />Grupos contables concretos
...
### <a name="allowing-substitute-customer-or-vendor-posting-groups-on-documents" />Permitir grupos de registro de clientes o proveedores sustitutos en documentos
...
## <a name="tax-posting-groups" />Grupos contables de impuestos
...
## <a name="example-of-linking-posting-groups" />Ejemplo de grupos contables de vinculación
...
## <a name="copying-posting-setup-lines" />Copiar líneas de configuración de grupos contables
...
## <a name="set-up-posting-groups-on-the-go" />Configurar grupos contables sobre la marcha
...
## <a name="troubleshooting-posting-group-errors" />Solución de problemas de errores de grupos de publicación
...
## <a name="see-related-microsoft-trainingtrainingmodulesposting-groups-dynamics--business-central" />Consultar la [formación de Microsoft](/training/modules/posting-groups-dynamics-365-business-central/) relacionada
