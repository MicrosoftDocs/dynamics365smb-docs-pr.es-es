...
ms.author: solsen
---
# <a name="run-batch-jobs-and-xmlports"></a><a name="run-batch-jobs-and-xmlports"></a><a name="run-batch-jobs-and-xmlports"></a><a name="run-batch-jobs-and-xmlports"></a>Ejecutar trabajos por lotes y XMLports
...
## <a name="to-run-a-batch-job"></a><a name="to-run-a-batch-job"></a><a name="to-run-a-batch-job"></a><a name="to-run-a-batch-job"></a>Para ejecutar un trabajo por lotes
