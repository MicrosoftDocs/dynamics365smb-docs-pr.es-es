...
ms.author: bholtorf
---
# <a name="onedrive-for-business-faq" />Preguntas más frecuentes de OneDrive para la Empresa
...
## <a name="is-onedrive-the-same-as-sharepoint-for-storing-files" />¿Es OneDrive lo mismo que SharePoint para almacenar archivos?
...
## <a name="are-all-onedrive-for-business-plans-supported" />¿Se admiten todos los planes de OneDrive para la Empresa?
...
## <a name="where-can-i-see-onedrive-service-health" />¿Dónde puedo ver el estado del servicio de OneDrive?
...
## <a name="how-does-this-work-in-an-organization-with-multiple-environments" />¿Cómo funciona esto en una organización con múltiples entornos?
...
## <a name="weve-changed-company-name-what-happens-to-my-previous-files" />Hemos cambiado el nombre de la empresa. ¿Qué pasa con mis archivos anteriores?
...
## <a name="i-want-to-open-files-in-sharepoint-instead-how-do-i-do-this" />Quiero abrir archivos en SharePoint. ¿Cómo lo hago?
...
## <a name="how-do-i-turn-off-integration-to-onedrive" />¿Cómo desactivo la integración con OneDrive?
...
## <a name="should-i-use-the-sharepoint-connection-setup-page-to-connect-to-sharepoint" />¿Debo usar la página Configuración de conexión de SharePoint para conectarme con SharePoint?
...
## <a name="will-microsoft-continue-to-improve-the-integration-to-onedrive" />¿Seguirá Microsoft mejorando la integración con OneDrive?
...
### <a name="business-central-cant-find-my-onedrive" />Business Central no puede encontrar mi OneDrive
...
### <a name="im-having-problems-sharing-from-outlook" />Tengo problemas para compartir desde Outlook
...
### <a name="actions-open-in-onedrive-and-share-are-missing" />Faltan las acciones Abrir en OneDrive y Compartir
