...
description: Obtenga respuestas para algunas preguntas típicas sobre el trabajo con OneDrive para el trabajo o la escuela (anteriormente conocido como OneDrive para la Empresa) y Business Central.
author: brentholtorf
...
---
# Preguntas más frecuentes de OneDrive para la Empresa
...
## ¿Funciona esto con todos los clientes de [!INCLUDE[prod_short](includes/prod_short.md)]?
...
## ¿Es OneDrive lo mismo que SharePoint para almacenar archivos?
...
## ¿Dónde puedo ver el estado del servicio de OneDrive?
...
## ¿Está disponible la integración de OneDrive en [!INCLUDE[prod_short](includes/prod_short.md)] local?
...
## Hemos cambiado el nombre de la empresa. ¿Qué pasa con mis archivos anteriores?
...
## Al adjuntar archivos a [!INCLUDE[prod_short](includes/prod_short.md)], ¿cómo elijo un archivo de OneDrive?
...
## Quiero abrir archivos en SharePoint. ¿Cómo lo hago?
...
## ¿Cómo desactivo la integración con OneDrive?
...
## ¿Debo usar la página Configuración de conexión de SharePoint para conectarme con SharePoint?
...
## ¿Qué versión de [!INCLUDE[prod_short](includes/prod_short.md)] admite OneDrive?

La integración con OneDrive pasó a estar disponible en el lanzamiento de versiones 2 de 2021.  

## <a name="features"></a>¿Qué características se ven afectadas por la integración de OneDrive?
...
## ¿Seguirá Microsoft mejorando la integración con OneDrive?
...
### Business Central no puede encontrar mi OneDrive
...
### Tengo problemas para compartir desde Outlook
...
### Faltan las acciones Abrir en OneDrive y Compartir
