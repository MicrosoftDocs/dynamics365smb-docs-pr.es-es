...
ms.author: edupont
---
# <a name="design-details-item-tracking-posting-structure" />Detalles de diseño: Estructura de registro de seguimiento de productos
...
## <a name="one-to-many-relation" />Relación de uno a varios
...
## <a name="codeunits-80-and-90" />Codeunits 80 y 90
...
## <a name="posting-the-item-journal" />Registro del diario de productos
