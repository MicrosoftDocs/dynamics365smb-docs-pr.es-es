...
ms.author: edupont
---
# <a name="design-details-item-tracking-posting-structure"></a><a name="design-details-item-tracking-posting-structure"></a>Detalles de diseño: Estructura de registro de seguimiento de productos
...
## <a name="one-to-many-relation"></a><a name="one-to-many-relation"></a>Relación de uno a varios
...
## <a name="codeunits-80-and-90"></a><a name="codeunits-80-and-90"></a>Codeunits 80 y 90
...
## <a name="posting-the-item-journal"></a><a name="posting-the-item-journal"></a>Registro del diario de productos
...
## <a name="code-unit-22"></a><a name="code-unit-22"></a>Codeunit 22
