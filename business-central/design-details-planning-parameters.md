...
---
# <a name="design-details-planning-parameters" />Detalles de diseño: parámetros de planificación
...
## <a name="define-whether-the-item-is-planned" />Definir si se planifica el producto
...
## <a name="define-when-to-reorder" />Definir cuándo reaprovisionar
...
## <a name="define-how-much-to-reorder" />Definir qué cantidad reaprovisionar
...
## <a name="optimize-when-and-how-much-to-reorder" />Optimizar cuando se produzca el reaprovisionamiento y según la cantidad de reaprovisionamiento
...
## <a name="modify-the-supply-orders" />Modificar los pedidos de suministro
...
## <a name="delimit-the-item" />Delimitación del producto
...
## <a name="use-low-level-codes-to-manage-derived-demand" />Utilizar códigos de bajo nivel para gestionar la demanda derivada
