---
title: Configurar nuevas empresas
description: Puede configurar y personalizar una nueva empresa que se haya creado con RapidStart Services. Para ajustar la implementación, procederá en tres fases para completar la configuración.
author: SorenGP
ms.topic: conceptual
ms.devlang: na
ms.tgt_pltfrm: na
...
ms.locfileid: "8515776"
---
# <a name="configure-new-companies-with-rapidstart-services"></a>Configurar nuevas empresas con RapidStart Services
...
2. Elija el icono ![Bombilla que abre la función Dígame.](media/ui-search/search_small.png "Dígame qué desea hacer") , escriba **Paquetes de configuración** y, a continuación, elija el vínculo relacionado.  
...
1. Elija el icono ![Bombilla que abre la función Dígame.](media/ui-search/search_small.png "Dígame qué desea hacer") , escriba **Paquetes de configuración** y, a continuación, elija el vínculo relacionado.  
