...
# <a name="manually-synchronize-table-mappings"></a><a name="manually-synchronize-table-mappings"></a><a name="manually-synchronize-table-mappings"></a><a name="manually-synchronize-table-mappings"></a>Sincronizar manualmente las asignaciones de tablas
...
## <a name="run-a-full-synchronization"></a><a name="run-a-full-synchronization"></a><a name="run-a-full-synchronization"></a><a name="run-a-full-synchronization"></a>Ejecutar una sincronización completa
...
### <a name="to-run-a-full-synchronization"></a><a name="to-run-a-full-synchronization"></a><a name="to-run-a-full-synchronization"></a><a name="to-run-a-full-synchronization"></a>Para ejecutar una sincronización completa
...
## <a name="synchronizing-all-modified-records"></a><a name="synchronizing-all-modified-records"></a><a name="synchronizing-all-modified-records"></a><a name="synchronizing-all-modified-records"></a>Sincronización de todos los registros modificados
...
### <a name="to-synchronize-data-for-all-tables"></a><a name="to-synchronize-data-for-all-tables"></a><a name="to-synchronize-data-for-all-tables"></a><a name="to-synchronize-data-for-all-tables"></a>Para sincronizar los datos para todas las tablas
...
## <a name="synchronize-individual-table-mappings"></a><a name="synchronize-individual-table-mappings"></a><a name="synchronize-individual-table-mappings"></a><a name="synchronize-individual-table-mappings"></a>Sincronizar las asignaciones de tablas individuales
...
### <a name="to-synchronize-records-of-an-integration-table-mapping"></a><a name="to-synchronize-records-of-an-integration-table-mapping"></a><a name="to-synchronize-records-of-an-integration-table-mapping"></a><a name="to-synchronize-records-of-an-integration-table-mapping"></a>Para sincronizar los registros de asignación de tabla de integración
