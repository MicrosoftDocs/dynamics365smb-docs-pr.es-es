...
ms.author: edupont
---
# <a name="save-and-personalize-list-views"></a><a name="save-and-personalize-list-views"></a><a name="save-and-personalize-list-views"></a><a name="save-and-personalize-list-views"></a>Guardar y personalizar vistas de lista
...
## <a name="to-save-a-view"></a><a name="to-save-a-view"></a><a name="to-save-a-view"></a><a name="to-save-a-view"></a>Para guardar una vista
...
## <a name="to-rename-or-remove-a-view"></a><a name="to-rename-or-remove-a-view"></a><a name="to-rename-or-remove-a-view"></a><a name="to-rename-or-remove-a-view"></a>Para cambiar el nombre de una vista o eliminarla
...
## <a name="managing-many-views"></a><a name="managing-many-views"></a><a name="managing-many-views"></a><a name="managing-many-views"></a>Administración de muchas vistas
