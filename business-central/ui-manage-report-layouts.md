...
ms.author: jswymer
---
# <a name="report-and-document-layouts-overview"></a><a name="report-and-document-layouts-overview"></a><a name="report-and-document-layouts-overview"></a>Información general de diseños de informes y documentos
...
## <a name="introduction"></a><a name="introduction"></a><a name="introduction"></a>Introducción
...
## <a name="layout-types"></a><a name="layout-types"></a><a name="layout-types"></a>Tipos de diseño
...
### <a name="external"></a><a name="external"></a><a name="external"></a>Externo
...
## <a name="layout-sources"></a><a name="layout-sources"></a><a name="layout-sources"></a>Orígenes de diseño
