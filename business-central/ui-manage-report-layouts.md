...
ms.author: jswymer
---
# <a name="report-and-document-layouts-overview"></a><a name="report-and-document-layouts-overview"></a><a name="report-and-document-layouts-overview"></a><a name="report-and-document-layouts-overview"></a>Información general de diseños de informes y documentos
...
## <a name="introduction"></a><a name="introduction"></a><a name="introduction"></a><a name="introduction"></a>Introducción
...
## <a name="layout-types"></a><a name="layout-types"></a><a name="layout-types"></a><a name="layout-types"></a>Tipos de diseño

Hay cuatro tipos de diseños que puede usar en los informes: Word, RDLC, Excel y externo.

### <a name="word"></a><a name="word"></a><a name="word"></a><a name="word"></a>Word
...
### <a name="rdlc"></a><a name="rdlc"></a><a name="rdlc"></a><a name="rdlc"></a>RDLC
...
### <a name="external"></a><a name="external"></a><a name="external"></a><a name="external"></a>Externo
...
## <a name="layout-sources"></a><a name="layout-sources"></a><a name="layout-sources"></a><a name="layout-sources"></a>Orígenes de diseño
...
<!--
### <a name="built-in-and-custom-report-layouts"></a><a name="built-in-and-custom-report-layouts"></a><a name="built-in-and-custom-report-layouts"></a><a name="built-in-and-custom-report-layouts"></a>Built-in and custom report layouts
