...
ms.author: bholtorf
---
# <a name="enable-automatic-breaking-bulk-with-directed-put-away-and-pick"></a><a name="enable-automatic-breaking-bulk-with-directed-put-away-and-pick"></a>Habilitar interrupción automática masiva con ubicaciones y picking directos
...
## <a name="breakbulk-in-picks"></a><a name="breakbulk-in-picks"></a>División en picking
...
## <a name="breakbulk-in-put-aways"></a><a name="breakbulk-in-put-aways"></a>Dividir bultos en almacenes
...
## <a name="breakbulk-in-movements"></a><a name="breakbulk-in-movements"></a>Dividir bultos en movimientos
