...
ms.author: bholtorf
---
# <a name="enable-automatic-breaking-bulk-with-directed-put-away-and-pick" />Habilitar interrupción automática masiva con ubicaciones y picking directos
...
## <a name="breakbulk-in-picks" />División en picking
...
## <a name="breakbulk-in-put-aways" />Dividir bultos en almacenes
...
## <a name="breakbulk-in-movements" />Dividir bultos en movimientos
