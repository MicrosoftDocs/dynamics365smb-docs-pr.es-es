...
## <a name="creating-a-regenerative-supply-plan"></a>Crear un plan de suministro regenerativo
...
## <a name="analyze-the-planning-result"></a>Analizar el resultado de planificación
...
## <a name="creating-a-net-change-plan"></a>Crear un plan de saldo periodo
...
### <a name="to-create-the-new-sales-demand-and-replan-accordingly"></a>Para crear la demanda de ventas nueva y replanificar en consecuencia
...
## <a name="analyze-the-changed-planning-result"></a>Analizar el resultado de planificación cambiado
