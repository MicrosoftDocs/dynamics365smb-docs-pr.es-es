...
## <a name="analyze-the-planning-result"></a>Análisis del resultado de planificación
...
## <a name="analyze-the-changed-planning-result"></a>Análisis del resultado de planificación modificado
