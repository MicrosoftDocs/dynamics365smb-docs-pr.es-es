...
ms.author: edupont
---
# <a name="walkthrough-planning-supplies-automatically"></a><a name="walkthrough-planning-supplies-automatically"></a>Tutorial: planificación automática de suministros
...
### <a name="to-create-stockkeeping-units"></a><a name="to-create-stockkeeping-units"></a>Para crear unidades de almacenamiento
...
### <a name="to-change-selected-planning-parameters"></a><a name="to-change-selected-planning-parameters"></a>Para cambiar los parámetros de planificación seleccionados
...
## <a name="creating-a-regenerative-supply-plan"></a><a name="creating-a-regenerative-supply-plan"></a>Creación de un plan de suministro regenerativo
...
### <a name="to-create-the-sales-order"></a><a name="to-create-the-sales-order"></a>Para crear el pedido de venta
...
### <a name="to-create-a-regenerative-plan-to-fulfill-demand-at-location-east"></a><a name="to-create-a-regenerative-plan-to-fulfill-demand-at-location-east"></a>Crear un plan regenerativo para satisfacer la demanda en el almacén EAST.
...
### <a name="to-calculate-mrp-to-include-underlying-component-needs"></a><a name="to-calculate-mrp-to-include-underlying-component-needs"></a>Para calcular MRP para incluir las necesidades subyacentes del componente
...
## <a name="analyzing-the-planning-result"></a><a name="analyzing-the-planning-result"></a>Análisis del resultado de planificación
...
### <a name="to-view-order-tracking-entries-for-item-1300"></a><a name="to-view-order-tracking-entries-for-item-1300"></a>Ver los movimientos de seguimiento del pedido para el producto 1300
...
### <a name="to-check-the-planning-parameter"></a><a name="to-check-the-planning-parameter"></a>Para comprobar el parámetro de planificación
...
### <a name="to-view-more-order-tracking-entries"></a><a name="to-view-more-order-tracking-entries"></a>Para ver más movimientos de seguimiento de pedidos
...
## <a name="carrying-out-action-messages"></a><a name="carrying-out-action-messages"></a>Realización de mensajes de acción
...
### <a name="to-automatically-create-the-suggested-supply-orders"></a><a name="to-automatically-create-the-suggested-supply-orders"></a>Para crear automáticamente los pedidos de suministros sugeridos
...
## <a name="creating-a-net-change-plan"></a><a name="creating-a-net-change-plan"></a>Creación de un plan de saldo periodo
...
### <a name="to-create-the-new-sales-demand-and-replan-accordingly"></a><a name="to-create-the-new-sales-demand-and-replan-accordingly"></a>Para crear la demanda de ventas nueva y replanificar
...
## <a name="analyzing-the-changed-planning-result"></a><a name="analyzing-the-changed-planning-result"></a>Análisis del resultado de planificación modificado
...
### <a name="to-view-order-tracking-entries-for-item-1250"></a><a name="to-view-order-tracking-entries-for-item-1250"></a>Ver los movimientos de seguimiento del pedido para el producto 1250
...
### <a name="to-view-an-existing-order"></a><a name="to-view-an-existing-order"></a>Ver un pedido existente
