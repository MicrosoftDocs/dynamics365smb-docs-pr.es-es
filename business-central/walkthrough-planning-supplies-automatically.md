...
## Historia  
 ...
 Al día siguiente, antes de que se inicie o registre alguno de los pedidos de suministro iniciales, notifican a Eduardo cuando otro cliente realiza un pedido de diez bicicletas de ruta para su envío el 12-02-2021. Eduardo vuelve a calcular para ajustar el plan de suministro según el cambio de la demanda. El nuevo cálculo arroja un plan de saldo periodo que sugiere cambios tanto en el tiempo como en la cantidad de algunos de los pedidos de suministro creados la primera vez.  
...
### Para crear unidades de almacenamiento  
...
### Para cambiar los parámetros de planificación seleccionados  
...
## Crear un plan de suministro regenerativo  
...
### Crear un plan regenerativo para satisfacer la demanda en el almacén EAST.  
...
### Para calcular MRP para incluir las necesidades subyacentes del componente  
...
## Analizar el resultado de planificación  
...
### Ver los movimientos de seguimiento del pedido para el producto 1300  
...
### Para comprobar el parámetro de planificación  
...
### Para ver más movimientos de seguimiento de pedidos  
...
1.  Seleccione la línea de planificación del producto 1110, Llanta y seleccione la acción **Seguimiento de pedido**.  
     ...
     Mismo seguimiento de pedidos se aplica a las líneas de planificación de los productos 1120, 1160, y 1170. Para el producto 1120, el campo **Cantidad por** en la L.M. de producción de cada producto de la rueda es 50 UDS, lo que da como resultado una necesidad total de 100.  
...
## Realización de mensajes de acción  
...
### Para crear automáticamente los pedidos de suministros sugeridos  
...
## Crear un plan de saldo periodo  
...
### Para crear la demanda de ventas nueva y replanificar en consecuencia  
...
## Analizar el resultado de planificación cambiado  
