...
---
# <a name="auditing-changes"></a>Auditar cambios
...
## <a name="setting-up-the-change-log"></a>Configuración del registro de cambios
...
## <a name="analyze-data-in-the-change-log"></a>Analizar datos en el registro de cambios
...
### <a name="change-log-ad-hoc-analysis-scenarios"></a>Escenarios de análisis ad hoc del registro de cambios
...
### <a name="example-who-changed-what-data-and-when"></a>Ejemplo: Quién ha cambiado qué datos y cuándo
...
### <a name="example-data-changes-by-tablefield"></a>Ejemplo: cambios de datos por tabla/campo
...
### <a name="set-up-field-monitoring"></a>Configurar supervisión de campos
...
### <a name="view-field-monitoring-telemetry"></a>Ver la telemetría de supervisar de campo
