...
ms.author: edupont
---
# <a name="auditing-changes-in-business-central"></a><a name="auditing-changes-in-business-central"></a><a name="auditing-changes-in-business-central"></a>Auditar cambios en Business Central
...
## <a name="about-the-change-log"></a><a name="about-the-change-log"></a><a name="about-the-change-log"></a>Sobre el Registro de cambios
...
### <a name="work-with-the-change-log"></a><a name="work-with-the-change-log"></a><a name="work-with-the-change-log"></a>Trabajar con el registro de cambios
...
## <a name="about-activity-logs"></a><a name="about-activity-logs"></a><a name="about-activity-logs"></a>Acerca de los registros de actividad
...
### <a name="work-with-activity-logs"></a><a name="work-with-activity-logs"></a><a name="work-with-activity-logs"></a>Trabajar con registros de actividad
...
## <a name="monitoring-sensitive-fields"></a><a name="monitoring-sensitive-fields"></a><a name="monitoring-sensitive-fields"></a>Supervisar campos confidenciales
...
### <a name="setting-up-field-monitoring"></a><a name="setting-up-field-monitoring"></a><a name="setting-up-field-monitoring"></a>Configuración de supervisión de campos
...
### <a name="work-with-field-monitoring"></a><a name="work-with-field-monitoring"></a><a name="work-with-field-monitoring"></a>Trabajar con la supervisión de campos
...
### <a name="viewing-field-monitoring-telemetry"></a><a name="viewing-field-monitoring-telemetry"></a><a name="viewing-field-monitoring-telemetry"></a>Ver la telemetría de monitoreo de campo
...
## <a name="defining-retention-policies"></a><a name="defining-retention-policies"></a><a name="defining-retention-policies"></a>Definición de directivas de retención
