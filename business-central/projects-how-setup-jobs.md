...
---
# <a name="set-up-jobs-prices-and-job-posting-groups" />Configurar proyectos, precios y grupos contables de proyectos
...
## <a name="to-set-general-information-for-jobs" />Para configurar la información general de los proyectos
...
### <a name="to-set-up-job-usage-tracking" />Para configurar el seguimiento de uso de proyecto
...
## <a name="to-set-up-prices-for-resources-items-and-general-ledger-accounts-for-jobs" />Para establecer los precios de recursos, productos y cuentas de contabilidad para trabajos
...
## <a name="to-set-up-job-posting-groups" />Para configurar grupos contables del proyecto
