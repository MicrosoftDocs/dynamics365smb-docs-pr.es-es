...
|**Tipo mov. producto**|**Tipo mov. valor**|**Tipo desviación**|**Coste previsto**|**Cuenta**|**Saldo**|  
|--------------------------------|--------------------------|-----------------------|-----------------------|-----------------|---------------------------|  
...
|Producción|Centro máquina/Centro trabajo|Coste indirecto|WIP Cuenta|Cost. gen. liqd.|  
