...
### <a name="to-create-a-reminder-automatically" />Para crear un recordatorio automáticamente
...
### <a name="to-create-a-reminder-manually" />Para crear un recordatorio manualmente
...
### <a name="to-replace-reminder-texts" />Para cambiar los textos de recordatorio
...
### <a name="to-issue-a-reminder" />Emitir un recordatorio
...
### <a name="to-cancel-an-issued-reminder" />Para cancelar un recordatorio emitido
