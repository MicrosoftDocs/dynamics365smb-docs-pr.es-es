...
ms.author: jswymer
---
# <a name="legacy-set-the-layout-used-by-a-report" />(Versión heredada) Establecer el diseño utilizado por un informe
...
## <a name="to-change-which-report-layout-to-use-for-a-report-or-document" />Para cambiar qué diseño de informe se usará para un informe o documento
...
## <a name="to-change-the-custom-layout-to-use-for-a-report-layout" />Para cambiar el diseño de informe personalizado para usar un diseño de informe
