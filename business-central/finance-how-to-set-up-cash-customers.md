...
ms.author: edupont
---
# <a name="set-up-cash-customers"></a><a name="set-up-cash-customers"></a><a name="set-up-cash-customers"></a><a name="set-up-cash-customers"></a>Configurar clientes de efectivo
...
## <a name="to-set-up-a-cash-customer"></a><a name="to-set-up-a-cash-customer"></a><a name="to-set-up-a-cash-customer"></a><a name="to-set-up-a-cash-customer"></a>Para configurar un cliente de efectivo
