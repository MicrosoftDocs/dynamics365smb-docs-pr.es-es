...
---
# <a name="set-up-intercompany-transactions"></a><a name="set-up-intercompany-transactions"></a>Configurar transacciones entre empresas vinculadas
...
## <a name="overview-of-the-steps-to-get-started"></a><a name="overview-of-the-steps-to-get-started"></a>Resumen de los pasos a seguir para empezar
...
## <a name="set-up-a-synchronization-partner"></a><a name="set-up-a-synchronization-partner"></a>Configurar un socio de sincronización
...
## <a name="set-up-the-intercompany-charts-of-accounts"></a><a name="set-up-the-intercompany-charts-of-accounts"></a>Configurar los planes de cuentas de las empresas vinculadas
...
### <a name="import-or-export-an-intercompany-chart-of-accounts"></a><a name="import-or-export-an-intercompany-chart-of-accounts"></a>Importar o exportar el plan de cuentas de empresas vinculadas
...
## <a name="map-the-intercompany-chart-of-accounts-to-your-companys-chart-of-accounts"></a><a name="map-the-intercompany-chart-of-accounts-to-your-companys-chart-of-accounts"></a>Asignar el plan de cuentas de empresas vinculadas al plan de cuentas de la empresa propia
...
## <a name="set-up-intercompany-dimensions"></a><a name="set-up-intercompany-dimensions"></a>Configurar dimensiones de empresas vinculadas
...
### <a name="import-or-export-intercompany-dimensions"></a><a name="import-or-export-intercompany-dimensions"></a>Importar o exportar dimensiones de empresas vinculadas
...
### <a name="map-intercompany-dimensions-to-your-companys-dimensions"></a><a name="map-intercompany-dimensions-to-your-companys-dimensions"></a>Asignar dimensiones de empresas vinculadas a las dimensiones de su empresa
...
## <a name="set-up-intercompany-general-journal-templates-and-batches"></a><a name="set-up-intercompany-general-journal-templates-and-batches"></a>Configurar plantillas y lotes del diario general de empresas vinculadas
...
## <a name="set-up-a-company-for-intercompany-transactions"></a><a name="set-up-a-company-for-intercompany-transactions"></a>Establecer una empresa para transacciones entre empresas vinculadas
...
## <a name="set-up-intercompany-partners"></a><a name="set-up-intercompany-partners"></a>Configurar socios de empresas vinculadas
...
### <a name="set-up-intercompany-partners-as-customers-and-vendors"></a><a name="set-up-intercompany-partners-as-customers-and-vendors"></a>Configurar socios de empresas vinculadas como empresas y proveedores
...
### <a name="set-up-default-intercompany-partner-general-ledger-accounts"></a><a name="set-up-default-intercompany-partner-general-ledger-accounts"></a>Configurar cuentas de contabilidad de socios de empresas vinculadas predeterminadas
...
### <a name="auto-accept-transactions-from-intercompany-partners"></a><a name="auto-accept-transactions-from-intercompany-partners"></a>Aceptación automática de transacciones de socios de empresas vinculadas
...
### <a name="specify-the-bank-accounts-to-use-for-intercompany-partners"></a><a name="specify-the-bank-accounts-to-use-for-intercompany-partners"></a>Especificar las cuentas bancarias que se usarán para los socios de empresas vinculadas
...
## <a name="troubleshoot-your-intercompany-setup"></a><a name="troubleshoot-your-intercompany-setup"></a>Solucionar problemas de configuración entre empresas
