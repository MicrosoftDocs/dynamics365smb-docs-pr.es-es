...
---
# Configurar transacciones entre empresas vinculadas
...
* Intercambie información sobre sus configuraciones de empresas vinculadas. Cada socio puede obtener esta información en la guía de configuración asistida de **Configuración entre entornos de socios IC**.
...
Ejecute la guía de configuración asistida **Configuración entre entornos de socios IC** en todas las empresas para especificar la información. Para iniciar la guía, en la página **Socio de empresas vinculada** , utilice la acción **Conectar externamente la configuración** .
...
> [!TIP]
> Es buena idea tener abierto un editor de texto, como el Bloc de notas, mientras crea su aplicación registrada. Necesitará parte de la información cuando ejecute la guía de configuración asistida **Configuración entre entornos de socios IC**, por lo que es bueno tener la información a mano.
...
5. En el campo **Conjunto de permisos**, elija el conjunto de permisos **API: empresas vinculadas entre entornos**.
...
### Especificar las cuentas bancarias que se usarán para los socios de empresas vinculadas
