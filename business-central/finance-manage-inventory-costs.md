...
ms.author: edupont
---
# <a name="managing-inventory-costs"></a><a name="managing-inventory-costs"></a><a name="managing-inventory-costs"></a><a name="managing-inventory-costs"></a>Gestión de costes de inventario
