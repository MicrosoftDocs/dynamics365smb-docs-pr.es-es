...
ms.author: bholtorf
---
# <a name="define-retention-policies" />Definir directivas de retención
...
## <a name="required-setups-and-permissions" />Configuraciones y permisos necesarios
...
### <a name="to-create-retention-periods" />Para crear períodos de retención
...
### <a name="set-up-a-retention-policy" />Configurar una directiva retención
...
## <a name="applying-retention-policies" />Aplicación de directivas de retención
...
## <a name="viewing-retention-policy-log-entries" />Visualización de entradas de registro de directivas de retención
...
## <a name="including-your-extension-in-a-retention-policy-requires-help-from-a-developer" />Incluir su extensión en una directiva de retención (requiere ayuda de un desarrollador)
