...
ms.author: bholtorf
---
# <a name="define-retention-policies"></a><a name="define-retention-policies"></a><a name="define-retention-policies"></a><a name="define-retention-policies"></a>Definir directivas de retención
...
## <a name="required-setups-and-permissions"></a><a name="required-setups-and-permissions"></a><a name="required-setups-and-permissions"></a><a name="required-setups-and-permissions"></a>Configuraciones y permisos necesarios
...
### <a name="to-create-retention-periods"></a><a name="to-create-retention-periods"></a><a name="to-create-retention-periods"></a><a name="to-create-retention-periods"></a>Para crear períodos de retención
...
### <a name="set-up-a-retention-policy"></a><a name="set-up-a-retention-policy"></a><a name="set-up-a-retention-policy"></a><a name="set-up-a-retention-policy"></a>Configurar una directiva retención
...
## <a name="applying-retention-policies"></a><a name="applying-retention-policies"></a><a name="applying-retention-policies"></a><a name="applying-retention-policies"></a>Aplicación de directivas de retención
...
## <a name="viewing-retention-policy-log-entries"></a><a name="viewing-retention-policy-log-entries"></a><a name="viewing-retention-policy-log-entries"></a><a name="viewing-retention-policy-log-entries"></a>Visualización de entradas de registro de directivas de retención
