...
ms.author: edupont
---
# <a name="review-and-apply-payments-manually-after-automatic-application" />Revisar y aplicar pagos manualmente después de unanaplicación automática
...
## <a name="to-review-or-apply-payments-after-automatic-application" />Para revisar o aplicar pagos después de una liquidación automática
