...
## <a name="displaying-reports-and-amounts-in-acy"></a>Mostrar los informes y los importes en la divisa adicional
...
## <a name="setting-up-an-acy"></a>Configurar una divisa de informes adicional
...
### <a name="to-activate-the-acy"></a>Activar la divisa adicional
1. Elija el icono ![Bombilla que abre la función Dígame.](media/ui-search/search_small.png "Dígame qué desea hacer") , escriba **Configuración de contabilidad**, y luego elija el enlace relacionado.  
