...
ms.author: edupont
---
# <a name="set-up-an-additional-reporting-currency"></a><a name="set-up-an-additional-reporting-currency"></a><a name="set-up-an-additional-reporting-currency"></a>Configurar una divisa de informes adicional
...
## <a name="displaying-reports-and-amounts-in-the-additional-reporting-currency"></a><a name="displaying-reports-and-amounts-in-the-additional-reporting-currency"></a><a name="displaying-reports-and-amounts-in-the-additional-reporting-currency"></a>Mostrar los informes y los importes en la divisa adicional
...
## <a name="setting-up-an-additional-reporting-currency"></a><a name="setting-up-an-additional-reporting-currency"></a><a name="setting-up-an-additional-reporting-currency"></a>Configurar una divisa de informes adicional
...
### <a name="to-specify-the-exchange-rate-adjustment-method-for-all-general-ledger-accounts"></a><a name="to-specify-the-exchange-rate-adjustment-method-for-all-general-ledger-accounts"></a><a name="to-specify-the-exchange-rate-adjustment-method-for-all-general-ledger-accounts"></a>Para especificar el método de ajuste de tipo de cambio para todas las cuentas
...
### <a name="to-specify-exchange-rate-adjustment-method-for-vat-entries"></a><a name="to-specify-exchange-rate-adjustment-method-for-vat-entries"></a><a name="to-specify-exchange-rate-adjustment-method-for-vat-entries"></a>Especificar el método de ajuste de tipo de cambio para los movimientos del IVA
...
### <a name="to-activate-the-additional-reporting-currency"></a><a name="to-activate-the-additional-reporting-currency"></a><a name="to-activate-the-additional-reporting-currency"></a>Activar la divisa adicional
1. Elija el icono ![Bombilla que abre la función Dígame.](media/ui-search/search_small.png "Dígame qué desea hacer") , escriba **Configuración de contabilidad**, y luego elija el enlace relacionado.  
