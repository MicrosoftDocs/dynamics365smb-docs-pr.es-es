...
## <a name="to-post-additional-acquisition-costs" />Para registrar costes adicionales
...
### <a name="example---posting-additional-acquisition-costs" />Ejemplo: registro de costes adicionales
