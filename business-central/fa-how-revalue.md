...
## <a name="to-post-other-acquisition-costs"></a>Para registrar costes adicionales
...
### <a name="example---posting-other-acquisition-costs"></a>Ejemplo: registro de costes adicionales
