...
ms.author: edupont
---
# <a name="create-service-orders"></a><a name="create-service-orders"></a><a name="create-service-orders"></a><a name="create-service-orders"></a>Crear pedidos de servicio
...
## <a name="to-create-a-service-order"></a><a name="to-create-a-service-order"></a><a name="to-create-a-service-order"></a><a name="to-create-a-service-order"></a>Para crear un pedido de servicio
...
## <a name="to-create-a-service-order-from-a-contract"></a><a name="to-create-a-service-order-from-a-contract"></a><a name="to-create-a-service-order-from-a-contract"></a><a name="to-create-a-service-order-from-a-contract"></a>Para crear un pedido de servicio a partir de un contrato
...
## <a name="to-convert-a-service-quote-to-a-service-order"></a><a name="to-convert-a-service-quote-to-a-service-order"></a><a name="to-convert-a-service-quote-to-a-service-order"></a><a name="to-convert-a-service-quote-to-a-service-order"></a>Para convertir una oferta de servicio en un pedido de servicio
...
## <a name="to-check-item-availability-for-one-or-more-orders"></a><a name="to-check-item-availability-for-one-or-more-orders"></a><a name="to-check-item-availability-for-one-or-more-orders"></a><a name="to-check-item-availability-for-one-or-more-orders"></a>Comprobación de la disponibilidad de los artículos para uno o varios pedidos de servicio
...
## <a name="to-reserve-an-item-for-a-service-order"></a><a name="to-reserve-an-item-for-a-service-order"></a><a name="to-reserve-an-item-for-a-service-order"></a><a name="to-reserve-an-item-for-a-service-order"></a>Reservar un artículo para un pedido de servicio
...
## <a name="to-insert-lines-based-on-standard-service-codes"></a><a name="to-insert-lines-based-on-standard-service-codes"></a><a name="to-insert-lines-based-on-standard-service-codes"></a><a name="to-insert-lines-based-on-standard-service-codes"></a>Para insertar líneas basadas en el servicio estándar
...
## <a name="to-register-internal-or-public-comments"></a><a name="to-register-internal-or-public-comments"></a><a name="to-register-internal-or-public-comments"></a><a name="to-register-internal-or-public-comments"></a>Para registrar comentarios internos o públicos
...
## <a name="to-delete-invoiced-service-orders"></a><a name="to-delete-invoiced-service-orders"></a><a name="to-delete-invoiced-service-orders"></a><a name="to-delete-invoiced-service-orders"></a>Para eliminar pedidos de servicio facturados
