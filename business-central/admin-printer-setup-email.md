...
---
# <a name="set-up-email-printers"></a><a name="set-up-email-printers"></a><a name="set-up-email-printers"></a>Configurar impresoras por correo electrónico
...
## <a name="add-an-email-printer"></a><a name="add-an-email-printer"></a><a name="add-an-email-printer"></a>Agregar una impresora de correo electrónico
