...
## <a name="to-add-prepayment-accounts-to-the-general-posting-setup" />Para agregar cuentas de prepago a la configuración de grupos contables
...
## <a name="to-set-up-number-series-for-prepayment-documents" />Configurar números de serie para documentos de prepago
...
## <a name="to-set-up-prepayment-percentages-for-items-customers-and-vendors" />Definir porcentajes de prepago para productos, clientes y vendedores
...
### <a name="to-determine-which-prepayment-percentage-has-first-priority" />Para determinar qué porcentaje de prepago tiene prioridad
...
## <a name="to-automatically-release-sales-orders-when-prepayments-are-applied" />Para liberar automáticamente pedidos de venta cuando se aplican prepagos
