...
## <a name="xbrl-comprises-the-following-components"></a>XBRL consta de los siguientes componentes
...
## <a name="set-up-xbrl-lines"></a>Configurar líneas XBRL
...
## <a name="import-an-xbrl-taxonomy"></a>Importar taxonomías XBRL
...
## <a name="update-an-xbrl-taxonomy"></a>Actualizar una taxonomía XBRL
...
## <a name="see-related-training-at-microsoft-learn"></a>Consulte la formación relacionada en [Microsoft Learn](/learn/modules/xbrl-reports-dynamics-365-business-central/index)
