...
ms.author: edupont
---
# <a name="create-reports-with-xbrl"></a><a name="create-reports-with-xbrl"></a><a name="create-reports-with-xbrl"></a>Crear informes con XBRL
...
## <a name="extensible-business-reporting-language"></a><a name="extensible-business-reporting-language"></a><a name="extensible-business-reporting-language"></a>eXtensible Business Reporting Language (Lenguaje ampliado para informes comerciales)
...
## <a name="xbrl-comprises-the-following-components"></a><a name="xbrl-comprises-the-following-components"></a><a name="xbrl-comprises-the-following-components"></a>XBRL consta de los siguientes componentes
...
## <a name="layered-taxonomies"></a><a name="layered-taxonomies"></a><a name="layered-taxonomies"></a>Taxonomías por niveles
...
## <a name="linkbases"></a><a name="linkbases"></a><a name="linkbases"></a>Base de enlaces
...
## <a name="set-up-xbrl-lines"></a><a name="set-up-xbrl-lines"></a><a name="set-up-xbrl-lines"></a>Configurar líneas XBRL
...
## <a name="import-an-xbrl-taxonomy"></a><a name="import-an-xbrl-taxonomy"></a><a name="import-an-xbrl-taxonomy"></a>Importar taxonomías XBRL
...
## <a name="update-an-xbrl-taxonomy"></a><a name="update-an-xbrl-taxonomy"></a><a name="update-an-xbrl-taxonomy"></a>Actualizar una taxonomía XBRL
...
## <a name="see-related-training-at-microsoft-learn"></a><a name="see-related-training-at-microsoft-learn"></a><a name="see-related-training-at-microsoft-learn"></a>Consulte la formación relacionada en [Microsoft Learn](/learn/modules/xbrl-reports-dynamics-365-business-central/index)
