...
---
# <a name="outbound-warehouse-processes"></a><a name="outbound-warehouse-processes"></a><a name="outbound-warehouse-processes"></a><a name="outbound-warehouse-processes"></a>Procesos de almacén salientes
...
### <a name="1-release-a-source-document"></a><a name="1-release-a-source-document"></a><a name="1-release-a-source-document"></a><a name="1-release-a-source-document"></a>1: Lanzar un documento de origen
...
### <a name="2-create-an-inventory-pick"></a><a name="2-create-an-inventory-pick"></a><a name="2-create-an-inventory-pick"></a><a name="2-create-an-inventory-pick"></a>2: Crear un picking de inventario
...
### <a name="3-post-an-inventory-pick"></a><a name="3-post-an-inventory-pick"></a><a name="3-post-an-inventory-pick"></a><a name="3-post-an-inventory-pick"></a>3: Registrar un picking de inventario
...
### <a name="1-release-a-source-document-1"></a><a name="1-release-a-source-document-1"></a><a name="1-release-a-source-document-1"></a><a name="1-release-a-source-document-1"></a>1: Lanzar un documento de origen
...
### <a name="2-create-a-warehouse-shipment"></a><a name="2-create-a-warehouse-shipment"></a><a name="2-create-a-warehouse-shipment"></a><a name="2-create-a-warehouse-shipment"></a>2: Crear un envío de almacén
...
### <a name="3-create-a-warehouse-pick"></a><a name="3-create-a-warehouse-pick"></a><a name="3-create-a-warehouse-pick"></a><a name="3-create-a-warehouse-pick"></a>3: Crear un picking de almacén
...
### <a name="4-register-a-warehouse-pick"></a><a name="4-register-a-warehouse-pick"></a><a name="4-register-a-warehouse-pick"></a><a name="4-register-a-warehouse-pick"></a>4: Registrar una selección de almacén
...
### <a name="5-post-the-warehouse-shipment"></a><a name="5-post-the-warehouse-shipment"></a><a name="5-post-the-warehouse-shipment"></a><a name="5-post-the-warehouse-shipment"></a>5: Registrar el envío de almacén
