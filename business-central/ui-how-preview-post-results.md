...
ms.author: solsen
---
# <a name="preview-posting-results"></a><a name="preview-posting-results"></a>Vista previa de los resultados del registro
...
## <a name="to-preview-gl-entries-that-will-result-from-posting-a-purchase-invoice"></a><a name="to-preview-gl-entries-that-will-result-from-posting-a-purchase-invoice"></a>Para obtener una vista previa de los movimientos contables que resultarán de registrar una factura de compra
