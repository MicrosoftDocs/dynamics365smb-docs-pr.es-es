...
ms.author: edupont
---
# <a name="design-details-cost-adjustment"></a><a name="design-details-cost-adjustment"></a><a name="design-details-cost-adjustment"></a>Detalles de diseño: Ajuste de coste
...
## <a name="detecting-the-adjustment"></a><a name="detecting-the-adjustment"></a><a name="detecting-the-adjustment"></a>Detección del ajuste
...
### <a name="item-application-entry"></a><a name="item-application-entry"></a><a name="item-application-entry"></a>Liq. mov. producto
...
### <a name="average-cost-adjustment-entry-point"></a><a name="average-cost-adjustment-entry-point"></a><a name="average-cost-adjustment-entry-point"></a>Punto de movimiento de ajuste de coste medio
...
### <a name="order-level"></a><a name="order-level"></a><a name="order-level"></a>Nivel de pedido
...
## <a name="manual-versus-automatic-cost-adjustment"></a><a name="manual-versus-automatic-cost-adjustment"></a><a name="manual-versus-automatic-cost-adjustment"></a>Ajuste de coste manual y automático
...
## <a name="adjust-cost---item-entries-batch-job"></a><a name="adjust-cost---item-entries-batch-job"></a><a name="adjust-cost---item-entries-batch-job"></a>Proceso Valorar stock - movs. producto
...
#### <a name="value-entries-1"></a><a name="value-entries-1"></a><a name="value-entries-1"></a>Movimientos de valor (1)
...
#### <a name="relation-entries-in-the-gl--item-ledger-relation-table-1"></a><a name="relation-entries-in-the-gl--item-ledger-relation-table-1"></a><a name="relation-entries-in-the-gl--item-ledger-relation-table-1"></a>Movimientos de relación en C/G: tabla Relación movs. productos (1)
...
#### <a name="general-ledger-entries-1"></a><a name="general-ledger-entries-1"></a><a name="general-ledger-entries-1"></a>Movimientos de contabilidad (1)
...
#### <a name="value-entries-2"></a><a name="value-entries-2"></a><a name="value-entries-2"></a>Movimientos de valor (2)
...
#### <a name="relation-entries-in-the-gl--item-ledger-relation-table-2"></a><a name="relation-entries-in-the-gl--item-ledger-relation-table-2"></a><a name="relation-entries-in-the-gl--item-ledger-relation-table-2"></a>Movimientos de relación en C/G: tabla Relación movs. productos (2)
...
#### <a name="general-ledger-entries-2"></a><a name="general-ledger-entries-2"></a><a name="general-ledger-entries-2"></a>Movimientos de contabilidad (2)
...
## <a name="automatic-cost-adjustment"></a><a name="automatic-cost-adjustment"></a><a name="automatic-cost-adjustment"></a>Ajuste automático coste
...
### <a name="example-1"></a><a name="example-1"></a><a name="example-1"></a>Ejemplo
