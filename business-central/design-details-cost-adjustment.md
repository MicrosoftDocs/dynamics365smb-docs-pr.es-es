...
ms.author: edupont
---
# <a name="design-details-cost-adjustment" />Detalles de diseño: Ajuste de coste
...
## <a name="detecting-the-adjustment" />Detección del ajuste
...
### <a name="item-application-entry" />Liq. mov. producto
...
### <a name="average-cost-adjustment-entry-point" />Punto de movimiento de ajuste de coste medio
...
### <a name="order-level" />Nivel de pedido
...
## <a name="manual-versus-automatic-cost-adjustment" />Ajuste de coste manual y automático
...
## <a name="adjust-cost---item-entries-batch-job" />Proceso Valorar stock - movs. producto
...
## <a name="automatic-cost-adjustment" />Ajuste automático coste
