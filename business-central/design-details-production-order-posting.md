...
ms.author: edupont
---
# <a name="design-details-production-order-posting"></a><a name="design-details-production-order-posting"></a><a name="design-details-production-order-posting"></a><a name="design-details-production-order-posting"></a>Detalles de diseño: Registro de órdenes de producción
...
## <a name="posting-structure"></a><a name="posting-structure"></a><a name="posting-structure"></a><a name="posting-structure"></a>Estructura de registro
...
## <a name="capacity-posting"></a><a name="capacity-posting"></a><a name="capacity-posting"></a><a name="capacity-posting"></a>Registro de capacidad
...
## <a name="production-order-costing"></a><a name="production-order-costing"></a><a name="production-order-costing"></a><a name="production-order-costing"></a>Gestión de costes del pedido de producción
