...
# <a name="validate-vat-registration-numbers"></a><a name="validate-vat-registration-numbers"></a>Validar un CIF/NIF
...
## <a name="configure-the-service-to-verify-vat-registration-numbers-automatically"></a><a name="configure-the-service-to-verify-vat-registration-numbers-automatically"></a>Configure el servicio para verificar los CIF/NIF automáticamente
...
## <a name="validation-templates"></a><a name="validation-templates"></a>Plantillas de validación
