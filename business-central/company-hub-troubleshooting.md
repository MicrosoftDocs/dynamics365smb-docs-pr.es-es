...
ms.author: edupont
---
# <a name="troubleshooting-your-company-hub" />Solución de problemas del hub de empresas
...
## <a name="check-errors" />Comprobar errores
...
## <a name="connection-failed" />Error de conexión
...
## <a name="data-does-not-refresh" />Los datos no se actualizan
