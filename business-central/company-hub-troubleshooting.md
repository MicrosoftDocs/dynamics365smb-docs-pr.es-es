...
ms.author: edupont
---
# <a name="troubleshooting-your-company-hub"></a><a name="troubleshooting-your-company-hub"></a>Solución de problemas del hub de empresas
...
## <a name="check-errors"></a><a name="check-errors"></a>Comprobar errores
...
## <a name="connection-failed"></a><a name="connection-failed"></a>Error de conexión
...
## <a name="data-does-not-refresh"></a><a name="data-does-not-refresh"></a>Los datos no se actualizan
