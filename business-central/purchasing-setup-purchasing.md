...
## <a name="exact-cost-reversing" />Reversión de coste exacto
...
## <a name="see-related-training-at-microsoft-learn" />Consulte la formación relacionada en [Microsoft Learn](/learn/paths/trade-get-started-dynamics-365-business-central/).
