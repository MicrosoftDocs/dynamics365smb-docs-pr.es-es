...
4. En las pestañas rápidas **Número de serie**, **Número de lote** y **Seguimiento de paquete**, defina políticas de seguimiento de artículos por número de serie, lote y paquete respectivamente.  
...
## <a name="to-specify-opening-balances-for-the-items-you-track"></a>Para especificar los saldos de apertura de los artículos que realiza el seguimiento
