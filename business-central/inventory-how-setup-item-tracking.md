...
ms.author: edupont
---
# <a name="set-up-item-tracking-with-serial-lot-and-package-numbers"></a><a name="set-up-item-tracking-with-serial-lot-and-package-numbers"></a><a name="set-up-item-tracking-with-serial-lot-and-package-numbers"></a>Configurar el seguimiento de productos con números de serie, de lote y de paquete
...
## <a name="numbers-and-item-tracking"></a><a name="numbers-and-item-tracking"></a><a name="numbers-and-item-tracking"></a>Seguimiento de números y productos
...
## <a name="to-set-up-item-tracking-codes"></a><a name="to-set-up-item-tracking-codes"></a><a name="to-set-up-item-tracking-codes"></a>Para configurar códigos de seguimiento de producto
...
## <a name="to-set-up-expiration-rules-for-serial-or-lot-numbers"></a><a name="to-set-up-expiration-rules-for-serial-or-lot-numbers"></a><a name="to-set-up-expiration-rules-for-serial-or-lot-numbers"></a>Para configurar las reglas de caducidad para números de serie o lote
...
## <a name="to-set-up-warranties-for-serial-or-lot-numbers"></a><a name="to-set-up-warranties-for-serial-or-lot-numbers"></a><a name="to-set-up-warranties-for-serial-or-lot-numbers"></a>Para configurar garantías para números de serie o lote
...
## <a name="to-set-up-items-for-tracking-with-the-correct-item-tracking-codes"></a><a name="to-set-up-items-for-tracking-with-the-correct-item-tracking-codes"></a><a name="to-set-up-items-for-tracking-with-the-correct-item-tracking-codes"></a>Para configurar los productos para el seguimiento con los códigos de seguimiento de productos correctos
...
## <a name="to-specify-opening-balances-for-the-items-you-track"></a><a name="to-specify-opening-balances-for-the-items-you-track"></a><a name="to-specify-opening-balances-for-the-items-you-track"></a>Para especificar saldos iniciales para los productos que sigue
...
### <a name="item-journals"></a><a name="item-journals"></a><a name="item-journals"></a>Diarios de productos
