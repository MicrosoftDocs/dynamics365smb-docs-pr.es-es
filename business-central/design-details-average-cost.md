...
ms.author: bholtorf
---
# <a name="design-details-average-cost" />Detalles de diseño: coste medio
...
## <a name="setting-up-average-cost-calculation" />Configurar el cálculo del coste medio
...
## <a name="calculating-average-cost" />Cálculo de coste promedio
...
### <a name="example-average-cost-period--day" />Ejemplo: Periodo de coste medio = Día
...
### <a name="example-average-cost-period--month" />Ejemplo: Periodo de coste medio = Mes
...
## <a name="setting-the-valuation-date" />Definición de la fecha de valoración
...
## <a name="recalculating-average-cost" />Nuevo cálculo de coste promedio
...
### <a name="example-of-recalculated-average-cost" />Ejemplo de coste medio recalculado
