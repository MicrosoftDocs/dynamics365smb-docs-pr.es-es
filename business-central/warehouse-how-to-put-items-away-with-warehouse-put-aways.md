...
---
# <a name="put-items-away-with-warehouse-put-aways" />Ubicar productos con ubic. exist. almacén
...
## <a name="to-create-put-away-documents-in-bulk-with-the-put-away-worksheet" />Para crear documentos de almacenamiento de forma masiva con la hoja de trabajo de almacenamiento
...
## <a name="to-create-a-put-away-from-a-posted-receipt" />Para crear una ubicación desde una recepción registrada
...
## <a name="to-put-items-away" />Para almacenar productos
