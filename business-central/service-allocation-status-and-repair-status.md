...
ms.author: bholtorf
---
# <a name="allocation-status-and-repair-status-of-service-items" />Estado de asignación y estado de reparación de productos de servicio
...
## <a name="changing-repair-status" />Modificar el estado de reparación
...
## <a name="converting-service-quotes-to-service-orders" />Convertir ofertas de servicios a pedidos de servicios
...
## <a name="canceling-allocations" />anular asignaciones
...
## <a name="reallocating-an-active-allocation-entry" />Reasignar un movimiento de asignación activo
...
## <a name="reallocating-a-service-item" />Reasignar un artículo de servicio
