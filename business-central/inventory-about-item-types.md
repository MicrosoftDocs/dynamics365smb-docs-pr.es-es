...
ms.author: edupont
---
# <a name="about-item-types" />Acerca de los tipos de productos
...
## <a name="costing-methods-for-types-of-items" />Valoración de existencias para tipos de productos
...
## <a name="catalog-and-service-items" />Productos de catálogo y de servicio
