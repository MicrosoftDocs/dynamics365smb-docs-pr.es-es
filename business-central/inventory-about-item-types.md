...
ms.author: edupont
---
# <a name="about-item-types"></a><a name="about-item-types"></a><a name="about-item-types"></a><a name="about-item-types"></a>Acerca de los tipos de productos
...
## <a name="costing-methods-for-types-of-items"></a><a name="costing-methods-for-types-of-items"></a><a name="costing-methods-for-types-of-items"></a><a name="costing-methods-for-types-of-items"></a>Valoración de existencias para tipos de productos
...
## <a name="catalog-and-service-items"></a><a name="catalog-and-service-items"></a><a name="catalog-and-service-items"></a><a name="catalog-and-service-items"></a>Productos de catálogo y de servicio
