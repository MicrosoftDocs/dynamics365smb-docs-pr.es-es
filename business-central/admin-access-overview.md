...
# <a name="manage-access-to-business-central"></a><a name="manage-access-to-business-central"></a>Administrar acceso a Business Central
...
## <a name="layered-access"></a><a name="layered-access"></a>Acceso por niveles
...
## <a name="licenses"></a><a name="licenses"></a>Licencias
...
## <a name="business-central-administrator-tasks"></a><a name="business-central-administrator-tasks"></a>Tareas del administrador de Business Central
...
## <a name="business-central-developer-tasks"></a><a name="business-central-developer-tasks"></a>Tareas para desarrolladores de Business Central
