...
---
# Usar aplicaciones de [!INCLUDE [prod_short](includes/prod_short.md)] en Power BI
...
## Instale una aplicación de [!INCLUDE[prod_short](includes/prod_short.md)] en Power BI
...
## Conecte la aplicación de [!INCLUDE[prod_short](includes/prod_short.md)] a sus datos
...
### Mensaje: No hay informes habilitados. Seleccione el informe para ver una lista de informes que se pueden visualizar.
...
### Necesita una licencia Power BI Pro para instalar la aplicación de [!INCLUDE[prod_short](includes/prod_short.md)] en Power BI
...
### "Error en la validación de parámetros, asegúrese de que todos los parámetros sean válidos"
...
### Mensaje: Su fuente de datos no se puede actualizar porque las credenciales no son válidas. Actualice sus credenciales y vuelva a intentarlo.
...
### La clave no coincidía con ninguna fila de la tabla
...
### Parece que faltan datos históricos
...
### Solo veo datos de una sola empresa
