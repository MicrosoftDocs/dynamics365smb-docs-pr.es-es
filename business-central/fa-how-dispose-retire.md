...
Los siguientes pasos asumen que sus grupos de contabilización están configurados en la página **A/F Grupo contable**. Para obtener más información, vea [Para configurar los grupos contables de activos fijos](fa-how-setup-general.md#to-set-up-fixed-asset-posting-groups).  
