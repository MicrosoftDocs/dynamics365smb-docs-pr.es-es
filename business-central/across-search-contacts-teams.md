...
# <a name="searching-for-customers-vendors-and-other-contacts-from-microsoft-teams" />Búsqueda de clientes, proveedores y otros contactos desde Microsoft Teams
...
## <a name="look-up-contacts-from-the-command-box" />Buscar contactos desde el cuadro de comando
...
## <a name="look-up-contacts-from-the-message-compose-box" />Buscar contactos desde el cuadro de redacción del mensaje
...
### <a name="heres-another-way" />Aquí hay otra forma
...
## <a name="viewing-contact-card-details" />Ver detalles de la ficha de contacto
