...
ms.search.form: 9171
---
# <a name="manage-user-profiles"></a><a name="manage-user-profiles"></a><a name="manage-user-profiles"></a><a name="manage-user-profiles"></a>Administración de perfiles de usuario
...
## <a name="page-customization"></a><a name="page-customization"></a><a name="page-customization"></a><a name="page-customization"></a>Personalización de página
...
## <a name="to-create-a-profile"></a><a name="to-create-a-profile"></a><a name="to-create-a-profile"></a><a name="to-create-a-profile"></a>Para crear un perfil
...
## <a name="to-copy-a-profile"></a><a name="to-copy-a-profile"></a><a name="to-copy-a-profile"></a><a name="to-copy-a-profile"></a>Para copiar un perfil
...
## <a name="to-edit-a-profile"></a><a name="to-edit-a-profile"></a><a name="to-edit-a-profile"></a><a name="to-edit-a-profile"></a>Para editar un perfil
...
## <a name="to-assign-a-profile-to-a-user"></a><a name="to-assign-a-profile-to-a-user"></a><a name="to-assign-a-profile-to-a-user"></a><a name="to-assign-a-profile-to-a-user"></a>Para asignar un perfil a un usuario
...
## <a name="to-define-user-settings-for-a-profile"></a><a name="to-define-user-settings-for-a-profile"></a><a name="to-define-user-settings-for-a-profile"></a><a name="to-define-user-settings-for-a-profile"></a>Para definir la configuración de usuario para un perfil
...
## <a name="to-activate-a-profile"></a><a name="to-activate-a-profile"></a><a name="to-activate-a-profile"></a><a name="to-activate-a-profile"></a>Para activar un perfil
...
## <a name="to-export-profiles"></a><a name="to-export-profiles"></a><a name="to-export-profiles"></a><a name="to-export-profiles"></a>Para exportar perfiles
...
## <a name="to-import-profiles"></a><a name="to-import-profiles"></a><a name="to-import-profiles"></a><a name="to-import-profiles"></a>Para importar perfiles
...
## <a name="to-delete-a-profile"></a><a name="to-delete-a-profile"></a><a name="to-delete-a-profile"></a><a name="to-delete-a-profile"></a>Para eliminar un perfil
...
## <a name="to-delete-all-personalizations-made-by-a-user"></a><a name="to-delete-all-personalizations-made-by-a-user"></a><a name="to-delete-all-personalizations-made-by-a-user"></a><a name="to-delete-all-personalizations-made-by-a-user"></a>Para eliminar todas las personalizaciones efectuadas por un usuario
...
## <a name="to-delete-personalizations-for-specific-pages"></a><a name="to-delete-personalizations-for-specific-pages"></a><a name="to-delete-personalizations-for-specific-pages"></a><a name="to-delete-personalizations-for-specific-pages"></a>Para eliminar las personalizaciones de páginas específicas
...
## <a name="managing-user-sessions"></a><a name="managing-user-sessions"></a><a name="managing-user-sessions"></a><a name="managing-user-sessions"></a>Administrar sesiones de usuario
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Consultar la [formación de Microsoft](/training/modules/users-security-dynamics-365-business-central/) relacionada
