...
ms.author: bholtorf
---
# Depreciar o amortizar activos fijos
...
## Para calcular la amortización de forma manual
...
## Para registrar una apreciación manualmente desde el diario general de activos fijos
...
## Para administrar el valor contable final
...
## Para calcular distribuciones en el diario general de activos
...
## Use las listas de duplicados para preparar el registro a varios libros de amortización
...
## Para registrar movimientos en distintos libros de amortización
...
## Para copiar los movimientos de activos entre los libros de amortización
...
## Consultar la [formación de Microsoft](/training/modules/calculate-post-depreciations/) relacionada
