...
ms.author: edupont
---
# <a name="set-up-fixed-asset-maintenance" />Configure el mantenimiento de los activos fijos
...
## <a name="to-set-up-general-maintenance-information" />Para configurar la información general de mantenimiento
...
## <a name="to-set-up-maintenance-codes" />Para configurar los códigos de mantenimiento
...
## <a name="to-set-up-maintenance-expense-accounts" />Para configurar las cuentas de gastos de mantenimiento
