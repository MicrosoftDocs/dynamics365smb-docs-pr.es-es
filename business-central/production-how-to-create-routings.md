...
ms.author: edupont
---
# <a name="create-routings"></a><a name="create-routings"></a>Creación de rutas
...
## <a name="to-create-a-routing"></a><a name="to-create-a-routing"></a>Para crear una ruta
...
## <a name="to-create-routing-links"></a><a name="to-create-routing-links"></a>Para crear conexiones de ruta
...
## <a name="to-assign-personnel-tools-and-quality-measures-to-routing-operations"></a><a name="to-assign-personnel-tools-and-quality-measures-to-routing-operations"></a>Para asignar personal, herramientas y medidas de calidad a operaciones de ruta
...
## <a name="to-create-a-new-versions-of-a-routing"></a><a name="to-create-a-new-versions-of-a-routing"></a>Para crear una versión de ruta nueva
