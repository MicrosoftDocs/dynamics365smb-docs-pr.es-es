...
ms.author: edupont
---
# <a name="create-routings" />Creación de rutas
...
## <a name="to-create-a-routing" />Para crear una ruta
...
## <a name="to-create-routing-links" />Para crear conexiones de ruta
...
## <a name="to-assign-personnel-tools-and-quality-measures-to-routing-operations" />Para asignar personal, herramientas y medidas de calidad a operaciones de ruta
...
## <a name="to-create-a-new-versions-of-a-routing" />Para crear una versión de ruta nueva
