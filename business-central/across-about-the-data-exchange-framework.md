...
ms.author: edupont
---
# <a name="about-the-data-exchange-framework" />Acerca del marco de intercambio de datos
...
## <a name="electronic-documents" />Documentos electrónicos
...
## <a name="bank-files" />Archivos bancarios
...
## <a name="currency-exchange-rates" />Tipos cambio divisa
