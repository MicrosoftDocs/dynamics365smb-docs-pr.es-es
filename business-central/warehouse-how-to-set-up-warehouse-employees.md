...
---
# <a name="set-up-warehouse-employees"></a><a name="set-up-warehouse-employees"></a>Configurar los empleados de almacén
...
## <a name="to-set-up-warehouse-employees"></a><a name="to-set-up-warehouse-employees"></a>Para configurar los empleados de almacén
