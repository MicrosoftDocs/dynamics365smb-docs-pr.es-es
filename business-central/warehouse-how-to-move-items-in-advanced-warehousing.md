...
# <a name="move-items-in-advanced-warehouse-configurations-that-use-directed-put-away-and-pick" />Mover productos en configuraciones avanzadas de almacén que usan almacenamiento y picking dirigidos
...
## <a name="warehouse-movement-worksheet" />Hoja de trabajo de movimiento de almacén

### <a name="to-move-items-with-the-warehouse-movement-worksheet" />Para mover los artículos con la hoja de cálculo del movimiento de almacén
...
### <a name="to-register-the-warehouse-movement" />Para registrar el movimiento de almacén
...
## <a name="internal-pick" />Picking interno

### <a name="to-create-an-internal-pick" />Para crear un picking interno
...
### <a name="to-register-the-warehouse-pick" />Para registrar el picking de almacén
...
## <a name="internal-put-away" />Almacenamiento interno

### <a name="to-create-an-internal-put-away" />Para crear un ubicación interna
...
### <a name="to-register-the-warehouse-put-away" />Para registrar el almacenamiento de almacén
...
## <a name="to-register-a-movement-that-has-already-happened" />Para registrar un movimiento que ya ha ocurrido
