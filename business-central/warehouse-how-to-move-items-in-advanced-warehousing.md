...
3. Si es necesario, indique su identificador de usuario cuando comience a trabajar en un almacenamiento.  
  ...
  > [!NOTE]  
  > Las líneas se ordenan en orden ascendente por los criterios seleccionados. Si ordena por documento, la ordenación se realiza primero por tipo de documento según la enumeración **Documento de origen de la actividad de almacén** . Si ordena por destino de envío, la clasificación se realiza por tipo de destino según el campo **Tipo de destino de almacén**.
