...
# <a name="add-marketing-text-to-items" />Agregar texto de marketing para productos
...
## <a name="a-namecopilotacreate-ai-generated-marketing-text-preview-with-copilot" /><a name=copilot></a>Crear texto de marketing generado por IA (vista previa) con Copilot
...
### <a name="create-first-draft-with-copilot" />Crear un primer borrador con Copilot
...
### <a name="review-edit-and-save-text" />Revisar, editar y guardar texto
...
### <a name="improve-and-tailor-text-suggestions" />Mejorar y adaptar las sugerencias de texto
...
## <a name="create-marketing-text-from-scratch" />Crear texto de marketing desde cero
