...
# <a name="printer-setup-and-management-overview"></a><a name="printer-setup-and-management-overview"></a><a name="printer-setup-and-management-overview"></a>Descripción general de la configuración y administración de la impresora
...
## <a name="what-are-your-printer-possibilities-in-business-central"></a><a name="what-are-your-printer-possibilities-in-business-central"></a><a name="what-are-your-printer-possibilities-in-business-central"></a>¿Cuáles son sus posibilidades de impresión en Business Central?
...
## <a name="custom-printer-extensions"></a><a name="custom-printer-extensions"></a><a name="custom-printer-extensions"></a>Extensiones de impresora personalizadas
