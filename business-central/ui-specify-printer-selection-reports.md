...
## <a name="set-a-printer-as-a-default-printer-for-all-print-jobs" />Configurar una impresora como impresora predeterminada para todos los trabajos de impresión
...
## <a name="set-a-default-printer-for-specific-reports" />Establecer una impresora predeterminada para informes específicos
...
## <a name="choosing-the-printer-when-running-a-report" />Elección de la impresora al generar un informe
...
## <a name="sizing-print-jobs" />Cambio de tamaño de los trabajos de impresión
