...
# <a name="handling-lot-sizes-in-production" />Manejo de tamaños de lote en producción
...
## <a name="units-of-measure-in-production-bill-of-materials" />Unidades de medida en la lista de materiales de producción
...
## <a name="lot-size-on-routing-lines" />Tamaño de lote en líneas de enrutamiento
...
## <a name="lot-sizes-for-items-and-stockkeeping-units" />Tamaños de lote para artículos y unidades de almacenamiento
...
## <a name="lot-size-on-item-and-stockkeeping-units" />Tamaño de lote en artículos y unidades de almacenamiento
