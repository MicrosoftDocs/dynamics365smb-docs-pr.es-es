...
ms.author: edupont
---
# <a name="create-contacts" />Crear contactos
...
## <a name="to-create-a-contact-manually" />Para crear un contacto manualmente
...
## <a name="to-create-a-contact-from-a-customer-vendor-or-bank-account" />Para crear un contacto desde un cliente, proveedor o banco
...
## <a name="to-create-a-customer-vendor-employee-or-bank-account-from-a-contact" />Para crear un un cliente, proveedor, empleado o banco a partir de un contacto
...
## <a name="to-link-a-contact-to-an-existing-customer-vendor-employee-or-bank-account" />Para vincular un contacto con un cliente, proveedor, empleado o cuenta bancaria existente
...
## <a name="to-remove-a-link-between-a-contact-and-an-existing-customer-vendor-employee-or-bank-account" />Para quitar un vínculo entre un contacto y un cliente, proveedor, empleado o cuenta bancaria existente
...
## <a name="synchronizing-contacts-with-customers-vendors-employees-and-bank-accounts" />Sincronizar contactos con clientes, proveedores, empleados y bancos
...
## <a name="to-view-which-customer-vendor-employee-or-bank-account-a-contact-is-related-to" />Para ver con qué cliente, proveedor, empleado o banco está relacionado un contacto
