...
ms.author: jswymer
---
# <a name="entering-data" />Introducción de datos
...
## <a name="work-with-editable-fields" />Trabajar con campos editables
...
### <a name="modifying-a-field-value" />Modificar un valor de campo
...
### <a name="how-quick-entry-works" />Cómo funciona la entrada rápida
...
#### <a name="tips-and-tricks" />Sugerencias y trucos
...
### <a name="to-change-quick-entry-fields" />Para cambiar los campos de entrada rápida
...
## <a name="mandatory-fields" />Campos obligatorios
...
## <a name="finding-data-as-you-type" />Buscar datos al escribir
...
## <a name="copying-and-pasting-faq-fields-and-lines" />Preguntas frecuentes sobre copiar y pegar campos y líneas
...
## <a name="filtering-line-items" />Filtrado de los productos de línea
...
### <a name="switching-the-focus-on-and-off" />Activar y desactivar el enfoque
...
## <a name="multitasking-across-multiple-pages" />Multitarea en varias páginas
...
## <a name="entering-quantities-by-calculation" />Introducir cantidades por cálculo
...
## <a name="entering-negative-numbers" />Especificación de números negativos
...
## <a name="entering-dates-and-times" />Introducir fechas y horas
...
### <a name="entering-dates" />Introducción de fechas
...
## <a name="entering-times" />Introducción de horas
...
## <a name="entering-combined-datetimes" />Introducir fechas/horas combinadas

[!INCLUDE [datetimes](includes/datetimes.md)]

## <a name="entering-duration" />Introducción de duración
