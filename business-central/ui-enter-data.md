...
ms.author: jswymer
---
# <a name="entering-data"></a><a name="entering-data"></a>Introducción de datos
...
## <a name="work-with-editable-fields"></a><a name="work-with-editable-fields"></a>Trabajar con campos editables
...
### <a name="modifying-a-field-value"></a><a name="modifying-a-field-value"></a>Modificar un valor de campo
...
## <a name="accelerating-data-entry-using-quick-entry"></a><a name="accelerating-data-entry-using-quick-entry"></a><a name="QuickEntry"></a>Acelerar la entrada de datos con la entrada rápida
...
### <a name="how-quick-entry-works"></a><a name="how-quick-entry-works"></a>Cómo funciona la entrada rápida
...
#### <a name="tips-and-tricks"></a><a name="tips-and-tricks"></a>Sugerencias y trucos
...
### <a name="to-change-quick-entry-fields"></a><a name="to-change-quick-entry-fields"></a>Para cambiar los campos de entrada rápida
...
## <a name="mandatory-fields"></a><a name="mandatory-fields"></a>Campos obligatorios
...
## <a name="finding-data-as-you-type"></a><a name="finding-data-as-you-type"></a>Buscar datos al escribir
...
## <a name="copying-and-pasting-faq-fields-and-lines"></a><a name="copying-and-pasting-faq-fields-and-lines"></a>Preguntas frecuentes sobre copiar y pegar campos y líneas
...
## <a name="filtering-line-items"></a><a name="filtering-line-items"></a>Filtrado de los productos de línea
...
## <a name="focusing-on-line-items"></a><a name="focusing-on-line-items"></a><a name="Focus"></a>Enfoque en los productos de línea
...
### <a name="switching-the-focus-on-and-off"></a><a name="switching-the-focus-on-and-off"></a>Activar y desactivar el enfoque
...
## <a name="multitasking-across-multiple-pages"></a><a name="multitasking-across-multiple-pages"></a>Multitarea en varias páginas
...
## <a name="entering-quantities-by-calculation"></a><a name="entering-quantities-by-calculation"></a>Introducir cantidades por cálculo
...
## <a name="entering-negative-numbers"></a><a name="entering-negative-numbers"></a>Especificación de números negativos
...
## <a name="entering-dates-and-times"></a><a name="entering-dates-and-times"></a>Introducir fechas y horas
...
## <a name="entering-combined-datetimes"></a><a name="entering-combined-datetimes"></a>Introducir fechas/horas combinadas
...
## <a name="setting-the-decimal-separator-used-by-numeric-keyboards"></a><a name="setting-the-decimal-separator-used-by-numeric-keyboards"></a><a name="decimal"></a>Configurar el separador decimal utilizado por los teclados numéricos
