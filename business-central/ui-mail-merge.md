...
## <a name="set-up-the-source-of-data"></a>Establecer el origen de los datos
...
## <a name="add-entries-that-are-related-or-unrelated-to-the-source-entity"></a>Agregue entradas relacionadas o no relacionadas con la entidad de origen
...
### <a name="select-the-fields-to-include"></a>Seleccionar los campos a incluir
...
## <a name="set-up-the-template-in-word"></a>Configurar la plantilla en Word
...
## <a name="apply-a-template"></a>Aplicar a plantilla
...
## <a name="edit-a-word-template"></a>Editar una plantilla de Word
