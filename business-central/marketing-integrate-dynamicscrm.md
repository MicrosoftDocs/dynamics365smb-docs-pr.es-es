...
## <a name="coupling-records" />Emparejamiento de registros
...
## <a name="fully-synchronizing-records" />Sincronización completa de los registros
...
## <a name="handling-sales-order-data" />Manejar datos de pedidos de venta
...
## <a name="handling-sales-quotes-data" />Manejar datos de ofertas de venta
...
## <a name="handling-posted-sales-invoices-customer-payments-and-statistics" />Gestión de histórico de facturas de venta, pagos de cliente y estadísticas
...
## <a name="handling-sales-prices" />Manejo de precios de venta
> [!NOTE]
