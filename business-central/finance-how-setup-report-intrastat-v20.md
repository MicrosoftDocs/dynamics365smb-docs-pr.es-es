...
ms.author: bholtorf
---
# <a name="set-up-and-report-intrastat"></a><a name="set-up-and-report-intrastat"></a><a name="set-up-and-report-intrastat"></a>Configuración y creación de informes Intrastat
...
## <a name="required-and-optional-setups"></a><a name="required-and-optional-setups"></a><a name="required-and-optional-setups"></a>Configuraciones necesarias y opcionales
...
### <a name="to-set-up-intrastat-templates-and-batches"></a><a name="to-set-up-intrastat-templates-and-batches"></a><a name="to-set-up-intrastat-templates-and-batches"></a>Para configurar libros y secciones de Intrastat
...
### <a name="to-set-up-transport-methods"></a><a name="to-set-up-transport-methods"></a><a name="to-set-up-transport-methods"></a>Configurar métodos de transporte
...
### <a name="to-set-up-which-intrastat-report-fields-are-mandatory"></a><a name="to-set-up-which-intrastat-report-fields-are-mandatory"></a><a name="to-set-up-which-intrastat-report-fields-are-mandatory"></a>Para configurar qué campos de informe Intrastat son obligatorios
...
### <a name="czechia"></a><a name="czechia"></a><a name="czechia"></a>Chequia
...
#### <a name="to-set-up-commodity-codes"></a><a name="to-set-up-commodity-codes"></a><a name="to-set-up-commodity-codes"></a>Para configurar códigos de mercancías
...
#### <a name="to-set-up-transaction-nature-codes"></a><a name="to-set-up-transaction-nature-codes"></a><a name="to-set-up-transaction-nature-codes"></a>Configurar códigos de naturaleza de transacción
...
## <a name="to-report-intrastat"></a><a name="to-report-intrastat"></a><a name="to-report-intrastat"></a>Para crear informes de Intrastat
...
### <a name="to-fill-in-intrastat-journals"></a><a name="to-fill-in-intrastat-journals"></a><a name="to-fill-in-intrastat-journals"></a>Para rellenar diarios Intrastat
...
### <a name="to-modify-intrastat-journals-lines"></a><a name="to-modify-intrastat-journals-lines"></a><a name="to-modify-intrastat-journals-lines"></a>Para modificar líneas de diarios de Intrastat
...
### <a name="report-intrastat-on-a-form-or-a-file"></a><a name="report-intrastat-on-a-form-or-a-file"></a><a name="report-intrastat-on-a-form-or-a-file"></a>Creación de informes Intrastat en un formulario o un archivo
...
### <a name="report-intrastat-in-a-file"></a><a name="report-intrastat-in-a-file"></a><a name="report-intrastat-in-a-file"></a>Emitir informes de Intrastat en un archivo
...
## <a name="reorganize-intrastat-journals"></a><a name="reorganize-intrastat-journals"></a><a name="reorganize-intrastat-journals"></a>Reorganizar diarios Intrastat
...
## <a name="tariff-numbers"></a><a name="tariff-numbers"></a><a name="tariff-numbers"></a>Códigos arancelarios
