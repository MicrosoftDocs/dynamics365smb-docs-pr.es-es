...
ms.author: edupont
---
# <a name="how-to-use-approval-workflows" />Cómo usar flujos de trabajo de aprobación
...
## <a name="request-a-record-approval" />Solicitar una aprobación de registro
...
## <a name="cancel-approval-requests" />Cancelar solicitudes de aprobación
...
## <a name="approve-or-reject-approval-requests" />Aprobar o rechazar solicitudes de aprobación
...
## <a name="delegate-approval-requests" />Delegar solicitudes de aprobación
...
## <a name="manage-overdue-approval-requests" />Gestionar solicitudes de aprobación vencidas
