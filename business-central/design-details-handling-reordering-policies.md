...
---
# <a name="design-details-handling-reordering-policies" />Detalles de diseño: Gestión de directivas de reaprovisionamiento
...
## <a name="the-role-of-the-reorder-point" />Función del punto de pedido
...
## <a name="monitoring-the-projected-inventory-level-and-the-reorder-point" />Supervisión del nivel de inventario proyectado y el punto de pedido
...
#### <a name="fixed-reorder-qty" />Cdad. fija reaprov.
...
## <a name="reordering-policies" />Directivas de reaprovisionamiento
...
### <a name="fixed-reorder-quantity" />Cantidad de reabastecimiento fija
