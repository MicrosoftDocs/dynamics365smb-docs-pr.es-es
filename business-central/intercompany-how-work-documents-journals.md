...
---
# <a name="work-with-intercompany-documents-and-journals" />Usar documentos y diarios de empresas vinculadas
...
## <a name="fill-in-and-send-an-intercompany-sales-order" />Rellene y envíe un pedido de venta de empresas vinculadas
...
## <a name="fill-in-and-post-an-intercompany-journal" />Rellenar y registrar un diario de empresas vinculadas
