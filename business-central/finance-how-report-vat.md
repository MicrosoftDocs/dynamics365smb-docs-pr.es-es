...
## <a name="to-set-up-vat-reports-in-"></a>Para configurar informes IVA en [!INCLUDE[prod_short](includes/prod_short.md)]
...
### <a name="vat-return-statuses"></a>Estados de la declaración del IVA
