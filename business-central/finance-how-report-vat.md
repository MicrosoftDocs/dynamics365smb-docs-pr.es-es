...
# <a name="report-vat-to-tax-authorities"></a><a name="report-vat-to-tax-authorities"></a><a name="report-vat-to-tax-authorities"></a><a name="report-vat-to-tax-authorities"></a>Crear informes de IVA para las autoridades fiscales
...
En ambos casos (como en otros informes relacionados con el IVA), el IVA se calcula en función de la configuración de la contabilización del IVA y de los grupos de contabilización del IVA que haya configurado. [!INCLUDE[prod_short](includes/prod_short.md)] muestra entradas de IVA siempre basadas en su **Fecha de IVA** como fecha de informe principal.  

> [!NOTE]
> Todos los informes relacionados con el IVA ahora se ejecutan con la **Fecha de IVA** para filtrar registros relevantes. Incluso si configura la **Uso de fecha de IVA** como **No utilice la función de fecha de IVA** [!INCLUDE[prod_short](includes/prod_short.md)] ocultará todas las instancias de la **Fecha de IVA** a través de la aplicación. Sin embargo, la **Fecha de IVA** todavía se usa en todos los informes y se completa automáticamente con la **Fecha de publicación**.
...
## <a name="about-the-ec-sales-list-report"></a><a name="about-the-ec-sales-list-report"></a><a name="about-the-ec-sales-list-report"></a><a name="about-the-ec-sales-list-report"></a><a name="ecsaleslist"></a>Acerca del informe de la Lista venta CE
...
### <a name="submit-an-ec-sales-list-report"></a><a name="submit-an-ec-sales-list-report"></a><a name="submit-an-ec-sales-list-report"></a><a name="submit-an-ec-sales-list-report"></a>Enviar un informe de lista de ventas de CE

[!INCLUDE [finance-ecsaleslist](includes/finance-ecsaleslist.md)]

## <a name="about-the-vat-return-report"></a><a name="about-the-vat-return-report"></a><a name="about-the-vat-return-report"></a><a name="about-the-vat-return-report"></a><a name="vatreturn"></a>Acerca del informe de devolución de IVA
...
## <a name="to-connect-to-your-tax-authoritys-web-service"></a><a name="to-connect-to-your-tax-authoritys-web-service"></a><a name="to-connect-to-your-tax-authoritys-web-service"></a><a name="to-connect-to-your-tax-authoritys-web-service"></a>Conectarse al servicio web de su autoridad fiscal
...
## <a name="to-set-up-vat-reports-in-"></a><a name="to-set-up-vat-reports-in-"></a><a name="to-set-up-vat-reports-in-"></a><a name="to-set-up-vat-reports-in-"></a>Para configurar informes IVA en [!INCLUDE[prod_short](includes/prod_short.md)]

[!INCLUDE [vat-report-setup](includes/vat-report-setup.md)]

### <a name="to-set-up-vat-return-periods"></a><a name="to-set-up-vat-return-periods"></a><a name="to-set-up-vat-return-periods"></a><a name="to-set-up-vat-return-periods"></a>Para configurar periodos de devolución de IVA
...
## <a name="to-prepare-and-submit-a-vat-report"></a><a name="to-prepare-and-submit-a-vat-report"></a><a name="to-prepare-and-submit-a-vat-report"></a><a name="to-prepare-and-submit-a-vat-report"></a>Para preparar y enviar un informe de IVA
...
### <a name="vat-return-statuses"></a><a name="vat-return-statuses"></a><a name="vat-return-statuses"></a><a name="vat-return-statuses"></a>Estados de la declaración del IVA

Las devoluciones del IVA pueden tener diferentes estados, tal y como se describe en la siguiente tabla.

| Status | Descripción |
|------------|-------------------------|
| Abierta | Cuando cree una nueva devolución del IVA. Puede ejecutar la acción **Sugerir líneas**. Si necesita corregir valores, puede ejecutar la acción **Sugerir líneas** de nuevo. No puede presentar una declaración de IVA que tenga este estado. |
| Lanzada | El estado cambiará cuando utilice la acción **Liberar**. [!INCLUDE[prod_short](includes/prod_short.md)] mostrará la ficha desplegable **Errores y Advertencias**. No puede realizar cambios ni utilizar la acción **Sugerir líneas**. Para realizar cambios, debe volver a abrir la declaración de IVA. |
| Rechazado | Si su envío no tuvo éxito (por ejemplo, si la autenticación falló), el estado cambiará a **Rechazado**. No puede reabrir una declaración de IVA que tenga este estado. |
| Enviada | La declaración del IVA se presenta mediante la acción **Entregar**, o se marca como enviada mediante la acción **Marcar como enviada**. |
| Aceptado | La declaración del IVA tiene este estado si el informe se marca como aceptada mediante la acción **Marcar como aceptada**. Si el informe **Declaración de IVA** está marcado como **Aceptado**, puede ejecutar la acción **Calcular y contabilizar liquidación de IVA**. |

## <a name="viewing-communications-with-your-tax-authority"></a><a name="viewing-communications-with-your-tax-authority"></a><a name="viewing-communications-with-your-tax-authority"></a><a name="viewing-communications-with-your-tax-authority"></a>Visualización de comunicaciones con la autoridad fiscal.
...
## <a name="submitting-vat-reports-manually"></a><a name="submitting-vat-reports-manually"></a><a name="submitting-vat-reports-manually"></a><a name="submitting-vat-reports-manually"></a>Enviar informes de IVA manualmente
...
## <a name="vat-settlement"></a><a name="vat-settlement"></a><a name="vat-settlement"></a><a name="vat-settlement"></a>Liquidación IVA
...
## <a name="configuring-your-own-vat-reports"></a><a name="configuring-your-own-vat-reports"></a><a name="configuring-your-own-vat-reports"></a><a name="configuring-your-own-vat-reports"></a>Configuración de sus propios informes de IVA
