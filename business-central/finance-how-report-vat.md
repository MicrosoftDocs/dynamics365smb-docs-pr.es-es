...
# <a name="report-vat-to-tax-authorities" />Crear informes de IVA para las autoridades fiscales
...
### <a name="submit-an-ec-sales-list-report" />Enviar un informe de lista de ventas de CE
...
## <a name="to-connect-to-your-tax-authoritys-web-service" />Conectarse al servicio web de su autoridad fiscal
...
### <a name="to-set-up-vat-return-periods" />Para configurar periodos de devolución de IVA
...
## <a name="to-prepare-and-submit-a-vat-report" />Para preparar y enviar un informe de IVA
...
### <a name="vat-return-statuses" />Estados de la declaración del IVA
...
## <a name="viewing-communications-with-your-tax-authority" />Visualización de comunicaciones con la autoridad fiscal.
...
## <a name="submitting-vat-reports-manually" />Enviar informes de IVA manualmente
...
## <a name="vat-settlement" />Liquidación IVA
...
## <a name="configuring-your-own-vat-reports" />Configuración de sus propios informes de IVA
