...
# <a name="report-vat-to-tax-authorities"></a><a name="report-vat-to-tax-authorities"></a><a name="report-vat-to-tax-authorities"></a>Crear informes de IVA para las autoridades fiscales
...
## <a name="about-the-ec-sales-list-report"></a><a name="about-the-ec-sales-list-report"></a><a name="about-the-ec-sales-list-report"></a><a name="ecsaleslist"></a>Acerca del informe de la Lista venta CE
...
### <a name="submit-an-ec-sales-list-report"></a><a name="submit-an-ec-sales-list-report"></a><a name="submit-an-ec-sales-list-report"></a>Enviar un informe de lista de ventas de CE

[!INCLUDE [finance-ecsaleslist](includes/finance-ecsaleslist.md)]

## <a name="about-the-vat-return-report"></a><a name="about-the-vat-return-report"></a><a name="about-the-vat-return-report"></a><a name="vatreturn"></a>Acerca del informe de devolución de IVA
...
## <a name="to-connect-to-your-tax-authoritys-web-service"></a><a name="to-connect-to-your-tax-authoritys-web-service"></a><a name="to-connect-to-your-tax-authoritys-web-service"></a>Conectarse al servicio web de su autoridad fiscal
...
## <a name="to-set-up-vat-reports-in-"></a><a name="to-set-up-vat-reports-in-"></a><a name="to-set-up-vat-reports-in-"></a>Para configurar informes IVA en [!INCLUDE[prod_short](includes/prod_short.md)]

[!INCLUDE [vat-report-setup](includes/vat-report-setup.md)]

### <a name="to-set-up-vat-return-periods"></a><a name="to-set-up-vat-return-periods"></a><a name="to-set-up-vat-return-periods"></a>Para configurar periodos de devolución de IVA
...
## <a name="to-prepare-and-submit-a-vat-report"></a><a name="to-prepare-and-submit-a-vat-report"></a><a name="to-prepare-and-submit-a-vat-report"></a>Para preparar y enviar un informe de IVA
...
### <a name="vat-return-statuses"></a><a name="vat-return-statuses"></a><a name="vat-return-statuses"></a>Estados de la declaración del IVA
...
## <a name="viewing-communications-with-your-tax-authority"></a><a name="viewing-communications-with-your-tax-authority"></a><a name="viewing-communications-with-your-tax-authority"></a>Visualización de comunicaciones con la autoridad fiscal.
...
## <a name="submitting-vat-reports-manually"></a><a name="submitting-vat-reports-manually"></a><a name="submitting-vat-reports-manually"></a>Enviar informes de IVA manualmente
...
## <a name="vat-settlement"></a><a name="vat-settlement"></a><a name="vat-settlement"></a>Liquidación IVA
...
## <a name="configuring-your-own-vat-reports"></a><a name="configuring-your-own-vat-reports"></a><a name="configuring-your-own-vat-reports"></a>Configuración de sus propios informes de IVA
