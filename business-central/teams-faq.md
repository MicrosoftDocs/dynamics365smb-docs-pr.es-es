...
### ¿Cómo inicio sesión en la aplicación [!INCLUDE [prod_short.md](includes/prod_short.md)] en Teams?
...
### ¿Cómo inicio sesión fuera de la aplicación [!INCLUDE [prod_short.md](includes/prod_short.md)] en Teams?
...
### ¿Se conecta la aplicación para Teams a [!INCLUDE [prod_short.md](includes/prod_short.md)] en las instalaciones? 
...
### ¿La aplicación funciona con múltiples empresas y entornos? 
...
### ¿En qué países o regiones está la aplicación [!INCLUDE [prod_short.md](includes/prod_short.md)] disponible? 
...
### ¿La aplicación [!INCLUDE [prod_short.md](includes/prod_short.md)] funciona con cualquier localización de [!INCLUDE [prod_short.md](includes/prod_short.md)]? 
...
### <a name="language"></a>¿Qué idiomas admite la aplicación [!INCLUDE [prod_short.md](includes/prod_short.md)]?
...
### ¿La aplicación [!INCLUDE [prod_short.md](includes/prod_short.md)] funciona con soluciones del sector?
...
### ¿Funciona [!INCLUDE [prod_short.md](includes/prod_short.md)] con la aplicación móvil de Teams?
...
### ¿Es la aplicación [!INCLUDE [prod_short.md](includes/prod_short.md)] para Teams igual que la aplicación [!INCLUDE [prod_short.md](includes/prod_short.md)] para iOS y Android?
...
### ¿La aplicación [!INCLUDE [prod_short.md](includes/prod_short.md)] funciona en todos los clientes de Teams?

N.º La aplicación [!INCLUDE [prod_short.md](includes/prod_short.md)] para Teams no es compatible cuando se instala como un paquete para macOS o Linux. En estas plataformas, se accede a Teams utilizando un navegador compatible.
...
### ¿Para qué cliente de Teams es mejor [!INCLUDE [prod_short.md](includes/prod_short.md)]?
...
### ¿Cuál es la mejor manera para mí de demostrar [!INCLUDE [prod_short.md](includes/prod_short.md)] y Microsoft Teams a los posibles clientes?
...
### ¿La aplicación [!INCLUDE [prod_short.md](includes/prod_short.md)] para Teams se adapta a mi personalización?
...
### ¿Cómo afectan a mi privacidad los permisos requeridos por la aplicación?
...
### ¿Dónde puedo obtener información sobre mi privacidad? 
...
### ¿Cómo desinstalo la aplicación [!INCLUDE [prod_short.md](includes/prod_short.md)] para Teams?
...
### ¿Seguirá Microsoft mejorando la aplicación [!INCLUDE [prod_short.md](includes/prod_short.md)] para Teams?
...
### ¿Dónde puedo encontrar la integración de Teams dentro del cliente web de Business Central? 
...
### <a name="who-can-view"></a>¿Quién puede ver el contenido de una pestaña?
...
### <a name=#recommended-content></a>¿De dónde viene el contenido recomendado?
...
### Cuando creo una pestaña, ¿otorga permisos a las personas en el canal o chat?
...
### ¿Puedo chatear junto a una pestaña?

Sí. Utilice el icono de chat para iniciar la conversación. Este hilo de chat se asocia entonces con la pestaña. 

### Si elimino una pestaña de un chat o canal, ¿se elimina algún dato de Business Central?

N.º

### ¿Puedo cambiar el nombre de una pestaña de forma segura?

Sí. El contenido de la pestaña no está relacionado con el nombre real de la pestaña. ¡Cambie el nombre cuando quiera! 

### Necesito trabajar en tareas en diferentes ventanas. ¿Puedo hacerlo?

Sí. Puede abrir la pestaña en su propia ventana del navegador para mostrar el cliente web de Business Central. 

### ¿Puedo agregar o fijar una pestaña en las reuniones del equipo?

N.º La aplicación Business Central para Teams no admite pestañas en las reuniones.

### No se puede agregar una pestaña si se usan URL de ISV como *.bc.dynamics.com (pero se pueden anclar)

No compatible.

### Cuando hago cosas en la pestaña, como navegar, reordenar, aplicar un filtro o buscar, ¿los demás ven mis cambios?

N.º Solo los cambios de campo o las acciones en ejecución afectan la forma en que otros ven el contenido de la pestaña.

### ¿El contenido de la pestaña se actualiza automáticamente? Si no, ¿cómo lo actualizo?
...
### ¿Esto muestra listas y registros de mis personalizaciones y complementos?

Sí. 

### Cuando agrego una pestaña, ¿las personas la verán en mi idioma?

N.º Cada usuario ve el contenido de la pestaña en la configuración de idioma, región y zona horaria de Business Central. 

### ¿Puedo tener varias pestañas que apunten a contenido diferente?

Sí.

### ¿También puedo agregar pestañas para chatear con una sola persona?
...
### ¿Puedo cambiar de compañía dentro de una pestaña?

N.º 

### ¿Es esto diferente a usar la capacidad genérica de Teams para crear una pestaña que aloje un sitio web?
...
### ¿En qué tablas busca la aplicación?
...
### ¿Qué campos de la tabla de contactos puedo buscar?
...
### ¿Los resultados de búsqueda incluyen empresas y personas?
...
### ¿Los resultados contactos de cualquier relación de negocio aparecerán en los resultados?
...
### ¿Puedo buscar datos de contacto durante las reuniones?
...
### ¿Cómo puede ver mis últimas interacciones con un contacto?
...
### ¿Cómo puedo registrar una llamada o reunión de Teams como una interacción?
...
### ¿Puedo llamar a un contacto desde la aplicación de [!INCLUDE [prod_short.md](includes/prod_short.md)] para Teams?
...
### ¿Cómo veo los documentos recientes de un cliente o proveedor?
...
### ¿Cómo puedo buscar contactos usando caracteres especiales?
...
### ¿Cómo puedo buscar contactos almacenados en una empresa diferente?
...
### ¿Los contactos de [!INCLUDE [prod_short.md](includes/prod_short.md)] son diferentes de los de la pantalla de contactos de Teams?
...
### ¿[!INCLUDE [prod_short.md](includes/prod_short.md)] sincroniza los contactos con Teams?
...
### ¿Cuál es la versión mínima de [!INCLUDE [prod_short.md](includes/prod_short.md)] para la búsqueda de contactos?
...
### ¿Puedo usar la búsqueda de contactos si soy administrador delegado?

Sí. También puede buscar contactos y detalles de contacto si tiene un rol de administrador delegado en una organización.

### ¿La búsqueda de contactos se ve afectada por los límites de la API?
...
### ¿Por qué a veces me pide que configure la aplicación?
...
### Me gustaría buscar productos o registros de otras tablas. ¿Puedo hacer esto desde Teams?
...
### ¿Qué tipos de enlaces admite la aplicación?
...
### ¿Cómo elimino una tarjeta que envié a un chat?
...
### ¿Las tarjetas siempre muestran información actualizada?
...
### ¿Cómo puedo saber a qué empresa pertenece una tarjeta en Teams?
...
### ¿Dónde está el botón guardar en la ventana de detalles en Teams?
...
### Si elijo ver los detalles de una tarjeta, ¿otros usuarios verán mi ventana de detalles?
...
### ¿Puedo iniciar una llamada de Teams desde la ventana de detalles en Teams?
...
### ¿Puedo imprimir documentos desde la ventana de detalles en Teams?
...
### ¿Puedo acceder a la cámara desde la ventana de detalles en Teams?
...
### <a name="location"></a>¿Puedo acceder a mi ubicación desde la ventana de detalles en Teams?
...
### ¿Cómo puedo abrir los detalles en una nueva ventana?
...
### ¿Puedo compartir tarjetas con usuarios fuera de mi organización?
...
### ¿La experiencia es diferente para los usuarios invitados?
...
### ¿Cómo instala un usuario invitado la aplicación [!INCLUDE [prod_short.md](includes/prod_short.md)]? 
...
### ¿Compartir con Teams envía una ficha compacta? 

Sí. El vínculo se expandirá automáticamente a una ficha si tiene instalada la aplicación Business Central para Teams. 

### ¿Los destinatarios recibirán el mensaje de mí o de una cuenta de servicio de Business Central? 
...
### ¿Dónde encuentro Compartir con Teams en Business Central? 
