...
ms.author: jswymer
---
# <a name="managing-database-access-intent" />Gestionar la intención de acceso a la base de datos
...
## <a name="to-change-the-database-access-intent" />Para cambiar la intención de acceso a la base de datos
