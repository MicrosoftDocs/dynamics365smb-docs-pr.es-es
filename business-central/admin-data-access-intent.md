...
ms.author: jswymer
---
# <a name="managing-database-access-intent"></a><a name="managing-database-access-intent"></a><a name="managing-database-access-intent"></a><a name="managing-database-access-intent"></a>Gestionar la intención de acceso a la base de datos
...
## <a name="to-change-the-database-access-intent"></a><a name="to-change-the-database-access-intent"></a><a name="to-change-the-database-access-intent"></a><a name="to-change-the-database-access-intent"></a>Para cambiar la intención de acceso a la base de datos
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Consultar la [formación de Microsoft](/training/paths/deploy-configure-dynamics-365-business-central/) relacionada
