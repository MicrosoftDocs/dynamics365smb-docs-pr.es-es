...
ms.author: jswymer
---
# <a name="create-interactions-on-contacts-and-segments" />Crear interacciones en contactos y segmentos
...
## <a name="to-create-an-interaction" />Para crear interacciones
...
## <a name="to-finish-and-delete-postponed-interactions" />Para finalizar y eliminar interacciones aplazadas
1. Abra el contacto, el vendedor o el movimiento de registro de interacción.
...
## <a name="to-create-an-interaction-on-a-segment" />Para crear una interacción en un segmento
