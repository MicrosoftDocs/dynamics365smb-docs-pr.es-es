...
ms.author: jswymer
---
# <a name="create-interactions-on-contacts-and-segments"></a><a name="create-interactions-on-contacts-and-segments"></a><a name="create-interactions-on-contacts-and-segments"></a><a name="create-interactions-on-contacts-and-segments"></a>Crear interacciones en contactos y segmentos
...
## <a name="to-create-an-interaction"></a><a name="to-create-an-interaction"></a><a name="to-create-an-interaction"></a><a name="to-create-an-interaction"></a>Para crear interacciones
...
## <a name="to-finish-and-delete-postponed-interactions"></a><a name="to-finish-and-delete-postponed-interactions"></a><a name="to-finish-and-delete-postponed-interactions"></a><a name="to-finish-and-delete-postponed-interactions"></a>Para finalizar y eliminar interacciones aplazadas
1. Abra el contacto, el vendedor o el movimiento de registro de interacción.
...
## <a name="to-create-an-interaction-on-a-segment"></a><a name="to-create-an-interaction-on-a-segment"></a><a name="to-create-an-interaction-on-a-segment"></a><a name="to-create-an-interaction-on-a-segment"></a>Para crear una interacción en un segmento
