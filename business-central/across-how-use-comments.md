...
ms.author: edupont
---
# <a name="add-comments-to-cards-and-documents" />Agregar comentarios a las fichas y documentos
...
## <a name="to-add-a-comments-to-an-item-card" />Para añadir un comentario a una ficha de producto
