...
ms.author: edupont
---
# <a name="set-up-incoming-documents"></a><a name="set-up-incoming-documents"></a>Configurar documentos entrantes
...
## <a name="to-set-up-the-incoming-documents-feature"></a><a name="to-set-up-the-incoming-documents-feature"></a>Para configurar la característica Documentos entrantes
...
## <a name="to-set-up-approvers-of-incoming-document-records"></a><a name="to-set-up-approvers-of-incoming-document-records"></a>Para configurar aprobadores de registros de documento entrante
...
## <a name="to-set-up-an-ocr-service"></a><a name="to-set-up-an-ocr-service"></a>Para configurar un servicio de OCR
