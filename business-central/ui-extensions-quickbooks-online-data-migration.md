...
# <a name="the-quickbooks-online-data-migration-extension" />Extensión de migración de datos de QuickBooks Online
...
## <a name="what-data-can-i-import-from-quickbooks-online" />¿Qué datos puedo importar desde QuickBooks Online?
...
## <a name="how-do-i-start-using-the-extension" />¿Cómo empiezo a usar la extensión?
...
## <a name="see-related-microsoft-training" />Consultar la [formación de Microsoft](/training/modules/migrate-data-dynamics-365-business-central/) relacionada
