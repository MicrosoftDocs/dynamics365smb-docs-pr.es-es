...
ms.author: edupont
---
# <a name="design-details-searching-for-dimension-combinations"></a><a name="design-details-searching-for-dimension-combinations"></a>Detalles de diseño: Búsqueda de combinaciones de dimensiones
...
## <a name="building-search-tree"></a><a name="building-search-tree"></a>Creación de árbol de búsqueda
...
### <a name="example-1"></a><a name="example-1"></a>Ejemplo 1
...
### <a name="example-2"></a><a name="example-2"></a>Ejemplo 2
...
### <a name="finding-dimension-set-id"></a><a name="finding-dimension-set-id"></a>Búsqueda del identificador de grupo dimensiones
