...
---
# <a name="use-job-queues-to-schedule-tasks"></a><a name="use-job-queues-to-schedule-tasks"></a><a name="use-job-queues-to-schedule-tasks"></a>Uso de colas de proyectos para programar tareas
...
## <a name="monitor-status-or-errors-in-the-job-queue"></a><a name="monitor-status-or-errors-in-the-job-queue"></a><a name="monitor-status-or-errors-in-the-job-queue"></a>Supervisar el estado o los errores en la cola de proyectos
...
### <a name="to-view-status-for-any-job"></a><a name="to-view-status-for-any-job"></a><a name="to-view-status-for-any-job"></a>Para ver el estado de un proyecto
...
## <a name="view-scheduled-tasks"></a><a name="view-scheduled-tasks"></a><a name="view-scheduled-tasks"></a>Ver tareas programadas
...
## <a name="the-my-job-queue-part"></a><a name="the-my-job-queue-part"></a><a name="the-my-job-queue-part"></a>El apartado de Mi cola de proyectos
...
### <a name="to-view-an-error-from-the-my-job-queue-part"></a><a name="to-view-an-error-from-the-my-job-queue-part"></a><a name="to-view-an-error-from-the-my-job-queue-part"></a>Procedimiento para ver un error del apartado Mi la cola de proyectos

1. En un movimiento con el estado **Error**, elija la acción **Mostrar error**.
2. Revise el mensaje de error y corrija el problema.

## <a name="examples-of-what-you-can-schedule-using-job-queue-entries"></a><a name="examples-of-what-you-can-schedule-using-job-queue-entries"></a><a name="examples-of-what-you-can-schedule-using-job-queue-entries"></a>Ejemplos de lo que puede programar mediante entradas de la cola de proyectos

### <a name="schedule-reports"></a><a name="schedule-reports"></a><a name="schedule-reports"></a>Programar informes
...
### <a name="schedule-synchronization-between--and-includeprod_short"></a><a name="schedule-synchronization-between--and-includeprod_short"></a><a name="schedule-synchronization-between--and-includeprod_short"></a>Programación de la sincronización entre [!INCLUDE[prod_short](includes/prod_short.md)] y [!INCLUDE[prod_short](includes/cds_long_md.md)]
...
### <a name="schedule-when-to-post-sales-and-purchase-orders"></a><a name="schedule-when-to-post-sales-and-purchase-orders"></a><a name="schedule-when-to-post-sales-and-purchase-orders"></a>Programar la contabilización de pedidos de compra y venta
...
## <a name="handle-job-queue-entry-issues"></a><a name="handle-job-queue-entry-issues"></a><a name="handle-job-queue-entry-issues"></a>Gestionar problemas de entrada de la cola de proyectos
...
## <a name="monitor-the-job-queue-with-telemetry"></a><a name="monitor-the-job-queue-with-telemetry"></a><a name="monitor-the-job-queue-with-telemetry"></a>Supervisar la cola de proyectos con telemetría
