...
## <a name="scheduling-synchronization-between-d365fin-and-crm_md"></a>Programación de la sincronización entre [!INCLUDE[d365fin](includes/d365fin_md.md)] y [!INCLUDE[crm_md](includes/crm_md.md)]
