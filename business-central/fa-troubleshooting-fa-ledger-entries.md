...
ms.author: bholtorf
---
# <a name="the-troubleshooting-fa-ledger-entries-extension" />La solución de problemas de la extensión de Movs. Activos
...
## <a name="troubleshooting-fixed-asset-ledger-entries" />Solución de problemas de entradas del libro mayor de activos fijos
