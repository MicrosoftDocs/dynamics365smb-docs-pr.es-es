...
ms.author: edupont
---
# <a name="enter-external-document-numbers" />Introducir números de documento externos
...
## <a name="to-enter-external-document-numbers-in-a-sales-order" />Para especificar números de documentos externos en un pedido de ventas
