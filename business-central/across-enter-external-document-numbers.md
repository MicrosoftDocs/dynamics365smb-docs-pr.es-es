...
ms.author: edupont
---
# <a name="enter-external-document-numbers"></a><a name="enter-external-document-numbers"></a>Introducir números de documento externos
...
## <a name="to-enter-external-document-numbers-in-a-sales-order"></a><a name="to-enter-external-document-numbers-in-a-sales-order"></a>Para especificar números de documentos externos en un pedido de ventas
