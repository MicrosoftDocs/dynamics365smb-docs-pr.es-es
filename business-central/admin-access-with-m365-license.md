...
# <a name="business-central-access-with-microsoft-365-licenses" />Acceso a Business Central con licencias de Microsoft 365
...
## <a name="why-enable-access-with-microsoft-365-licenses" />¿Por qué habilitar el acceso con licencias de Microsoft 365?
...
## <a name="use-rights" />Derechos de uso
...
 
### <a name="client-access" />Acceso de clientes
...
### <a name="data-access" />Acceso a datos
...
### <a name="use-of-objects" />Uso de objetos
...
## <a name="simplified-user-interface" />Interfaz de usuario simplificada
...
### <a name="requirements-to-enable-access" />Requisitos para habilitar el acceso

- [!INCLUDE [prod_short](includes/prod_short.md)] en línea (SaaS).

- Los entornos deben ser de la plataforma versión 21.1 o posterior.

### <a name="requirements-for-individual-users-to-access-data-in-teams" />Requisitos para que los usuarios individuales accedan a los datos en Teams
