...
# <a name="managing-microsoft-teams-integration-with-"></a>Gestionar la integración de Microsoft Teams con [!INCLUDE [prod_short](includes/prod_short.md)]
...
### <a name="managing-the--app-optional"></a>Gestionar la aplicación de [!INCLUDE [prod_short](includes/prod_short.md)] (opcional)
...
### <a name="minimum-requirements-1"></a>Requisitos mínimos
...
> [!NOTE]
> Para configurar la implementación centralizada, su cuenta de Teams debe tener al menos el rol de [Administrador de Teams](/entra/identity/role-based-access-control/permissions-reference#teams-administrator].
...
### <a name="understanding-where--cards-are-stored"></a>Saber dónde se almacenan las tarjetas de [!INCLUDE [prod_short](includes/prod_short.md)]
...
## <a name="show-or-hide-record-data-on-cards"></a>Mostrar u ocultar datos de registro en tarjetas
