...
## <a name="in-microsoft-teams" />En Microsoft Teams
...
## <a name="installing-the-business-central-app-by-using-centralized-deployment" />Instalación de la aplicación Business Central mediante Implementación centralizada
...
## <a name="managing-privacy-and-compliance" />Gestionar la privacidad y el cumplimiento
...
### <a name="restricting-sharing-of-cards" />Restringir el intercambio de tarjetas
...
### <a name="responding-to-data-requests" />Responder a solicitudes de datos
...
## <a name="show-or-hide-record-data-on-cards" />Mostrar u ocultar datos de registro en tarjetas
