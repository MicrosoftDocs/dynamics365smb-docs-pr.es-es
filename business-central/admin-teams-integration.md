...
# <a name="managing-microsoft-teams-integration-with-"></a><a name="managing-microsoft-teams-integration-with-"></a><a name="managing-microsoft-teams-integration-with-"></a><a name="managing-microsoft-teams-integration-with-"></a>Gestionar la integración de Microsoft Teams con [!INCLUDE [prod_short](includes/prod_short.md)]
...
## <a name="in-microsoft-teams"></a><a name="in-microsoft-teams"></a><a name="in-microsoft-teams"></a><a name="in-microsoft-teams"></a>En Microsoft Teams

### <a name="minimum-requirements"></a><a name="minimum-requirements"></a><a name="minimum-requirements"></a><a name="minimum-requirements"></a>Requisitos mínimos
...
### <a name="managing-the--app-optional"></a><a name="managing-the--app-optional"></a><a name="managing-the--app-optional"></a><a name="managing-the--app-optional"></a>Gestionar la aplicación de [!INCLUDE [prod_short](includes/prod_short.md)] (opcional)
...
## <a name="in-"></a><a name="in-"></a><a name="in-"></a><a name="in-"></a>En [!INCLUDE [prod_short](includes/prod_short.md)]

### <a name="minimum-requirements-1"></a><a name="minimum-requirements-1"></a><a name="minimum-requirements-1"></a><a name="minimum-requirements-1"></a>Requisitos mínimos
...
## <a name="installing-the-business-central-app-by-using-centralized-deployment"></a><a name="installing-the-business-central-app-by-using-centralized-deployment"></a><a name="installing-the-business-central-app-by-using-centralized-deployment"></a><a name="installing-the-business-central-app-by-using-centralized-deployment"></a>Instalación de la aplicación Business Central mediante Implementación centralizada
...
## <a name="managing-privacy-and-compliance"></a><a name="managing-privacy-and-compliance"></a><a name="managing-privacy-and-compliance"></a><a name="managing-privacy-and-compliance"></a>Gestionar la privacidad y el cumplimiento
...
### <a name="understanding-where--cards-are-stored"></a><a name="understanding-where--cards-are-stored"></a><a name="understanding-where--cards-are-stored"></a><a name="understanding-where--cards-are-stored"></a>Saber dónde se almacenan las tarjetas de [!INCLUDE [prod_short](includes/prod_short.md)]
...
### <a name="restricting-sharing-of-cards"></a><a name="restricting-sharing-of-cards"></a><a name="restricting-sharing-of-cards"></a><a name="restricting-sharing-of-cards"></a>Restringir el intercambio de tarjetas
...
### <a name="responding-to-data-requests"></a><a name="responding-to-data-requests"></a><a name="responding-to-data-requests"></a><a name="responding-to-data-requests"></a>Responder a solicitudes de datos
...
## <a name="show-or-hide-record-data-on-cards"></a><a name="show-or-hide-record-data-on-cards"></a><a name="show-or-hide-record-data-on-cards"></a><a name="show-or-hide-record-data-on-cards"></a>Mostrar u ocultar datos de registro en tarjetas
