...
ms.author: edupont
---
# <a name="set-up-statuses-for-service-orders-and-repairs"></a><a name="set-up-statuses-for-service-orders-and-repairs"></a><a name="set-up-statuses-for-service-orders-and-repairs"></a>Configuración de estados para órdenes y reparaciones de servicio
...
## <a name="to-set-up-service-status-priorities"></a><a name="to-set-up-service-status-priorities"></a><a name="to-set-up-service-status-priorities"></a>Para configurar prioridades de estado de servicio
...
## <a name="to-set-up-a-repair-status"></a><a name="to-set-up-a-repair-status"></a><a name="to-set-up-a-repair-status"></a>Para configurar un estado de reparación
