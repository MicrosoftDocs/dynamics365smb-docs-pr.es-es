...
ms.author: edupont
---
# <a name="set-up-statuses-for-service-orders-and-repairs" />Configuración de estados para órdenes y reparaciones de servicio
...
## <a name="to-set-up-service-status-priorities" />Para configurar prioridades de estado de servicio
...
## <a name="to-set-up-a-repair-status" />Para configurar un estado de reparación
