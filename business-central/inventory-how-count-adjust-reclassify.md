...
---
# <a name="count-adjust-and-reclassify-inventory-using-journals" />Recuento, ajuste y reclasificación de inventario con diarios
...
## <a name="to-count-physical-inventory" />Para contar el inventario físico
...
### <a name="to-calculate-expected-inventory-in-basic-warehouse-configurations" />Para calcular el inventario esperado en las configuraciones básicas del almacén
...
### <a name="to-print-the-report-to-be-used-when-counting" />Para imprimir el informe que va utilizar para el recuento
...
### <a name="to-enter-and-post-the-actual-counted-inventory-in-basic-warehouse-configurations" />Para introducir y registrar el inventario contado real en configuraciones básicas de almacén
...
### <a name="to-calculate-the-expected-inventory-in-advanced-warehouse-configurations" />Para calcular el inventario esperado en las configuraciones avanzadas del almacén
...
### <a name="to-enter-and-post-the-actual-counted-inventory-in-advanced-warehouse-configurations" />Para introducir y registrar el inventario contado real en configuraciones avanzadas de almacén
...
## <a name="to-do-cycle-counting" />Realizar el recuento cíclico
...
### <a name="to-set-up-counting-periods" />Para configurar periodos de recuento
...
### <a name="to-assign-a-counting-period-to-an-item" />Asignar un periodo de recuento a un producto
...
### <a name="to-start-a-count-based-on-counting-periods-in-basic-warehouse-configurations" />Para empezar a contar basándose en periodos de recuento en las configuraciones básicas de almacén
...
### <a name="to-start-a-count-based-on-counting-periods-in-advanced-warehouse-configurations" />Para empezar un recuento basándose en periodos de recuento en las configuraciones avanzadas de almacén
...
## <a name="to-adjust-the-quantity-of-one-item" />Para ajustar la cantidad de un producto
...
### <a name="to-adjust-the-quantities-of-multiple-items-in-basic-warehouse-configurations" />Para ajustar las cantidades de varios productos en configuraciones básicas de almacén
...
### <a name="to-adjust-bin-quantities-in-advanced-warehouse-configurations" />Para ajustar las cantidades de la ubicación de configuraciones avanzadas de almacén
...
## <a name="to-synchronize-the-adjusted-warehouse-entries-with-the-related-item-ledger-entries" />Para sincronizar los movimientos ajustados de almacén con los correspondientes movimientos de producto
