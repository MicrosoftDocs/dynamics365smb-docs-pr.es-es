...
---
# <a name="count-adjust-and-reclassify-inventory-using-journals"></a><a name="count-adjust-and-reclassify-inventory-using-journals"></a><a name="count-adjust-and-reclassify-inventory-using-journals"></a>Recuento, ajuste y reclasificación de inventario con diarios
...
## <a name="to-count-physical-inventory"></a><a name="to-count-physical-inventory"></a><a name="to-count-physical-inventory"></a>Para contar el inventario físico
...
### <a name="to-calculate-expected-inventory-in-basic-warehouse-configurations"></a><a name="to-calculate-expected-inventory-in-basic-warehouse-configurations"></a><a name="to-calculate-expected-inventory-in-basic-warehouse-configurations"></a>Para calcular el inventario esperado en las configuraciones básicas del almacén
...
### <a name="to-print-the-report-to-be-used-when-counting"></a><a name="to-print-the-report-to-be-used-when-counting"></a><a name="to-print-the-report-to-be-used-when-counting"></a>Para imprimir el informe que va utilizar para el recuento
...
### <a name="to-enter-and-post-the-actual-counted-inventory-in-basic-warehouse-configurations"></a><a name="to-enter-and-post-the-actual-counted-inventory-in-basic-warehouse-configurations"></a><a name="to-enter-and-post-the-actual-counted-inventory-in-basic-warehouse-configurations"></a>Para introducir y registrar el inventario contado real en configuraciones básicas de almacén
...
### <a name="to-calculate-the-expected-inventory-in-advanced-warehouse-configurations"></a><a name="to-calculate-the-expected-inventory-in-advanced-warehouse-configurations"></a><a name="to-calculate-the-expected-inventory-in-advanced-warehouse-configurations"></a>Para calcular el inventario esperado en las configuraciones avanzadas del almacén
...
### <a name="to-enter-and-post-the-actual-counted-inventory-in-advanced-warehouse-configurations"></a><a name="to-enter-and-post-the-actual-counted-inventory-in-advanced-warehouse-configurations"></a><a name="to-enter-and-post-the-actual-counted-inventory-in-advanced-warehouse-configurations"></a>Para introducir y registrar el inventario contado real en configuraciones avanzadas de almacén
...
## <a name="to-do-cycle-counting"></a><a name="to-do-cycle-counting"></a><a name="to-do-cycle-counting"></a>Realizar el recuento cíclico
...
### <a name="to-set-up-counting-periods"></a><a name="to-set-up-counting-periods"></a><a name="to-set-up-counting-periods"></a>Para configurar periodos de recuento
...
### <a name="to-assign-a-counting-period-to-an-item"></a><a name="to-assign-a-counting-period-to-an-item"></a><a name="to-assign-a-counting-period-to-an-item"></a>Asignar un periodo de recuento a un producto
...
### <a name="to-start-a-count-based-on-counting-periods-in-basic-warehouse-configurations"></a><a name="to-start-a-count-based-on-counting-periods-in-basic-warehouse-configurations"></a><a name="to-start-a-count-based-on-counting-periods-in-basic-warehouse-configurations"></a>Para empezar a contar basándose en periodos de recuento en las configuraciones básicas de almacén
...
### <a name="to-start-a-count-based-on-counting-periods-in-advanced-warehouse-configurations"></a><a name="to-start-a-count-based-on-counting-periods-in-advanced-warehouse-configurations"></a><a name="to-start-a-count-based-on-counting-periods-in-advanced-warehouse-configurations"></a>Para empezar un recuento basándose en periodos de recuento en las configuraciones avanzadas de almacén
...
## <a name="to-adjust-the-quantity-of-one-item"></a><a name="to-adjust-the-quantity-of-one-item"></a><a name="to-adjust-the-quantity-of-one-item"></a>Para ajustar la cantidad de un producto
...
### <a name="to-adjust-the-quantities-of-multiple-items-in-basic-warehouse-configurations"></a><a name="to-adjust-the-quantities-of-multiple-items-in-basic-warehouse-configurations"></a><a name="to-adjust-the-quantities-of-multiple-items-in-basic-warehouse-configurations"></a>Para ajustar las cantidades de varios productos en configuraciones básicas de almacén
...
### <a name="to-adjust-bin-quantities-in-advanced-warehouse-configurations"></a><a name="to-adjust-bin-quantities-in-advanced-warehouse-configurations"></a><a name="to-adjust-bin-quantities-in-advanced-warehouse-configurations"></a>Para ajustar las cantidades de la ubicación de configuraciones avanzadas de almacén
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Consultar la [formación de Microsoft](/training/modules/adjust-inventory/) relacionada
