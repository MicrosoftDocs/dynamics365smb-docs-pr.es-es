...
ms.author: jswymer
---
# <a name="create-segments"></a><a name="create-segments"></a><a name="create-segments"></a>Crear segmentos
...
## <a name="to-create-a-segment"></a><a name="to-create-a-segment"></a><a name="to-create-a-segment"></a>Para crear segmentos
