...
ms.author: jswymer
---
# <a name="create-segments"></a><a name="create-segments"></a><a name="create-segments"></a><a name="create-segments"></a>Crear segmentos
...
## <a name="to-create-a-segment"></a><a name="to-create-a-segment"></a><a name="to-create-a-segment"></a><a name="to-create-a-segment"></a>Para crear segmentos
...
3. En la sección **General**, en el campo **N.º**, introduzca un número para el segmento.
    ...
    Por otra parte, si configuró números de serie para los segmentos en la página **Configuración de marketing**, puede seleccionar <kbd>Entrar</kbd> para seleccionar el siguiente número de segmento disponible.
