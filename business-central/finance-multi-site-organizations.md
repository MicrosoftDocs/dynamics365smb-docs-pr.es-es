...
# <a name="business-central-for-multi-site-and-international-organizations" />Business Central para organizaciones internacionales y de sitios múltiples
...
## <a name="integrating-the-headquarter-company-and-the-sites" />Integración de la empresa matriz y los sitios
...
## <a name="meet-the-needs-of-domestic-and-international-sites" />Satisfacer las necesidades de los sitios nacionales e internacionales
...
## <a name="consolidate-financial-data" />Consolidar datos financieros
...
## <a name="share-business-insight-with-integrated-analytics" />Comparta Business Insight con el análisis integrado
...
## <a name="exchange-data-using-apis-and-xmlports" />Intercambio de datos mediante API y XMLports
...
## <a name="promote-an-efficient-intercompany-supply-chain" />Promover una cadena de suministro interempresas eficiente
...
## <a name="respond-quickly-to-new-business-conditions" />Responda rápidamente a las nuevas condiciones comerciales
