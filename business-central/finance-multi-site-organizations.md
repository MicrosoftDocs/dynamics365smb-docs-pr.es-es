...
| **Requisito de negocio** | **Cómo lo soporta Business Central** | **Más información** |
|-------------------------|-------------------------|-------------------------|
| Comparta conocimientos con sitios sin un amplio soporte de TI. | Cree KPI y paneles de inteligencia empresarial en Power BI basados en sus datos. | [Conectarse a Power BI desde Business Central local](across-working-with-business-central-in-powerbi.md) |
