...
---
# <a name="use-a-power-automate-flow-to-timely-synchronize-dataverse-entity-changes"></a>Utilizar un flujo de Power Automate para sincronizar a tiempo cambios de entidad de Dataverse
