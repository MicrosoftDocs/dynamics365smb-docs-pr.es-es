...
## <a name="to-update-skills-for-items-service-items-or-service-item-groups" />Para actualizar las cualificaciones para los productos, productos de servicio o grupos de producto de servicio
