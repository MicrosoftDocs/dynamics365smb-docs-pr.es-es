...
---
# <a name="put-items-away-with-inventory-put-aways" />Ubicar productos con ubicación de inventario
...
## <a name="to-create-an-inventory-put-away-from-the-source-document" />Para crear una ubicación de inventario desde el documento de origen
...
## <a name="to-create-multiple-inventory-put-aways-with-a-batch-job" />Para crear varias Ubicaciones de existencias con un proceso
...
## <a name="to-create-the-put-away-in-two-steps" />Para crear el almacenamiento de inventario en dos pasos

### <a name="to-request-an-inventory-put-away-by-releasing-the-source-document" />Para solicitar una ubicación de inventario lanzando el documento de origen
...
### <a name="to-create-an-inventory-put-away-based-on-the-source-document" />Para crear una ubicación de inventario según el documento de origen
...
## <a name="to-record-the-inventory-put-away" />Para registrar las ubicaciones de inventario
