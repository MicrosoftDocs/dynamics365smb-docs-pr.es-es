...
ms.author: edupont
---
# <a name="record-purchases-with-purchase-invoices-and-orders"></a><a name="record-purchases-with-purchase-invoices-and-orders"></a><a name="record-purchases-with-purchase-invoices-and-orders"></a>Registrar compras con facturas de compra y pedidos
...
## <a name="record-purchases-with-purchase-invoices"></a><a name="record-purchases-with-purchase-invoices"></a><a name="record-purchases-with-purchase-invoices"></a>Registrar compras con facturas de compra
...
### <a name="create-a-and-post-purchase-invoice"></a><a name="create-a-and-post-purchase-invoice"></a><a name="create-a-and-post-purchase-invoice"></a>Crear y registrar una factura de venta
...
## <a name="posted-invoices"></a><a name="posted-invoices"></a><a name="posted-invoices"></a>Facturas registradas
...
## <a name="purchasing-non-inventory-items"></a><a name="purchasing-non-inventory-items"></a><a name="purchasing-non-inventory-items"></a>Comprar artículos que no pertenecen al inventario
...
## <a name="when-to-use-purchase-orders"></a><a name="when-to-use-purchase-orders"></a><a name="when-to-use-purchase-orders"></a>Cuándo usar pedidos de compra
...
## <a name="receive-items-with-a-purchase-order"></a><a name="receive-items-with-a-purchase-order"></a><a name="receive-items-with-a-purchase-order"></a>Recibir productos con un pedido de compra
...
## <a name="receive-more-items-than-ordered"></a><a name="receive-more-items-than-ordered"></a><a name="receive-more-items-than-ordered"></a>Recibir más artículos de los solicitados
...
### <a name="set-up-over-receipts"></a><a name="set-up-over-receipts"></a><a name="set-up-over-receipts"></a>Configurar recibos en exceso
...
### <a name="assign-the-over-receipt-code-to-an-item"></a><a name="assign-the-over-receipt-code-to-an-item"></a><a name="assign-the-over-receipt-code-to-an-item"></a>Asignar el código de recepción en exceso a un producto
...
### <a name="over-receive-an-order"></a><a name="over-receive-an-order"></a><a name="over-receive-an-order"></a>Recibir un pedido en exceso
...
## <a name="posting-purchases"></a><a name="posting-purchases"></a><a name="posting-purchases"></a>Registrar compras
...
## <a name="viewing-ledger-entries"></a><a name="viewing-ledger-entries"></a><a name="viewing-ledger-entries"></a>Ver movimientos
...
## <a name="editing-ledger-entries"></a><a name="editing-ledger-entries"></a><a name="editing-ledger-entries"></a>Editar movimientos
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Consultar la [formación de Microsoft](/training/modules/receive-invoice-dynamics-d365-business-central/index) relacionada.

## <a name="see-related-microsoft-training-1"></a><a name="see-related-microsoft-training-1"></a><a name="see-related-microsoft-training-1"></a>Consultar la [formación de Microsoft](/training/modules/processing-invoices-dynamics-365-business-central/index) relacionada
