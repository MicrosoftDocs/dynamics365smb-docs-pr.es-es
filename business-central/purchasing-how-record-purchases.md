...
ms.author: edupont
---
# <a name="record-purchases-with-purchase-invoices-and-orders" />Registrar compras con facturas de compra y pedidos
...
## <a name="record-purchases-with-purchase-invoices" />Registrar compras con facturas de compra
...
### <a name="create-a-and-post-purchase-invoice" />Crear y registrar una factura de venta
...
## <a name="purchasing-non-inventory-items" />Comprar artículos que no pertenecen al inventario
...
## <a name="when-to-use-purchase-orders" />Cuándo usar pedidos de compra
...
## <a name="receive-items-with-a-purchase-order" />Recibir productos con un pedido de compra
...
## <a name="receive-more-items-than-ordered" />Recibir más artículos de los solicitados
...
### <a name="set-up-over-receipts" />Configurar recibos en exceso
...
### <a name="assign-the-over-receipt-code-to-an-item" />Asignar el código de recepción en exceso a un producto
...
### <a name="over-receive-an-order" />Recibir un pedido en exceso
...
## <a name="posting-purchases" />Registrar compras
...
## <a name="see-related-microsoft-training" />Consultar la [formación de Microsoft](/training/modules/receive-invoice-dynamics-d365-business-central/index) relacionada.

## <a name="see-related-microsoft-training-1" />Consultar la [formación de Microsoft](/training/modules/processing-invoices-dynamics-365-business-central/index) relacionada
