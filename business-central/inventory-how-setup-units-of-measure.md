...
ms.author: edupont
---
# <a name="set-up-units-of-measure"></a><a name="set-up-units-of-measure"></a><a name="set-up-units-of-measure"></a><a name="set-up-units-of-measure"></a>Configurar unidades de medida
...
## <a name="to-set-up-units-of-measure"></a><a name="to-set-up-units-of-measure"></a><a name="to-set-up-units-of-measure"></a><a name="to-set-up-units-of-measure"></a>Para configurar unidades de medida
...
## <a name="to-set-up-multiple-item-units-of-measure"></a><a name="to-set-up-multiple-item-units-of-measure"></a><a name="to-set-up-multiple-item-units-of-measure"></a><a name="to-set-up-multiple-item-units-of-measure"></a>Para configurar múltiples unidades medida producto
...
## <a name="to-set-up-unit-of-measure-translations"></a><a name="to-set-up-unit-of-measure-translations"></a><a name="to-set-up-unit-of-measure-translations"></a><a name="to-set-up-unit-of-measure-translations"></a>Para configurar traducciones de unidades de medida
