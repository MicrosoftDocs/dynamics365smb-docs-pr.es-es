...
ms.author: edupont
---
# <a name="set-up-units-of-measure" />Configurar unidades de medida
...
## <a name="to-set-up-units-of-measure" />Para configurar unidades de medida
...
## <a name="to-set-up-multiple-item-units-of-measure" />Para configurar múltiples unidades medida producto
...
## <a name="to-set-up-unit-of-measure-translations" />Para configurar traducciones de unidades de medida
...
## <a name="to-enter-a-default-unit-of-measure-code-for-sales-and-purchasing-transactions" />Para introducir un código de unidad de medida predeterminada para las transacciones de compra y venta
