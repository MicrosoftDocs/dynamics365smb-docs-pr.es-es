...
ms.author: bholtorf
---
# <a name="block-items-from-sales-or-purchasing" />Bloquear productos de venta o de compra
...
## <a name="to-block-an-item-from-being-entered-on-sales-lines" />Para bloquear que un producto se introduzca en líneas de venta
...
## <a name="to-block-an-item-from-being-entered-on-purchase-lines" />Para bloquear que un producto se introduzca en líneas de compra

1. Elija el icono ![Bombilla que abre la función Dígame.](media/ui-search/search_small.png "Dígame qué desea hacer") , escriba **Productos**, y luego elija el enlace relacionado.  
2. Seleccione el producto que desea bloquear y, a continuación, marque la casilla **Compra bloqueada**.  

## <a name="to-block-an-item-from-being-posted" />Para bloquear que se registre un producto
