...
ms.author: edupont
---
# <a name="adjust-item-costs"></a><a name="adjust-item-costs"></a>Modificar costes de productos
...
## <a name="to-adjust-item-costs-manually"></a><a name="to-adjust-item-costs-manually"></a>Para ajustar manualmente precios de productos
...
## <a name="to-make-general-changes-in-the-direct-unit-cost"></a><a name="to-make-general-changes-in-the-direct-unit-cost"></a>Para hacer cambios generales en el precio de compra
...
## <a name="understanding-unit-cost-calculation"></a><a name="understanding-unit-cost-calculation"></a>Comprender el cálculo del coste unitario
...
## <a name="unit-cost-calculation-for-purchases"></a><a name="unit-cost-calculation-for-purchases"></a>Cálculo del coste unitario para las compras
...
### <a name="costing-method-fifo-lifo-specific-or-average"></a><a name="costing-method-fifo-lifo-specific-or-average"></a>Métodos de valoración de existencias FIFO, LIFO, Especial o Medio
...
## <a name="unit-cost-calculation-for-sales"></a><a name="unit-cost-calculation-for-sales"></a>Cálculo del coste unitario de ventas
