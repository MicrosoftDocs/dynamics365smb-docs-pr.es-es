...
---
# <a name="archive-documents"></a><a name="archive-documents"></a>Archivar documentos
...
## <a name="to-set-up-automatic-document-archiving"></a><a name="to-set-up-automatic-document-archiving"></a>Para configurar el archivado automático de documentos
...
## <a name="to-manually-archive-a-sales-order"></a><a name="to-manually-archive-a-sales-order"></a>Archivar manualmente pedidos de venta
...
## <a name="to-restore-a-non-posted-sales-order-from-the-archive"></a><a name="to-restore-a-non-posted-sales-order-from-the-archive"></a>Para restaurar un pedido de venta no registrado desde el archivo
...
## <a name="to-delete-archived-sales-orders"></a><a name="to-delete-archived-sales-orders"></a>Para eliminar pedidos de venta archivados
