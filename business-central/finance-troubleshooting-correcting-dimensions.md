...
# <a name="troubleshooting-and-correcting-dimensions"></a><a name="troubleshooting-and-correcting-dimensions"></a><a name="troubleshooting-and-correcting-dimensions"></a>Resolución de problemas y corrección de dimensiones
...
## <a name="troubleshooting-dimensions-errors"></a><a name="troubleshooting-dimensions-errors"></a><a name="troubleshooting-dimensions-errors"></a>Solución de errores de dimensiones
...
## <a name="changing-dimension-assignments-after-posting"></a><a name="changing-dimension-assignments-after-posting"></a><a name="changing-dimension-assignments-after-posting"></a>Cambio de asignaciones de dimensión después del registro
...
### <a name="setting-up-dimension-corrections"></a><a name="setting-up-dimension-corrections"></a><a name="setting-up-dimension-corrections"></a>Configuración de correcciones de dimensión
...
### <a name="correcting-a-dimension"></a><a name="correcting-a-dimension"></a><a name="correcting-a-dimension"></a>Corrección de una dimensión
...
### <a name="validating-dimension-corrections"></a><a name="validating-dimension-corrections"></a><a name="validating-dimension-corrections"></a>Validación de correcciones de dimensión
...
### <a name="undoing-a-correction"></a><a name="undoing-a-correction"></a><a name="undoing-a-correction"></a>Deshacer una corrección
...
### <a name="dimension-corrections-on-large-data-sets"></a><a name="dimension-corrections-on-large-data-sets"></a><a name="dimension-corrections-on-large-data-sets"></a>Correcciones de dimensión en grandes conjuntos de datos
...
### <a name="use-analysis-views-with-dimension-corrections"></a><a name="use-analysis-views-with-dimension-corrections"></a><a name="use-analysis-views-with-dimension-corrections"></a>Usar vistas de análisis con correcciones de dimensión
...
### <a name="viewing-historical-dimension-corrections"></a><a name="viewing-historical-dimension-corrections"></a><a name="viewing-historical-dimension-corrections"></a>Visualización de correcciones de dimensión históricas
...
### <a name="handling-incomplete-corrections"></a><a name="handling-incomplete-corrections"></a><a name="handling-incomplete-corrections"></a>Gestión de correcciones incompletas
...
### <a name="use-cost-accounting-with-corrected-gl-entries"></a><a name="use-cost-accounting-with-corrected-gl-entries"></a><a name="use-cost-accounting-with-corrected-gl-entries"></a>Usar la contabilidad de costes con movimientos de contabilidad corregidos
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Consultar la [formación de Microsoft](/training/modules/dimensions-dynamics-365-business-central/) relacionada
