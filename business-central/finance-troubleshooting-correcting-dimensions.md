...
# <a name="troubleshooting-and-correcting-dimensions" />Resolución de problemas y corrección de dimensiones
...
## <a name="troubleshooting-dimensions-errors" />Solución de errores de dimensiones
...
## <a name="changing-dimension-assignments-after-posting" />Cambio de asignaciones de dimensión después del registro
...
### <a name="setting-up-dimension-corrections" />Configuración de correcciones de dimensión
...
### <a name="correcting-a-dimension" />Corrección de una dimensión
...
### <a name="validating-dimension-corrections" />Validación de correcciones de dimensión
...
### <a name="undoing-a-correction" />Deshacer una corrección
...
### <a name="dimension-corrections-on-large-data-sets" />Correcciones de dimensión en grandes conjuntos de datos
...
### <a name="use-analysis-views-with-dimension-corrections" />Usar vistas de análisis con correcciones de dimensión
...
### <a name="viewing-historical-dimension-corrections" />Visualización de correcciones de dimensión históricas
...
### <a name="handling-incomplete-corrections" />Gestión de correcciones incompletas
...
### <a name="use-cost-accounting-with-corrected-gl-entries" />Usar la contabilidad de costes con movimientos de contabilidad corregidos
...
## <a name="see-related-microsoft-trainingtrainingmodulesdimensions-dynamics-365-business-central" />Consultar la [formación de Microsoft](/training/modules/dimensions-dynamics-365-business-central/) relacionada
