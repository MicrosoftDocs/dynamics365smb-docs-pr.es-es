...
ms.author: edupont
---
# <a name="register-employees" />Registrar empleados
...
## <a name="adding-new-employees" />Agregar nuevos empleados
...
## <a name="to-set-up-an-employee" />Para configurar un empleado
...
## <a name="to-insert-a-picture-of-an-employee" />Para insertar una imagen de un empleado
...
## <a name="to-register-various-information-about-an-employee" />Para registrar información diversa acerca de un empleado
