...
ms.author: edupont
---
# <a name="combine-receipts-on-a-single-invoice"></a><a name="combine-receipts-on-a-single-invoice"></a><a name="combine-receipts-on-a-single-invoice"></a>Agrupar albaranes en una factura única
...
## <a name="to-combine-receipts"></a><a name="to-combine-receipts"></a><a name="to-combine-receipts"></a>Para combinar albaranes
