...
ms.author: edupont
---
# <a name="combine-receipts-on-a-single-invoice"></a><a name="combine-receipts-on-a-single-invoice"></a>Agrupar albaranes en una factura única
...
## <a name="to-combine-receipts"></a><a name="to-combine-receipts"></a>Para combinar albaranes
...
## <a name="to-remove-open-purchase-orders-after-combined-receipt-posting"></a><a name="to-remove-open-purchase-orders-after-combined-receipt-posting"></a>Procedimiento para eliminar pedidos de compra abiertos después del registro de recepción combinada
