...
ms.author: edupont
---
# <a name="process-sales-return-orders"></a><a name="process-sales-return-orders"></a>Procesar devoluciones ventas
...
## <a name="create-a-sales-return-order-based-on-one-or-more-posted-sales-documents"></a><a name="create-a-sales-return-order-based-on-one-or-more-posted-sales-documents"></a>Crear un pedido de devolución de ventas basado en uno o más documentos de ventas publicados
...
## <a name="to-create-a-replacement-sales-order-from-a-sales-return-order"></a><a name="to-create-a-replacement-sales-order-from-a-sales-return-order"></a>Para crear un pedido de venta de reposición desde un pedido de devolución de venta
...
## <a name="to-create-return-related-documents-from-a-sales-return-order"></a><a name="to-create-return-related-documents-from-a-sales-return-order"></a>Crear documentos relativos a devoluciones a partir de un pedido de devolución de ventas
...
## <a name="to-create-a-restock-charge"></a><a name="to-create-a-restock-charge"></a>Para crear un cargo de reaprovisionamiento
