...
ms.author: edupont
---
# <a name="process-sales-return-orders" />Procesar devoluciones ventas
...
## <a name="create-a-sales-return-order-based-on-one-or-more-posted-sales-documents" />Crear un pedido de devolución de ventas basado en uno o más documentos de ventas publicados
...
## <a name="to-create-a-replacement-sales-order-from-a-sales-return-order" />Para crear un pedido de venta de reposición desde un pedido de devolución de venta
...
## <a name="to-create-return-related-documents-from-a-sales-return-order" />Crear documentos relativos a devoluciones a partir de un pedido de devolución de ventas
...
## <a name="to-create-a-restock-charge" />Para crear un cargo de reaprovisionamiento
