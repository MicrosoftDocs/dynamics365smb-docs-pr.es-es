...
ms.author: edupont
---
# <a name="import-multiple-item-pictures" />Importar varias imágenes de producto
...
## <a name="to-name-picture-files-by-the-item-names-and-prepare-the-zip-file" />Para asignar nombres a los archivos de imagen por los nombres de los productos y preparar el archivo ZIP
...
## <a name="to-import-item-pictures" />Para importar imágenes de producto
