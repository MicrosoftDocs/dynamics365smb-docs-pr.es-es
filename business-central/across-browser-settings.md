...
ms.author: jswymer
---
# <a name="setting-up-and-troubleshooting-your-browser-to-work-with-business-central-web-client" />Configuración y solución de problemas de su navegador para que funcione con Business Central Web Client
...
## <a name="allow-javascript-from-business-central" />Permitir JavaScript desde Business Central
...
## <a name="allow-cookies-from-business-central" />Permitir cookies desde Business Central
