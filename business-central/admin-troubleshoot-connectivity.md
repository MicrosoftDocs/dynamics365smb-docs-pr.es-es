...
[!INCLUDE[prod_short](includes/prod_short.md)] Online incluye la página **Solución de problemas de conectividad** que puede utilizar para identificar problemas con su conexión al servicio en línea. Hay varias cosas que afectan la conectividad a Business Central, como la configuración del firewall de su red o la configuración del servicio de nombres de dominio. La página le permite ejecutar una lista de comprobaciones que diagnosticarán problemas comunes de conectividad de Business Central. Puede utilizar la información para intentar solucionar los problemas usted mismo o transmitirla a su representante de soporte.
