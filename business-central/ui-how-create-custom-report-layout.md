...
ms.author: edupont
---
# <a name="legacy-create-and-modify-custom-report-layouts" />(Versión heredada) Crear y modificar diseños de informe personalizados
...
## <a name="create-a-custom-layout" />Crear un diseño personalizado
...
### <a name="modify-a-custom-layout" />Modificar un diseño personalizado
