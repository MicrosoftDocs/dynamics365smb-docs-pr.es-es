---
title: Información inteligente y migración a la nube (solo local)
...
# <a name="intelligent-insights-and-cloud-migration-on-premises-only"></a>Información inteligente y migración a la nube (solo local)

Si utiliza [!INCLUDE[prod_short](includes/prod_short.md)] en línea, tiene acceso completo a escenarios basados en la nube inteligente. Por ejemplo, indicadores clave de rendimiento (KPI) que se basan en el aprendizaje automático o cuando visualiza sus datos en Power BI.  
...
Para un entorno local para el cual los datos se migraron a [!INCLUDE[prod_short](includes/prod_short.md)] en línea, la página **Información de Nube inteligente** en el entorno en línea muestra cuatro puntos clave de interés. para la mayoría de las empresas:
...
Junto a los gráficos de KPI, obtendrá información sobre posibles áreas de preocupación, incluidos los pagos atrasados. Elija la información para explorar los datos.  
