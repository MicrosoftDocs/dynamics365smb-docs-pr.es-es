...
ms.author: bholtorf
---
# <a name="design-details-inbound-warehouse-flow"></a><a name="design-details-inbound-warehouse-flow"></a><a name="design-details-inbound-warehouse-flow"></a><a name="design-details-inbound-warehouse-flow"></a>Detalles de diseño: Flujo de entrada en almacén
...
## <a name="no-dedicated-warehouse-activity"></a><a name="no-dedicated-warehouse-activity"></a><a name="no-dedicated-warehouse-activity"></a><a name="no-dedicated-warehouse-activity"></a>No hay ninguna actividad de almacén dedicada
...
## <a name="basic-warehouse-configurations"></a><a name="basic-warehouse-configurations"></a><a name="basic-warehouse-configurations"></a><a name="basic-warehouse-configurations"></a>Configuraciones básicas de almacén
...
### <a name="1-release-a-source-document-to-create-a-request-for-an-inventory-put-away"></a><a name="1-release-a-source-document-to-create-a-request-for-an-inventory-put-away"></a><a name="1-release-a-source-document-to-create-a-request-for-an-inventory-put-away"></a><a name="1-release-a-source-document-to-create-a-request-for-an-inventory-put-away"></a>1: Liberar un documento de origen para crear una solicitud de ubicación de inventario
...
### <a name="2-create-an-inventory-put-away"></a><a name="2-create-an-inventory-put-away"></a><a name="2-create-an-inventory-put-away"></a><a name="2-create-an-inventory-put-away"></a>2: Crear una ubicación de inventario
...
### <a name="3-post-an-inventory-put-away"></a><a name="3-post-an-inventory-put-away"></a><a name="3-post-an-inventory-put-away"></a><a name="3-post-an-inventory-put-away"></a>3: Registrar un almacenamiento de inventario
...
### <a name="1-release-the-source-document"></a><a name="1-release-the-source-document"></a><a name="1-release-the-source-document"></a><a name="1-release-the-source-document"></a>1: Lanzar el documento de origen
...
### <a name="2-create-a-warehouse-receipt"></a><a name="2-create-a-warehouse-receipt"></a><a name="2-create-a-warehouse-receipt"></a><a name="2-create-a-warehouse-receipt"></a>2: Crear una recepción de almacén
...
### <a name="3-post-the-warehouse-receipt"></a><a name="3-post-the-warehouse-receipt"></a><a name="3-post-the-warehouse-receipt"></a><a name="3-post-the-warehouse-receipt"></a>3: Registrar la recepción de almacén
...
### <a name="4-optional-generate-put-away-worksheet-lines"></a><a name="4-optional-generate-put-away-worksheet-lines"></a><a name="4-optional-generate-put-away-worksheet-lines"></a><a name="4-optional-generate-put-away-worksheet-lines"></a>4: (Opcional) Generar líneas de hoja de trabajo de ubicación
...
### <a name="5-create-a-warehouse-put-away-document"></a><a name="5-create-a-warehouse-put-away-document"></a><a name="5-create-a-warehouse-put-away-document"></a><a name="5-create-a-warehouse-put-away-document"></a>5: Crear un documento de almacenamiento de almacén
...
### <a name="6-register-a-warehouse-put-away"></a><a name="6-register-a-warehouse-put-away"></a><a name="6-register-a-warehouse-put-away"></a><a name="6-register-a-warehouse-put-away"></a>6: Registrar una ubicación de almacén
...
## <a name="related-tasks"></a><a name="related-tasks"></a><a name="related-tasks"></a><a name="related-tasks"></a>Tareas relacionadas
