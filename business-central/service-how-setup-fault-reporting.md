...
# <a name="set-up-fault-reporting" />Crear informes de defecto
...
## <a name="to-specify-the-overall-level-of-fault-reporting" />Para especificar el nivel total de información de defecto
...
## <a name="to-create-fault-and-resolution-code-relationships" />Para crear relaciones de códigos de defecto y resolución
