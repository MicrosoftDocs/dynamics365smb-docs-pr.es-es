...
# <a name="application-compliance" />Conformidad de las aplicaciones
...
## <a name="data-privacy" />Privacidad de datos
...
## <a name="accounting-processes-and-controls-to-aid-compliance" />Procesos y controles contables para facilitar el cumplimiento
...
## <a name="enhance-people-practices-with-technology" />Mejorar las prácticas de las personas con la tecnología
...
## <a name="realize-the-benefits-of-an-integrated-business-management-solution" />Obtener los beneficios de una solución de gestión empresarial integrada
...
## <a name="gain-control-of-critical-information-processes-and-reports" />Obtener control de información, procesos e informes críticos.
...
### <a name="manage-compliance-to-the-standards-that-matter" />Gestionar la conformidad de las normas importantes
...
### <a name="tailor-financial-reports-to-your-needs" />Adaptar los informes financieros a sus necesidades
...
### <a name="improve-information-validity" />Mejorar la validez de la información
...
### <a name="comply-quickly-with-discovery-requests-and-reporting-demands" />Cumpla rápidamente con las solicitudes de descubrimiento y las demandas de informes
...
### <a name="help-ensure-clear-audit-trails" />Facilidad para garantizar pistas de auditoría claras
...
## <a name="compliance-and-local-functionality" />Conformidad y funcionalidad local
