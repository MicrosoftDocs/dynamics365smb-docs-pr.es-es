...
ms.author: edupont
---
# <a name="process-sales-returns-or-cancellations" />Procesamiento de devoluciones de ventas o cancelaciones
...
## <a name="to-create-a-sales-credit-memo-from-a-posted-sales-invoice" />Para crear un nuevo abono de venta desde una factura de venta registrada.
...
## <a name="to-create-a-sales-credit-memo-by-copying-a-posted-sales-invoice" />Crear un nuevo abono de venta copiándolo desde una factura de venta registrada
...
## <a name="to-create-a-sales-allowance" />Para crear una deducción de venta
...
## <a name="to-combine-return-receipts" />Agrupar recibos de devolución
...
### <a name="to-manually-combine-return-receipts" />Para agrupar recibos de devolución de forma manual
...
### <a name="to-automatically-combine-return-receipts" />Agrupar automáticamente recepciones de devolución
...
### <a name="to-remove-a-received-and-invoiced-return-order" />Para eliminar un pedido de devolución recibido y facturado
