...
ms.author: edupont
---
# <a name="transfer-bank-funds" />Transferir fondos bancarios
...
## <a name="to-post-a-transfer-between-bank-accounts-with-the-same-currency-code" />Para registrar transferencias entre bancos con el mismo código de divisa
...
## <a name="to-post-a-transfer-between-bank-accounts-with-different-currency-codes" />Para registrar transferencias entre bancos con códigos de divisa distintos
