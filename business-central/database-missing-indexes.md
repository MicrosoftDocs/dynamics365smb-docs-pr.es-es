...
ms.date: 06/09/2022
---
# <a name="database-missing-indexes-in-"></a><a name="database-missing-indexes-in-"></a><a name="database-missing-indexes-in-"></a>Faltan índices en la base de datos en [!INCLUDE[prod_long](includes/prod_long.md)]
