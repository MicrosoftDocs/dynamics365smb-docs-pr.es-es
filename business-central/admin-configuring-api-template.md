...
# <a name="configure-api-templates"></a><a name="configure-api-templates"></a><a name="configure-api-templates"></a><a name="configure-api-templates"></a>Configurar plantillas API
...
## <a name="setting-up-the-entity-template"></a><a name="setting-up-the-entity-template"></a><a name="setting-up-the-entity-template"></a><a name="setting-up-the-entity-template"></a>Configuración de la plantilla de entidad
...
## <a name="assign-the-template-to-an-api"></a><a name="assign-the-template-to-an-api"></a><a name="assign-the-template-to-an-api"></a><a name="assign-the-template-to-an-api"></a>Asigne la plantilla a una API
