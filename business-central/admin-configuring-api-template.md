...
# <a name="configure-api-templates" />Configurar plantillas API
...
## <a name="setting-up-the-entity-template" />Configuración de la plantilla de entidad
...
## <a name="assign-the-template-to-an-api" />Asigne la plantilla a una API
