...
ms.author: edupont
---
# <a name="work-on-service-tasks"></a><a name="work-on-service-tasks"></a><a name="work-on-service-tasks"></a>Trabajar en tareas de servicio
...
## <a name="to-work-on-a-service-task"></a><a name="to-work-on-a-service-task"></a><a name="to-work-on-a-service-task"></a>Para trabajar en una tarea de servicio
...
## <a name="to-register-service-operations"></a><a name="to-register-service-operations"></a><a name="to-register-service-operations"></a>Para registrar operaciones de servicio
...
## <a name="to-register-spare-parts"></a><a name="to-register-spare-parts"></a><a name="to-register-spare-parts"></a>Para registrar componentes
...
## <a name="to-register-spare-parts-from-a-service-order"></a><a name="to-register-spare-parts-from-a-service-order"></a><a name="to-register-spare-parts-from-a-service-order"></a>Registrar piezas de repuesto desde un pedido de servicio
...
## <a name="to-replace-a-service-item-or-a-service-item-component"></a><a name="to-replace-a-service-item-or-a-service-item-component"></a><a name="to-replace-a-service-item-or-a-service-item-component"></a>Para cambiar un producto de servicio o un componente de producto de servicio
...
## <a name="to-change-the-response-time-for-a-service-item-line"></a><a name="to-change-the-response-time-for-a-service-item-line"></a><a name="to-change-the-response-time-for-a-service-item-line"></a>Para cambiar la hora de respuesta en líneas de productos de servicio
...
## <a name="to-register-faultresolution-codes"></a><a name="to-register-faultresolution-codes"></a><a name="to-register-faultresolution-codes"></a>Para registrar códigos de defecto/resolución
