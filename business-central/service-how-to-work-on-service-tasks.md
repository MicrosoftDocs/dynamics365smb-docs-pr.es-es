...
ms.author: edupont
---
# <a name="work-on-service-tasks" />Trabajar en tareas de servicio
...
## <a name="to-work-on-a-service-task" />Para trabajar en una tarea de servicio
...
## <a name="to-register-service-operations" />Para registrar operaciones de servicio
...
## <a name="to-register-spare-parts" />Para registrar componentes
...
## <a name="to-register-spare-parts-from-a-service-order" />Registrar piezas de repuesto desde un pedido de servicio
...
## <a name="to-replace-a-service-item-or-a-service-item-component" />Para cambiar un producto de servicio o un componente de producto de servicio
...
## <a name="to-change-the-response-time-for-a-service-item-line" />Para cambiar la hora de respuesta en líneas de productos de servicio
...
## <a name="to-register-faultresolution-codes" />Para registrar códigos de defecto/resolución
