...
# <a name="resources-for-help-and-support"></a><a name="resources-for-help-and-support"></a>Recursos de ayuda y soporte técnico

Consejos y orientación sobre cómo usar [!INCLUDE[prod_long](includes/prod_long.md)], cómo desbloquearlo, dónde obtener más información y cómo encontrar información técnica está todo disponible desde [!INCLUDE [prod_short](includes/prod_short.md)]. Este artículo describe cómo encontrar qué.  

## <a name="in-product-tips"></a><a name="in-product-tips"></a>Consejos en el producto

[!INCLUDE [ua-get-help](includes/ua-get-help.md)] Estos enlaces también pueden acceder al contenido que se publica en otros sitios web, como los sitios web de los proveedores de cualquier aplicación que esté instalada en su [!INCLUDE [prod_short](includes/prod_short.md)].  

## <a name="help-pane"></a><a name="help-pane"></a>Panel de ayuda
...
## <a name="search-in-the-help-pane"></a><a name="search-in-the-help-pane"></a>Buscar en el panel de ayuda
...
## <a name="help--support-page"></a><a name="help--support-page"></a>Página Ayuda y soporte técnico
...
### <a name="find-answers"></a><a name="find-answers"></a>Encontrar respuestas
...
#### <a name="product-help"></a><a name="product-help"></a>Ayuda de productos
...
#### <a name="community"></a><a name="community"></a>Comunidad
...
#### <a name="blog"></a><a name="blog"></a>Blog
...
#### <a name="capabilities-coming-soon"></a><a name="capabilities-coming-soon"></a>Futuras funcionalidades
...
### <a name="do-more-with-your-trial"></a><a name="do-more-with-your-trial"></a>Hacer más con la versión de prueba
...
### <a name="give-feedback"></a><a name="give-feedback"></a>Enviar comentarios
...
### <a name="product-suggestions"></a><a name="product-suggestions"></a>Sugerencias de productos
...
### <a name="report-a-problem"></a><a name="report-a-problem"></a>Informar sobre un problema
...
### <a name="support-contacts"></a><a name="support-contacts"></a>Contactos de soporte
...
## <a name="learn-more-using-the-product-documentation"></a><a name="learn-more-using-the-product-documentation"></a>Obtener más información utilizando la documentación del producto
...
### <a name="content-on-the-site"></a><a name="content-on-the-site"></a>Contenido en el sitio
...
### <a name="finding-other-content"></a><a name="finding-other-content"></a>Buscar otro contenido
...
### <a name="languages"></a><a name="languages"></a>Idiomas
...
Para cada idioma, la tabla de contenido se traduce, pero el contenido en la sección *Funcionalidad local* está en inglés, excepto para el país que se corresponde con el idioma actual. Por ejemplo, en la versión danesa de Microsoft Learn (`https://learn.microsoft.com/da-dk/dynamics365/business-central/`), puede ver las entradas para la funcionalidad local australiana en danés en la tabla de contenido, pero los artículos están en inglés. Solo los artículos sobre la funcionalidad local danesa se traducen al danés.  

### <a name="recommended-content"></a><a name="recommended-content"></a>Contenido recomendado

En marzo de 2021, apareció una nueva sección debajo de la mayoría de artículos en Microsoft Learn. La sección **Contenido recomendado** se genera automáticamente en función de cómo se usa cada artículo con el resto del sitio. Los vínculos no son estáticos y cambiarán con el tiempo.

### <a name="tell-us-what-you-think"></a><a name="tell-us-what-you-think"></a>Indíquenos su opinión
...
### <a name="navigating-to-other-parts-of-the-site"></a><a name="navigating-to-other-parts-of-the-site"></a>Navegar a otras partes del sitio
...
## <a name="apps-and-other-solutions"></a><a name="apps-and-other-solutions"></a>Aplicaciones y otras soluciones
