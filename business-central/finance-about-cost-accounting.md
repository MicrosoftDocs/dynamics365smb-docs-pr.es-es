...
ms.author: edupont
---
# <a name="about-cost-accounting" />Acerca de la contabilidad de costes
...
## <a name="workflow-in-cost-accounting" />Flujo de trabajo en contabilidad de costes
...
## <a name="cost-types-cost-centers-and-cost-objects" />Tipos de coste, centros de coste y objetos de costes
...
## <a name="cost-entries-and-cost-journals" />Movimientos de costes y diarios de costes
...
## <a name="cost-allocations" />Asignaciones coste
...
## <a name="cost-budgets" />Presupuestos coste
...
## <a name="cost-reporting" />Información de coste
