...
ms.author: edupont
---
# <a name="about-cost-accounting"></a><a name="about-cost-accounting"></a><a name="about-cost-accounting"></a>Acerca de la contabilidad de costes
...
## <a name="workflow-in-cost-accounting"></a><a name="workflow-in-cost-accounting"></a><a name="workflow-in-cost-accounting"></a>Flujo de trabajo en contabilidad de costes
...
## <a name="cost-types-cost-centers-and-cost-objects"></a><a name="cost-types-cost-centers-and-cost-objects"></a><a name="cost-types-cost-centers-and-cost-objects"></a>Tipos de coste, centros de coste y objetos de costes
...
## <a name="cost-entries-and-cost-journals"></a><a name="cost-entries-and-cost-journals"></a><a name="cost-entries-and-cost-journals"></a>Movimientos de costes y diarios de costes
...
## <a name="cost-allocations"></a><a name="cost-allocations"></a><a name="cost-allocations"></a>Asignaciones coste
...
## <a name="cost-budgets"></a><a name="cost-budgets"></a><a name="cost-budgets"></a>Presupuestos coste
...
## <a name="cost-reporting"></a><a name="cost-reporting"></a><a name="cost-reporting"></a>Información de coste
