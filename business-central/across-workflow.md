...
---
# <a name="workflows-in-dynamics-365-business-central"></a><a name="workflows-in-dynamics-365-business-central"></a>Flujos de trabajo en Dynamics 365 Business Central
...
## <a name="power-automate-flows"></a><a name="power-automate-flows"></a>Flujos de Power Automate
...
## <a name="approval-workflows"></a><a name="approval-workflows"></a>Flujos de trabajo de aprobación
