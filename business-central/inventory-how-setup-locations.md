...
ms.author: bholtorf
---
# <a name="set-up-locations"></a><a name="set-up-locations"></a><a name="set-up-locations"></a>Configurar ubicaciones
...
## <a name="location-cards"></a><a name="location-cards"></a><a name="location-cards"></a>Fichas de almacén
...
### <a name="to-set-up-a-location"></a><a name="to-set-up-a-location"></a><a name="to-set-up-a-location"></a>Para configurar un almacén
...
### <a name="to-create-a-transfer-route"></a><a name="to-create-a-transfer-route"></a><a name="to-create-a-transfer-route"></a>Para crear una ruta de transferencia
...
## <a name="bins"></a><a name="bins"></a><a name="bins"></a>Ubicaciones
...
## <a name="zones"></a><a name="zones"></a><a name="zones"></a>Zonas
...
## <a name="default-dimensions-for-locations"></a><a name="default-dimensions-for-locations"></a><a name="default-dimensions-for-locations"></a>Dimensiones predeterminadas para ubicaciones
...
### <a name="example-of-default-dimensions-on-locations"></a><a name="example-of-default-dimensions-on-locations"></a><a name="example-of-default-dimensions-on-locations"></a>Ejemplo de dimensiones predeterminadas para ubicaciones
...
## <a name="see-related-training-at-microsoft-learn"></a><a name="see-related-training-at-microsoft-learn"></a><a name="see-related-training-at-microsoft-learn"></a>Consulte la formación relacionada en [Microsoft Learn](/learn/modules/trade-set-up-dynamics-365-business-central/)
