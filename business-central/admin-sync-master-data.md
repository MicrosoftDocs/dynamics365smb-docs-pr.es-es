...
---
# <a name="manage-master-data-synchronization" />Administrar la sincronización de datos maestros
...
## <a name="investigate-the-status-of-synchronization" />Investigar el estado de la sincronización
...
## <a name="synchronize-modified-records" />Sincronizar registros modificados
...
## <a name="update-table-schemas" />Actualizar esquemas de tablas
...
## <a name="enable-or-disable-couplings-between-records" />Habilitar o deshabilitar los acoplamientos entre registros
...
## <a name="adding-extensions" />Agregar extensiones
...
## <a name="clean-up-old-entries" />Limpiar entradas antiguas
