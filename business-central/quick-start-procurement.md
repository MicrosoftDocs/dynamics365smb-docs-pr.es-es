...
# <a name="procurement-quick-start" />Inicio rápido de adquisiciones
...
## <a name="set-up-vendors" />Configurar proveedores
...
### <a name="set-up-a-new-vendor" />Configurar un proveedor nuevo
...
## <a name="create-new-purchase-orders" />Crear nuevos pedidos de compra
...
### <a name="to-create-a-purchase-order" />Para crear un pedido de compra
...
## <a name="create-a-purchase-invoice" />Crear una factura de compra
...
### <a name="how-to-create-and-post-a-purchase-invoice" />Cómo crear y registrar una factura de compra
