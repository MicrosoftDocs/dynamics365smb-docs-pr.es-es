...
# <a name="procurement-quick-start"></a><a name="procurement-quick-start"></a>Inicio rápido de adquisiciones
...
## <a name="set-up-vendors"></a><a name="set-up-vendors"></a>Configurar proveedores
...
### <a name="set-up-a-new-vendor"></a><a name="set-up-a-new-vendor"></a>Configurar un proveedor nuevo
...
## <a name="create-new-purchase-orders"></a><a name="create-new-purchase-orders"></a>Crear nuevos pedidos de compra
...
### <a name="to-create-a-purchase-order"></a><a name="to-create-a-purchase-order"></a>Para crear un pedido de compra
...
## <a name="create-a-purchase-invoice"></a><a name="create-a-purchase-invoice"></a>Crear una factura de compra
...
### <a name="how-to-create-and-post-a-purchase-invoice"></a><a name="how-to-create-and-post-a-purchase-invoice"></a>Cómo crear y registrar una factura de compra
