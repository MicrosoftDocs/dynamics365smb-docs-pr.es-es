...
ms.author: edupont
---
# <a name="design-details-item-application" />Detalles de diseño: Liquidación de productos
...
## <a name="inventory-increase" />Entrada de existencias
...
## <a name="inventory-decrease" />Salida de existencias
...
## <a name="fixed-application" />Liquidación fija
...
### <a name="example--fixed-application-in-purchase-return" />Ejemplo: Liquidación fija en devolución de compra
...
### <a name="example--fixed-application-with-average-cost" />Ejemplo: Liquidación fija con coste medio
...
### <a name="example--fixed-application-in-sales-return" />Ejemplo: Liquidación fija en devolución de venta
...
## <a name="transfer-application" />Solicitud de transferencia
...
### <a name="example--average-costing-method" />Ejemplo: Método de coste promedio
...
### <a name="example--standard-costing-method" />Ejemplo: Método de coste Estándar
...
## <a name="reapplication" />Nueva liquidación
