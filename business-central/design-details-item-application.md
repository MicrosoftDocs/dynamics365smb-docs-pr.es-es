...
ms.author: edupont
---
# <a name="design-details-item-application"></a><a name="design-details-item-application"></a><a name="design-details-item-application"></a>Detalles de diseño: Liquidación de productos
...
## <a name="inventory-increase"></a><a name="inventory-increase"></a><a name="inventory-increase"></a>Entrada de existencias
...
## <a name="inventory-decrease"></a><a name="inventory-decrease"></a><a name="inventory-decrease"></a>Salida de existencias
...
## <a name="fixed-application"></a><a name="fixed-application"></a><a name="fixed-application"></a>Liquidación fija
...
### <a name="example--fixed-application-in-purchase-return"></a><a name="example--fixed-application-in-purchase-return"></a><a name="example--fixed-application-in-purchase-return"></a>Ejemplo: Liquidación fija en devolución de compra
...
### <a name="example--fixed-application-with-average-cost"></a><a name="example--fixed-application-with-average-cost"></a><a name="example--fixed-application-with-average-cost"></a>Ejemplo: Liquidación fija con coste medio
...
### <a name="example--fixed-application-in-sales-return"></a><a name="example--fixed-application-in-sales-return"></a><a name="example--fixed-application-in-sales-return"></a>Ejemplo: Liquidación fija en devolución de venta
...
## <a name="transfer-application"></a><a name="transfer-application"></a><a name="transfer-application"></a>Solicitud de transferencia
...
### <a name="example--average-costing-method"></a><a name="example--average-costing-method"></a><a name="example--average-costing-method"></a>Ejemplo: Método de coste promedio
...
### <a name="example--standard-costing-method"></a><a name="example--standard-costing-method"></a><a name="example--standard-costing-method"></a>Ejemplo: Método de coste Estándar
...
## <a name="reapplication"></a><a name="reapplication"></a><a name="reapplication"></a>Nueva liquidación
