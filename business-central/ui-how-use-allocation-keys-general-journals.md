...
ms.author: edupont
---
# <a name="use-allocation-keys-in-general-journals"></a><a name="use-allocation-keys-in-general-journals"></a><a name="use-allocation-keys-in-general-journals"></a><a name="use-allocation-keys-in-general-journals"></a>Utilizar claves de asignación en diarios generales
...
## <a name="to-set-up-allocation-keys"></a><a name="to-set-up-allocation-keys"></a><a name="to-set-up-allocation-keys"></a><a name="to-set-up-allocation-keys"></a>Para configurar claves de asignación
...
## <a name="to-change-an-allocation-key-that-has-already-been-set-up"></a><a name="to-change-an-allocation-key-that-has-already-been-set-up"></a><a name="to-change-an-allocation-key-that-has-already-been-set-up"></a><a name="to-change-an-allocation-key-that-has-already-been-set-up"></a>Para modificar una clave de asignación que ya haya sido configurada
1. Elija el icono ![Bombilla que abre la función Dígame.](media/ui-search/search_small.png "Dígame qué desea hacer") , escriba **Diario general periódico** y luego elija el enlace relacionado.
