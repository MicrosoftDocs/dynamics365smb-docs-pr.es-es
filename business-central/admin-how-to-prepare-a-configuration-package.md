...
ms.locfileid: "8382450"
---
# <a name="prepare-a-configuration-package"></a>Preparar un paquete de configuración

Cuando se configura una nueva empresa, basada en un paquete e configuración, se reconocen y se procesan las relaciones de tabla. Los datos se importan y se aplican en el orden correcto. Si en el paquete de configuración se incluyen tablas de dimensión, estas también se importan. Para obtener más información, consulte [Para importar datos del cliente](admin-migrate-customer-data.md#to-import-customer-data).  
