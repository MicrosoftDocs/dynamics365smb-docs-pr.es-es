...
ms.author: edupont
---
# <a name="design-details-item-tracking-and-reservations" />Detalles de diseño: Seguimiento de productos y reservas
...
## <a name="specific-reservation" />Reserva específica
...
## <a name="nonspecific-reservation" />Reserva no específica
...
## <a name="supported-business-scenarios" />Escenarios empresariales admitidos
...
### <a name="entering-serial-or-lot-numbers-on-an-outbound-document-with-wrong-nonspecific-reservation" />Registrar números de serie o de lote en un documento de salida con reserva no específica incorrecta.
...
### <a name="reserve-specific-serial-or-lot-numbers" />Reservar un número de serie o de lote específico
...
### <a name="posting-an-outbound-document-with-nonspecific-reservation-of-serial-or-lot-numbers" />Registrar un documento de salida con la reserva no específica de los números de serie o de lote.
