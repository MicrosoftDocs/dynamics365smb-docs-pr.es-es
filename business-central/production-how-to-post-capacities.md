...
ms.author: edupont
---
# <a name="post-capacities"></a><a name="post-capacities"></a><a name="post-capacities"></a>Registrar capacidades
...
## <a name="to-post-capacities"></a><a name="to-post-capacities"></a><a name="to-post-capacities"></a>Para registrar capacidades
...
## <a name="to-view-work-center-ledger-entries"></a><a name="to-view-work-center-ledger-entries"></a><a name="to-view-work-center-ledger-entries"></a>Para consultar los movimientos de centros de trabajo
