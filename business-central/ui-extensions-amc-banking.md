...
# <a name="use-the-amc-banking-365-fundamentals-extension"></a><a name="use-the-amc-banking-365-fundamentals-extension"></a>Usar la extensión de AMC Banking 365 Fundamentals
...
## <a name="use-our-demonstration-account"></a><a name="use-our-demonstration-account"></a>Usar nuestra cuenta de demostración
...
## <a name="setting-up-the-extension"></a><a name="setting-up-the-extension"></a>Configuración de la extensión
...
### <a name="to-set-up-the-required-permission-sets"></a><a name="to-set-up-the-required-permission-sets"></a>Para configurar los conjuntos de permisos necesarios
...
### <a name="to-connect-the-extension-to-amc-banking"></a><a name="to-connect-the-extension-to-amc-banking"></a>Para conectar la extensión a AMC Banking
...
### <a name="to-connect-bank-accounts-to-the-extension"></a><a name="to-connect-bank-accounts-to-the-extension"></a>Para conectar bancos a la extensión
...
## <a name="use-the-extension"></a><a name="use-the-extension"></a>Usar la extensión
...
### <a name="to-export-data-and-submit-it-to-your-bank"></a><a name="to-export-data-and-submit-it-to-your-bank"></a>Para exportar datos y enviarlos a su banco
...
### <a name="to-import-and-apply-the-converted-file"></a><a name="to-import-and-apply-the-converted-file"></a>Para importar y aplicar el archivo convertido
