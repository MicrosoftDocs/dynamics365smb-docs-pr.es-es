...
# <a name="use-the-amc-banking-365-fundamentals-extension" />Usar la extensión de AMC Banking 365 Fundamentals
...
## <a name="use-our-demonstration-account" />Usar nuestra cuenta de demostración
...
## <a name="setting-up-the-extension" />Configuración de la extensión
...
### <a name="to-set-up-the-required-permission-sets" />Para configurar los conjuntos de permisos necesarios
...
### <a name="to-connect-the-extension-to-amc-banking" />Para conectar la extensión a AMC Banking
...
### <a name="to-connect-bank-accounts-to-the-extension" />Para conectar bancos a la extensión
...
## <a name="use-the-extension" />Usar la extensión
...
### <a name="to-export-data-and-submit-it-to-your-bank" />Para exportar datos y enviarlos a su banco
...
### <a name="to-import-and-apply-the-converted-file" />Para importar y aplicar el archivo convertido
