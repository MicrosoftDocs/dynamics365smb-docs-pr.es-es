---
title: Cómo utilizar la extensión AMC Banking 365 Fundamentals
...
# <a name="use-the-amc-banking-365-fundamentals-extension"></a>Utilice la extensión AMC Banking 365 Fundamentals
...
Comenzar a usar la extensión implica solo unos pocos pasos sencillos y una guía de configuración asistida establecerá la conexión y activará la extensión. Guía le ayuda con cosas como instalar las definiciones de intercambio de datos para configuraciones de importación/exportación de extractos bancarios e iniciar la serie de números utilizada para los mensajes de transferencia de crédito.  
...
3. En el campo **Nombre**, elija el formato que requiere su banco.  
