...
## <a name="to-create-the-pick-in-two-steps"></a>Para crear el picking en dos pasos
...
## <a name="to-record-inventory-picks"></a>Para registrar pickings de inventario
...
## <a name="handling-assemble-to-order-items-with-inventory-picks"></a>Tratamiento de productos de ensamblar para pedido con pickings de inventario
