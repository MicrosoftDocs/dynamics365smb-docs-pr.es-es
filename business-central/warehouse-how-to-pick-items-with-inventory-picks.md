...
---
# Realizar el picking de productos con picking inventario
...
## Para crear varios picking de inventario con un trabajo por lotes
...
## Para crear el picking en dos pasos

### Para solicitar un picking de inventario lanzado el documento de origen
...
### Para crear un picking de inventario basado en el documento de origen
...
## Para registrar pickings de inventario
...
## Tratamiento de productos de ensamblar para pedido con pickings de inventario
