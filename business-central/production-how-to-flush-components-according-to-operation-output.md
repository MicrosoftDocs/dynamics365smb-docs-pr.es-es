...
ms.author: edupont
---
# <a name="flush-components-according-to-operation-output" />Bajar componentes según la salida de la operación
...
## <a name="automatic-consumption-posting-flushing-methods" />Métodos de registro automático del consumo (consumo automático)
...
### <a name="automatic-reporting---forward-flush-the-entire-order" />Registro automático - Baja hacia adelante de toda la orden
...
### <a name="automatic-reporting---forward-flushing-by-operation" />Registro automático - Baja hacia adelante por operación
...
### <a name="automatic-reporting---back-flushing-by-operation" />Registro automático - Baja hacia atrás por operación
...
### <a name="automatic-reporting---back-flushing-the-entire-order" />Registro automático - Baja hacia atrás de toda la orden
...
## <a name="to-flush-components-according-to-operation-output" />Para bajar componentes según la salida de la operación
...
## <a name="flushing-methods" />Métodos de baja
