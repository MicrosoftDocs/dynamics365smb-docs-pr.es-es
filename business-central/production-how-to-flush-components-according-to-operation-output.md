---
title: Realizar la baja de componentes según la salida de la operación
description: Este artículo describe cómo bajar componentes de acuerdo con el resultado de la operación y otros métodos de baja involucrados.
author: brentholtorf
ms.topic: conceptual
ms.devlang: al
...
# Realizar la baja de componentes según la salida de la operación
...
## Métodos de registro automático del consumo (consumo automático)  
...
Si realiza la baja hacia adelante de la orden de producción al comienzo del proyecto, el comportamiento de la aplicación es parecido al del consumo manual. La diferencia principal es que el consumo tiene lugar automáticamente.  
...
El consumo se registra automáticamente cuando registre la salida. Para obtener más información, consulte [Registro de salida y tiempos de ejecución por lotes](production-how-to-post-output-quantity.md)
