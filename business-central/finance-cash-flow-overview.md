...
# <a name="cash-flow-overview" />Descripción del flujo de efectivo
...
## <a name="definition-of-cash-flow" />Definición de flujos de efectivo
...
## <a name="work-with-cash-flow" />Trabajar con flujo de efectivo
...
## <a name="making-a-cash-flow-forecast" />Realización de una previsión flujo efectivo
