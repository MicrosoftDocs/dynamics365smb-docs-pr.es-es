...
# <a name="finding-pages-with-the-role-explorer"></a><a name="finding-pages-with-the-role-explorer"></a>Búsqueda de páginas con el explorador de roles
...
## <a name="open-the-role-explorer"></a><a name="open-the-role-explorer"></a>Abrir el explorador de roles
...
## <a name="navigate-features"></a><a name="navigate-features"></a>Navegar por las funciones
...
## <a name="search-for-features"></a><a name="search-for-features"></a>Buscar características
...
## <a name="explore-other-roles"></a><a name="explore-other-roles"></a>Explorar otros roles
...
## <a name="expand-and-collapse-nodes-on-the-role-explorer"></a><a name="expand-and-collapse-nodes-on-the-role-explorer"></a>Expandir y contraer nodos en el explorador de roles
