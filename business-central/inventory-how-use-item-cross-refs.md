...
ms.author: edupont
---
# <a name="use-item-references"></a><a name="use-item-references"></a><a name="use-item-references"></a><a name="use-item-references"></a>Usar referencias de producto
...
## <a name="to-start-using-item-references"></a><a name="to-start-using-item-references"></a><a name="to-start-using-item-references"></a><a name="to-start-using-item-references"></a>Para comenzar a usar referencias de productos
...
## <a name="to-set-up-an-item-reference"></a><a name="to-set-up-an-item-reference"></a><a name="to-set-up-an-item-reference"></a><a name="to-set-up-an-item-reference"></a>Para configurar una referencia de artículo
...
## <a name="to-enter-a-vendors-item-description-on-a-document"></a><a name="to-enter-a-vendors-item-description-on-a-document"></a><a name="to-enter-a-vendors-item-description-on-a-document"></a><a name="to-enter-a-vendors-item-description-on-a-document"></a>Para introducir la descripción del producto de un proveedor en un documento
