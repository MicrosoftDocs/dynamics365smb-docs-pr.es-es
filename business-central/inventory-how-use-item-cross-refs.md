...
ms.author: edupont
---
# <a name="use-item-references" />Usar referencias de producto
...
## <a name="to-start-using-item-references" />Para comenzar a usar referencias de productos
...
## <a name="to-set-up-an-item-reference" />Para configurar una referencia de artículo
...
## <a name="to-enter-a-vendors-item-description-on-a-document" />Para introducir la descripción del producto de un proveedor en un documento
