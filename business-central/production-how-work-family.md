...
ms.author: edupont
---
# <a name="work-with-production-families" />Trabajar con familias de producción
...
## <a name="to-set-up-a-production-family" />Para configurar una familia de producción
...
## <a name="to-produce-based-on-a-production-family" />Para producir basándose en una familia de producción
