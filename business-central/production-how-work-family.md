...
ms.author: edupont
---
# <a name="work-with-production-families"></a><a name="work-with-production-families"></a><a name="work-with-production-families"></a><a name="work-with-production-families"></a>Trabajar con familias de producción
...
## <a name="to-set-up-a-production-family"></a><a name="to-set-up-a-production-family"></a><a name="to-set-up-a-production-family"></a><a name="to-set-up-a-production-family"></a>Para configurar una familia de producción
...
## <a name="to-produce-based-on-a-production-family"></a><a name="to-produce-based-on-a-production-family"></a><a name="to-produce-based-on-a-production-family"></a><a name="to-produce-based-on-a-production-family"></a>Para producir basándose en una familia de producción
