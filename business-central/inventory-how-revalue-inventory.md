...
ms.author: edupont
---
# <a name="revalue-inventory"></a><a name="revalue-inventory"></a><a name="revalue-inventory"></a><a name="revalue-inventory"></a>Revaluar inventario
Si desea apreciar o depreciar un producto o el movimiento de un determinado producto, utilice el diario de revalorización.

## <a name="to-revalue-inventory"></a><a name="to-revalue-inventory"></a><a name="to-revalue-inventory"></a><a name="to-revalue-inventory"></a>Para revaluar el inventario
