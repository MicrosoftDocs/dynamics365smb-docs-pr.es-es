...
ms.author: edupont
---
# <a name="create-service-quotes"></a><a name="create-service-quotes"></a><a name="create-service-quotes"></a>Crear ofertas de servicio
...
## <a name="to-create-a-service-quote"></a><a name="to-create-a-service-quote"></a><a name="to-create-a-service-quote"></a>Para crear una oferta de servicio
