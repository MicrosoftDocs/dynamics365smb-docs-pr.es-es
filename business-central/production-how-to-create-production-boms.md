...
ms.author: bholtorf
---
# <a name="create-production-boms" />Crear LM de producción
...
## <a name="to-create-a-production-bom" />Crear una L.M. de producción.
...
## <a name="to-create-a-new-version-of-a-production-bom" />Para crear una versión nueva de una L.M. de producción
...
## <a name="quantity-calculation-formula-on-production-boms" />Fórmula de cálculo de la cantidad en las L.M. de producción
