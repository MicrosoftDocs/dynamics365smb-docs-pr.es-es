...
ms.author: bholtorf
---
# <a name="create-production-boms"></a><a name="create-production-boms"></a><a name="create-production-boms"></a><a name="create-production-boms"></a>Crear LM de producción
...
## <a name="to-create-a-production-bom"></a><a name="to-create-a-production-bom"></a><a name="to-create-a-production-bom"></a><a name="to-create-a-production-bom"></a>Crear una L.M. de producción.
...
## <a name="to-create-a-new-version-of-a-production-bom"></a><a name="to-create-a-new-version-of-a-production-bom"></a><a name="to-create-a-new-version-of-a-production-bom"></a><a name="to-create-a-new-version-of-a-production-bom"></a>Para crear una versión nueva de una L.M. de producción
...
## <a name="quantity-calculation-formula-on-production-boms"></a><a name="quantity-calculation-formula-on-production-boms"></a><a name="quantity-calculation-formula-on-production-boms"></a><a name="quantity-calculation-formula-on-production-boms"></a>Fórmula de cálculo de la cantidad en las L.M. de producción
