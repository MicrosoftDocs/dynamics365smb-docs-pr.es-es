...
ms.author: edupont
---
# <a name="set-up-the-amc-banking-365-fundamentals-extension" />Configurar la extensión AMC Banking 365 Fundamentals
...
## <a name="to-sign-your-company-up-for-the-amc-banking-365-fundamentals-extension" />Para inscribir a su empresa en la extensión AMC Banking 365 Fundamentals
...
## <a name="to-view-or-update-the-list-of-currently-supported-bank-data-formats" />Para ver o actualizar la lista de formatos de datos de banco actualmente compatibles
1. Elija el icono ![Bombilla que abre la función Dígame.](media/ui-search/search_small.png "Dígame qué desea hacer") , escriba **Configuración de servicio de conv. de datos del banco** y luego elija el enlace relacionado.
