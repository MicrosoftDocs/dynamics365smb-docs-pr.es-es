...
# <a name="troubleshoot-access-with-microsoft-365-licenses"></a><a name="troubleshoot-access-with-microsoft-365-licenses"></a><a name="troubleshoot-access-with-microsoft-365-licenses"></a><a name="troubleshoot-access-with-microsoft-365-licenses"></a>Solucionar problemas de acceso con licencias de Microsoft 365
...
### <a name="symptoms"></a><a name="symptoms"></a><a name="symptoms"></a><a name="symptoms"></a>Síntomas
...
### <a name="cause"></a><a name="cause"></a><a name="cause"></a><a name="cause"></a>Causa

Lo más probable es que le falten permisos de objeto para las tablas a las que se vincula la página actual o el registro.

## <a name="microsoft-365-access-has-been-enabled-but-users-get-a-permission-error"></a><a name="microsoft-365-access-has-been-enabled-but-users-get-a-permission-error"></a><a name="microsoft-365-access-has-been-enabled-but-users-get-a-permission-error"></a><a name="microsoft-365-access-has-been-enabled-but-users-get-a-permission-error"></a>Se ha habilitado el acceso a Microsoft 365, pero los usuarios obtienen un error de permiso

### <a name="symptoms-1"></a><a name="symptoms-1"></a><a name="symptoms-1"></a><a name="symptoms-1"></a>Síntomas
...
### <a name="cause-1"></a><a name="cause-1"></a><a name="cause-1"></a><a name="cause-1"></a>Causa
...
### <a name="resolution"></a><a name="resolution"></a><a name="resolution"></a><a name="resolution"></a>Resolución
...
## <a name="you-shared-a-link-in-teams-but-users-get-a-message-that-they-can-only-view-data"></a><a name="you-shared-a-link-in-teams-but-users-get-a-message-that-they-can-only-view-data"></a><a name="you-shared-a-link-in-teams-but-users-get-a-message-that-they-can-only-view-data"></a><a name="you-shared-a-link-in-teams-but-users-get-a-message-that-they-can-only-view-data"></a>Compartió un vínculo en Teams, pero los usuarios reciben un mensaje de que solo pueden ver datos

### <a name="symptoms-2"></a><a name="symptoms-2"></a><a name="symptoms-2"></a><a name="symptoms-2"></a>Síntomas
...
### <a name="cause-2"></a><a name="cause-2"></a><a name="cause-2"></a><a name="cause-2"></a>Causa
...
### <a name="resolution-1"></a><a name="resolution-1"></a><a name="resolution-1"></a><a name="resolution-1"></a>Resolución
...
### <a name="symptoms-3"></a><a name="symptoms-3"></a><a name="symptoms-3"></a><a name="symptoms-3"></a>Síntomas
...
### <a name="cause-3"></a><a name="cause-3"></a><a name="cause-3"></a><a name="cause-3"></a>Causa
