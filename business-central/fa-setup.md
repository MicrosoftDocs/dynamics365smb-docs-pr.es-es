...
ms.author: edupont
---
# <a name="setting-up-fixed-assets"></a><a name="setting-up-fixed-assets"></a><a name="setting-up-fixed-assets"></a><a name="setting-up-fixed-assets"></a>Configurar activos fijos
