...
ms.author: edupont
---
# <a name="set-up-approval-workflows" />Configurar flujos de trabajo de aprobación
...
## <a name="example-of-an-approval-workflow" />Ejemplo de un flujo de trabajo de aprobación
