...
### Administración de diferencias en valores de campo
...
### Administración de valores de opciones que faltan en la asignación
...
#### Para filtrar registros o filas para la sincronización  
