...
---
# <a name="mapping-the-tables-and-fields-to-synchronize"></a><a name="mapping-the-tables-and-fields-to-synchronize"></a><a name="mapping-the-tables-and-fields-to-synchronize"></a>Asignación de tablas y campos para sincronizar
...
## <a name="mapping-integration-tables"></a><a name="mapping-integration-tables"></a><a name="mapping-integration-tables"></a>Asignación de tablas de integración
...
### <a name="additional-mappings"></a><a name="additional-mappings"></a><a name="additional-mappings"></a>Asignaciones adicionales
...
### <a name="strategies-for-auto-resolving-conflicts"></a><a name="strategies-for-auto-resolving-conflicts"></a><a name="strategies-for-auto-resolving-conflicts"></a>Estrategias para la resolución automática de conflictos
...
## <a name="mapping-integration-fields"></a><a name="mapping-integration-fields"></a><a name="mapping-integration-fields"></a>Asignaciones de campos de integración
...
### <a name="handle-differences-in-field-values"></a><a name="handle-differences-in-field-values"></a><a name="handle-differences-in-field-values"></a>Manejo de diferencias en valores de campos
...
### <a name="handle-missing-option-values"></a><a name="handle-missing-option-values"></a><a name="handle-missing-option-values"></a>Manejo de valores de opciones que faltan
...
## <a name="couple-records"></a><a name="couple-records"></a><a name="couple-records"></a>Emparejar registros
...
## <a name="filter-records-and-rows"></a><a name="filter-records-and-rows"></a><a name="filter-records-and-rows"></a>Filtrar registros y filas
...
## <a name="create-new-records"></a><a name="create-new-records"></a><a name="create-new-records"></a>Crear nuevos registros
...
### <a name="to-create-new-records-during-synchronization"></a><a name="to-create-new-records-during-synchronization"></a><a name="to-create-new-records-during-synchronization"></a>Para crear registros nuevos durante la sincronización
...
## <a name="use-configuration-templates-on-table-mappings"></a><a name="use-configuration-templates-on-table-mappings"></a><a name="use-configuration-templates-on-table-mappings"></a>Usar plantillas de configuración en asignaciones de tabla
...
### <a name="to-specify-configuration-templates-on-a-table-mapping"></a><a name="to-specify-configuration-templates-on-a-table-mapping"></a><a name="to-specify-configuration-templates-on-a-table-mapping"></a>Para especificar plantillas de configuración en una asignación de tabla
