...
# <a name="manage-work-across-multiple-companies-in-the-company-hub"></a><a name="manage-work-across-multiple-companies-in-the-company-hub"></a><a name="manage-work-across-multiple-companies-in-the-company-hub"></a>Administrar el trabajo de varias empresas en el hub de empresas
...
## <a name="company-hub-home-page"></a><a name="company-hub-home-page"></a><a name="company-hub-home-page"></a>Página de inicio del hub de empresas
...
## <a name="assigned-tasks"></a><a name="assigned-tasks"></a><a name="assigned-tasks"></a>Tareas asignadas
...
### <a name="my-user-tasks"></a><a name="my-user-tasks"></a><a name="my-user-tasks"></a>Mis tareas de usuario
...
## <a name="access-the-company-hub"></a><a name="access-the-company-hub"></a><a name="access-the-company-hub"></a>Acceder al hub de empresas
...
## <a name="set-up-the-company-hub"></a><a name="set-up-the-company-hub"></a><a name="set-up-the-company-hub"></a>Establecer el hub de empresas
