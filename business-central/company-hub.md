...
# <a name="manage-work-across-multiple-companies-in-the-company-hub" />Administrar el trabajo de varias empresas en el hub de empresas
...
## <a name="company-hub-home-page" />Página de inicio del hub de empresas
...
## <a name="assigned-tasks" />Tareas asignadas
...
### <a name="my-user-tasks" />Mis tareas de usuario
...
## <a name="access-the-company-hub" />Acceder al hub de empresas
...
## <a name="set-up-the-company-hub" />Establecer el hub de empresas
