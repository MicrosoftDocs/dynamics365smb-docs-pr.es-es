...
# <a name="setting-up-troubleshooting-for-service-items" />Configuración de la solución de problemas de los productos de servicio
...
## <a name="to-set-up-troubleshooting-guidelines" />Para configurar instrucciones de detección de errores
...
## <a name="to-assign-troubleshooting-guidelines-to-items-service-items-or-service-item-groups" />Para asignar directrices de solución de problemas a productos, productos de servicio o grupos de productos de servicio
