...
## <a name="to-set-up-a-document-sending-profile"></a><a name="to-set-up-a-document-sending-profile"></a>Para configurar un perfil de envío de documentos
...
## <a name="to-specify-a-sending-profile-on-a-customer-card"></a><a name="to-specify-a-sending-profile-on-a-customer-card"></a>Para especificar un perfil de envío en una ficha cliente
