...
## <a name="to-set-up-a-document-sending-profile" />Para configurar un perfil de envío de documentos
...
## <a name="to-specify-a-sending-profile-on-a-customer-card" />Para especificar un perfil de envío en una ficha cliente
