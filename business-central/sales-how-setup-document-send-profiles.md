...
## <a name="to-set-up-a-document-sending-profile"></a><a name="to-set-up-a-document-sending-profile"></a><a name="to-set-up-a-document-sending-profile"></a><a name="to-set-up-a-document-sending-profile"></a>Para configurar un perfil de envío de documentos
1. Elija el icono ![Bombilla que abre la función Dígame.](media/ui-search/search_small.png "Dígame qué desea hacer") , escriba **Perfiles de envío de documentos** y luego elija el enlace relacionado.
2. En la página **Perfiles de envío de documentos**, elija la acción **Nuevo**.
3. Rellene los campos según sea necesario. [!INCLUDE[tooltip-inline-tip](includes/tooltip-inline-tip_md.md)]

## <a name="to-specify-a-sending-profile-on-a-customer-card"></a><a name="to-specify-a-sending-profile-on-a-customer-card"></a><a name="to-specify-a-sending-profile-on-a-customer-card"></a><a name="to-specify-a-sending-profile-on-a-customer-card"></a>Para especificar un perfil de envío en una ficha cliente
