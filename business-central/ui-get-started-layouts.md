...
ms.author: jswymer
---
# <a name="get-started-creating-report-layouts"></a><a name="get-started-creating-report-layouts"></a>Empezar a crear diseños de informes
...
## <a name="decide-what-type-of-layout-you-want"></a><a name="decide-what-type-of-layout-you-want"></a><a name="decide"></a>Decida qué tipo de diseño desea
...
## <a name="create-a-new-layout"></a><a name="create-a-new-layout"></a><a name="create"></a>Crear un nuevo diseño
...
## <a name="modify-a-layout"></a><a name="modify-a-layout"></a><a name="modify"></a>Modificar un diseño
...
## <a name="replace-a-layout"></a><a name="replace-a-layout"></a><a name="replace"></a>Reemplazar un diseño
...
## <a name="rename-a-layout"></a><a name="rename-a-layout"></a><a name="rename"></a>Cambiar el nombre de un diseño
