...
Las experiencias que se pueden seleccionar en [!INCLUDE[prod_short](includes/prod_short.md)] reflejan las licencias de solución, llamadas planes, que se definen para el producto. Para obtener información acerca de los planes de Esencial y Premium, consulte [Business Central](https://go.microsoft.com/fwlink/?linkid=2264940) en el sitio de marketing de Microsoft Dynamics 365. Consulte también [[!INCLUDE[prod_short](includes/prod_short.md)], guía de licencia](https://go.microsoft.com/fwlink/?linkid=2264939).

> [!IMPORTANT]  
> Los usuarios del tipo Miembro del equipo, Administrador interno, Contable externo y Administrador delegado, a quienes se les puede asignar un plan diferente al de otros usuarios en la solución. Solo los usuarios de tipo Evaluación o Premium pueden cambiar el valor del campo **Experiencia** de Essential a Premium.

> [!NOTE]
> En el primer lanzamiento de versiones de 2024, un usuario con el plan Premium puede iniciar sesión en una empresa que esté utilizando el plan Essentials. Sin embargo, el usuario Premium no puede utilizar ninguna de las funciones que proporciona la licencia Premium. No ocurre lo mismo en la dirección opuesta. Los usuarios que tienen el plan Essentials no pueden iniciar sesión en una empresa que esté utilizando el plan Premium.
...
## <a name="enabling-premium-features-after-upgrading-a-plan"></a>Habilitar características premium tras actualizar un plan
...
## <a name="help-assumes-the-premium-experience"></a>En la ayuda se asume la experiencia Premium
