...
ms.author: edupont
---
# <a name="change-which-features-are-displayed"></a><a name="change-which-features-are-displayed"></a>Cambiar las funciones que se muestran
...
## <a name="enabling-premium-features-after-upgrading-a-plan"></a><a name="enabling-premium-features-after-upgrading-a-plan"></a>Habilitar características premium después de actualizar un plan
...
### <a name="to-update-plan-changes-in-users-groups"></a><a name="to-update-plan-changes-in-users-groups"></a>Para actualizar los cambios del plan en grupos de usuarios
...
### <a name="to-select-the-premium-experience"></a><a name="to-select-the-premium-experience"></a>Para seleccionar la experiencia Premium
...
## <a name="help-assumes-premium-experience"></a><a name="help-assumes-premium-experience"></a>En la ayuda se asume la experiencia premium
