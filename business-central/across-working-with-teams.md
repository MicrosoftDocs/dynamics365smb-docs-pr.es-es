...
# Compartir registros y vínculos de página de Business Central en Microsoft Teams
...
## Incluir y ver una tarjeta Business Central en una conversación de Teams
...
### Incluir una tarjeta Business Central en una conversación de Teams
...
## <a name="share-link"></a>Compartir un vínculo a una página de Business Central a Teams
...
5. El cuadro de mensaje incluye un vínculo a la página. Si la aplicación [!INCLUDE [prod_short](includes/prod_short.md)] está instalada para Teams, también aparecerá una tarjeta para el registro o la página vinculados en el cuadro de mensaje.
