---
title: Actualizar tipos de cambio de divisa
...
4. Asigne los campos del archivo XML a la tabla de tipos de cambio de moneda en el campo de origen.
5. Aplique las reglas de transformación necesarias.
6. Active el control de alternancia a **Habilitado** para habilitar el servicio.
