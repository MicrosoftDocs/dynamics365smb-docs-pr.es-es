...
ms.author: edupont
---
# <a name="importing-payroll-transactions"></a><a name="importing-payroll-transactions"></a><a name="importing-payroll-transactions"></a><a name="importing-payroll-transactions"></a>Importación de transacciones de nómina
...
## <a name="to-import-a-payroll-file"></a><a name="to-import-a-payroll-file"></a><a name="to-import-a-payroll-file"></a><a name="to-import-a-payroll-file"></a>Para importar un archivo de nómina
