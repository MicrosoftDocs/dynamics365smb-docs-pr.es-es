...
ms.author: edupont
---
# <a name="collect-payments-with-sepa-direct-debit" />Cobrar pagos mediante adeudo directo SEPA
...
## <a name="setting-up-sepa-direct-debit" />Configuración de domiciliaciones de adeudo directo SEPA
...
### <a name="to-set-up-your-bank-account-for-sepa-direct-debit" />Configuración del banco para adeudo directo SEPA
...
### <a name="to-set-up-the-customers-payment-method-for-sepa-direct-debit" />Configuración de la forma de pago del cliente para adeudo directo SEPA
...
#### <a name="to-set-up-the-direct-debit-mandate-that-represents-the-customer-agreement" />Configuración de la orden de domiciliación de adeudo directo que representa el acuerdo del cliente
...
## <a name="creating-sepa-direct-debit-collection-entries-and-export-to-a-bank-file" />Creación de movimientos de domiciliación de adeudo directo SEPA y exportación a un archivo bancario
...
### <a name="to-create-a-direct-debit-collection" />Creación de un cobro por domiciliación
...
### <a name="to-export-a-direct-debit-collection-entry-to-a-bank-file" />Exportación de movimientos de cobro por domiciliación a un archivo de banco
...
### <a name="to-reject-a-direct-debit-collection-entry" />Rechazo de un movimiento de cobro por domiciliación
...
### <a name="to-close-a-direct-debit-collection" />Cierre de un cobro por domiciliación
...
## <a name="posting-sepa-direct-debit-payment-receipts" />Registro de recibos de pagos de domiciliación de adeudo directo SEPA
...
### <a name="to-post-a-direct-debit-payment-receipt-from-the-direct-debit-collections-page" />Registro de un recibo de pago de domiciliación desde la página Cobros por adeudo directo
