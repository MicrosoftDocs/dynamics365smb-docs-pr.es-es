...
ms.author: edupont
---
# <a name="record-and-reimburse-employees-expenses" />Registro y reembolso de los costes de los empleados
...
## <a name="to-record-an-employees-expense" />Registrar el gasto de un empleado
...
## <a name="to-reimburse-an-employee" />Reembolsar al empleado
...
## <a name="to-reconcile-reimbursements-with-employee-ledger-entries" />Conciliar reembolsos con movimientos de empleado
