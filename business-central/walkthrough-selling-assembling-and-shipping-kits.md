...
ms.author: edupont
---
# <a name="walkthrough-selling-assembling-and-shipping-kits"></a><a name="walkthrough-selling-assembling-and-shipping-kits"></a>Tutorial: vender, ensamblar y enviar kits
...
### <a name="setting-up-assembly-items"></a><a name="setting-up-assembly-items"></a>Configurar productos de ensamblado
...
### <a name="selling-customized-assembly-items"></a><a name="selling-customized-assembly-items"></a>Vender elementos del ensamblado personalizados
...
### <a name="planning-for-assembly-items"></a><a name="planning-for-assembly-items"></a>Planificar para los elementos del ensamblado
...
### <a name="assembling-items"></a><a name="assembling-items"></a>Ensamblar productos
...
### <a name="shipping-assembly-items-from-stock-and-assembled-to-order"></a><a name="shipping-assembly-items-from-stock-and-assembled-to-order"></a>Enviar elementos del ensamblado, desde el inventario y ensamblado para pedido
...
## <a name="prepare-sample-data"></a><a name="prepare-sample-data"></a>Preparar datos de ejemplo
...
### <a name="creating-the-assembly-items"></a><a name="creating-the-assembly-items"></a>Crear elementos del ensamblado
...
### <a name="selling-the-assembly-items"></a><a name="selling-the-assembly-items"></a>Vender elementos del ensamblado
...
### <a name="planning-for-the-unavailable-ats-items"></a><a name="planning-for-the-unavailable-ats-items"></a>Planificar para producto ATS no disponibles
...
### <a name="assembling-and-shipping-the-first-ato-quantity"></a><a name="assembling-and-shipping-the-first-ato-quantity"></a>Ensamblar y enviar la primera cantidad ATO
...
### <a name="assembling-and-recording-the-second-ato-quantity"></a><a name="assembling-and-recording-the-second-ato-quantity"></a>Ensamblar y registrar la segunda cantidad ATO
...
### <a name="assembling-the-ats-quantity"></a><a name="assembling-the-ats-quantity"></a>Ensamblar la cantidad ATS
...
### <a name="shipping-the-remaining-items-partly-from-stock-and-partly-assembled-to-the-order"></a><a name="shipping-the-remaining-items-partly-from-stock-and-partly-assembled-to-the-order"></a>Enviar productos restantes, parcialmente de las existencias y parcialmente ensamblado para pedido
