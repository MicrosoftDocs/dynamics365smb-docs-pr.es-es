...
ms.author: edupont
---
# <a name="set-up-multiple-interest-rates-for-delayed-payment"></a><a name="set-up-multiple-interest-rates-for-delayed-payment"></a><a name="set-up-multiple-interest-rates-for-delayed-payment"></a><a name="set-up-multiple-interest-rates-for-delayed-payment"></a>Configurar tasas de interés múltiples para pagos atrasados
...
## <a name="to-set-up-multiple-interest-rates"></a><a name="to-set-up-multiple-interest-rates"></a><a name="to-set-up-multiple-interest-rates"></a><a name="to-set-up-multiple-interest-rates"></a>Configurar varios tipos de interés
