...
ms.author: edupont
---
# <a name="set-up-multiple-interest-rates-for-delayed-payment" />Configurar tasas de interés múltiples para pagos atrasados
...
## <a name="to-set-up-multiple-interest-rates" />Configurar varios tipos de interés
