...
# <a name="the-data-archive-extension"></a><a name="the-data-archive-extension"></a><a name="the-data-archive-extension"></a><a name="the-data-archive-extension"></a>La extensión Archivo de datos
...
## <a name="start-archiving-data"></a><a name="start-archiving-data"></a><a name="start-archiving-data"></a><a name="start-archiving-data"></a>Iniciar el archivo de datos
...
## <a name="storage-considerations"></a><a name="storage-considerations"></a><a name="storage-considerations"></a><a name="storage-considerations"></a>Consideraciones sobre el almacenamiento
