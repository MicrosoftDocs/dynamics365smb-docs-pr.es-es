...
Para deshacer un registro de albarán o de envío, antes de que se registre como facturado, puede usar la función **Deshacer** en el documento registrado. Puede deshacer cantidades de tipo **Producto**.
...
A continuación se describe cómo deshacer un albarán publicado. Los pasos son parecidos para los envíos registrados.
...
Una línea correctiva se inserta bajo la línea de recepción seleccionada. Si la cantidad se ha recibido en una recepción de almacén, entonces se inserta una línea de corrección en la recepción de almacén registrado.  
...
A continuación se describe cómo deshacer un envío de devolución registrado y luego volver a publicar la devolución de la compra con una nueva cantidad.
