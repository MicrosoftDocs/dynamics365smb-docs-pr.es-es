...
ms.author: bholtorf
---
# <a name="reverse-journal-postings-and-undo-receiptsshipments" />Revertir los registros de diario y deshacer los recibos/envíos
...
## <a name="to-undo-a-quantity-on-a-posted-purchase-receipt" />Para deshacer la cantidad en un albarán de compra registrado
