...
ms.author: edupont
---
# <a name="approval-workflow-notifications"></a><a name="approval-workflow-notifications"></a>Notificaciones de flujo de trabajo de aprobación
...
## <a name="set-up-notifications"></a><a name="set-up-notifications"></a>Configuración de notificaciones
