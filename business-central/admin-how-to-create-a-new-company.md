---
title: Crear una nueva empresa con paquetes de configuración
...
ms.locfileid: "8512417"
---
# <a name="create-a-new-company-based-on-configuration-packages"></a>Crear una nueva empresa basada en paquetes de configuración
...
## <a name="to-use-the-sample-configuration-packages"></a>Para utilizar los paquetes de configuración de ejemplo

1. Abra la empresa de demostración CRONUS. Para obtener más información, consulte [Cambiar configuración básica](ui-change-basic-settings.md).  
...
3. Elija el paquete pertinente de la lista y, a continuación, seleccione la acción **Exportar paquete**.  

Utilice el procedimiento siguiente para crear una nueva empresa y utilizar el paquete de configuración como parte del proceso.  
...
2. Elija el icono ![Bombilla que abre la característica Dígame.](media/ui-search/search_small.png "Dígame qué desea hacer") , escriba **Paquete de configuración** y luego elija el vínculo relacionado.  
3. Elija la acción **Importar paquete** y luego especifique el archivo .rapidstart que desea importar.  
