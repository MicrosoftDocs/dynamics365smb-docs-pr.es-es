...
ms.author: edupont
---
# <a name="use-xml-schemas-to-prepare-data-exchange-definitions" />Uso de esquemas XML para preparar definiciones de intercambio de datos
...
## <a name="to-load-an-xml-schema-file" />Para cargar un archivo de esquema XML
...
### <a name="to-select-or-clear-nodes-in-an-xml-schema" />Para seleccionar o borrar nodos en un esquema XML
...
### <a name="to-generate-a-data-exchange-definition-that-is-based-on-an-xml-schema" />Para generar una definición de intercambio de datos basada en un esquema XML
