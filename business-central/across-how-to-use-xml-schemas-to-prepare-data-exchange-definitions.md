...
ms.author: edupont
---
# <a name="use-xml-schemas-to-prepare-data-exchange-definitions"></a><a name="use-xml-schemas-to-prepare-data-exchange-definitions"></a><a name="use-xml-schemas-to-prepare-data-exchange-definitions"></a>Uso de esquemas XML para preparar definiciones de intercambio de datos
...
## <a name="to-load-an-xml-schema-file"></a><a name="to-load-an-xml-schema-file"></a><a name="to-load-an-xml-schema-file"></a>Para cargar un archivo de esquema XML
...
### <a name="to-select-or-clear-nodes-in-an-xml-schema"></a><a name="to-select-or-clear-nodes-in-an-xml-schema"></a><a name="to-select-or-clear-nodes-in-an-xml-schema"></a>Para seleccionar o borrar nodos en un esquema XML
