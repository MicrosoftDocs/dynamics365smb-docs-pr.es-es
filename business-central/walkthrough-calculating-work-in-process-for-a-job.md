...
ms.author: edupont
---
# <a name="walkthrough-calculating-work-in-process-for-a-job" />Tutorial: cálculo del trabajo en curso para un proyecto
...
## <a name="calculating-wip" />Cálculo de WIP
...
### <a name="to-calculate-wip" />Para calcular WIP
...
### <a name="to-review-wip-warnings" />Para revisar las advertencias WIP
...
### <a name="to-recalculate-wip" />Para volver a calcular WIP
...
## <a name="posting-wip-to-general-ledger" />Registro de WIP en contabilidad

 Ahora que Tricia ha calculado el WIP para este proyecto, puede registrarlo en la contabilidad general.  

### <a name="to-post-wip-to-general-ledger" />Para registrar un WIP en contabilidad
...
## <a name="reversing-a-wip-posting" />Reversión de un registro WIP
...
### <a name="to-reverse-a-wip-posting" />Para revertir un registro WIP
