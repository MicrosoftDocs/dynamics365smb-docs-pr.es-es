...
# <a name="troubleshooting-microsoft-teams-integration-with-include-prodshortincludesprodshortmd" />Solución de problemas de integración de Microsoft Teams con [!INCLUDE [prod_short](includes/prod_short.md)]
...
## <a name="the-sign-in-link-doesnt-work" />El vínculo de inicio de sesión no funciona
...
## <a name="the-settings-page-is-empty" />La página Configuración está vacía
...
## <a name="i-changed-company-but-it-didnt-seem-to-work" />Cambié de empresa, pero no pareció funcionar
...
## <a name="something-went-wrong-error-when-searching-for-contacts" />Error "Algo salió mal" al buscar contactos
...
## <a name="cannot-find-the-contactcontact-summary-api-error-when-searching-for-contacts" />Error "No se puede encontrar la API de contacto/resumen de contactos" al buscar contactos
...
## <a name="none-of-my-links-expand-into-a-card" />Ninguno de mis enlaces se expande en una tarjeta
...
## <a name="my-link-sometimes-doesnt-expand-into-a-card" />Mi enlace a veces no se expande en una tarjeta
...
## <a name="the-details-window-opens-but-shows-an-error-before-details-are-shown" />Se abre la ventana de detalles, pero muestra un error antes de que se muestren los detalles
...
## <a name="im-having-problems-with-the-camera-or-location-in-teams" />Tengo problemas con la cámara o la ubicación en Teams
...
## <a name="teams-displays-mixed-languages-for-my-cards-and-card-details" />Teams muestra varios idiomas para mis tarjetas y detalles de tarjetas
...
## <a name="i-edited-a-field-in-the-details-window-but-my-change-wasnt-saved" />Edité un campo en la ventana de detalles, pero mi cambio no se guardó
...
## <a name="a-new-tile-appeared-in-the-app-launcher-how-do-i-remove-it" />Apareció un nuevo mosaico en el Iniciador de aplicaciones. ¿Cómo puedo eliminarlo?
...
## <a name="duplicate-text-in-the-share-to-teams-window" />Texto duplicado en la ventana Compartir con Teams
...
## <a name="unable-to-sign-into-the-share-to-teams-window" />No se puede iniciar sesión en la ventana Compartir con Teams
...
## <a name="my-cards-no-longer-have-a-popout-button" />Mis tarjetas ya no tienen un botón emergente
...
## <a name="cant-pin-a-card-to-tab" />No se puede anclar una tarjeta a la pestaña
...
## <a name="someone-added-a-tab-but-the-tab-doesnt-show-up-for-me" />Alguien agregó una pestaña, pero no me aparece la pestaña
...
## <a name="others-see-different-sorting-or-column-layout-than-what-the-tab-author-sees" />Otros ven una ordenación o disposición de columnas diferente a la que ve el autor de la pestaña
