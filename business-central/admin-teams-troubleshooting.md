...
# Solución de problemas de integración de Microsoft Teams con [!INCLUDE [prod_short](includes/prod_short.md)]
...
## El vínculo de inicio de sesión no funciona
...
## La página Configuración está vacía
...
## Cambié de empresa, pero no pareció funcionar
...
## Error "Algo salió mal" al buscar contactos
...
## Error "No se puede encontrar la API de contacto/resumen de contactos" al buscar contactos
...
## Ninguno de mis enlaces se expande en una tarjeta 
...
## Mi enlace a veces no se expande en una tarjeta 
...
## Se abre la ventana de detalles, pero muestra un error antes de que se muestren los detalles
...
## Tengo problemas con la cámara o la ubicación en Teams
...
## Teams muestra varios idiomas para mis tarjetas y detalles de tarjetas
...
## Edité un campo en la ventana de detalles, pero mi cambio no se guardó
...
## Apareció un nuevo mosaico en el Iniciador de aplicaciones. ¿Cómo puedo eliminarlo?
...
## Texto duplicado en la ventana Compartir con Teams
...
## No se puede iniciar sesión en la ventana Compartir con Teams 
...
## Mis tarjetas ya no tienen un botón emergente
...
## No se puede anclar una tarjeta a la pestaña
...
## Alguien agregó una pestaña, pero no me aparece la pestaña
...
## Otros ven una ordenación o disposición de columnas diferente a la que ve el autor de la pestaña
