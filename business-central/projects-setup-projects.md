...
ms.author: edupont
---
# <a name="setting-up-project-management"></a><a name="setting-up-project-management"></a><a name="setting-up-project-management"></a>Configurar la administración de proyectos
