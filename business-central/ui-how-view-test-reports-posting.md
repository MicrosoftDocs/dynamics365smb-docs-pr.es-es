...
ms.author: solsen
---
# <a name="view-test-reports-before-posting" />Ver informes de prueba antes de realizar el registro
...
## <a name="to-print-a-test-report-before-posting-a-purchase-invoice" />Para imprimir un test antes de registrar una factura de compra
