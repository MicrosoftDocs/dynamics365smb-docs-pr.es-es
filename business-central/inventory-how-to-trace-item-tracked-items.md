...
ms.author: edupont
---
# <a name="trace-item-tracked-items"></a><a name="trace-item-tracked-items"></a><a name="trace-item-tracked-items"></a><a name="trace-item-tracked-items"></a>Realizar seguimiento de productos seguidos
...
## <a name="to-trace-item-tracked-items"></a><a name="to-trace-item-tracked-items"></a><a name="to-trace-item-tracked-items"></a><a name="to-trace-item-tracked-items"></a>Para controlar productos seguidos
...
## <a name="to-find-item-tracked-items-with-find-entries"></a><a name="to-find-item-tracked-items-with-find-entries"></a><a name="to-find-item-tracked-items-with-find-entries"></a><a name="to-find-item-tracked-items-with-find-entries"></a>Para buscar productos marcados para seguimiento con Buscar movimientos
