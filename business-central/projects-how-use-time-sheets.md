...
## <a name="copy-project-planning-lines-to-a-time-sheet"></a>Para copiar líneas de planificación del proyecto en un parte de horas
...
## <a name="view-and-approve-time-sheets-by-project"></a>Para ver y aprobar partes de horas por tarea
...
### <a name="approve-or-reject-a-time-sheet-by-project"></a>Para aprobar o rechazar un parte de horas por trabajo
...
## <a name="post-time-sheet-lines-in-a-project-journal"></a>Para registrar las líneas del parte de horas en un diario de proyectos
