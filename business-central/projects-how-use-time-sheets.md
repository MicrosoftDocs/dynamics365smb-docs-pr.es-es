...
1. Elija el icono ![bombilla que abre la función Dígame](media/ui-search/search_small.png "Dígame que desea hacer"), escriba **Partes de horas** y luego elija el enlace relacionado.
...
5. Elija la acción **Enviar** y, a continuación, elija la acción **Todas las líneas abiertas** para enviar todas las líneas o la acción **Solo líneas seleccionadas** para enviar únicamente las líneas que están seleccionadas en la página **Hoja de horas**.  
...
1. Elija el icono ![bombilla que abre la función Dígame](media/ui-search/search_small.png "Dígame que desea hacer"), escriba **Hoja de horas del administrador** y luego elija el enlace relacionado.
...
1. Elija el icono ![bombilla que abre la función Dígame](media/ui-search/search_small.png "Dígame que desea hacer"), escriba **Hoja de horas del administrador** o **Partes de horas** y luego elija el enlace relacionado.
...
1. Elija el icono ![bombilla que abre la función Dígame](media/ui-search/search_small.png "Dígame que desea hacer"), escriba **Diario de recurso** y luego elija el enlace relacionado.  
...
1. Elija el icono ![bombilla que abre la función Dígame](media/ui-search/search_small.png "Dígame que desea hacer"), escriba **Diario proyecto** y luego elija el enlace relacionado.  
2. Elija la acción **Sugerir líneas de hojas de horas**.  
3. Rellene los campos según sea necesario.  
...
1. Elija el icono ![bombilla que abre la función Dígame](media/ui-search/search_small.png "Dígame que desea hacer"), escriba **Mover partes de horas a archivo** y luego elija el enlace relacionado.  
2. Rellene los campos según sea necesario y, a continuación, haga clic en el botón **Aceptar**.  
3. Para revisar las hojas de horas archivadas, elija el icono ![bombilla que abre la función Dígame](media/ui-search/search_small.png "Dígame que desea hacer"), escriba **Archivos de parte de horas** o **Archivos de parte de horas del administrador** y luego elija el enlace relacionado.
