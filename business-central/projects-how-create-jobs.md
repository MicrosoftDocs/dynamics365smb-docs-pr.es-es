...
ms.author: edupont
---
# <a name="create-jobs"></a><a name="create-jobs"></a>Crear proyectos
...
## <a name="to-create-a-job-card"></a><a name="to-create-a-job-card"></a>Para crear una ficha de proyecto
...
## <a name="to-create-tasks-for-a-job"></a><a name="to-create-tasks-for-a-job"></a>Para crear tareas para un proyecto
...
## <a name="to-create-planning-lines-for-a-job"></a><a name="to-create-planning-lines-for-a-job"></a>Para crear líneas de planificación de un proyecto
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Consultar la [formación de Microsoft](/training/modules/create-new-job/) relacionada
