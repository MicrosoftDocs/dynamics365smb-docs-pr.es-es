...
ms.author: bholtorf
---
# <a name="create-bank-deposits" />Crear depósitos bancarios
> [!NOTE]
...
### <a name="number-series-and-lump-sum-deposits" />Serie numérica y depósitos de suma total
...
### <a name="general-journal-templates-for-bank-deposits" />Libros de diario general para depósitos bancarios
...
## <a name="dimensions-on-bank-deposit-lines" />Dimensiones en líneas de depósito bancario
...
## <a name="create-a-bank-deposit" />Crear un depósito bancario
...
## <a name="finding-posted-bank-deposits" />Encontrar depósitos bancarios registrados
...
## <a name="reversing-a-posted-bank-deposit" />Reversión de un depósito bancario registrado
