...
4. En el campo **N.º cuenta bancaria**, escoja la cuenta bancaria en la que hacer el depósito.
    ...
    > [!TIP]
    > Puede volver a comprobar que está depositando en la cuenta correcta mediante las acciones **Ficha banco** y **Movs. bancos** para buscar los movimientos de la cuenta bancaria seleccionada. Por ejemplo, para comprobar si se hicieron depósitos similares en la cuenta.
...
* Sobre la página **Depósitos bancarios registrados**, elija el depósito y luego elija la acción **Deshacer publicación**.
* En la página **Registro movs. contabilidad**, busque el registro para el depósito y luego elija la acción **Revertir mov.**.
