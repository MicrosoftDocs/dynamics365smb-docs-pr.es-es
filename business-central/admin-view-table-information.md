...
# <a name="viewing-table-information"></a><a name="viewing-table-information"></a><a name="viewing-table-information"></a>Visualización de información de tabla
...
## <a name="viewing-table-information-1"></a><a name="viewing-table-information-1"></a><a name="viewing-table-information-1"></a>Visualización de información de tabla
