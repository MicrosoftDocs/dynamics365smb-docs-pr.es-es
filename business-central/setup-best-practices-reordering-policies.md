...
---
# <a name="setup-best-practices-reordering-policies"></a><a name="setup-best-practices-reordering-policies"></a><a name="setup-best-practices-reordering-policies"></a><a name="setup-best-practices-reordering-policies"></a><a name="setup-best-practices-reordering-policies"></a>Procedimientos recomendados de configuración: políticas de reaprovisionamiento
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Consultar la [formación de Microsoft](/training/paths/replenish-items-dynamics-365-business-central/) relacionada
