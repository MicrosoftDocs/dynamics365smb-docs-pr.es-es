...
## <a name="see-related-microsoft-trainingtrainingpathsreplenish-items-dynamics--business-central" /><a name="see-related-microsoft-training"></a>Consultar la [formación de Microsoft](/training/paths/replenish-items-dynamics-365-business-central/) relacionada
