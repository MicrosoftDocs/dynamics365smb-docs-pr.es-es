...
ms.reviewer: jswymer
---
# <a name="create-users-according-to-licenses"></a><a name="create-users-according-to-licenses"></a><a name="create-users-according-to-licenses"></a><a name="create-users-according-to-licenses"></a>Crear usuarios de acuerdo con las licencias
...
## <a name="manage-users-and-licenses-in-online-tenants"></a><a name="manage-users-and-licenses-in-online-tenants"></a><a name="manage-users-and-licenses-in-online-tenants"></a><a name="manage-users-and-licenses-in-online-tenants"></a>Administrar usuarios y licencias en los suscriptores en línea
...
### <a name="configure-permissions-based-on-licenses"></a><a name="configure-permissions-based-on-licenses"></a><a name="configure-permissions-based-on-licenses"></a><a name="configure-permissions-based-on-licenses"></a><a name="licensespermissions"></a>Configurar permisos basados en licencias
...
### <a name="to-add-users-or-update-user-information-and-license-assignments-in-business-central"></a><a name="to-add-users-or-update-user-information-and-license-assignments-in-business-central"></a><a name="to-add-users-or-update-user-information-and-license-assignments-in-business-central"></a><a name="to-add-users-or-update-user-information-and-license-assignments-in-business-central"></a><a name="adduser"></a>Para agregar usuarios o actualizar información de usuario y asignaciones de licencia en Business Central
...
### <a name="to-remove-a-users-access-to-the-system"></a><a name="to-remove-a-users-access-to-the-system"></a><a name="to-remove-a-users-access-to-the-system"></a><a name="to-remove-a-users-access-to-the-system"></a>Para eliminar el acceso de un usuario al sistema
...
### <a name="synchronization-with-microsoft-365"></a><a name="synchronization-with-microsoft-365"></a><a name="synchronization-with-microsoft-365"></a><a name="synchronization-with-microsoft-365"></a><a name="m365"></a>Sincronización con Microsoft 365
...
## <a name="manage-users-and-licenses-in-on-premises-deployments"></a><a name="manage-users-and-licenses-in-on-premises-deployments"></a><a name="manage-users-and-licenses-in-on-premises-deployments"></a><a name="manage-users-and-licenses-in-on-premises-deployments"></a>Administrar usuarios y licencias en implementaciones locales
...
### <a name="to-edit-or-delete-a-user-in-an-on-premises-deployment"></a><a name="to-edit-or-delete-a-user-in-an-on-premises-deployment"></a><a name="to-edit-or-delete-a-user-in-an-on-premises-deployment"></a><a name="to-edit-or-delete-a-user-in-an-on-premises-deployment"></a>Para editar o eliminar un usuario en una implementación local
