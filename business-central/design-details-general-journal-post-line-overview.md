...
ms.author: edupont
---
# <a name="general-journal-post-line-overview" />Descripción de la línea de registro en diario general
...
## <a name="old-architecture" />Arquitectura antigua
...
### <a name="new-architecture" />Nueva arquitectura
