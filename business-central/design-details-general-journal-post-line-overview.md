...
ms.author: edupont
---
# <a name="general-journal-post-line-overview"></a><a name="general-journal-post-line-overview"></a><a name="general-journal-post-line-overview"></a><a name="general-journal-post-line-overview"></a>Descripción de la línea de registro en diario general
...
## <a name="old-architecture"></a><a name="old-architecture"></a><a name="old-architecture"></a><a name="old-architecture"></a>Arquitectura antigua
...
### <a name="new-architecture"></a><a name="new-architecture"></a><a name="new-architecture"></a><a name="new-architecture"></a>Nueva arquitectura
