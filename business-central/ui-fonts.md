...
ms.author: edupont
---
# <a name="available-fonts"></a><a name="available-fonts"></a>Fuentes Disponibles
...
## <a name="document-fonts"></a><a name="document-fonts"></a>Fuentes de documentos
...
## <a name="fonts-for-checks"></a><a name="fonts-for-checks"></a>Fuentes para cheques
...
## <a name="fonts-for-barcodes"></a><a name="fonts-for-barcodes"></a>Fuentes para códigos de barras
