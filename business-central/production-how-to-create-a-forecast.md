...
También puede definir el nivel correcto de detalles en los campos **Pronóstico por ubicación** y **Pronóstico por variante** en la página **Descripción general de la previsión de la demanda**. Los filtros y otras configuraciones se almacenan en la tabla **Nombre de previsión de demanda**, para que pueda detenerse fácilmente y continuar su trabajo más tarde. 
...
## <a name="forecast-by-locations"></a>Previsión por almacenes
...
### <a name="if-you-dont-use-forecast-by-locations"></a>Si no usa previsiones por almacenes
