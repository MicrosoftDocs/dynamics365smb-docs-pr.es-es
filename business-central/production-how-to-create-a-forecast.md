...
description: "Es posible crear previsiones de ventas y producción desde la ventana **Previsión de la demanda**."
...
Es posible crear previsiones de ventas y producción desde la ventana **Previsión de la demanda**.  
...
Las previsiones se crean manualmente en la ventana **Previsión de la demanda**. En el sistema puede haber muchas previsiones, que se distinguen por el nombre y el tipo. Las previsiones se pueden copiar y editar como sea necesario. Tenga en cuenta que, en un momento dado, sólo se puede usar una previsión para realizar la planificación.  
...
> [!NOTE]  
>  También se puede editar una previsión existente. Haga clic en la ventana **Matriz de previsión de la demanda**, seleccione la acción **Copiar previsión de la demanda** y rellene la ventana **Previsión de la demanda** con una previsión existente. Es posible realizar modificaciones a las cantidades según sea pertinente.  
