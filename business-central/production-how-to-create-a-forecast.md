...
ms.author: edupont
---
# <a name="create-a-demand-forecast" />Crear una previsión de la demanda
...
## <a name="sales-forecasts-and-production-forecasts" />Previsiones de ventas y previsiones de producción
...
## <a name="component-forecast" />Previsión de componentes
...
## <a name="forecasting-periods" />Periodos de previsión
...
## <a name="forecast-by-locations" />Previsión por ubicación
...
### <a name="use-forecast-by-locations" />User previsiones por almacenes
...
### <a name="do-not-use-forecast-by-locations" />No use previsiones por almacenes
...
## <a name="to-create-a-demand-forecast" />Para crear una previsión de la demanda
