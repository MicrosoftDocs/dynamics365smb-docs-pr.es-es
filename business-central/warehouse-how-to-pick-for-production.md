...
---
# <a name="pick-for-production-assembly-or-jobs-in-basic-warehouse-configurations" />Realizar picking para producción, ensamblado o proyectos en una configuración básica de almacén
...
## <a name="inventory-picks" />Picking de inventario
...
## <a name="inventory-movements" />Movimientos de inventario
...
### <a name="project-management" />Administración de proyectos
...
## <a name="pick-or-move-for-production-assembly-and-jobs-in-a-basic-warehouse-configuration" />Realizar picking o mover a producción, ensamblado y proyectos en una configuración básica de almacén
...
### <a name="to-create-an-inventory-movement-from-the-source-document" />Para crear un movimiento de inventario desde el documento de origen
...
### <a name="to-create-multiple-inventory-picks-or-movements-with-a-batch-job" />Para crear varios picking o movimientos de inventario con un trabajo por lotes
...
### <a name="to-create-inventory-picks-or-movements-in-two-steps" />Para crear pickings o movimientos de inventario en dos pasos
...
## <a name="to-record-the-inventory-pick" />Para registrar el picking de inventario
...
## <a name="flushing-production-components-in-a-basic-warehouse-configuration" />La bajada de los componentes para producción en una configuración básica de almacén
