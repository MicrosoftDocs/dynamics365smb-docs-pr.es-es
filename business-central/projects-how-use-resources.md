...
ms.author: edupont
---
# <a name="use-resources-for-jobs" />Uso de recursos para proyectos
...
## <a name="to-assign-resources-to-jobs" />Para asignar recursos a proyectos
...
## <a name="to-record-resource-usage-for-a-job" />Para registrar el uso de recursos de un proyecto
...
## <a name="to-adjust-resource-prices" />Para ajustar los precios de los recursos
...
## <a name="to-get-resource-price-change-suggestions-based-on-existing-alternate-prices" />Para obtener propuestas de modificación de precios de venta de recursos basadas en precios de venta alternativos existentes
...
## <a name="to-get-resource-price-change-suggestions-based-on-standard-prices" />Para obtener propuestas de cambio de precio de venta de recursos basadas en precios de venta estándar
...
## <a name="to-get-resource-price-change-suggestions-based-on-alternate-prices" />Para obtener propuestas para la modificación de precios de venta de recursos basadas en los precios de venta estándar
