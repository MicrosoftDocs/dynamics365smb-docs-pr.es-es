...
## Para crear una ubicación desde la ficha de almacén
...
## Para crear las ubicaciones individualmente en la hoja de trabajo de creación de ubicación
...
## Para crear ubicaciones automáticamente en la hoja de trabajo de creación de ubicación

Antes de empezar a crear ubicaciones automáticamente, debe determinar el tipo de ubicaciones básicas para sus operaciones y el flujo más práctico de los productos a través de la estructura física del almacén.  
...
9. Cuando haya eliminado todas las ubicaciones innecesarias, elija la acción **Crear ubicaciones** y la aplicación crea ubicaciones para cada línea de la hoja de trabajo.  

Repita el proceso para otro grupo de ubicaciones hasta que cree todas las ubicaciones del almacén.  
