...
ms.locfileid: "8137099"
---
# <a name="built-in-analytics"></a>Análisis integrados

[!INCLUDE[prod_short](includes/prod_short.md)] viene con una serie de características que le permiten analizar datos de forma agregada. Tal vez desee realizar un seguimiento de los KPI financieros o analizar los estados financieros en Excel.
...
|Analice los datos financieros en tiempo real con esquemas de cuentas y vista de análisis.| [Análisis financiero](bi.md) |
