...
ms.author: bholtorf
---
# <a name="create-service-invoices-or-credit-memos"></a><a name="create-service-invoices-or-credit-memos"></a><a name="create-service-invoices-or-credit-memos"></a>Crear facturas o abonos de servicios
...
## <a name="to-create-a-service-credit-memo"></a><a name="to-create-a-service-credit-memo"></a><a name="to-create-a-service-credit-memo"></a>Para crear un abono de servicio
