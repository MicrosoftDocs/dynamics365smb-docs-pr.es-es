...
---
# <a name="design-details-transfers-in-planning" />Detalles de diseño: Transferencias en planificación
...
## <a name="why-is-a-transfer-a-special-case" />¿Por qué la transferencia es un caso especial?
...
## <a name="transfers-are-dependent-demand" />Las transferencias dependen de la demanda
...
## <a name="planning-sequence" />Secuencia de planificación
...
## <a name="transfer-level-code" />Código de nivel de transferencia
...
## <a name="planning-transfers-without-sku" />Transferencias de planificación sin SKU
...
## <a name="changing-quantity-with-reservations" />Cambio de cantidad con reservas
...
## <a name="changing-quantity-in-a-transfer-chain" />Cambio de cantidad en un cadena de transferencia
...
## <a name="lead-time-calculation" />Cálculo del plazo
...
## <a name="safety-lead-time" />Plazo de seguridad
...
## <a name="serial-and-lot-numbers-in-transfer-chains" />Números de serie y de lote en cadenas de transferencias
