...
ms.author: edupont
---
# <a name="set-up-general-inventory-information" />Configurar información de inventario general

Especifique la configuración del inventario en la página **Configuración de inventario**.

## <a name="to-set-up-general-inventory-information" />Para configurar la información de inventario general
