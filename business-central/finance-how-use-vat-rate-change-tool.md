...
# Administración de cambios del tipo de IVA
...
## La herramienta de cambio del tipo de IVA
...
## Conocer el proceso y limitaciones de la conversión del tipo de IVA
...
### Para preparar conversiones de cambio de tasa de IVA
...
### Para configurar la herramienta de cambio de tasa de IVA
...
### Para configurar una conversión grupos de registro de producto
...
### Para realizar la conversión de cambio de tasa de IVA
...
## Consultar la [formación de Microsoft](/training/modules/rate-change-dynamics-365-business-central/) relacionada
