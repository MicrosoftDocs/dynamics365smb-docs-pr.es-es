...
# <a name="managing-vat-rate-changes" />Administración de cambios del tipo de IVA
...
## <a name="changing-vat-rates" />Cambio de los tipos de IVA
...
## <a name="the-vat-rate-change-tool" />La herramienta de cambio del tipo de IVA
...
## <a name="understanding-the-vat-rate-conversion-process-and-limitations" />Conocer el proceso y limitaciones de la conversión del tipo de IVA
...
### <a name="to-prepare-vat-rate-change-conversions" />Para preparar conversiones de cambio de tasa de IVA
...
### <a name="to-set-up-the-vat-rate-change-tool" />Para configurar la herramienta de cambio de tasa de IVA
...
### <a name="to-set-up-product-posting-group-conversion" />Para configurar una conversión grupos de registro de producto
...
### <a name="to-perform-vat-rate-change-conversion" />Para realizar la conversión de cambio de tasa de IVA
...
## <a name="see-related-microsoft-trainingtrainingmodulesrate-change-dynamics--business-central" />Consultar la [formación de Microsoft](/training/modules/rate-change-dynamics-365-business-central/) relacionada
