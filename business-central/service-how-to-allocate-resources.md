...
# <a name="allocate-resources" />Asignar recursos
...
## <a name="to-see-an-overview-of-service-orders-and-service-quotes" />Para ver un resumen de las ofertas o los pedidos de servicio
...
## <a name="to-allocate-a-resource-using-resource-or-resource-group-availability" />Para asignar un recurso mediante disponibilidad de grupo de recursos o grupos de recursos
...
## <a name="to-allocate-a-resource-using-a-service-order" />Para asignar un recurso mediante un pedido de servicio
...
## <a name="to-reallocate-resources-on-a-service-order" />Para reasignar recursos en un pedido de servicio
...
## <a name="to-reallocate-a-resource-using-the-dispatch-board" />Para reasignar un recurso con el panel despacho
...
## <a name="to-register-resource-hours" />Para registrar horas de recursos
...
## <a name="to-assign-a-resource-to-all-service-items-in-an-order" />Para asignar recursos a todos los productos de servicio de un pedido
...
## <a name="to-cancel-an-allocation" />Para cancelar una asignación
