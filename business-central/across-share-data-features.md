...
ms.author: jswymer
---
# <a name="sharing-business-data-from-business-central" />Compartir datos comerciales desde Business Central
...
## <a name="copying-a-link" />Copiar un vínculo
...
### <a name="modify-the-page-link" />Modificar el vínculo de la página
...
### <a name="about-filtered-lists" />Acerca de las listas filtradas
...
## <a name="sharing-to-teams" />Compartir con Teams
...
## <a name="sharing-through-onedrive" />Compartir a través de OneDrive
...
## <a name="opening-in-excel" />Abrir en Excel
...
## <a name="sharing-rows-or-tables" />Compartir filas o tablas
