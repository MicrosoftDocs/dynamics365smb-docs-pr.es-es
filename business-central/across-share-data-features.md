...
Puede compartir uno o varios registros en una lista. Simplemente pulsa el método abreviado de teclado Ctrl+C para copiar al portapapeles. A continuación, pegue lo que copió en otra aplicación pulsando Ctrl+V. Por ejemplo, al copiar tres pedidos de venta y pegarlos en un correo electrónico se mostrarán los pedidos en una tabla con un formato agradable.
