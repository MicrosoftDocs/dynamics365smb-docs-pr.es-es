...
ms.author: edupont
---
# <a name="export-a-positive-pay-file" />Exportar un archivo de Positive Pay
...
## <a name="to-set-up-a-bank-account-for-positive-pay" />Para configurar una cuenta bancaria para Positive Pay
...
## <a name="to-export-a-positive-pay-file" />Para exportar un archivo de Positive Pay
1. Elija el icono ![Bombilla que abre la función Dígame.](media/ui-search/search_small.png "Dígame qué desea hacer") , escriba **Cuentas bancarias** y luego elija el enlace relacionado.
