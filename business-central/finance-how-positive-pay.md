...
ms.author: edupont
---
# <a name="export-a-positive-pay-file"></a><a name="export-a-positive-pay-file"></a><a name="export-a-positive-pay-file"></a>Exportar un archivo de Positive Pay
...
## <a name="to-set-up-a-bank-account-for-positive-pay"></a><a name="to-set-up-a-bank-account-for-positive-pay"></a><a name="to-set-up-a-bank-account-for-positive-pay"></a>Para configurar una cuenta bancaria para Positive Pay
...
## <a name="to-export-a-positive-pay-file"></a><a name="to-export-a-positive-pay-file"></a><a name="to-export-a-positive-pay-file"></a>Para exportar un archivo de Positive Pay
1. Elija el icono ![Bombilla que abre la función Dígame.](media/ui-search/search_small.png "Dígame qué desea hacer") , escriba **Cuentas bancarias** y luego elija el enlace relacionado.
