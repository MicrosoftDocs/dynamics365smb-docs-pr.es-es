...
ms.author: edupont
---
# <a name="create-special-orders"></a><a name="create-special-orders"></a>Crear pedidos especiales
...
## <a name="to-create-a-special-order"></a><a name="to-create-a-special-order"></a>Para crear un pedido especial
