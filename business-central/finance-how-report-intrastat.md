...
ms.author: altotovi
---
# <a name="work-with-intrastat-reporting"></a><a name="work-with-intrastat-reporting"></a>Trabajar con informes de Intrastat
...
## <a name="fill-in-the-intrastat-report"></a><a name="fill-in-the-intrastat-report"></a>Rellenar el informe de Intrastat
...
## <a name="modify-the-intrastat-report"></a><a name="modify-the-intrastat-report"></a>Modificar el informe de Intrastat
...
## <a name="validate-intrastat-lines"></a><a name="validate-intrastat-lines"></a>Validar las líneas de Intrastat
...
## <a name="recalculating-weight-or-supplementary-unit-of-measure"></a><a name="recalculating-weight-or-supplementary-unit-of-measure"></a>Recalcular peso o unidad de medida suplementaria
...
## <a name="intrastat-rules"></a><a name="intrastat-rules"></a>Reglas Intrastat
...
### <a name="fixed-assets-reporting"></a><a name="fixed-assets-reporting"></a>Informes de activos fijos
...
### <a name="intrastat-report-statuses"></a><a name="intrastat-report-statuses"></a>Estados de informes Intrastat
