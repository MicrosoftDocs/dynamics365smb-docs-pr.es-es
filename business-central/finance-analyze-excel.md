...
ms.author: edupont
---
# <a name="analyzing-financial-statements-in-microsoft-excel"></a><a name="analyzing-financial-statements-in-microsoft-excel"></a>Análisis de estados financieros en Microsoft Excel
...
## <a name="getting-the-overview-and-the-details-in-excel"></a><a name="getting-the-overview-and-the-details-in-excel"></a>Obtención de panorama y detalles en Excel
...
### <a name="understanding-the-excel-templates"></a><a name="understanding-the-excel-templates"></a>Conocer las plantillas de Excel
...
## <a name="the--excel-add-in"></a><a name="the--excel-add-in"></a>Complemento [!INCLUDE [prod_short](includes/prod_short.md)] de Excel
