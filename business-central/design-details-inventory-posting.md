...
ms.author: edupont
---
# <a name="design-details-inventory-posting"></a><a name="design-details-inventory-posting"></a><a name="design-details-inventory-posting"></a><a name="design-details-inventory-posting"></a>Detalles de diseño: Registro de inventario
...
### <a name="item-ledger-entries-1"></a><a name="item-ledger-entries-1"></a><a name="item-ledger-entries-1"></a><a name="item-ledger-entries-1"></a>Movimientos contables de producto (1)
...
### <a name="item-application-entries-1"></a><a name="item-application-entries-1"></a><a name="item-application-entries-1"></a><a name="item-application-entries-1"></a>Movimientos de liquidación de producto (1)
...
### <a name="item-ledger-entries-2"></a><a name="item-ledger-entries-2"></a><a name="item-ledger-entries-2"></a><a name="item-ledger-entries-2"></a>Movimientos contables de producto (2)
...
### <a name="item-application-entries-2"></a><a name="item-application-entries-2"></a><a name="item-application-entries-2"></a><a name="item-application-entries-2"></a>Movimientos de liquidación de producto (2)
...
### <a name="value-entries-3"></a><a name="value-entries-3"></a><a name="value-entries-3"></a><a name="value-entries-3"></a>Movimientos de valor (3)
...
### <a name="general-ledger-entries-3"></a><a name="general-ledger-entries-3"></a><a name="general-ledger-entries-3"></a><a name="general-ledger-entries-3"></a>Movimientos de contabilidad (3)
...
### <a name="relation-entries-in-the-gl--item-ledger-relation-table-3"></a><a name="relation-entries-in-the-gl--item-ledger-relation-table-3"></a><a name="relation-entries-in-the-gl--item-ledger-relation-table-3"></a><a name="relation-entries-in-the-gl--item-ledger-relation-table-3"></a>Movimientos de relación en C/G: tabla Relación movs. productos (3)
...
## <a name="assembly-and-production-posting"></a><a name="assembly-and-production-posting"></a><a name="assembly-and-production-posting"></a><a name="assembly-and-production-posting"></a>Registro del ensamblado y de producción
