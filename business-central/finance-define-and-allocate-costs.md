...
ms.author: edupont
---
# <a name="defining-and-allocating-costs" />Definición y asignación de costes
...
### <a name="to-set-up-cost-allocations" />Para configurar asignaciones de coste
...
### <a name="to-define-the-allocation-source-prod-cost-center-on-the-general-fasttab" />Para definir el centro de coste PROD de origen de asignación en la ficha desplegable General
...
### <a name="to-define-the-allocation-target-cost-objects-on-the-lines-fasttab" />Para definir los objetos de coste de destino de asignación en la Ficha desplegable Líneas
