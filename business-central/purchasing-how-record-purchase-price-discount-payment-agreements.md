...
ms.author: bholtorf
---
# <a name="record-special-purchase-prices-and-discounts" />Registrar precios y descuentos de compra especiales
...
## <a name="to-set-up-a-special-purchase-price-for-a-vendor" />Para configurar un precio de compra especial para un proveedor
...
## <a name="to-set-up-a-line-discount-for-a-vendor" />Para configurar un descuento de línea para un proveedor
...
## <a name="to-set-up-an-invoice-discount-for-a-vendor" />Para configurar términos de descuento en factura para un proveedor:
...
## <a name="to-choose-a-principle-for-posting-purchase-discounts" />Para seleccionar un principio de registro para descuentos de compra
...
## <a name="purchase-invoice-discounts-and-service-charges" />Descuentos y cargos por servicios de la factura de compra
...
## <a name="see-related-microsoft-trainingtrainingmodulesset-up-prices-discounts-dynamics--business-centralindex" />Consultar la [formación de Microsoft](/training/modules/set-up-prices-discounts-dynamics-365-business-central/index) relacionada
