...
ms.author: bholtorf
---
# <a name="lend-and-receive-loaners" />Prestar y recibir productos prestados
Puede prestar productos a los clientes para reemplazar temporalmente productos de servicio recibidos para servicio.  
  
## <a name="to-lend-a-loaner-item" />Para prestar un producto de préstamo
...
## <a name="to-receive-a-loaner" />Para recibir un producto prestado
...
## <a name="to-register-loaner-comments" />Para registrar comentarios de productos prestados
