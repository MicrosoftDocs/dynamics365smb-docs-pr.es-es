...
ms.author: edupont
---
# <a name="work-with-"></a><a name="work-with-"></a>Trabajar con [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="tips-and-tricks"></a><a name="tips-and-tricks"></a><a name="cheatsheet"></a>Sugerencias y trucos
...
## <a name="links-to-learn-more"></a><a name="links-to-learn-more"></a>Vínculos para obtener más información
...
## <a name="getting-around-in-business-central"></a><a name="getting-around-in-business-central"></a>Desplazarse por Business Central
...
## <a name="choosing-a-desktop-browser"></a><a name="choosing-a-desktop-browser"></a>Elegir un navegador de escritorio
...
## <a name="action-bars"></a><a name="action-bars"></a>Barras de acción
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Consultar la [formación de Microsoft](/training/paths/work-pro-data-dynamics-365-business-central/) relacionada
