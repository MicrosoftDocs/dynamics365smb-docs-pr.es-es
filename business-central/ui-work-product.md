...
| Para | Vea |
| --- | --- |
| Encuentre una página, informe, acción, tema de ayuda o extensión de socio específica. |[Usar la opción Dígame para encontrar características e información](ui-search.md) |
...
|Obtenga información sobre cómo copiar y pegar datos rápidamente incluido mediante el uso de métodos abreviados de teclado.|[Copiar y pegar](ui-copy-paste.md)|
...
|Obtenga información sobre cómo interactuar con Excel desde prácticamente cualquier lugar en [!INCLUDE[d365fin](includes/d365fin_md.md)]|[Ver y editar en Excel](across-work-with-excel.md)|
...
| Cambie qué elementos de la interfaz de usuario y dónde se muestran para que se ajusten a sus preferencias.|[Personalización de su área de trabajo](ui-personalization-user.md) |
|Definir, previsualizar, imprimir o guardar los informes y definir y ejecutar los procesos.|[Trabajar con informes y trabajos por lotes](ui-work-report.md)|
