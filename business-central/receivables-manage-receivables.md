...
description: Este artículo resume las tareas para administrar los cobros y liquidar los pagos en los movimientos de cliente o proveedor.
author: brentholtorf
ms.author: bholtorf
...
| Para | Vea |
| --- | --- |
| Aplique pagos para abrir asientos contables de clientes o proveedores basados en un archivo o fuente de extracto bancario importado. Concilie la cuenta bancaria después de aplicar todos los pagos. |[Liquidación de pagos automáticamente y conciliación de bancos](receivables-apply-payments-auto-reconcile-bank-accounts.md) |
