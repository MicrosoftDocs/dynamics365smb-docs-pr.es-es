...
## <a name="to-change-the-annual-amount-of-the-service-contract-or-contract-quote"></a><a name="to-change-the-annual-amount-of-the-service-contract-or-contract-quote"></a><a name="to-change-the-annual-amount-of-the-service-contract-or-contract-quote"></a>Para cambiar el importe anual del contrato de servicio o la oferta de contrato
...
## <a name="distributing-differences-between-new-and-calculated-annual-amounts"></a><a name="distributing-differences-between-new-and-calculated-annual-amounts"></a><a name="distributing-differences-between-new-and-calculated-annual-amounts"></a>Diferencias de distribución entre cantidades anuales nuevas y calculadas
...
### <a name="even-distribution"></a><a name="even-distribution"></a><a name="even-distribution"></a>Distribución uniforme
...
### <a name="distribution-based-on-line-amount"></a><a name="distribution-based-on-line-amount"></a><a name="distribution-based-on-line-amount"></a>Distribución basada en Importe de línea
...
### <a name="distribution-based-on-profit"></a><a name="distribution-based-on-profit"></a><a name="distribution-based-on-profit"></a>Distribución basada en beneficio bruto
...
#### <a name="example-2"></a><a name="example-2"></a><a name="example-2"></a>Ejemplo
La casilla de verificación **Permite importes sin saldar** no está activada en el contrato de servicio que contiene tres líneas de contrato con esta información.  
