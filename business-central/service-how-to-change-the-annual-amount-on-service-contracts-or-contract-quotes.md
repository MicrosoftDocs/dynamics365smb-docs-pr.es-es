...
ms.author: bholtorf
---
# <a name="change-the-annual-amount-on-service-contracts-or-contract-quotes" />Cambiar el importe anual de los contratos de servicio o las ofertas de contrato
...
## <a name="to-change-the-annual-amount-of-the-service-contract-or-contract-quote" />Para cambiar el importe anual del contrato de servicio o la oferta de contrato
...
## <a name="distributing-differences-between-new-and-calculated-annual-amounts" />Diferencias de distribución entre cantidades anuales nuevas y calculadas
...
### <a name="even-distribution" />Distribución uniforme
...
### <a name="distribution-based-on-line-amount" />Distribución basada en Importe de línea
...
### <a name="distribution-based-on-profit" />Distribución basada en beneficio bruto
