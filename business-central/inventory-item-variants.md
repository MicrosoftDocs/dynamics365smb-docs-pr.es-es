...
ms.author: edupont
---
# <a name="manage-product-variants" />Administrar variantes de productos
...
## <a name="add-variants-to-an-item" />Agregar variantes a un producto

Si su organización ha decidido utilizar variantes, es bastante fácil definir variantes para un producto.  

### <a name="to-add-variants" />Para agregar variantes
...
## <a name="item-availability-by-variant" />Disponibilidad de productos por variante

[!INCLUDE [inventory_variant-availability](includes/inventory_variant-availability.md)]

## <a name="require-use-of-variants" />Requerir el uso de variantes
...
## <a name="categories-attributes-and-variants" />Categorías, atributos y desviaciones
