...
ms.author: edupont
---
# <a name="create-recurring-sales" />Crear ventas periódicas
...
## <a name="set-up-recurring-sales-lines" />Configurar las líneas de ventas periódicas
...
## <a name="assign-recurring-sales-lines-to-a-customer" />Asignar líneas de ventas periódicas a un cliente
...
## <a name="insert-recurring-sales-lines-on-a-sales-invoice" />Insertar líneas de ventas periódicas en una factura de ventas
...
## <a name="create-multiple-sales-invoices-based-on-recurring-sales-lines" />Crear varias facturas de venta basadas en líneas de ventas periódicas
