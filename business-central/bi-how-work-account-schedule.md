...
---
# <a name="prepare-financial-reporting-with-financial-data-and-account-categories" />Preparar Financial Reporting con categorías de cuentas y datos financieros
...
## <a name="financial-reports" />Informes financieros
...
## <a name="gl-account-categories" />Categorías de cuenta de G/L
...
## <a name="create-a-new-financial-report" />Crear un nuevo informe financiero
...
### <a name="edit-a-column-definition" />Editar una definición de columna
...
### <a name="create-a-column-that-calculates-percentages" />Crear una columna que calcule porcentajes
...
## <a name="set-up-financial-reports-with-overviews" />Configurar informes financieros con resúmenes
...
## <a name="comparing-accounting-periods-using-period-formulas" />Comparación de períodos contables usando fórmulas de períodos
...
## <a name="print-and-save-financial-reports" />Imprimir y guardar informes financieros
...
### <a name="schedule-a-financial-report-or-save-as-a-pdf-word-or-excel-document" />Programe un informe financiero o guárdelo como un documento PDF, Word o Excel
...
## <a name="importing-or-exporting-financial-reports" />Importación o exportación de informes financieros
...
### <a name="import-and-export-financial-reports" />Importar y exportar informes financieros
...
## <a name="see-related-microsoft-training" />Consulte la [formación de Microsoft](/training/modules/configure-financial-reports-dynamics-365-business-central/index) relacionada.
