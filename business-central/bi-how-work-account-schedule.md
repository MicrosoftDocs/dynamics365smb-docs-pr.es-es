...
---
# <a name="prepare-financial-reporting-with-financial-data-and-account-categories"></a><a name="prepare-financial-reporting-with-financial-data-and-account-categories"></a>Preparar Financial Reporting con categorías de cuentas y datos financieros
...
## <a name="financial-reports"></a><a name="financial-reports"></a>Informes financieros
...
## <a name="gl-account-categories"></a><a name="gl-account-categories"></a>Categorías de cuenta de G/L
...
## <a name="create-a-new-financial-report"></a><a name="create-a-new-financial-report"></a>Crear un nuevo informe financiero
...
### <a name="edit-a-column-definition"></a><a name="edit-a-column-definition"></a>Editar una definición de columna
...
### <a name="create-a-column-that-calculates-percentages"></a><a name="create-a-column-that-calculates-percentages"></a>Crear una columna que calcule porcentajes
...
## <a name="set-up-financial-reports-with-overviews"></a><a name="set-up-financial-reports-with-overviews"></a>Configurar informes financieros con resúmenes
...
## <a name="comparing-accounting-periods-using-period-formulas"></a><a name="comparing-accounting-periods-using-period-formulas"></a>Comparación de períodos contables usando fórmulas de períodos
...
## <a name="print-and-save-financial-reports"></a><a name="print-and-save-financial-reports"></a>Imprimir y guardar informes financieros
...
### <a name="schedule-a-financial-report-or-save-as-a-pdf-word-or-excel-document"></a><a name="schedule-a-financial-report-or-save-as-a-pdf-word-or-excel-document"></a>Programe un informe financiero o guárdelo como un documento PDF, Word o Excel
...
## <a name="importing-or-exporting-financial-reports"></a><a name="importing-or-exporting-financial-reports"></a>Importación o exportación de informes financieros
...
### <a name="import-and-export-financial-reports"></a><a name="import-and-export-financial-reports"></a>Importar y exportar informes financieros
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Consulte la [formación de Microsoft](/training/modules/configure-financial-reports-dynamics-365-business-central/index) relacionada.
