...
ms.author: jswymer
---
# <a name="change-basic-settings"></a><a name="change-basic-settings"></a>Cambiar la configuración básica
...
## <a name="role"></a><a name="role"></a><a name="role-center"></a>Función
...
### <a name="change-the-role"></a><a name="change-the-role"></a>Cambiar el rol
...
## <a name="company"></a><a name="company"></a><a name="company"></a>Compañía
...
### <a name="work-date-indication"></a><a name="work-date-indication"></a>Indicación de la fecha de trabajo
...
## <a name="region"></a><a name="region"></a><a name="region"></a> Región
...
## <a name="language"></a><a name="language"></a><a name="language"></a> Idioma
...
## <a name="time-zone"></a><a name="time-zone"></a>Zona horaria
...
## <a name="teaching-tips"></a><a name="teaching-tips"></a>Consejos didácticos
