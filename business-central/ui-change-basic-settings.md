...
Utilice la página **Mi configuración** para administrar la configuración básica para su [!INCLUDE[prod_short](includes/prod_short.md)]. Los cambios que realice solo afectarán a su espacio de trabajo, no a los de otros usuarios.  
...
* Si descarta el recordatorio, la fecha de trabajo aparece en el título de la página.  
...
El idioma inicial lo determina el administrador o la configuración de su navegador cuando inicia sesión en [!INCLUDE[prod_short](includes/prod_short.md)]. El idioma que establezca se usa en todos los dispositivos desde los que inicie sesión, como un teléfono o una tableta.

Pueden instalar más idiomas para [!INCLUDE[prod_short](includes/prod_short.md)] desde AppSource. Si bien todos los idiomas de visualización compatibles se muestran en la lista, el administrador debe instalar la aplicación de idioma pertinente para el suscriptor antes de que los usuarios puedan cambiar al nuevo idioma en [!INCLUDE[prod_short](includes/prod_short.md)].  
...
Elija el vínculo **Cambiar cuándo recibo notificaciones** para gestionar las notificaciones que recibe sobre determinados eventos o cambios de estado. Por ejemplo, obtener una notificación cuando va a facturar a un cliente que tiene una deuda vencida o cuando el inventario disponible es inferior a la cantidad que va a vender, por ejemplo. Obtenga más información en [Administrar notificaciones](ui-smart-notifications.md).
