...
ms.author: edupont
---
# <a name="create-production-order-headers"></a><a name="create-production-order-headers"></a><a name="create-production-order-headers"></a><a name="create-production-order-headers"></a>Crear cabeceras de orden de producción
...
## <a name="to-create-a-production-order-header"></a><a name="to-create-a-production-order-header"></a><a name="to-create-a-production-order-header"></a><a name="to-create-a-production-order-header"></a>Para crear la cabecera de una orden de producción
