...
ms.author: edupont
---
# <a name="create-production-order-headers" />Crear cabeceras de orden de producción
...
## <a name="to-create-a-production-order-header" />Para crear la cabecera de una orden de producción
