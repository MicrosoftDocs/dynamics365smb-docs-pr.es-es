...
## <a name="to-add-bank-statement-lines-by-importing-a-bank-statement"></a>Para agregar líneas de extractos de bancos importando un extracto bancario
...
## <a name="to-validate-your-bank-reconciliation"></a>Para validar su conciliación bancaria
