...
ms.author: jswymer
---
# <a name="add-contacts-to-segments" />Añadir contactos a segmentos
...
## <a name="to-add-a-contact-to-a-segment" />Procedimiento para agregar un contacto a un segmento
...
## <a name="to-refine-the-number-of-contacts" />Para redefinir el número de contactos
...
## <a name="to-reduce-the-number-of-contacts" />Para reducir el número de contactos
