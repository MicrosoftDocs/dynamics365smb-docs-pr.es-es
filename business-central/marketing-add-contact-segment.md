...
ms.author: jswymer
---
# <a name="add-contacts-to-segments"></a><a name="add-contacts-to-segments"></a><a name="add-contacts-to-segments"></a>Añadir contactos a segmentos
...
## <a name="to-add-a-contact-to-a-segment"></a><a name="to-add-a-contact-to-a-segment"></a><a name="to-add-a-contact-to-a-segment"></a>Procedimiento para agregar un contacto a un segmento
...
## <a name="to-refine-the-number-of-contacts"></a><a name="to-refine-the-number-of-contacts"></a><a name="to-refine-the-number-of-contacts"></a>Para redefinir el número de contactos
...
## <a name="to-reduce-the-number-of-contacts"></a><a name="to-reduce-the-number-of-contacts"></a><a name="to-reduce-the-number-of-contacts"></a>Para reducir el número de contactos
