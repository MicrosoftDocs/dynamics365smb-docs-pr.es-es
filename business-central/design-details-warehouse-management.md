...
# <a name="warehouse-management-overview" />Información general de la gestión de almacenes
...
## <a name="modeling-the-physical-warehouse" />Modelado del almacén físico
...
### <a name="locations-and-bins" />Ubicaciones y contenedores
...
### <a name="shelves-and-bins" />Estantes y contenedores
...
## <a name="typical-warehouse-workflow" />Flujo de trabajo de almacén típico
...
## <a name="terminology-related-to-warehouse-management" />Terminología relacionada con la gestión de almacenes

### <a name="complexity-levels" />Niveles de complejidad
...
### <a name="warehouse-flows" />Flujos de almacén
...
### <a name="basic-documents" />Documentos básicos
...
### <a name="advanced-documents" />Documentos avanzados
...
### <a name="pages-and-settings" />Páginas y configuraciones

Esta sección describe los conceptos detrás de las páginas clave y la configuración para el almacenamiento.

#### <a name="bins-and-bin-content" />Ubicaciones y contenido de ubicación
...
#### <a name="bin-type" />Tipo ubicación
...
#### <a name="bin-ranking" />Ranking ubicación
...
#### <a name="bin-setup" />Configuración de ubicación
...
#### <a name="warehouse-class" />Clase almacén
...
#### <a name="first-expired-first-out" />Primero en caducar primero en salir
...
#### <a name="put-away-template" />Plantilla ubicar
