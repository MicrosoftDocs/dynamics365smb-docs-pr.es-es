...
# <a name="warehouse-management-overview"></a><a name="warehouse-management-overview"></a><a name="warehouse-management-overview"></a><a name="warehouse-management-overview"></a>Información general de la gestión de almacenes
...
## <a name="modeling-the-physical-warehouse"></a><a name="modeling-the-physical-warehouse"></a><a name="modeling-the-physical-warehouse"></a><a name="modeling-the-physical-warehouse"></a>Modelado del almacén físico
...
### <a name="locations-and-bins"></a><a name="locations-and-bins"></a><a name="locations-and-bins"></a><a name="locations-and-bins"></a>Ubicaciones y contenedores
...
### <a name="shelves-and-bins"></a><a name="shelves-and-bins"></a><a name="shelves-and-bins"></a><a name="shelves-and-bins"></a>Estantes y contenedores
...
## <a name="typical-warehouse-workflow"></a><a name="typical-warehouse-workflow"></a><a name="typical-warehouse-workflow"></a><a name="typical-warehouse-workflow"></a>Flujo de trabajo de almacén típico
...
## <a name="terminology-related-to-warehouse-management"></a><a name="terminology-related-to-warehouse-management"></a><a name="terminology-related-to-warehouse-management"></a><a name="terminology-related-to-warehouse-management"></a>Terminología relacionada con la gestión de almacenes

### <a name="complexity-levels"></a><a name="complexity-levels"></a><a name="complexity-levels"></a><a name="complexity-levels"></a>Niveles de complejidad
...
### <a name="warehouse-flows"></a><a name="warehouse-flows"></a><a name="warehouse-flows"></a><a name="warehouse-flows"></a>Flujos de almacén
...
### <a name="basic-documents"></a><a name="basic-documents"></a><a name="basic-documents"></a><a name="basic-documents"></a>Documentos básicos
...
### <a name="advanced-documents"></a><a name="advanced-documents"></a><a name="advanced-documents"></a><a name="advanced-documents"></a>Documentos avanzados
...
### <a name="pages-and-settings"></a><a name="pages-and-settings"></a><a name="pages-and-settings"></a><a name="pages-and-settings"></a>Páginas y configuraciones

Esta sección describe los conceptos detrás de las páginas clave y la configuración para el almacenamiento.

#### <a name="bins-and-bin-content"></a><a name="bins-and-bin-content"></a><a name="bins-and-bin-content"></a><a name="bins-and-bin-content"></a>Ubicaciones y contenido de ubicación
...
#### <a name="bin-type"></a><a name="bin-type"></a><a name="bin-type"></a><a name="bin-type"></a>Tipo ubicación
...
#### <a name="bin-ranking"></a><a name="bin-ranking"></a><a name="bin-ranking"></a><a name="bin-ranking"></a>Ranking ubicación
...
#### <a name="bin-setup"></a><a name="bin-setup"></a><a name="bin-setup"></a><a name="bin-setup"></a>Configuración de ubicación
...
#### <a name="zone"></a><a name="zone"></a><a name="zone"></a><a name="zone"></a>Zona
...
#### <a name="warehouse-class"></a><a name="warehouse-class"></a><a name="warehouse-class"></a><a name="warehouse-class"></a>Clase almacén
...
#### <a name="location"></a><a name="location"></a><a name="location"></a><a name="location"></a>Almacén
...
#### <a name="first-expired-first-out"></a><a name="first-expired-first-out"></a><a name="first-expired-first-out"></a><a name="first-expired-first-out"></a>Primero en caducar primero en salir
...
#### <a name="put-away-template"></a><a name="put-away-template"></a><a name="put-away-template"></a><a name="put-away-template"></a>Plantilla ubicar
