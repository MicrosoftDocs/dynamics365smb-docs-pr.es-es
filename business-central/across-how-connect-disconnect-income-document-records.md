...
ms.author: edupont
---
# <a name="create-incoming-document-records-directly-from-documents-and-entries" />Crear registros de documentos entrantes directamente desde documentos y movimientos
...
## <a name="create-and-connect-an-incoming-document-record-from-a-purchase-invoice" />Para crear y conectar un registro de documento entrante a partir de una factura de compra
...
## <a name="create-and-connect-an-incoming-document-record-from-a-vendor-ledger-entry" />Para crear y conectar un registro de documento entrante a partir de movimiento de proveedor
...
## <a name="remove-a-connection-from-an-incoming-document-record-to-a-posted-document" />Para eliminar la conexión de un registro de documento entrante a un documento registrado
