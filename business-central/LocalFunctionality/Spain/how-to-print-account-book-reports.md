...
ms.author: edupont
---
# <a name="print-account-book-reports-in-the-spanish-version" />Imprimir informes de libro diario en la versión en español
...
## <a name="to-print-an-official-account-book-report" />Para imprimir un informe de libro diario oficial
...
## <a name="to-print-an-official-account-summarized-book-report" />Para imprimir un libro diario oficial resumido
