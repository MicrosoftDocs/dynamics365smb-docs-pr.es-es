...
ms.author: edupont
---
# <a name="set-up-bank-ccc-codes-in-the-spanish-version"></a><a name="set-up-bank-ccc-codes-in-the-spanish-version"></a><a name="set-up-bank-ccc-codes-in-the-spanish-version"></a><a name="set-up-bank-ccc-codes-in-the-spanish-version"></a>Configurar códigos bancarios CCC en la versión en español
...
## <a name="to-enter-ccc-codes"></a><a name="to-enter-ccc-codes"></a><a name="to-enter-ccc-codes"></a><a name="to-enter-ccc-codes"></a>Para introducir códigos CCC
...
## <a name="to-set-up-bank-ccc-codes-for-a-customer-bank-account"></a><a name="to-set-up-bank-ccc-codes-for-a-customer-bank-account"></a><a name="to-set-up-bank-ccc-codes-for-a-customer-bank-account"></a><a name="to-set-up-bank-ccc-codes-for-a-customer-bank-account"></a>Para configurar códigos CCC de banco de un banco cliente
