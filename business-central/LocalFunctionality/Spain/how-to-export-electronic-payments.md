...
# <a name="export-electronic-payments-in-the-spanish-version" />Exportar pagos electrónicos en la versión en español
...
## <a name="to-export-electronic-payments-using-the-payment-orders-page" />Para exportar pagos electrónicos mediante la página Órdenes de pago
...
## <a name="to-export-electronic-payments-using-the-payment-journal-page" />Para exportar pagos electrónicos mediante la página Diario de pagos
...
## <a name="to-export-electronic-payments-from-the-cartera-module" />Para exportar los pagos electrónicos del módulo Cartera
