...
# <a name="export-electronic-payments-in-the-spanish-version"></a><a name="export-electronic-payments-in-the-spanish-version"></a><a name="export-electronic-payments-in-the-spanish-version"></a><a name="export-electronic-payments-in-the-spanish-version"></a>Exportar pagos electrónicos en la versión en español
...
## <a name="to-export-electronic-payments-using-the-payment-orders-page"></a><a name="to-export-electronic-payments-using-the-payment-orders-page"></a><a name="to-export-electronic-payments-using-the-payment-orders-page"></a><a name="to-export-electronic-payments-using-the-payment-orders-page"></a>Para exportar pagos electrónicos mediante la página Órdenes de pago
...
## <a name="to-export-electronic-payments-using-the-payment-journal-page"></a><a name="to-export-electronic-payments-using-the-payment-journal-page"></a><a name="to-export-electronic-payments-using-the-payment-journal-page"></a><a name="to-export-electronic-payments-using-the-payment-journal-page"></a>Para exportar pagos electrónicos mediante la página Diario de pagos
...
## <a name="to-export-electronic-payments-from-the-cartera-module"></a><a name="to-export-electronic-payments-from-the-cartera-module"></a><a name="to-export-electronic-payments-from-the-cartera-module"></a><a name="to-export-electronic-payments-from-the-cartera-module"></a>Para exportar los pagos electrónicos del módulo Cartera
