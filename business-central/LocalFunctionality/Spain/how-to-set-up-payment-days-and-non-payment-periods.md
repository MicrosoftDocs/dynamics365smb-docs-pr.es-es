...
ms.author: edupont
---
# <a name="set-up-payment-days-and-non-payment-periods" />Configurar días de pago y de periodos no-pago
...
## <a name="to-set-up-payment-days-and-non-payment-periods-for-a-company" />Para configurar días de pago y periodos no-pago para una empresa
...
## <a name="to-set-up-payment-days-for-customers-and-vendors" />Para configurar días de pago para clientes y proveedores
...
## <a name="to-set-up-non-payment-periods-for-customers-and-vendors" />Para configurar periodos no-pago para clientes y proveedores
