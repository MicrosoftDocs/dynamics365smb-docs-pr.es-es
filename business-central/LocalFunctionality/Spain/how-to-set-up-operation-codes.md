...
ms.author: edupont
---
# <a name="set-up-operation-codes" />Configurar códigos de operación
...
## <a name="to-set-up-operation-codes" />Para configurar códigos de operación
...
## <a name="to-link-operation-codes-to-general-product-posting-groups" />Para vincular códigos de operación a grupos de publicación de productos en general
