...
ms.author: edupont
---
# <a name="set-up-operation-codes"></a><a name="set-up-operation-codes"></a><a name="set-up-operation-codes"></a><a name="set-up-operation-codes"></a>Configurar códigos de operación
...
## <a name="to-set-up-operation-codes"></a><a name="to-set-up-operation-codes"></a><a name="to-set-up-operation-codes"></a><a name="to-set-up-operation-codes"></a>Para configurar códigos de operación
...
## <a name="to-link-operation-codes-to-general-product-posting-groups"></a><a name="to-link-operation-codes-to-general-product-posting-groups"></a><a name="to-link-operation-codes-to-general-product-posting-groups"></a><a name="to-link-operation-codes-to-general-product-posting-groups"></a>Para vincular códigos de operación a grupos de publicación de productos en general
