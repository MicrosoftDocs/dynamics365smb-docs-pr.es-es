...
ms.author: edupont
---
# <a name="report-349-in-the-spanish-version"></a><a name="report-349-in-the-spanish-version"></a><a name="report-349-in-the-spanish-version"></a>Informe 349 en la versión en español
...
## <a name="delivery-operation-codes"></a><a name="delivery-operation-codes"></a><a name="delivery-operation-codes"></a>Códigos operación entrega
...
### <a name="delivery-operation-codes-and-item-setup"></a><a name="delivery-operation-codes-and-item-setup"></a><a name="delivery-operation-codes-and-item-setup"></a>Códigos de operación de entrega y configuración de producto
