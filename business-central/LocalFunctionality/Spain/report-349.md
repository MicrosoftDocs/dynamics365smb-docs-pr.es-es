...
## <a name="delivery-operation-codes" />Códigos operación entrega
...
### <a name="delivery-operation-codes-and-item-setup" />Códigos de operación de entrega y configuración de producto
