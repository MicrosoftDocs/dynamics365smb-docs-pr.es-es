...
ms.author: edupont
---
# <a name="set-up-bank-accounts-for-electronic-payments-in-the-spanish-version"></a><a name="set-up-bank-accounts-for-electronic-payments-in-the-spanish-version"></a><a name="set-up-bank-accounts-for-electronic-payments-in-the-spanish-version"></a><a name="set-up-bank-accounts-for-electronic-payments-in-the-spanish-version"></a>Configurar cuentas bancarias para pagos electrónicos en la versión en español
En [!INCLUDE[prod_short](../../includes/prod_short.md)], puede configurar cuentas bancarias para realizar pagos electrónicos.  

## <a name="to-set-up-bank-accounts-for-electronic-payments"></a><a name="to-set-up-bank-accounts-for-electronic-payments"></a><a name="to-set-up-bank-accounts-for-electronic-payments"></a><a name="to-set-up-bank-accounts-for-electronic-payments"></a>Para configurar cuentas bancarias para realizar pagos electrónicos
...
## <a name="to-set-up-vendor-bank-accounts-for-electronic-payments"></a><a name="to-set-up-vendor-bank-accounts-for-electronic-payments"></a><a name="to-set-up-vendor-bank-accounts-for-electronic-payments"></a><a name="to-set-up-vendor-bank-accounts-for-electronic-payments"></a>Para configurar cuentas bancarias para realizar pagos electrónicos
