...
ms.author: edupont
---
# <a name="export-vat-statements-in-text-format"></a><a name="export-vat-statements-in-text-format"></a>Exportar declaraciones de IVA en formato de texto
...
## <a name="to-export-a-vat-statement-in-text-format"></a><a name="to-export-a-vat-statement-in-text-format"></a>Para exportar declaraciones de IVA en formato de texto
