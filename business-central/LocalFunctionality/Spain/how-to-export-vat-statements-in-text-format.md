...
ms.author: edupont
---
# <a name="export-vat-statements-in-text-format" />Exportar declaraciones de IVA en formato de texto
...
## <a name="to-export-a-vat-statement-in-text-format" />Para exportar declaraciones de IVA en formato de texto
