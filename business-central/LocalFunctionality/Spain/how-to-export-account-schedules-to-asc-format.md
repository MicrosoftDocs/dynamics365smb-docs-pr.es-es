...
ms.author: edupont
---
# <a name="export-financial-reports-to-asc-format" />Exportar informes financieros a formato ASC
...
## <a name="to-export-financial-reports-into-asc-format" />Para exportar informes financieros a formato ASC
