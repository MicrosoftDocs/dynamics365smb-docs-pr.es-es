...
ms.author: edupont
---
# <a name="export-financial-reports-to-asc-format"></a><a name="export-financial-reports-to-asc-format"></a><a name="export-financial-reports-to-asc-format"></a>Exportar informes financieros a formato ASC
...
## <a name="to-export-financial-reports-into-asc-format"></a><a name="to-export-financial-reports-into-asc-format"></a><a name="to-export-financial-reports-into-asc-format"></a>Para exportar informes financieros a formato ASC
