...
ms.author: soalex
---
# <a name="use-the-same-external-document-numbers-across-fiscal-years"></a><a name="use-the-same-external-document-numbers-across-fiscal-years"></a><a name="use-the-same-external-document-numbers-across-fiscal-years"></a>Usar los mismos números de documento externo en todos los ejercicios
...
## <a name="to-allow-posting-of-the-same-external-document-no-across-fiscal-years"></a><a name="to-allow-posting-of-the-same-external-document-no-across-fiscal-years"></a><a name="to-allow-posting-of-the-same-external-document-no-across-fiscal-years"></a>Para permitir el registro del mismo **número de documento externo** en todos los ejercicios
