...
description: La funcionalidad de factura rectificativa permite enviar una factura rectificativa cuando haya un error o conflicto que afecte al importe del IVA o a los datos fiscales.
