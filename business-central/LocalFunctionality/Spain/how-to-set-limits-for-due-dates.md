...
ms.author: edupont
---
# <a name="set-limits-for-due-dates"></a><a name="set-limits-for-due-dates"></a>Establecer límites para fechas de vencimiento
...
## <a name="to-set-limits-for-due-dates-on-payment-terms"></a><a name="to-set-limits-for-due-dates-on-payment-terms"></a>Para definir los límites para las fechas de vencimiento en términos de pago
