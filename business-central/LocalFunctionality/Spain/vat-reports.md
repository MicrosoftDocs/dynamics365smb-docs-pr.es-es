...
ms.author: edupont
---
# <a name="vat-reports-in-the-spanish-version"></a><a name="vat-reports-in-the-spanish-version"></a><a name="vat-reports-in-the-spanish-version"></a>Informes de IVA en la versión en español
...
## <a name="equivalence-charge"></a><a name="equivalence-charge"></a><a name="equivalence-charge"></a>Recargo de equivalencia
...
### <a name="vat-with-ec-percentage"></a><a name="vat-with-ec-percentage"></a><a name="vat-with-ec-percentage"></a>IVA con porcentaje RE
...
### <a name="telematic-vat"></a><a name="telematic-vat"></a><a name="telematic-vat"></a>IVA Telemático
...
### <a name="vat-statement"></a><a name="vat-statement"></a><a name="vat-statement"></a>Declaración IVA
...
### <a name="vat-vies-declaration"></a><a name="vat-vies-declaration"></a><a name="vat-vies-declaration"></a>IVA - declaración VIES
