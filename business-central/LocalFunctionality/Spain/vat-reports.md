...
ms.author: edupont
---
# <a name="vat-reports-in-the-spanish-version" />Informes de IVA en la versión en español
...
## <a name="equivalence-charge" />Recargo de equivalencia
...
### <a name="vat-with-ec-percentage" />IVA con porcentaje RE
...
### <a name="telematic-vat" />IVA Telemático
...
### <a name="vat-statement" />Declaración IVA
...
### <a name="vat-vies-declaration" />IVA - declaración VIES
