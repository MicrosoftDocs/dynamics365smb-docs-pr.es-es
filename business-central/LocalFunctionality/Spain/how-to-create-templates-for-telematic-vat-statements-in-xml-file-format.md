...
ms.author: edupont
---
# <a name="create-templates-for-telematic-vat-statements-in-xml-file-format" />Crear plantillas para las declaraciones telemáticas de IVA en formato XML
...
## <a name="to-create-a-template-for-vat-statements-in-xml-file-format" />Para crear una plantilla para las declaraciones telemáticas de IVA en formato de archivo XML
