...
## <a name="file-format" />Formato de archivo
...
### <a name="small-businesses" />Empresas pequeñas
...
### <a name="invoices-including-different-vat-percentages-or-ec-percentages" />Facturas con diferentes porcentajes de IVA o de RE
...
## <a name="file-format-restrictions" />Restricciones del formato de archivo
