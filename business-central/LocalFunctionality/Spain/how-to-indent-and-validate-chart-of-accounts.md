...
ms.author: edupont
---
# <a name="indent-and-validate-chart-of-accounts" />Efectuar el test y la validación del plan de cuentas
...
## <a name="to-indent-and-validate-the-chart-of-accounts" />Para efectuar el test y la validación del plan de cuentas
...
## <a name="to-validate-the-chart-of-accounts-in-portugal" />Para efectuar la validación del plan de cuentas en Portugal
