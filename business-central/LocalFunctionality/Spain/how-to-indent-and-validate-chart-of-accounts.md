...
ms.author: edupont
---
# <a name="indent-and-validate-chart-of-accounts"></a><a name="indent-and-validate-chart-of-accounts"></a><a name="indent-and-validate-chart-of-accounts"></a><a name="indent-and-validate-chart-of-accounts"></a>Efectuar el test y la validación del plan de cuentas
...
## <a name="to-indent-and-validate-the-chart-of-accounts"></a><a name="to-indent-and-validate-the-chart-of-accounts"></a><a name="to-indent-and-validate-the-chart-of-accounts"></a><a name="to-indent-and-validate-the-chart-of-accounts"></a>Para efectuar el test y la validación del plan de cuentas
...
## <a name="to-validate-the-chart-of-accounts-in-portugal"></a><a name="to-validate-the-chart-of-accounts-in-portugal"></a><a name="to-validate-the-chart-of-accounts-in-portugal"></a><a name="to-validate-the-chart-of-accounts-in-portugal"></a>Para efectuar la validación del plan de cuentas en Portugal
