...
ms.author: edupont
---
# <a name="equivalence-charges-ec-in-the-spanish-version"></a><a name="equivalence-charges-ec-in-the-spanish-version"></a>Recargos de equivalencia (RE) en la versión en español
