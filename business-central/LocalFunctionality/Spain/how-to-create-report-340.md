...
ms.author: edupont
---
# <a name="create-report--in-the-spanish-version" />Crear informe 340 en la versión en español
...
## <a name="to-create-report-" />Para crear el informe 340
...
## <a name="to-create-a-modelo--report-under-the-cac-regimen" />Para crear un informe de Modelo 340 en de régimen CAC
