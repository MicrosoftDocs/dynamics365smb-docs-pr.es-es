...
ms.author: edupont
---
# <a name="calculating-due-dates-in-the-spanish-version"></a><a name="calculating-due-dates-in-the-spanish-version"></a><a name="calculating-due-dates-in-the-spanish-version"></a>Cálculo de fechas de vencimiento en la versión en español
...
## <a name="payment-terms"></a><a name="payment-terms"></a><a name="payment-terms"></a>Condiciones de pago
...
## <a name="overdue-payments"></a><a name="overdue-payments"></a><a name="overdue-payments"></a>Pagos vencidos
