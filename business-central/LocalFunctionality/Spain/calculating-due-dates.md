...
ms.author: edupont
---
# <a name="calculating-due-dates-in-the-spanish-version" />Cálculo de fechas de vencimiento en la versión en español
...
## <a name="payment-terms" />Condiciones de pago
...
## <a name="overdue-payments" />Pagos vencidos
