...
ms.author: edupont
---
# <a name="post-and-print-all-transactions-for-a-period"></a><a name="post-and-print-all-transactions-for-a-period"></a>Registrar e imprimir todas las transacciones de un periodo
...
## <a name="to-post-all-transactions-for-a-period"></a><a name="to-post-all-transactions-for-a-period"></a>Para registrar todas las transacciones de un periodo
...
## <a name="to-print-all-transactions-for-a-period"></a><a name="to-print-all-transactions-for-a-period"></a>Para imprimir todas las transacciones de un periodo
