...
ms.author: edupont
---
# <a name="set-up-340-reports-for-small-businesses-in-the-spanish-version"></a><a name="set-up-340-reports-for-small-businesses-in-the-spanish-version"></a><a name="set-up-340-reports-for-small-businesses-in-the-spanish-version"></a><a name="set-up-340-reports-for-small-businesses-in-the-spanish-version"></a>Configurar informes 340 para pequeñas empresas en la versión en español
...
## <a name="to-set-up-reporting-under-cac"></a><a name="to-set-up-reporting-under-cac"></a><a name="to-set-up-reporting-under-cac"></a><a name="to-set-up-reporting-under-cac"></a>Para configurar informes según el CAC
