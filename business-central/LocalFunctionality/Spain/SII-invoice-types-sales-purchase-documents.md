...
ms.author: edupont
---
# <a name="sii---invoice-and-credit-memo-types-in-sales-and-purchase-documents"></a><a name="sii---invoice-and-credit-memo-types-in-sales-and-purchase-documents"></a><a name="sii---invoice-and-credit-memo-types-in-sales-and-purchase-documents"></a><a name="sii---invoice-and-credit-memo-types-in-sales-and-purchase-documents"></a>SII - Tipos de factura y abonos en documentos de compra y venta
...
## <a name="sales-invoices"></a><a name="sales-invoices"></a><a name="sales-invoices"></a><a name="sales-invoices"></a>Facturas de venta
...
## <a name="sales-credit-memos"></a><a name="sales-credit-memos"></a><a name="sales-credit-memos"></a><a name="sales-credit-memos"></a>Notas de abono de venta
...
## <a name="purchase-invoices"></a><a name="purchase-invoices"></a><a name="purchase-invoices"></a><a name="purchase-invoices"></a>Facturas de compra
...
## <a name="purchase-credit-memos"></a><a name="purchase-credit-memos"></a><a name="purchase-credit-memos"></a><a name="purchase-credit-memos"></a>Notas de abono de compra
