...
ms.author: edupont
---
# <a name="pay-vendors-using-electronic-payments-in-the-spanish-version"></a><a name="pay-vendors-using-electronic-payments-in-the-spanish-version"></a><a name="pay-vendors-using-electronic-payments-in-the-spanish-version"></a><a name="pay-vendors-using-electronic-payments-in-the-spanish-version"></a>Pagar a los proveedores utilizando pagos electrónicos en la versión en español
...
## <a name="to-pay-a-vendor-electronically"></a><a name="to-pay-a-vendor-electronically"></a><a name="to-pay-a-vendor-electronically"></a><a name="to-pay-a-vendor-electronically"></a>Para pagar a un proveedor electrónicamente
