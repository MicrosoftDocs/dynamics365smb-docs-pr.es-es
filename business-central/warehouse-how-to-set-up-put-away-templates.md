...
ms.author: edupont
---
# <a name="set-up-put-away-templates"></a><a name="set-up-put-away-templates"></a><a name="set-up-put-away-templates"></a><a name="set-up-put-away-templates"></a>Configurar plantillas de ubicación
...
## <a name="to-set-up-put-away-templates"></a><a name="to-set-up-put-away-templates"></a><a name="to-set-up-put-away-templates"></a><a name="to-set-up-put-away-templates"></a>Para configurar las plantillas de ubicación
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Consultar la [formación de Microsoft](/training/modules/put-away-templates/) relacionada
