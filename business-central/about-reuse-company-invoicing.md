...
ms.author: bholtorf
---
# <a name="use-the-same-microsoft-365-account-in--and-microsoft-invoicing"></a><a name="use-the-same-microsoft-365-account-in--and-microsoft-invoicing"></a>Usar la misma cuenta de Microsoft 365 en [!INCLUDE[prod_short](includes/prod_long.md)] y Microsoft Invoicing
...
## <a name="workaround"></a><a name="workaround"></a>Solución
...
### <a name="to-rename-your-company"></a><a name="to-rename-your-company"></a>Para cambiar el nombre de su empresa
...
### <a name="what-about-my-data"></a><a name="what-about-my-data"></a>¿Qué sucede con mis datos?
