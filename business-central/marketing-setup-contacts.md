...
ms.author: edupont
---
# <a name="set-up-contacts"></a><a name="set-up-contacts"></a>Configuración de contactos
...
## <a name="to-assign-industry-groups-to-a-contact"></a><a name="to-assign-industry-groups-to-a-contact"></a>Para asignar grupos de industria a un contacto
...
## <a name="to-assign-mailing-groups-to-a-contact"></a><a name="to-assign-mailing-groups-to-a-contact"></a>Para asignar grupos de correo a un contacto
...
## <a name="to-define-a-contacts-alternate-address"></a><a name="to-define-a-contacts-alternate-address"></a>Para definir la dirección alternativa de un contacto
...
## <a name="to-assign-job-responsibilities-to-a-contact"></a><a name="to-assign-job-responsibilities-to-a-contact"></a>Para asignar responsabilidades del cargo a contactos
...
## <a name="to-assign-organizational-levels-to-a-contact"></a><a name="to-assign-organizational-levels-to-a-contact"></a>Para asignar niveles de organización a un contacto
...
## <a name="to-assign-web-sources-to-a-contact"></a><a name="to-assign-web-sources-to-a-contact"></a>Para asignar enlaces web a un contacto
...
## <a name="to-assign-business-relations-to-a-contact"></a><a name="to-assign-business-relations-to-a-contact"></a>Para asignar relaciones de negocio a un contacto
...
## <a name="automatically-copying-specific-information-from-contact-companies-to-contact-persons"></a><a name="automatically-copying-specific-information-from-contact-companies-to-contact-persons"></a>Copiar automáticamente información específica desde las empresas de contacto a las personas de contacto
...
## <a name="use-predefined-defaults-on-new-contacts"></a><a name="use-predefined-defaults-on-new-contacts"></a>Usar valores predeterminados predefinidos en contactos nuevos
...
## <a name="synchronizing-contacts-with-customers-vendors-and-bank-accounts"></a><a name="synchronizing-contacts-with-customers-vendors-and-bank-accounts"></a>Sincronizar contactos con clientes, proveedores y cuentas bancarias
...
## <a name="searching-for-duplicate-contacts"></a><a name="searching-for-duplicate-contacts"></a>Búsqueda de contactos duplicados
