...
ms.author: edupont
---
# <a name="set-up-contacts" />Configuración de contactos
...
## <a name="to-assign-industry-groups-to-a-contact" />Para asignar grupos de industria a un contacto
...
## <a name="to-assign-mailing-groups-to-a-contact" />Para asignar grupos de correo a un contacto
...
## <a name="to-define-a-contacts-alternate-address" />Para definir la dirección alternativa de un contacto
...
## <a name="to-assign-job-responsibilities-to-a-contact" />Para asignar responsabilidades del cargo a contactos
...
## <a name="to-assign-organizational-levels-to-a-contact" />Para asignar niveles de organización a un contacto
...
## <a name="to-assign-web-sources-to-a-contact" />Para asignar enlaces web a un contacto
...
## <a name="to-assign-business-relations-to-a-contact" />Para asignar relaciones de negocio a un contacto
...
## <a name="synchronizing-contacts-with-customers-vendors-and-bank-accounts" />Sincronizar contactos con clientes, proveedores y cuentas bancarias
...
## <a name="searching-for-duplicate-contacts" />Búsqueda de contactos duplicados
