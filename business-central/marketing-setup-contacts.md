...
## <a name="to-assign-industry-groups-to-a-contact"></a> Para asignar grupos de industria a un contacto
...
## <a name="to-assign-mailing-groups-to-a-contact"></a> Para asignar grupos de correo a un contacto
...
## <a name="to-define-a-contacts-alternate-address"></a>Para definir la dirección alternativa de un contacto
...
## <a name="to-assign-job-responsibilities-to-a-contact"></a>Para asignar responsabilidades del cargo a contactos
...
## <a name="to-assign-organizational-levels-to-a-contact"></a>Para asignar niveles de organización a un contacto
...
## <a name="to-assign-web-sources-to-a-contact"></a>Para asignar enlaces web a un contacto
...
## <a name="to-assign-business-relations-to-a-contact"></a> Para asignar relaciones de negocio a un contacto
