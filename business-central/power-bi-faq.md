...
### <a name="a-namedatabasemodsaive-tried-the-preview-of-the-new-connector-for-the-february--update-when-i-connect-to-my-custom-business-central-api-page-i-get-the-error-cannot-insert-a-record-current-connection-intent-is-read-only-how-can-i-fix-it" /><a name="databasemods"></a>He probado la versión preliminar del nuevo conector para la actualización de febrero de 2022. Cuando me conecto a mi página personalizada de la API de Business Central, aparece el error "No se puede insertar un registro. La intención de conexión actual es de solo lectura". ¿Cómo puedo solucionarlo?
...
### <a name="when-i-get-data-from-business-central-to-use-in-my-power-bi-reports-i-see-some-values-like-x-what-are-these-values" />Cuando obtengo datos de Business Central para usarlos en mis informes de Power BI, veo algunos valores como "_x0020_". ¿Qué son estos valores?
