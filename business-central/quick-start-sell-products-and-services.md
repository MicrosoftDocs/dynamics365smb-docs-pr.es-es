...
# <a name="sales-quick-start" />Inicio rápido de ventas
...
## <a name="set-up-items-to-sell" />Configurar productos para vender
...
### <a name="set-up-a-new-item" />Configurar un producto nuevo
...
## <a name="set-up-customers" />Configurar clientes
...
### <a name="set-up-a-new-customer" />Configurar un cliente nuevo
...
### <a name="to-create-a-sales-order" />Para crear un pedido de ventas
...
## <a name="create-a-sales-invoice" />Crear una factura de venta
...
### <a name="to-create-and-post-a-sales-invoice" />Para crear y registrar una factura de venta
