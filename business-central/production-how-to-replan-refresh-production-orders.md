...
ms.author: edupont
---
# <a name="replan-or-refresh-production-orders-directly" />Replanificar o actualizar órdenes de producción directamente
...
## <a name="to-replan-a-production-order" />Para replanificar una orden de producción
...
## <a name="to-refresh-a-production-order" />Para actualizar una orden de producción
