...
ms.author: edupont
---
# <a name="replan-or-refresh-production-orders-directly"></a><a name="replan-or-refresh-production-orders-directly"></a><a name="replan-or-refresh-production-orders-directly"></a>Replanificar o actualizar órdenes de producción directamente
...
## <a name="to-replan-a-production-order"></a><a name="to-replan-a-production-order"></a><a name="to-replan-a-production-order"></a>Para replanificar una orden de producción
...
## <a name="to-refresh-a-production-order"></a><a name="to-refresh-a-production-order"></a><a name="to-refresh-a-production-order"></a>Para actualizar una orden de producción
