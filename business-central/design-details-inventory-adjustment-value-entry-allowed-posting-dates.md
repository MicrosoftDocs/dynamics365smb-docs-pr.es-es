...
## <a name="change-the-user-setup" />Cambiar la configuración del usuario
...
### <a name="overview-of-involved-posting-date-setup" />Descripción general de la configuración de la fecha de registro involucrada
...
#### <a name="user-setup" />Configuración de usuarios
