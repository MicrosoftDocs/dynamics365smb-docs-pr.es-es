...
## <a name="change-the-user-setup"></a><a name="change-the-user-setup"></a><a name="change-the-user-setup"></a>Cambiar la configuración del usuario
...
### <a name="overview-of-involved-posting-date-setup"></a><a name="overview-of-involved-posting-date-setup"></a><a name="overview-of-involved-posting-date-setup"></a>Descripción general de la configuración de la fecha de registro involucrada

#### <a name="inventory-periods"></a><a name="inventory-periods"></a><a name="inventory-periods"></a>Periodos de inventario
...
#### <a name="user-setup"></a><a name="user-setup"></a><a name="user-setup"></a>Configuración de usuarios
