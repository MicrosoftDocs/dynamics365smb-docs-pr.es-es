...
# <a name="responding-to-requests-about-users-personal-data"></a><a name="responding-to-requests-about-users-personal-data"></a><a name="responding-to-requests-about-users-personal-data"></a>Respuesta a las solicitudes de datos personales de usuarios
...
## <a name="types-of-requests"></a><a name="types-of-requests"></a><a name="types-of-requests"></a>Tipos de solicitudes
...
## <a name="restrict-data-processing-for-a-data-subject"></a><a name="restrict-data-processing-for-a-data-subject"></a><a name="restrict-data-processing-for-a-data-subject"></a>Restringir el procesamiento de datos para un interesado
...
## <a name="handling-data-subject-requests-when-using-a-trial-version"></a><a name="handling-data-subject-requests-when-using-a-trial-version"></a><a name="handling-data-subject-requests-when-using-a-trial-version"></a>Gestionar solicitudes de interesados cuando se utiliza una versión de prueba
...
## <a name="exporting-data-from-tables-not-classified-by-data-subject"></a><a name="exporting-data-from-tables-not-classified-by-data-subject"></a><a name="exporting-data-from-tables-not-classified-by-data-subject"></a>Exportar datos de tablas no clasificadas por interesado
...
## <a name="handling-data-about-minors"></a><a name="handling-data-about-minors"></a><a name="handling-data-about-minors"></a>Controlar datos sobre menores
