...
# <a name="responding-to-requests-about-users-personal-data" />Respuesta a las solicitudes de datos personales de usuarios
...
## <a name="types-of-requests" />Tipos de solicitudes
...
## <a name="restrict-data-processing-for-a-data-subject" />Restringir el procesamiento de datos para un interesado
...
## <a name="handling-data-subject-requests-when-using-a-trial-version" />Gestionar solicitudes de interesados cuando se utiliza una versión de prueba
...
## <a name="exporting-data-from-tables-not-classified-by-data-subject" />Exportar datos de tablas no clasificadas por interesado
...
## <a name="handling-data-about-minors" />Controlar datos sobre menores
