...
# <a name="install-the--app-for-microsoft-teams"></a><a name="install-the--app-for-microsoft-teams"></a>Instale la aplicación [!INCLUDE [prod_short](includes/prod_short.md)] para Microsoft Teams
...
## <a name="add-the-business-central-app-to-teams"></a><a name="add-the-business-central-app-to-teams"></a>Agregar la aplicación Business Central a Teams
...
## <a name="next-step"></a><a name="next-step"></a>Paso siguiente
