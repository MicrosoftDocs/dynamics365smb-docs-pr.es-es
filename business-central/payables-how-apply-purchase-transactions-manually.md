...
ms.author: edupont
---
# <a name="reconcile-vendor-payments-with-the-payment-journal-or-from-vendor-ledger-entries" />Conciliar pagos a proveedores con el diario de pagos o desde los movimientos de proveedor
...
## <a name="to-apply-a-payment-to-a-single-or-multiple-vendor-ledger-entries" />Para liquidar uno o varios movimientos del proveedor con un pago:
...
## <a name="to-apply-a-credit-memo-to-a-single-or-multiple-vendor-ledger-entries" />Para liquidar un abono con uno o varios movimientos de proveedor
...
## <a name="to-apply-posted-vendor-ledger-entries" />Para liquidar movimientos de proveedor registrados
...
## <a name="to-apply-vendor-ledger-entries-in-different-currencies-to-one-another" />Para liquidar movimientos de proveedor entre divisas distintas
...
## <a name="to-unapply-an-application-of-vendor-entries" />Para deshacer un movimiento de liquidación de movimientos de proveedor
