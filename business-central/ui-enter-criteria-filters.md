...
ms.author: jswymer
---
# <a name="sorting-searching-and-filtering" />Ordenar, buscar y filtrar
...
### <a name="fine-tuning-the-search-with-filter-criteria" />Ajuste de los criterios de búsqueda con filtro
...
### <a name="filtering-with-option-fields" />Filtrado con campos de opción
...
### <a name="setting-filters-on-lists" />Configuración de filtros en listas
...
### <a name="setting-filters-in-reports-batch-jobs-and-xmlports" />Configuración de filtros en informes, trabajos por lotes y XMLports
...
## <a name="entering-filter-criteria" />Introducción de criterios de filtros
...
### <a name="a-namefiltercriteria-afilter-criteria-and-operators" /><a name="FilterCriteria"> </a>Criterios y operadores de filtro
...
#### <a name="-greater-than" />(>) Mayor de

|Ejemplo|Registros mostrados|  
|-----------------------|-----------------------|  
|`>1200`|Números mayores que 1200|  

#### <a name="-greater-than-or-equal-to" />(>=) Mayor o igual a

|Ejemplo|Registros mostrados|  
|-----------------------|-----------------------|  
|`>=1200`|Números mayores o igual que 1200|  

#### <a name="-less-than" />(<) Menor de

|Ejemplo|Registros mostrados|  
|-----------------------|-----------------------|  
|`<1200`|Números menores que 1200|  

#### <a name="-less-than-or-equal-to" />(<=) Menor o igual que
...
#### <a name="-an-exact-character-match" />(") Una coincidencia exacta de carácter
...
#### <a name="-case-insensitive" />(@) Distinción entre mayúsculas y minúsculas

|Ejemplo|Registros mostrados|  
|-----------------------|-----------------------|  
|`@man*`|Texto que empieza por **man** y no distingue mayúsculas de minúsculas.|  

#### <a name="-an-indefinite-number-of-unknown-characters" />(*) Un número indefinido de caracteres desconocidos (quizás ninguno)
...
#### <a name="-one-unknown-character" />(?) Un carácter desconocido

|Ejemplo|Registros mostrados|  
|-----------------------|-----------------------|  
|`Hans?n`|Texto como **Mendoza** o **Mendosa**|  

#### <a name="combined-format-expressions" />Expresiones de formato combinadas
...
### <a name="a-namefiltertokens-afilter-tokens" /><a name="FilterTokens"> </a>Tokens de filtro
...
#### <a name="me-or-userid-records-assigned-to-you" />(%me o %userid) Registros que se le han asignado
...
#### <a name="mycustomers-customers-in-my-customers" />(%mycustomers) Clientes en Mis clientes
...
#### <a name="myitems-items-in-my-items" />(%myitems) Artículos en Mis artículos
...
#### <a name="myvendors-vendors-in-my-vendors" />(%myvendors) Proveedores en Mis proveedores
