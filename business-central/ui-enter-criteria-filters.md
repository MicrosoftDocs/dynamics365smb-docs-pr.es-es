...
ms.author: jswymer
---
# <a name="sorting-searching-and-filtering"></a><a name="sorting-searching-and-filtering"></a>Ordenar, buscar y filtrar
...
## <a name="sorting"></a><a name="sorting"></a>Ordenación
...
## <a name="searching"></a><a name="searching"></a>Búsqueda
...
### <a name="fine-tuning-the-search-with-filter-criteria"></a><a name="fine-tuning-the-search-with-filter-criteria"></a>Ajuste de los criterios de búsqueda con filtro
...
## <a name="filtering"></a><a name="filtering"></a><a name="filtering"></a>Filtrado
...
### <a name="filtering-with-option-fields"></a><a name="filtering-with-option-fields"></a>Filtrado con campos de opción
...
### <a name="setting-filters-on-lists"></a><a name="setting-filters-on-lists"></a>Configuración de filtros en listas
...
### <a name="setting-filters-in-reports-batch-jobs-and-xmlports"></a><a name="setting-filters-in-reports-batch-jobs-and-xmlports"></a>Configuración de filtros en informes, trabajos por lotes y XMLports
...
## <a name="entering-filter-criteria"></a><a name="entering-filter-criteria"></a>Introducción de criterios de filtros
...
### <a name="a-namefiltercriteria-afilter-criteria-and-operators"></a><a name="a-namefiltercriteria-afilter-criteria-and-operators"></a><a name="FilterCriteria"> </a>Criterios y operadores de filtro
...
#### <a name="-interval"></a><a name="-interval"></a>(..) Intervalo
...
#### <a name="124-eitheror"></a><a name="124-eitheror"></a>(&#124;) O/o

|Ejemplo|Registros mostrados|  
|-----------------------|-----------------------|  
|`1200|1300`|Números con 1200 ó 1300|  

#### <a name="-not-equal-to"></a><a name="-not-equal-to"></a>(<>) Distinto
...
#### <a name="-greater-than"></a><a name="-greater-than"></a>(>) Mayor de

|Ejemplo|Registros mostrados|  
|-----------------------|-----------------------|  
|`>1200`|Números mayores que 1200|  

#### <a name="-greater-than-or-equal-to"></a><a name="-greater-than-or-equal-to"></a>(>=) Mayor o igual a

|Ejemplo|Registros mostrados|  
|-----------------------|-----------------------|  
|`>=1200`|Números mayores o igual que 1200|  

#### <a name="-less-than"></a><a name="-less-than"></a>(<) Menor de

|Ejemplo|Registros mostrados|  
|-----------------------|-----------------------|  
|`<1200`|Números menores que 1200|  

#### <a name="-less-than-or-equal-to"></a><a name="-less-than-or-equal-to"></a>(<=) Menor o igual que

|Ejemplo|Registros mostrados|  
|-----------------------|-----------------------|  
|`<=1200`|Números menores o iguales que 1200|  

#### <a name="-and"></a><a name="-and"></a>(&) y

|Ejemplo|Registros mostrados|  
|-----------------------|-----------------------|  
|`>200&<1200`|Números mayores de 200 e inferiores a 1200|  

#### <a name="-an-exact-character-match"></a><a name="-an-exact-character-match"></a>(") Una coincidencia exacta de carácter
...
#### <a name="-case-insensitive"></a><a name="-case-insensitive"></a>(@) Distinción entre mayúsculas y minúsculas

|Ejemplo|Registros mostrados|  
|-----------------------|-----------------------|  
|`@man*`|Texto que empieza por **man** y no distingue mayúsculas de minúsculas.|  

#### <a name="-an-indefinite-number-of-unknown-characters"></a><a name="-an-indefinite-number-of-unknown-characters"></a>(*) Un número indefinido de caracteres desconocidos (quizás ninguno)
...
#### <a name="-one-unknown-character"></a><a name="-one-unknown-character"></a>(?) Un carácter desconocido

|Ejemplo|Registros mostrados|  
|-----------------------|-----------------------|  
|`Hans?n`|Texto como **Mendoza** o **Mendosa**|  

#### <a name="combined-format-expressions"></a><a name="combined-format-expressions"></a>Expresiones de formato combinadas
...
### <a name="filtering-on-values-that-contain-symbols"></a><a name="filtering-on-values-that-contain-symbols"></a><a name="symbols"></a>Filtrado por valores que contienen símbolos
...
### <a name="a-namefiltertokens-afilter-tokens"></a><a name="a-namefiltertokens-afilter-tokens"></a><a name="FilterTokens"> </a>Tokens de filtro
...
#### <a name="me-or-userid-records-assigned-to-you"></a><a name="me-or-userid-records-assigned-to-you"></a>(%me o %userid) Registros que se le han asignado
...
#### <a name="mycustomers-customers-in-my-customers"></a><a name="mycustomers-customers-in-my-customers"></a>(%mycustomers) Clientes en Mis clientes
...
#### <a name="myitems-items-in-my-items"></a><a name="myitems-items-in-my-items"></a>(%myitems) Artículos en Mis artículos
...
#### <a name="myvendors-vendors-in-my-vendors"></a><a name="myvendors-vendors-in-my-vendors"></a>(%myvendors) Proveedores en Mis proveedores
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Consultar la [formación de Microsoft](/training/modules/search-filter-sort-data-dynamics-365-business-central/) relacionada
