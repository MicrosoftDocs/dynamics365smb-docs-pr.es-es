...
### <a name="a-namefiltercriteria-afilter-criteria-and-operators"></a><a name="FilterCriteria"> </a>Criterios y operadores de filtro
...
|`Bicycle..Car`| Cadenas de bicicleta a automóvil cuando se ordenan lexiográficamente|  
...
> [!NOTE]  
> Si el campo por el que filtra es de tipo Texto, se utiliza el orden lexiográfico para determinar qué se incluye en el intervalo. Para los campos que se utilizan para almacenar números enteros, esto puede llevar al resultado (inesperado) de que un filtro en 10000..10042 también incluya los valores 100000 y 1000042.
...
### <a name="a-namefiltertokens-afilter-tokens"></a><a name="FilterTokens"> </a>Tokens de filtro
...
#### <a name="me-or-user-records-assigned-to-you"></a>(%me o %user) Registros que se le han asignado

Utilice `%me` o `%user` cuando filtre campos que contengan el ID de usuario, como el campo **Asignado a ID de usuario**, para mostrar todos los registros que se le asignaron.

|Ejemplo|Registros mostrados|  
|-----------------------|-----------------------|  
|`%me`<br />o<br />`%user`|Registros que se han asignado a su cuenta. |  
