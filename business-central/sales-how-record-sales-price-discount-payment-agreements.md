...
# <a name="record-special-sales-prices-and-discounts" />Registrar precios y descuentos de ventas especiales
...
## <a name="to-set-up-a-sales-price-for-a-customer" />Para configurar un precio de venta para un cliente
...
## <a name="using-sales-and-purchase-price-lists" />Uso de listas de precios de compra y venta
...
### <a name="converting-existing-prices-when-you-turn-on-the-pricing-feature-update" />Conversión de precios ya existentes al activar la actualización de la función de precios
...
### <a name="editing-active-price-lists" />Editar listas de precios activas
...
#### <a name="create-sales-price-lines-based-on-the-unit-price" />Crear líneas de precios de venta basadas en el precio unitario
...
#### <a name="create-sales-price-lines-based-on-existing-price-lists" />Crear líneas de precios de venta basadas en listas de precios ya existentes
...
## <a name="to-copy-sales-prices" />Para copiar precios de venta
...
## <a name="to-bulk-update-item-prices" />Para actualizar de forma masiva los precios de los artículos
...
## <a name="best-price-calculation" />Cálculo del mejor precio
...
## <a name="sales-invoice-discounts-and-service-charges" />Descuentos y cargos por servicios de la factura de venta
...
## <a name="to-set-up-a-sales-line-discount-for-a-customer" />Para configurar un descuento de línea de venta para un cliente
...
## <a name="to-set-up-an-invoice-discount-for-a-customer" />Para configurar un descuento en factura para un cliente
...
## <a name="see-related-microsoft-trainingtrainingmodulesmanage-sales-prices-dynamics-365-business-centralindex" />Consultar la [formación de Microsoft](/training/modules/manage-sales-prices-dynamics-365-business-central/index) relacionada
