...
# <a name="record-special-sales-prices-and-discounts"></a><a name="record-special-sales-prices-and-discounts"></a>Registrar precios y descuentos de ventas especiales
...
## <a name="to-set-up-a-sales-price-for-a-customer"></a><a name="to-set-up-a-sales-price-for-a-customer"></a>Para configurar un precio de venta para un cliente
...
## <a name="using-sales-and-purchase-price-lists"></a><a name="using-sales-and-purchase-price-lists"></a>Uso de listas de precios de compra y venta
...
### <a name="converting-existing-prices-when-you-turn-on-the-pricing-feature-update"></a><a name="converting-existing-prices-when-you-turn-on-the-pricing-feature-update"></a>Conversión de precios ya existentes al activar la actualización de la función de precios
...
### <a name="editing-active-price-lists"></a><a name="editing-active-price-lists"></a>Editar listas de precios activas
...
#### <a name="create-sales-price-lines-based-on-the-unit-price"></a><a name="create-sales-price-lines-based-on-the-unit-price"></a>Crear líneas de precios de venta basadas en el precio unitario
...
#### <a name="create-sales-price-lines-based-on-existing-price-lists"></a><a name="create-sales-price-lines-based-on-existing-price-lists"></a>Crear líneas de precios de venta basadas en listas de precios ya existentes
...
## <a name="to-copy-sales-prices"></a><a name="to-copy-sales-prices"></a>Para copiar precios de venta
...
## <a name="to-bulk-update-item-prices"></a><a name="to-bulk-update-item-prices"></a>Para actualizar de forma masiva los precios de los artículos
...
## <a name="best-price-calculation"></a><a name="best-price-calculation"></a>Cálculo del mejor precio
...
## <a name="sales-invoice-discounts-and-service-charges"></a><a name="sales-invoice-discounts-and-service-charges"></a>Descuentos y cargos por servicios de la factura de venta
...
### <a name="calculating-invoice-discounts-on-sales"></a><a name="calculating-invoice-discounts-on-sales"></a>Calcular descuentos en factura para ventas

[!INCLUDE [sales-invoice-discounts](includes/sales-invoice-discounts.md)]

## <a name="to-set-up-a-sales-line-discount-for-a-customer"></a><a name="to-set-up-a-sales-line-discount-for-a-customer"></a>Para configurar un descuento de línea de venta para un cliente
...
## <a name="to-set-up-an-invoice-discount-for-a-customer"></a><a name="to-set-up-an-invoice-discount-for-a-customer"></a>Para configurar un descuento en factura para un cliente
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Consultar la [formación de Microsoft](/training/modules/manage-sales-prices-dynamics-365-business-central/index) relacionada
