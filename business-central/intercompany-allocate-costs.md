...
ms.author: bholtorf
---
# <a name="allocate-costs-to-intercompany-partners" />Asignar costos a socios entre empresas
...
## <a name="to-allocate-costs-using-an-intercompany-general-journal" />Asignar costos mediante un diario general de empresas vinculadas
...
## <a name="to-allocate-costs-using-a-purchase-document" />Para imputar costos mediante un documento de compra
...
## <a name="to-send-the-allocated-costs-to-intercompany-partners" />Para enviar los costos asignados a socios de empresas vinculadas
...
## <a name="calculating-vat-for-cost-distributions" />Cálculo del IVA para distribuciones de costos
