...
## <a name="flushing-production-components-in-a-advanced-warehouse-configuration"></a>Baja de componentes de producción en una configuración de almacén avanzada
