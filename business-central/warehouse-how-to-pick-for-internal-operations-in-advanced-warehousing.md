...
ms.author: bholtorf
---
# <a name="pick-for-production-assembly-or-jobs-in-advanced-warehouse-configurations" />Realizar picking para producción, ensamblado o proyectos en una configuración avanzada de almacén
...
## <a name="to-create-pick-documents-in-bulk-with-the-pick-worksheet" />Para crear documentos de picking de forma masiva con la hoja de trabajo de picking
...
## <a name="to-pick-items-for-a-productions-order-assembly-order-job" />Para seleccionar pedidos para un pedido de producción, pedido de ensamblado y trabajo
...
## <a name="flushing-production-components-in-a-advanced-warehouse-configuration" />Baja de componentes de producción en una configuración de almacén avanzada
