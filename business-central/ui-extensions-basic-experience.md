...
# <a name="the-basic-experience-extension"></a><a name="the-basic-experience-extension"></a>Extensión de la experiencia básica
...
## <a name="whats-available"></a><a name="whats-available"></a>Lo que hay disponible
...
## <a name="migrating-data"></a><a name="migrating-data"></a>Migración de datos
