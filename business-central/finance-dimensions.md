...
description: Puede utilizar dimensiones para clasificar movimientos, como por departamentos o proyecto, por lo que le será más fácil realizar un seguimiento de los datos y analizarlos para ayudarle a tomar buenas decisiones empresariales.
author: edupont04
ms.topic: conceptual
ms.devlang: na
ms.tgt_pltfrm: na
...
## <a name="see-related-microsoft-training"></a>Consultar la [formación de Microsoft](/training/modules/dimensions-dynamics-365-business-central/index) relacionada
