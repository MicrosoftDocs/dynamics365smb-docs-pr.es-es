...
---
# <a name="work-with-general-journals"></a><a name="work-with-general-journals"></a><a name="work-with-general-journals"></a>Trabajar con diarios generales
...
## <a name="use-journal-templates-and-batches"></a><a name="use-journal-templates-and-batches"></a><a name="use-journal-templates-and-batches"></a>Usar plantillas y secciones del diario
...
### <a name="validating-general-journal-batches"></a><a name="validating-general-journal-batches"></a><a name="validating-general-journal-batches"></a>Validación de lotes de diario general
...
## <a name="understanding-main-accounts-and-balancing-accounts"></a><a name="understanding-main-accounts-and-balancing-accounts"></a><a name="understanding-main-accounts-and-balancing-accounts"></a>Descripción de las cuentas principales y las cuentas de contrapartida
...
## <a name="work-with-recurring-journals"></a><a name="work-with-recurring-journals"></a><a name="work-with-recurring-journals"></a>Trabajar con diarios periódicos
...
### <a name="recurring-method-field"></a><a name="recurring-method-field"></a><a name="recurring-method-field"></a>Campo Periodicidad
...
### <a name="recurring-frequency-field"></a><a name="recurring-frequency-field"></a><a name="recurring-frequency-field"></a>Campo Frecuencia repetición
...
### <a name="expiration-date-field"></a><a name="expiration-date-field"></a><a name="expiration-date-field"></a>Campo fecha caducidad
...
### <a name="allocating-recurring-journal-amounts-to-several-accounts"></a><a name="allocating-recurring-journal-amounts-to-several-accounts"></a><a name="allocating-recurring-journal-amounts-to-several-accounts"></a>Asignación de importes de diario periódicos a varias cuentas
...
#### <a name="example-allocating-rent-payments-to-different-departments"></a><a name="example-allocating-rent-payments-to-different-departments"></a><a name="example-allocating-rent-payments-to-different-departments"></a>Ejemplo: Asignación de pagos de alquiler a diferentes departamentos
...
### <a name="calculate-the-reversal-date"></a><a name="calculate-the-reversal-date"></a><a name="calculate-the-reversal-date"></a>Cálculo de la fecha de reversión
...
## <a name="work-with-standard-journals"></a><a name="work-with-standard-journals"></a><a name="work-with-standard-journals"></a>Trabajar con diarios estándar
...
### <a name="to-save-a-standard-journal"></a><a name="to-save-a-standard-journal"></a><a name="to-save-a-standard-journal"></a>Para guardar un diario estándar
...
### <a name="to-reuse-a-standard-journal"></a><a name="to-reuse-a-standard-journal"></a><a name="to-reuse-a-standard-journal"></a>Para reutilizar un diario estándar
...
## <a name="to-renumber-document-numbers-in-journals"></a><a name="to-renumber-document-numbers-in-journals"></a><a name="to-renumber-document-numbers-in-journals"></a>Para renumerar números de documento en diarios
...
### <a name="to-renumber-documents-in-journals"></a><a name="to-renumber-documents-in-journals"></a><a name="to-renumber-documents-in-journals"></a>Para renumerar los documentos en diarios
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Consultar la [formación de Microsoft](/training/paths/use-journals-dynamics-365-business-central/) relacionada
