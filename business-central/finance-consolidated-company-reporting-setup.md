...
Si su consolidación es directa, por ejemplo porque es propietario de la totalidad de las empresas a consolidar, la guía **Consolidación de la empresa** le ayuda con los pasos siguientes:
...
### <a name="busunit"></a>Agregar empresas
...
4. En la ficha desplegable **Importar de datos** en el campo **Importación de datos predeterminada**, especifique cómo compartirá los asientos del libro mayor con la empresa consolidada:
   ...
   * Para compartir datos entre empresas en diferentes entornos, elija **API** y luego complete el campo **Punto final de API**.
        ...
        Para obtener la URL del punto final, en la empresa de la unidad de negocio [!INCLUDE [prod_short](includes/prod_short.md)], abra la **Página de configuración de consolidación** y verifique el valor del campo Punto final API del entorno actual. 
   * Para exportar un archivo .xml y compartirlo manualmente, elija **Formato de archivo**.

### <a name="glacc"></a>Preparar los libros de contabilidad para la consolidación
...
### <a name="exclude"></a>Excluir una empresa de la consolidación
...
### <a name="include"></a>Incluir una empresa poseída parcialmente en la consolidación
