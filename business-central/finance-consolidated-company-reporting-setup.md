...
# <a name="set-up-company-consolidation"></a><a name="set-up-company-consolidation"></a><a name="set-up-company-consolidation"></a><a name="set-up-company-consolidation"></a>Configuración de la consolidación de empresas
...
## <a name="simple-consolidation-setup"></a><a name="simple-consolidation-setup"></a><a name="simple-consolidation-setup"></a><a name="simple-consolidation-setup"></a>Configuración de consolidación sencilla
...
## <a name="advanced-consolidation-setup"></a><a name="advanced-consolidation-setup"></a><a name="advanced-consolidation-setup"></a><a name="advanced-consolidation-setup"></a>Configuración de consolidación avanzada
...
### <a name="set-up-the-consolidated-company"></a><a name="set-up-the-consolidated-company"></a><a name="set-up-the-consolidated-company"></a><a name="set-up-the-consolidated-company"></a>Configurar la empresa consolidada
...
### <a name="add-business-units"></a><a name="add-business-units"></a><a name="add-business-units"></a><a name="add-business-units"></a><a name="busunit"></a>Agregar empresas
...
### <a name="prepare-general-ledger-accounts-for-consolidation"></a><a name="prepare-general-ledger-accounts-for-consolidation"></a><a name="prepare-general-ledger-accounts-for-consolidation"></a><a name="prepare-general-ledger-accounts-for-consolidation"></a><a name="glacc"></a>Preparar los libros de contabilidad para la consolidación
...
### <a name="specify-exchange-rates-for-consolidations"></a><a name="specify-exchange-rates-for-consolidations"></a><a name="specify-exchange-rates-for-consolidations"></a><a name="specify-exchange-rates-for-consolidations"></a><a name="exchrates"></a>Especificar los tipos de cambio para consolidaciones
...
### <a name="include-or-exclude-dimensions"></a><a name="include-or-exclude-dimensions"></a><a name="include-or-exclude-dimensions"></a><a name="include-or-exclude-dimensions"></a><a name="dim"></a>Incluir o excluir dimensiones
...
### <a name="exclude-a-company-from-consolidation"></a><a name="exclude-a-company-from-consolidation"></a><a name="exclude-a-company-from-consolidation"></a><a name="exclude-a-company-from-consolidation"></a><a name="exclude"></a>Excluir una empresa de la consolidación
...
### <a name="include-a-partially-owned-company-in-consolidation"></a><a name="include-a-partially-owned-company-in-consolidation"></a><a name="include-a-partially-owned-company-in-consolidation"></a><a name="include-a-partially-owned-company-in-consolidation"></a><a name="include"></a>Incluir una empresa poseída parcialmente en la consolidación
