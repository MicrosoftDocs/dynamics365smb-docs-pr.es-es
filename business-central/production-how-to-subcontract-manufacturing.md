...
ms.author: edupont
---
# <a name="subcontract-manufacturing" />Subcontratación de fabricación
...
## <a name="subcontract-work-centers" />Subcontratar centros de trabajo
...
### <a name="subcontract-work-center-fields" />Subcontratar campos de centros de trabajo
...
### <a name="routings-that-use-subcontract-work-centers" />Rutas que usan centros de trabajo subcontratados
...
## <a name="calculate-subcontracting-worksheets-and-create-subcontract-purchase-orders" />Calcular las hojas de cálculo de la subcontratación y cree los pedidos de compra de subcontratación
...
### <a name="to-calculate-the-subcontracting-worksheet" />Para calcular la hoja de subcontratación
...
### <a name="to-create-the-subcontract-purchase-order" />Para generar el pedido de compra subcontratado
1.  Elija el icono ![Bombilla que abre la función Dígame.](media/ui-search/search_small.png "Dígame qué desea hacer") , escriba **Hoja subcontratación** y, a continuación, elija el vínculo relacionado.  
...
## <a name="posting-subcontract-purchase-orders" />Registrar pedidos de compra de subcontratación
...
## <a name="to-post-a-subcontract-purchase-order" />Para registrar un pedido de compra de subcontratación
