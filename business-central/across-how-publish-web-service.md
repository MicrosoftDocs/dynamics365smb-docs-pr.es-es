...
ms.author: edupont
---
# <a name="publish-a-web-service"></a><a name="publish-a-web-service"></a>Publicar un servicio web
...
## <a name="creating-and-publishing-a-web-service"></a><a name="creating-and-publishing-a-web-service"></a>Crear y publicar un servicio web

Los pasos siguientes explican cómo crear y publicar un servicio web.  

### <a name="to-create-and-publish-a-web-service"></a><a name="to-create-and-publish-a-web-service"></a>Para crear y publicar un servicio web
...
### <a name="to-verify-the-availability-of-a-web-service"></a><a name="to-verify-the-availability-of-a-web-service"></a>Para verificar la disponibilidad de un servicio web
