...
ms.author: edupont
---
# <a name="merge-duplicate-records"></a><a name="merge-duplicate-records"></a><a name="merge-duplicate-records"></a><a name="merge-duplicate-records"></a>Combinar registros duplicados
