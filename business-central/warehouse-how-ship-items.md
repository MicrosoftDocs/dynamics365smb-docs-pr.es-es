...
# <a name="ship-items-with-a-warehouse-shipment" />Enviar productos con envío de almacén
...
## <a name="to-ship-items-using-a-warehouse-shipment-document" />Para enviar productos con un documento de envío de almacén
...
## <a name="how-to-use-filters-to-get-source-documents" />Cómo utilizar filtros para obtener documentos de origen
...
## <a name="zone-and-bin-codes" />Códigos de zona y ubicación
...
## <a name="handling-assemble-to-order-items-in-warehouse-shipments" />Tratamiento de productos ensamblar para pedido en los envíos de almacén
...
## <a name="see-related-microsoft-training" />Consultar la [formación de Microsoft](/training/modules/ship-invoice-items-dynamics-365-business-central/) relacionada.
