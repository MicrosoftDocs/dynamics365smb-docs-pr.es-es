---
title: Conciliar los pagos de los clientes con el diario de recibos de efectivo o con las entradas del libro mayor de clientes
description: Aplicar recibos de efectivo o reembolsos de clientes a una o más entradas abiertas del libro mayor de clientes.
author: brentholtorf
ms.author: bholtorf
...
---
# <a name="reconcile-customer-payments-with-a-cash-receipt-journal-or-from-customer-ledger-entries"></a>Conciliar los pagos de los clientes con un diario de recibos de efectivo o con las entradas del libro mayor de clientes
...
* Introduzca información en las siguientes páginas:
   * La página  **Diarios de conciliación de pagos** . Para obtener más información, vea [Liquidación de pagos automáticamente y conciliación de cuentas bancarias](receivables-apply-payments-auto-reconcile-bank-accounts.md).
   * La página de  **Configuración del registro de pago** . Para obtener más información, consulte [Conciliar pagos de cliente desde una lista de documentos de ventas sin abonar](receivables-how-reconcile-customer-payments-list-unpaid-sales-documents.md).
   * La página  **Diarios de recibos de caja** . Para obtener más información, consulte  [Cómo llenar y registrar un diario de recibos de efectivo](#to-fill-and-post-a-cash-receipt-journal).
* Rellenando el campo **Liq. por nº documento** en documentos de abono de venta. Para obtener más información, consulte  [Para aplicar una nota de crédito a una sola entrada del libro mayor de clientes](#to-apply-a-credit-memo-to-a-single-customer-ledger-entry).
* Mediante la acción **Marcar id. de liquidación** en un movimiento de cliente. Para obtener más información, consulte  [Para aplicar un pago a una sola entrada de libro mayor de cliente](#to-apply-a-payment-to-a-single-customer-ledger-entry).
...
1. Elija el icono ![Bombilla que abre la característica Dígame](media/ui-search/search_small.png "Dígame qué desea hacer"), , escriba **Diarios de recibos de efectivo**, y luego elija el enlace relacionado.
...
6. Utilice el campo **Nº documento externo** para almacenar un identificador como el número de comprobación del cliente.
   ...
   > [!NOTE]
   > De forma predeterminada, el campo Número de documento externo está oculto. Si es así y quieres usarlo, puedes usar la personalización para agregarlo. Para obtener más información, consulte [Personalizar el área de trabajo](ui-personalization-user.md).
...
1. Elija el icono ![Bombilla que abre la característica Dígame](media/ui-search/search_small.png "Dígame qué desea hacer") Icono, ingrese  **Diario de recibos de caja** y seleccione el vincular relacionado.
2. Seleccione la acción **Editar diario**.
