...
ms.author: edupont
---
# <a name="reconcile-customer-payments-with-the-cash-receipt-journal-or-from-customer-ledger-entries" />Concilie los pagos de clientes con el diario de recibos de efectivo o de los movimientos de cliente.
...
## <a name="to-fill-and-post-a-cash-receipt-journal" />Para rellenar y registrar un diario de recibos de efectivo
...
## <a name="to-apply-a-payment-to-a-single-customer-ledger-entry" />Para liquidar un pago a un solo movimiento de cliente
...
## <a name="to-apply-a-payment-to-multiple-customer-ledger-entries" />Para liquidar un pago a varios movimientos de cliente
...
## <a name="to-apply-a-credit-memo-to-a-single-customer-ledger-entry" />Para liquidar un abono a un único movimiento de cliente
...
## <a name="to-apply-a-credit-memo-to-multiple-customer-ledger-entries" />Para liquidar un abono a varios movimientos de cliente
1. Elija el icono ![Bombilla que abre la función Dígame.](media/ui-search/search_small.png "Dígame qué desea hacer") , escriba **Abonos de venta** y, a continuación, elija el vínculo relacionado.
2. Abra el abono de venta correspondiente.
...
## <a name="to-apply-posted-customer-ledger-entries" />Para liquidar movimientos de clientes registrados
...
## <a name="to-apply-customer-ledger-entries-in-different-currencies-to-one-another" />Para liquidar movimientos de cliente en divisas diferentes
...
## <a name="to-correct-an-application-of-customer-entries" />Para corregir una liquidación de movimientos de clientes
