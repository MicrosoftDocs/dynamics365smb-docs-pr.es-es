...
# <a name="define-an-invoice-posting-policy-for-users"></a><a name="define-an-invoice-posting-policy-for-users"></a><a name="define-an-invoice-posting-policy-for-users"></a>Definir una directiva de registro de facturas para usuarios
...
## <a name="to-specify-a-posting-policy"></a><a name="to-specify-a-posting-policy"></a><a name="to-specify-a-posting-policy"></a>Para especificar una directiva de registro
...
## <a name="effect-on-documents"></a><a name="effect-on-documents"></a><a name="effect-on-documents"></a>Efecto en documentos
