...
* **Obligatorio**: permite al usuario registrar facturas junto con recibos o envíos. [!INCLUDE [prod_short](includes/prod_short.md)] muestra un diálogo de confirmación con las opciones **Enviar y facturar** o **Recibir y facturar**.
...
|Nota de abono de venta|Sin opciones|La publicación está prohibida según la configuración del usuario|¿Confirma que desea registrar la nota de abono?|
...
|Nota abono de compra|Sin opciones|La publicación está prohibida según la configuración del usuario|¿Confirma que desea registrar la nota de abono?|
