...
# <a name="define-an-invoice-posting-policy-for-users" />Definir una directiva de registro de facturas para usuarios
...
## <a name="to-specify-a-posting-policy" />Para especificar una directiva de registro
...
## <a name="effect-on-documents" />Efecto en documentos
