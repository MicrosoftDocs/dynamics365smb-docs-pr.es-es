...
ms.author: edupont
---
# <a name="plan-for-new-demand-order-by-order"></a><a name="plan-for-new-demand-order-by-order"></a><a name="plan-for-new-demand-order-by-order"></a><a name="plan-for-new-demand-order-by-order"></a>Planear la nueva demanda de pedido por pedido
...
## <a name="to-plan-for-new-production-order-demand"></a><a name="to-plan-for-new-production-order-demand"></a><a name="to-plan-for-new-production-order-demand"></a><a name="to-plan-for-new-production-order-demand"></a>Para planificar una nueva demanda de orden de producción
...
## <a name="to-plan-for-any-new-demand"></a><a name="to-plan-for-any-new-demand"></a><a name="to-plan-for-any-new-demand"></a><a name="to-plan-for-any-new-demand"></a>Para planificar nueva demanda
...
## <a name="to-make-supply-orders"></a><a name="to-make-supply-orders"></a><a name="to-make-supply-orders"></a><a name="to-make-supply-orders"></a>Para crear pedidos de suministro
