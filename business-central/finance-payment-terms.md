...
Los términos de pago determinan cómo administra las fechas de vencimiento y los descuentos de pago. Puede utilizar fórmulas de fecha para definir las condiciones de pago. Cuando se registra por primera vez para [!INCLUDE [prod_short](includes/prod_short.md)], la empresa de demostración ofrece algunos métodos de pago que las empresas suelen utilizar. Sin embargo, puede agregar tantas como necesite.  
...
> [!TIP]
> En la versión base de [!INCLUDE [prod_short](includes/prod_short.md)], las condiciones de pago no admiten pagos parciales. En su lugar, debe utilizar la función de prepagos. Para obtener más información sobre los prepagos, vaya a [Configurar prepagos](finance-set-up-prepayments.md).
>
