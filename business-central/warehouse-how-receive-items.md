...
---
# <a name="receive-items-with-warehouse-receipts" />Recibir productos con recepción de almacén
...
## <a name="receive-items-with-a-warehouse-receipt" />Recibir productos con recibo de almacén
