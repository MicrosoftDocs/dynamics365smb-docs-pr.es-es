...
2. Elija el botón de búsqueda en el campo **Código de recepción en exceso**.
3. Seleccione la acción **Nuevo**.
4. En la página **Códigos de recepción en exceso**, cree una o más líneas nuevas que definan diferentes políticas de recepción en exceso. [!INCLUDE[tooltip-inline-tip](includes/tooltip-inline-tip_md.md)].
5. Seleccione una línea y luego seleccione el botón **Aceptar**.
...
> [!NOTE]
> Puede configurar un flujo de trabajo de aprobación para requerir que se aprueben las recepciones en exceso antes de que se puedan administrar. En ese caso, debe seleccionar la casilla **Aprobación requerida** en la página **Códigos de recepción en exceso**. Para este fin, existe una respuesta de flujo de trabajo dedicada, **Aprobar recepción en exceso**, en los datos de flujo de trabajo estándar. Para obtener más información, consulte [Crear flujos de trabajo](across-how-to-create-workflows.md).
