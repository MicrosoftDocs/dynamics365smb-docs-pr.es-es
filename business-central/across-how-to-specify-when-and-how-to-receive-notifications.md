...
ms.author: bholtorf
---
# <a name="specify-when-and-how-to-receive-workflow-notifications"></a><a name="specify-when-and-how-to-receive-workflow-notifications"></a>Especificar cómo y cuándo recibir notificaciones de flujos de trabajo
...
## <a name="steps-in-workflows"></a><a name="steps-in-workflows"></a>Pasos de flujos de trabajo
...
## <a name="specify-when-and-how-approval-users-receive-notifications"></a><a name="specify-when-and-how-approval-users-receive-notifications"></a>Especificar cómo y cuándo los usuarios de aprobaciones reciben notificaciones
...
## <a name="change-when-and-how-you-receive-notifications"></a><a name="change-when-and-how-you-receive-notifications"></a>Cambiar cómo y cuándo recibe notificaciones
