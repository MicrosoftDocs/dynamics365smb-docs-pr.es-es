...
# <a name="the-sales-and-inventory-forecast-extension"></a><a name="the-sales-and-inventory-forecast-extension"></a>Extensión de previsión de ventas e inventario
...
## <a name="setting-up-forecasting"></a><a name="setting-up-forecasting"></a>Configurar la previsión
...
## <a name="use-the-forecasts"></a><a name="use-the-forecasts"></a>Usar las previsiones
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Consultar la [formación de Microsoft](/training/modules/use-sales-inventory-forecast-extension/) relacionada
