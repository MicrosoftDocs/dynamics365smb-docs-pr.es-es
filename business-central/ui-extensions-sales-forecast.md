...
# <a name="the-sales-and-inventory-forecast-extension" />Extensión de previsión de ventas e inventario
...
## <a name="setting-up-forecasting" />Configurar la previsión
...
## <a name="use-the-forecasts" />Usar las previsiones
...
## <a name="a-nameanchortext-acreate-and-use-your-own-predictive-web-service-for-sales-and-inventory-forecasts" /><a name="AnchorText"> </a>Crear y usar su propio servicio web predictivo para ventas y previsiones de inventario
