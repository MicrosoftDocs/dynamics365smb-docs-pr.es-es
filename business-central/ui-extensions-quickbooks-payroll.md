...
ms.author: bholtorf
---
# <a name="the-quickbooks-payroll-file-import-extension"></a><a name="the-quickbooks-payroll-file-import-extension"></a>Extensión de importación del archivo de nóminas de QuickBooks
...
## <a name="steps-to-import-payroll-data"></a><a name="steps-to-import-payroll-data"></a>Pasos para importar datos de nómina
