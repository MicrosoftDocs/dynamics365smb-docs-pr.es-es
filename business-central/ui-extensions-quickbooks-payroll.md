...
ms.author: bholtorf
---
# <a name="the-quickbooks-payroll-file-import-extension" />Extensión de importación del archivo de nóminas de QuickBooks
...
## <a name="steps-to-import-payroll-data" />Pasos para importar datos de nómina
