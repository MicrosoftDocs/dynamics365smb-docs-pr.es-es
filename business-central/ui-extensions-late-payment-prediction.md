...
3. En la pestaña rápida **Usar mi suscripción de Azure**, ingrese la URL de API y la clave de API para su modelo.  

## <a name="see-also"></a>Consulte también

[Personalización de Business Central mediante extensiones](ui-extensions.md)    
[Bienvenido a [!INCLUDE[prod_long](includes/prod_long.md)]](welcome.md)    
[Utilizar la Inteligencia Artificial en Microsoft Dynamics 365 Business Central](/training/paths/use-artificial-intelligence/)    
