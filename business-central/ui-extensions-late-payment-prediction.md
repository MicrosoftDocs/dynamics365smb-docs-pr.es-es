...
ms.author: bholtorf
---
# <a name="the-late-payment-prediction-extension"></a><a name="the-late-payment-prediction-extension"></a>Extensión de Predicción de pagos atrasados
...
## <a name="viewing-all-payment-predictions"></a><a name="viewing-all-payment-predictions"></a>Ver todas las predicciones de pago
...
## <a name="viewing-a-payment-prediction-for-a-specific-sales-document"></a><a name="viewing-a-payment-prediction-for-a-specific-sales-document"></a>Visualización de una predicción de pago para un documento de ventas específico
...
## <a name="design-details"></a><a name="design-details"></a>Detalles de diseño
...
### <a name="data-required-to-train-and-evaluate-the-model"></a><a name="data-required-to-train-and-evaluate-the-model"></a>Datos requeridos para entrenar y evaluar el modelo
...
### <a name="standard-model-and-my-model"></a><a name="standard-model-and-my-model"></a>Modelo estándar y mi modelo
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Consultar la [formación de Microsoft](/training/modules/predict-late-payments-sales-documents/) relacionada
