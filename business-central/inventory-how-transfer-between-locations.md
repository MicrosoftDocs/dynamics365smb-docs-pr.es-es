...
---
# <a name="transfer-inventory-between-locations" />Transferir el inventario entre almacenes
...
## <a name="transfer-orders" />Pedidos de transferencia
...
## <a name="item-reclassification-journals" />Diarios de reclasificación de productos
...
## <a name="to-transfer-items-with-a-transfer-order" />Para transferir productos con un pedido de transferencia
...
### <a name="post-multiple-transfer-orders-in-a-batch" />Contabilizar varios pedidos de transferencia en un lote
...
### <a name="schedule-a-job-queue-entry-to-post-multiple-documents-in-a-batch" />Programar una entrada de la cola de trabajos para contabilizar varios documentos en un lote
...
## <a name="to-transfer-items-with-the-item-reclassification-journal" />Para transferir productos con el diario de reclasificación de productos
...
## <a name="undo-a-transfer-shipment" />Deahacer un envío de transferencia
