...
ms.author: edupont
---
# <a name="quote-an-assemble-to-order-sale" />Oferta de una venta de ensamblar para pedido
...
## <a name="to-create-a-sales-quote-for-an-assemble-to-order-item" />Para crear una oferta de venta de productos ensamblar para pedido
