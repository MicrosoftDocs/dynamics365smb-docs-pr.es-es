...
---
# <a name="unsubscribe-or-remove-"></a><a name="unsubscribe-or-remove-"></a><a name="unsubscribe-or-remove-"></a><a name="unsubscribe-or-remove-"></a><a name="unsubscribe-or-remove-prod_short"></a>Cancelar la suscripción o quitar [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="removing--from-your-app-launcher"></a><a name="removing--from-your-app-launcher"></a><a name="removing--from-your-app-launcher"></a><a name="removing--from-your-app-launcher"></a><a name="removing-prod_short-from-your-app-launcher"></a>Eliminar [!INCLUDE[prod_short](includes/prod_short.md)] de su lanzador de aplicaciones
