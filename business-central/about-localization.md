...
ms.author: bholtorf
---
# <a name="what-is-local-functionality-in-"></a>Funcionalidad local en [!INCLUDE[prod_long](includes/prod_long.md)]
...
### <a name="other-countriesregions"></a>Otros países y regiones
