...
ms.author: edupont
---
# <a name="local-functionality-in-"></a><a name="local-functionality-in-"></a>Funcionalidad local en [!INCLUDE[prod_long](includes/prod_long.md)]
...
## <a name="local-functionality"></a><a name="local-functionality"></a>Funcionalidad local
...
### <a name="other-countries"></a><a name="other-countries"></a>Otros países o regiones
