...
---
# <a name="set-up-customer-discount-groups" />Configurar los grupos de descuento de clientes
...
## <a name="create-sales-line-discounts-for-a-customer-group" />Crear descuentos en la línea de ventas para un grupo de clientes
...
## <a name="assign-a-customer-to-a-discount-group" />Asignar un cliente a un grupo de descuento
