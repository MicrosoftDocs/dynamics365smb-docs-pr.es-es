...
# <a name="integrating-with-microsoft-dataverse"></a><a name="integrating-with-microsoft-dataverse"></a><a name="integrating-with-microsoft-dataverse"></a>Integración con Microsoft Dataverse
...
## <a name="getting-started-with-"></a><a name="getting-started-with-"></a><a name="getting-started-with-"></a>Introducción a [!INCLUDE[prod_short](includes/cds_long_md.md)]
...
## <a name="bi-directional-or-uni-directional-data-synchronization"></a><a name="bi-directional-or-uni-directional-data-synchronization"></a><a name="bi-directional-or-uni-directional-data-synchronization"></a>Sincronización de datos bidireccional o unidireccional
...
## <a name="standard-and-custom-entities"></a><a name="standard-and-custom-entities"></a><a name="standard-and-custom-entities"></a>Entidades estándar y personalizadas
...
## <a name="about-the-business-central-base-integration-solution"></a><a name="about-the-business-central-base-integration-solution"></a><a name="about-the-business-central-base-integration-solution"></a>Acerca de la solución de integración base de Business Central
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Consultar la [formación de Microsoft](/training/modules/use-model-driven-apps-common-data-service/) relacionada
