...
ms.author: bholtorf
---
# <a name="walkthrough-tracing-seriallot-numbers" />Tutorial: seguimiento de números de serie/lote
...
### <a name="to-create-the-items" />Para crear los productos
...
### <a name="to-purchase-components" />Para comprar componentes
...
### <a name="to-produce-end-items" />Para producir los productos finales
...
### <a name="to-sell-the-end-items" />Para vender los productos finales
...
## <a name="tracing-from-usage-to-origin" />Seguimiento desde el uso hasta el origen
...
### <a name="to-determine-which-lot-included-the-faulty-frame-and-who-supplied-it" />Para determinar qué lote incluía el cuadro defectuoso y quién lo suministró
...
## <a name="tracing-from-origin-to-usage" />Seguimiento desde el origen hasta el uso
...
### <a name="to-find-all-usage-of-the-faulty-lot" />Para buscar todos los usos del lote defectuoso
...
## <a name="finding-all-records-of-a-seriallot-number" />Búsqueda de un número de serie/lote en todos los registros
