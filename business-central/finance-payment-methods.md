...
ms.author: bholtorf
---
# <a name="set-up-payment-methods"></a><a name="set-up-payment-methods"></a>Configure formas de pago
...
## <a name="to-set-up-a-payment-method"></a><a name="to-set-up-a-payment-method"></a>Para configurar una forma de pago
...
## <a name="to-assign-a-payment-method-to-a-customer-or-vendor"></a><a name="to-assign-a-payment-method-to-a-customer-or-vendor"></a>Para asignar una forma de pago a un cliente o proveedor
