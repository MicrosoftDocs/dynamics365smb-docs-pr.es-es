...
Sin embargo, los abonos para devoluciones son excepciones porque el dinero fluye en direcciones opuestas, de usted a su cliente y de su proveedor a usted. Por lo tanto, no se asigna una forma de pago predeterminada a los abonos. Sin embargo, existe una solución. Puede especificar condiciones de pago para el cliente o proveedor. Aunque el campo **Calc. dto. P.P. en abonos** no se ha diseñado para esta solución alternativa, si marca la casilla de la página **Condiciones de pago**, se añadirá una forma de pago predeterminada al crear un abono. <br><br>  
