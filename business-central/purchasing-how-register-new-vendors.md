...
ms.author: bholtorf
---
# <a name="register-new-vendors" />Permite registrar nuevos proveedores
...
## <a name="adding-new-vendors" />Agregar nuevos proveedores
...
### <a name="to-create-a-new-vendor" />Para crear un nuevo proveedor
...
### <a name="deleting-and-editing-vendor-information" />Eliminar y editar la información del proveedor
...
## <a name="to-save-the-vendor-card-as-a-template" />Para guardar la ficha de proveedor como una plantilla
