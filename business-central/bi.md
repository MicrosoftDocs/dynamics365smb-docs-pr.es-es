---
title: Análisis financiero en Business Central
...
# Análisis financiero en Business Central
...
Para obtener una descripción general de los informes disponibles, puede hacer clic en **Todos los informes** en el panel superior de su página de inicio. Esto le llevará al explorador de roles, que se filtra según las funciones en la opción **Informe y análisis**. Para obtener más información, vaya a [Búsqueda de informes con el explorador de roles](ui-role-explorer.md).
...
La página Plan de cuentas muestra todas las cuentas de contabilidad general con números agregados sobre lo que se publica en la contabilidad general. Desde esta página, puede hacer cosas como:  
