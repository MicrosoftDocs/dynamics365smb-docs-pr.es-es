...
ms.author: edupont
---
# <a name="set-up-fixed-asset-insurance" />Configure el seguro de los activos fijos
...
## <a name="to-set-up-general-insurance-information" />Para configurar la información general de seguros
...
## <a name="to-set-up-insurance-types" />Para configurar tipos de seguros
...
## <a name="to-set-up-insurance-cards" />Para configurar fichas de seguros
...
## <a name="to-set-up-insurance-journal-templates" />Para configurar libros diarios de seguros
...
## <a name="to-set-up-insurance-journal-batches" />Para configurar secciones del diario de seguros
