...
ms.author: edupont
---
# <a name="set-up-fixed-asset-insurance"></a><a name="set-up-fixed-asset-insurance"></a>Configure el seguro de los activos fijos
...
## <a name="to-set-up-general-insurance-information"></a><a name="to-set-up-general-insurance-information"></a>Para configurar la información general de seguros
...
## <a name="to-set-up-insurance-types"></a><a name="to-set-up-insurance-types"></a>Para configurar tipos de seguros
...
## <a name="to-set-up-insurance-cards"></a><a name="to-set-up-insurance-cards"></a>Para configurar fichas de seguros
...
## <a name="to-set-up-insurance-journal-templates"></a><a name="to-set-up-insurance-journal-templates"></a>Para configurar libros diarios de seguros
...
## <a name="to-set-up-insurance-journal-batches"></a><a name="to-set-up-insurance-journal-batches"></a>Para configurar secciones del diario de seguros
