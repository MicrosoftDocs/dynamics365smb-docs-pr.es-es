...
# <a name="scheduling-a-synchronization-between-business-central-and-dataverse" />Programación de una sincronización entre Business Central y Dataverse
...
## <a name="default-synchronization-job-queue-entries" />Entradas de cola de proyectos de sincronización predeterminados
...
## <a name="synchronization-process" />Proceso de sincronización
...
## <a name="about-inactivity-timeouts" />Acerca de los tiempos de espera de inactividad
...
## <a name="to-view-the-synchronization-job-log" />Para ver el registro de proyectos de sincronización
...
## <a name="to-view-the-synchronization-job-log-from-the-table-mappings" />Para ver el registro del proyecto de sincronización desde las asignaciones de tabla
...
## <a name="to-view-the-synchronization-error-log" />Para ver el registro de errores de sincronización
