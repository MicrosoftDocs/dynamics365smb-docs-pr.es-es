...
ms.author: edupont
---
# <a name="create-analysis-reports" />Crear informes de análisis
...
## <a name="setting-up-line-and-column-layouts" />Configuración de plantillas de líneas y columnas
...
## <a name="set-up-analysis-column-templates" />Configurar plantillas de columnas de análisis
...
## <a name="set-up-analysis-line-templates" />Configurar plantillas de líneas de análisis
...
## <a name="create-a-new-sales-analysis-report" />Crear un nuevo informe de análisis de ventas
