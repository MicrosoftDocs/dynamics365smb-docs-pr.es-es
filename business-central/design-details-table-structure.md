...
## <a name="transaction-and-budget-tables" />Tablas de transacción y de presupuesto
...
### <a name="tables-that-contain-the-dimension-set-id-field" />Tablas que contienen el campo Id. grupo dimensiones
