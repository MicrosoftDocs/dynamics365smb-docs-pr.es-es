...
ms.author: edupont
---
# <a name="design-details-reservation-order-tracking-and-action-messaging" />Detalles de diseño: Reserva, seguimiento de pedidos y mensajes de acciones
...
### <a name="offsetting-in-reservations" />Compensación en reservas
...
### <a name="manual-reservation" />Reserva manual
...
### <a name="automatic-reservations" />Reservas automáticas
...
## <a name="order-tracking" />Seg. pedido
...
### <a name="the-order-network" />Red de pedidos
...
### <a name="offsetting-in-order-tracking" />Compensación en el seguimiento de pedidos
...
### <a name="example-order-tracking-in-sales-production-and-transfers" />Ejemplo: Seguimiento de pedidos en ventas, producción y transferencias
...
## <a name="action-messaging" />Mensajes de acción
...
## <a name="order-tracking-and-planning" />Seguimiento y planificación de pedidos
...
### <a name="planning-system-versus-order-tracking-and-action-messaging" />Sistema de planificación con respecto al seguimiento de pedidos y los mensajes de acción
