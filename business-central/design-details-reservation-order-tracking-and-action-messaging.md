...
ms.author: edupont
---
# <a name="design-details-reservation-order-tracking-and-action-messaging"></a><a name="design-details-reservation-order-tracking-and-action-messaging"></a>Detalles de diseño: Reserva, seguimiento de pedidos y mensajes de acciones
...
## <a name="reservation"></a><a name="reservation"></a>Reserva
...
### <a name="offsetting-in-reservations"></a><a name="offsetting-in-reservations"></a>Compensación en reservas
...
### <a name="manual-reservation"></a><a name="manual-reservation"></a>Reserva manual
...
### <a name="automatic-reservations"></a><a name="automatic-reservations"></a>Reservas automáticas
...
## <a name="order-tracking"></a><a name="order-tracking"></a>Seg. pedido
...
### <a name="the-order-network"></a><a name="the-order-network"></a>Red de pedidos
...
### <a name="offsetting-in-order-tracking"></a><a name="offsetting-in-order-tracking"></a>Compensación en el seguimiento de pedidos
...
### <a name="example-order-tracking-in-sales-production-and-transfers"></a><a name="example-order-tracking-in-sales-production-and-transfers"></a>Ejemplo: Seguimiento de pedidos en ventas, producción y transferencias
...
### <a name="entry-numbers-8-and-9"></a><a name="entry-numbers-8-and-9"></a>Números de movimiento 8 y 9
...
### <a name="entry-numbers-10"></a><a name="entry-numbers-10"></a>Números de movimiento 10
...
### <a name="entry-numbers-8-and-9-1"></a><a name="entry-numbers-8-and-9-1"></a>Números de movimiento 8 y 9
...
### <a name="entry-numbers-12-to-16"></a><a name="entry-numbers-12-to-16"></a>Números de movimiento de 12 a 16
...
### <a name="entry-numbers-21-and-22"></a><a name="entry-numbers-21-and-22"></a>Números de movimiento 21 y 22
...
## <a name="action-messaging"></a><a name="action-messaging"></a>Mensajes de acción
...
## <a name="order-tracking-and-planning"></a><a name="order-tracking-and-planning"></a>Seguimiento y planificación de pedidos
...
### <a name="planning-system-versus-order-tracking-and-action-messaging"></a><a name="planning-system-versus-order-tracking-and-action-messaging"></a>Sistema de planificación con respecto al seguimiento de pedidos y los mensajes de acción
