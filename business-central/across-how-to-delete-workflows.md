...
ms.author: edupont
---
# <a name="delete-approval-workflows"></a><a name="delete-approval-workflows"></a>Eliminar flujos de trabajo de aprobación
...
## <a name="delete-a-workflow"></a><a name="delete-a-workflow"></a>Eliminar un flujo de trabajo
