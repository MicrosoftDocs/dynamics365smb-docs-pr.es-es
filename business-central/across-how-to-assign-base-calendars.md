...
ms.author: edupont
---
# <a name="set-up-base-calendars" />Configurar calendarios base
...
## <a name="to-set-up-a-base-calendar" />Para configurar un calendario base
...
## <a name="lead-time-calculation" />Plazo entrega (días)
...
## <a name="to-customize-a-calendar" />Para personalizar un calendario
...
## <a name="to-assign-a-base-calendar" />Para asignar un calendario base
