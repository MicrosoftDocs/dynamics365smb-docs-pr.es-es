...
## <a name="to-create-a-permission-set"></a>Crear un conjunto de permisos
...
## <a name="to-set-up-time-constraints-for-users"></a>Para configurar restricciones para usuarios
