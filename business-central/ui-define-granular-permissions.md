...
# <a name="assign-permissions-to-users-and-groups" />Asignar permisos a usuarios y grupos
...
## <a name="to-create-a-permission-set" />Crear un conjunto de permisos
...
### <a name="example---indirect-permission" />Ejemplo: permiso indirecto
...
### <a name="to-add-other-permission-sets" />Para agregar otros conjuntos de permisos
...
## <a name="to-copy-a-permission-set" />Copiar un conjunto de permisos
...
## <a name="to-create-or-modify-permissions-by-recording-your-actions" />Para crear o modificar permisos registrando las acciones
...
### <a name="to-export-and-import-a-permission-set" />Para exportar e importar un conjunto de permisos
...
## <a name="to-remove-obsolete-permissions-from-all-permission-sets" />Para eliminar permisos obsoletos de todos los conjuntos de permisos

En la página **conjunto de permisos**, seleccione la acción **Eliminar permisos obsoletos**.

## <a name="to-set-up-time-constraints-for-users" />Para configurar restricciones para usuarios
...
## <a name="to-manage-permissions-through-user-groups" />Para administrar permisos a través de grupos de usuarios
...
### <a name="to-add-users-to-a-user-group" />Para agregar usuarios a un grupo de usuarios
...
### <a name="to-copy-a-user-group-and-all-its-permission-sets" />Para copiar un grupo de usuarios y todos los conjuntos de permisos
...
### <a name="to-assign-permission-sets-to-user-groups" />Para asignar conjuntos de permisos a grupos de usuarios
...
### <a name="to-assign-a-permission-set-on-the-permission-set-by-user-group-page" />Para asignar un conjunto de permisos en la página **Conjunto de permisos por grupo de usuarios**
...
## <a name="to-assign-permission-sets-to-users" />Para asignar conjuntos de permisos a los usuarios
...
### <a name="to-assign-a-permission-set-on-a-user-card" />Para asignar un conjunto de permisos en una tarjeta de usuario
...
### <a name="to-assign-a-permission-set-on-the-permission-set-by-user-page" />Para asignar un conjunto de permisos en la página Conjunto de permisos por usuario
...
## <a name="to-get-an-overview-of-a-users-permissions" />Para obtener un resumen de los permisos de un usuario
...
### <a name="security-filters-limit-a-users-access-to-specific-records-in-a-table" />Los filtros de seguridad restringen el acceso de un usuario a registros específicos en una tabla
...
## <a name="viewing-permission-changes-telemetry" />Ver los cambios de permisos de telemetría
...
## <a name="delegated-admin-users" />Usuarios de administrador delegados
