...
## <a name="create-a-permission-set"></a>Crear un conjunto de permisos
...
### <a name="to-add-other-permission-sets"></a>Para agregar otros conjuntos de permisos
...
## <a name="copy-a-permission-set"></a>Copiar un conjunto de permisos
...
## <a name="create-or-modify-permissions-by-recording-your-actions"></a>Crear o modificar permisos registrando las acciones
...
## <a name="remove-obsolete-permissions-from-all-permission-sets"></a>Eliminar permisos obsoletos de todos los conjuntos de permisos

En la página **conjunto de permisos**, seleccione la acción **Eliminar permisos obsoletos**.

## <a name="set-up-time-constraints-for-users"></a>Configurar restricciones para usuarios
...
## <a name="control-access-to-specific-companies"></a>Controlar el acceso a empresas específicas
...
## <a name="manage-permissions-through-user-groups"></a>Administrar permisos a través de grupos de usuarios
...
## <a name="assign-permission-sets-to-users"></a>Asignar conjuntos de permisos a los usuarios
...
## <a name="get-an-overview-of-a-users-permissions"></a>Obtener un resumen de los permisos de un usuario
...
## <a name="view-permission-changes-telemetry"></a>Ver los cambios de permisos de telemetría
