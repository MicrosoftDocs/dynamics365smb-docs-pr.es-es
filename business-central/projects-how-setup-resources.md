...
ms.author: edupont
---
# <a name="set-up-resources-for-projects" />Configurar recursos para proyectos
...
## <a name="to-set-up-a-resource" />Para configurar un recurso
...
## <a name="to-set-up-a-resource-group" />Para configurar una familia de recursos
...
## <a name="to-set-capacity-for-a-resource" />Para configurar la capacidad de un recurso
...
## <a name="to-set-up-alternate-resource-costs" />Para configurar costes de recursos alternativos
...
## <a name="to-set-up-alternate-resource-prices" />Para configurar precios de recursos alternativos
