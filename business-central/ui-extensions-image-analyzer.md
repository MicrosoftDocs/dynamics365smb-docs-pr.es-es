...
---
# <a name="the-image-analyzer-extension" /><a name="the-image-analyzer-extension"></a>Extensión del analizador de imágenes
...
## <a name="privacy-notice" /><a name="privacy-notice"></a>Aviso de privacidad
...
## <a name="requirements" /><a name="requirements"></a>Requisitos
...
## <a name="switch-on-the-image-analyzer-extension" /><a name="switch-on-the-image-analyzer-extension"></a>Activar la extensión del analizador de imágenes
...
## <a name="analyze-an-item-image" /><a name="analyze-an-item-image"></a>Analizar una imagen de producto
...
## <a name="analyze-a-contact-person-picture" /><a name="analyze-a-contact-person-picture"></a>Analizar una imagen de persona de contacto
...
## <a name="use-your-own-computer-vision-api-account" /><a name="use-your-own-computer-vision-api-account"></a>Usar su propia cuenta de la API de Computer Vision
...
## <a name="see-how-many-analyses-you-have-left-in-the-current-period" /><a name="see-how-many-analyses-you-have-left-in-the-current-period"></a>Ver cuántos análisis ha dejado en el período actual
...
## <a name="stop-using-the-image-analyzer-extension" /><a name="stop-using-the-image-analyzer-extension"></a>Detener el uso de la extensión del analizador de imágenes
