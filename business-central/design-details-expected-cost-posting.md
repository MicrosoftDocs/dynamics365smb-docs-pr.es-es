...
ms.author: edupont
---
# <a name="design-details-expected-cost-posting" />Detalles de diseño: Registro de coste previsto
...
## <a name="prerequisites-for-posting-expected-costs" />Requisitos previos para registrar los costes previstos
