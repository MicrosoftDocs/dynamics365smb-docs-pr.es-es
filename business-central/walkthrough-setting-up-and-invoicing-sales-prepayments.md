...
ms.author: edupont
---
# <a name="walkthrough-setting-up-and-invoicing-sales-prepayments" />Tutorial: Configuración y facturación de prepagos de ventas
...
## <a name="set-up-prepayments" />Configurar prepagos
...
### <a name="to-set-up-number-series-for-prepayments" />Para configurar series numéricas para prepagos
...
### <a name="to-block-shipments-for-unpaid-prepayment" />Para bloquear envíos por prepagos sin abonar
...
### <a name="to-assign-default-prepayment-percentages-to-customers-and-items" />Para asignar porcentajes de prepago predeterminados a clientes y productos
...
### <a name="to-specify-an-account-for-sales-prepayments-in-general-posting-setup" />Para especificar una cuenta para los prepagos de ventas en la configuración del registro general
...
## <a name="create-an-order-that-requires-a-prepayment" />Crear un pedido que requiera un prepago
...
### <a name="to-create-a-sales-order-with-a-prepayment" />Para crear un pedido de venta con prepago
...
## <a name="create-a-prepayment-invoice" />Crear una factura de prepago
...
### <a name="to-create-a-prepayment-invoice" />Para crear una factura de prepago
...
## <a name="create-an-additional-prepayment-invoice" />Crear una factura de prepago adicional
...
### <a name="to-create-an-additional-prepayment-invoice" />Para crear una factura de prepago adicional
...
## <a name="apply-the-prepayments" />Aplicar los prepagos
...
### <a name="to-apply-a-payment-to-the-prepayment-invoices" />Para aplicar un pago a las facturas de prepago
...
## <a name="invoice-the-remaining-amount" />Facturar el importe restante
...
### <a name="to-invoice-the-remaining-amount" />Para facturar el importe restante
