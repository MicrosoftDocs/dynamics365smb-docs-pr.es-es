...
ms.author: bholtorf
---
# <a name="service-price-management" />Gestión de precios de servicios
...
## <a name="service-price-adjustment-groups" />Grupos de ajuste de precio de servicio
...
## <a name="service-price-groups" />Grupos precio servicio
...
## <a name="service-pricing" />Tarifas de servicio
...
## <a name="service-price-adjustment" />Ajuste precio servicio
