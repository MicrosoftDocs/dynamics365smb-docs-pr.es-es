...
ms.author: bholtorf
---
# <a name="service-price-management"></a><a name="service-price-management"></a><a name="service-price-management"></a>Gestión de precios de servicios
...
## <a name="service-price-adjustment-groups"></a><a name="service-price-adjustment-groups"></a><a name="service-price-adjustment-groups"></a>Grupos de ajuste de precio de servicio
...
## <a name="service-price-groups"></a><a name="service-price-groups"></a><a name="service-price-groups"></a>Grupos precio servicio
...
## <a name="service-pricing"></a><a name="service-pricing"></a><a name="service-pricing"></a>Tarifas de servicio
...
## <a name="service-price-adjustment"></a><a name="service-price-adjustment"></a><a name="service-price-adjustment"></a>Ajuste precio servicio
