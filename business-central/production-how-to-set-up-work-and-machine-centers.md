...
ms.author: edupont
---
# <a name="set-up-work-centers-and-machine-centers" />Configuración de centros de trabajo y centros de máquinas
...
## <a name="to-set-up-a-work-center" />Para definir centros de trabajo
...
## <a name="considerations-about-capacity" />Consideraciones sobre la capacidad
...
### <a name="run-time" />Tiempo ejecución
...
### <a name="setup-time" />Tiempo preparación
...
### <a name="work-center-processing-multiple-orders-simultaneously" />Centro de trabajo que procesa varios pedidos simultáneamente
...
### <a name="efficient-resource-can-dedicate-only-part-of-their-work-date-to-productive-work" />Los recursos eficientes pueden dedicar solo una parte de su fecha de trabajo al trabajo productivo
...
### <a name="consolidated-calendar" />Calendario consolidado
...
### <a name="example---different-machine-centers-assigned-to-a-work-center" />Ejemplo: distintos centros de máquina asignados a un centro de trabajo.
...
## <a name="to-set-up-a-capacity-constrained-machine-or-work-center" />Para configurar una capacidad efectiva de una máquina o de un centro de trabajo
