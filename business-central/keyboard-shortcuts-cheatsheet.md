...
# <a name="keyboard-quick-reference---pc-only"></a><a name="keyboard-quick-reference---pc-only"></a>Referencia rápida de teclado: solo PC
...
#### <a name="navigate--select-rows"></a><a name="navigate--select-rows"></a>Desplazarse y seleccionar filas
...
#### <a name="copy--paste"></a><a name="copy--paste"></a>Copiar y pegar
...
#### <a name="search-filter--sort"></a><a name="search-filter--sort"></a>Buscar, filtrar y ordenar
...
#### <a name="quick-entry"></a><a name="quick-entry"></a>Entrada rápida
...
##### <a name="report-preview"></a><a name="report-preview"></a>Vista preliminar de un informe

|Seleccione estas teclas|Para hacer esto|
|-|-|
|<kbd>Ctrl</kbd>+<kbd>Inicio</kbd>/<kbd>Fin</kbd>|Ir a la primera/última página|

#### <a name="numeric-keypad"></a><a name="numeric-keypad"></a>Teclado numérico
