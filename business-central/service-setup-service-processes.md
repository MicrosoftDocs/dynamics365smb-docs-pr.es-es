...
ms.author: bholtorf
---
# <a name="configure-service-processes"></a><a name="configure-service-processes"></a><a name="configure-service-processes"></a><a name="configure-service-processes"></a>Configurar procesos de servicio
...
## <a name="to-enter-general-and-mandatory-settings"></a><a name="to-enter-general-and-mandatory-settings"></a><a name="to-enter-general-and-mandatory-settings"></a><a name="to-enter-general-and-mandatory-settings"></a>Para introducir valores generales y obligatorios
