...
ms.author: bholtorf
---
# <a name="configure-service-processes" />Configurar procesos de servicio
...
## <a name="to-enter-general-and-mandatory-settings" />Para introducir valores generales y obligatorios
