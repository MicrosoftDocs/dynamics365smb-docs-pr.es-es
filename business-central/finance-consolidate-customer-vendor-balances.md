...
ms.author: bholtorf
---
# <a name="consolidate-balances-for-a-company-that-is-a-customer-and-a-vendor" />Consolidar saldos para una empresa que es un cliente y un proveedor
...
## <a name="link-an-existing-customer-and-vendor-company-thorough-a-contact" />Vincular una empresa de cliente y proveedor existente a través de un contacto
...
## <a name="create-a-vendor-from-a-customer-or-vice-versa" />Crear un proveedor desde un cliente, o viceversa
...
## <a name="create-a-new-customer-or-vendor-and-link-them-through-a-vendor-or-customer-contact" />Crear un nuevo cliente o proveedor y vincularlos a través de un contacto de proveedor o cliente
...
## <a name="to-consolidate-the-customer-and-vendor-balances-for-a-contact-company" />Consolidar saldos del cliente y de proveedor para una empresa de contacto
...
## <a name="handling-duplicates" />Gestión de duplicados
