...
ms.author: edupont
---
# <a name="count-and-adjust-inventory-using-documents"></a><a name="count-and-adjust-inventory-using-documents"></a>Recuento y ajuste de inventario mediante documentos
...
## <a name="to-create-a-physical-inventory-order"></a><a name="to-create-a-physical-inventory-order"></a>Para crear un pedido de inventario físico
...
## <a name="to-create-a-physical-inventory-recording"></a><a name="to-create-a-physical-inventory-recording"></a>Para crear un registro de inventario físico
...
## <a name="to-finish-a-physical-inventory-recording"></a><a name="to-finish-a-physical-inventory-recording"></a>Para finalizar un registro de inventario físico
...
## <a name="to-complete-a-physical-inventory-order"></a><a name="to-complete-a-physical-inventory-order"></a>Para completar un pedido de inventario físico
...
### <a name="to-find-duplicate-physical-inventory-order-lines"></a><a name="to-find-duplicate-physical-inventory-order-lines"></a>Para encontrar líneas de pedido de inventario físico duplicadas
...
### <a name="to-post-a-physical-inventory-order"></a><a name="to-post-a-physical-inventory-order"></a>Para registrar un pedido de inventario físico
...
### <a name="to-view-posted-physical-inventory-orders"></a><a name="to-view-posted-physical-inventory-orders"></a>Para ver los pedidos de inventario físico registrados
...
## <a name="handling-item-tracking-when-counting-inventory"></a><a name="handling-item-tracking-when-counting-inventory"></a>Control del seguimiento de producto al contar el inventario
...
### <a name="example---prepare-a-physical-inventory-recording-for-an-item-tracked-item"></a><a name="example---prepare-a-physical-inventory-recording-for-an-item-tracked-item"></a>Ejemplo: preparar un registro de inventario físico para un producto seguido
...
### <a name="example---record-and-post-counted-lot-number-differences"></a><a name="example---record-and-post-counted-lot-number-differences"></a>Ejemplo: registrar y contabilizar diferencias de los números de lote contados
...
## <a name="inventory-documents"></a><a name="inventory-documents"></a>Documentos de inventario
...
### <a name="to-set-up-numbering-for-inventory-documents"></a><a name="to-set-up-numbering-for-inventory-documents"></a>Para configurar la numeración de los documentos de inventario
...
### <a name="to-create-and-post-an-inventory-document"></a><a name="to-create-and-post-an-inventory-document"></a>Para crear y registrar un documento de inventario
...
## <a name="printing-inventory-documents"></a><a name="printing-inventory-documents"></a>Impresión de documentos de inventario
