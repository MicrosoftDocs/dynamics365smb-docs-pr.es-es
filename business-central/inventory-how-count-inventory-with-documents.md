...
ms.author: edupont
---
# <a name="count-and-adjust-inventory-using-documents" />Recuento y ajuste de inventario mediante documentos
...
## <a name="to-create-a-physical-inventory-order" />Para crear un pedido de inventario físico
...
## <a name="to-create-a-physical-inventory-recording" />Para crear un registro de inventario físico
...
## <a name="to-finish-a-physical-inventory-recording" />Para finalizar un registro de inventario físico
...
## <a name="to-complete-a-physical-inventory-order" />Para completar un pedido de inventario físico
...
### <a name="to-find-duplicate-physical-inventory-order-lines" />Para encontrar líneas de pedido de inventario físico duplicadas
...
### <a name="to-post-a-physical-inventory-order" />Para registrar un pedido de inventario físico
...
### <a name="to-view-posted-physical-inventory-orders" />Para ver los pedidos de inventario físico registrados
...
## <a name="handling-item-tracking-when-counting-inventory" />Control del seguimiento de producto al contar el inventario
...
### <a name="example---prepare-a-physical-inventory-recording-for-an-item-tracked-item" />Ejemplo: preparar un registro de inventario físico para un producto seguido
...
### <a name="example---record-and-post-counted-lot-number-differences" />Ejemplo: registrar y contabilizar diferencias de los números de lote contados
...
## <a name="inventory-documents" />Documentos de inventario
...
### <a name="to-set-up-numbering-for-inventory-documents" />Para configurar la numeración de los documentos de inventario
...
### <a name="to-create-and-post-an-inventory-document" />Para crear y registrar un documento de inventario
...
## <a name="printing-inventory-documents" />Impresión de documentos de inventario
