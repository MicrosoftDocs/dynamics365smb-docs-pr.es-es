...
ms.author: edupont
---
# <a name="overview-of-tasks-to-set-up-"></a><a name="overview-of-tasks-to-set-up-"></a><a name="overview-of-tasks-to-set-up-"></a>Resumen de tareas para configurar [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="set-up-apps"></a><a name="set-up-apps"></a><a name="set-up-apps"></a>Configurar aplicaciones
