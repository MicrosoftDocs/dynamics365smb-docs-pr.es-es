...
### <a name="sign-up-power-bi" />Registrarse en Power BI
...
## <a name="work-with-power-bi-reports" />Trabajar con informes de Power BI

### <a name="show-reports-on-list-pages" />Mostrar informes en páginas de lista
...
### <a name="switch-reports" />Cambiar informes
...
### <a name="get-more-reports" />Obtener más informes
...
### <a name="manage-and-modify-reports" />Gestionar y modificar informes
...
#### <a name="you-cant-see-a-report-on-the-select-report-page-on-a-list-page" />No puede ver un informe en la página Seleccionar informe en una página de lista
