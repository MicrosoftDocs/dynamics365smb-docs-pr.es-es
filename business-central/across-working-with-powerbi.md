...
ms.author: jswymer
---
# <a name="work-with-power-bi-reports-in-"></a><a name="work-with-power-bi-reports-in-"></a><a name="work-with-power-bi-reports-in-"></a><a name="work-with-power-bi-reports-in-"></a>Trabajar con informes de Power BI en [!INCLUDE [prod_short](includes/prod_short.md)]
...
### <a name="sign-up-power-bi"></a><a name="sign-up-power-bi"></a><a name="sign-up-power-bi"></a><a name="sign-up-power-bi"></a>Registrarse en Power BI
...
## <a name="connect-to-power-bi---one-time-only"></a><a name="connect-to-power-bi---one-time-only"></a><a name="connect-to-power-bi---one-time-only"></a><a name="connect-to-power-bi---one-time-only"></a><a name="connect"></a>Conectar a Power BI, solo una vez
...
#### <a name="from--on-premises"></a><a name="from--on-premises"></a><a name="from--on-premises"></a><a name="from--on-premises"></a>Desde [!INCLUDE [prod_short](includes/prod_short.md)] local
...
## <a name="work-with-power-bi-reports"></a><a name="work-with-power-bi-reports"></a><a name="work-with-power-bi-reports"></a><a name="work-with-power-bi-reports"></a>Trabajar con informes de Power BI

### <a name="show-reports-on-list-pages"></a><a name="show-reports-on-list-pages"></a><a name="show-reports-on-list-pages"></a><a name="show-reports-on-list-pages"></a>Mostrar informes en páginas de lista
...
### <a name="switch-reports"></a><a name="switch-reports"></a><a name="switch-reports"></a><a name="switch-reports"></a>Cambiar informes
...
### <a name="get-more-reports"></a><a name="get-more-reports"></a><a name="get-more-reports"></a><a name="get-more-reports"></a>Obtener más informes
...
### <a name="manage-and-modify-reports"></a><a name="manage-and-modify-reports"></a><a name="manage-and-modify-reports"></a><a name="manage-and-modify-reports"></a>Gestionar y modificar informes
...
### <a name="upload-reports"></a><a name="upload-reports"></a><a name="upload-reports"></a><a name="upload-reports"></a><a name="upload"></a>Cargar informes
...
#### <a name="you-cant-see-a-report-on-the-select-report-page-on-a-list-page"></a><a name="you-cant-see-a-report-on-the-select-report-page-on-a-list-page"></a><a name="you-cant-see-a-report-on-the-select-report-page-on-a-list-page"></a><a name="you-cant-see-a-report-on-the-select-report-page-on-a-list-page"></a>No puede ver un informe en la página Seleccionar informe en una página de lista
