...
# <a name="synchronize-customers"></a><a name="synchronize-customers"></a>Sincronizar clientes
...
## <a name="important-settings-when-importing-customers-from-shopify"></a><a name="important-settings-when-importing-customers-from-shopify"></a>Configuraciones importantes al importar clientes desde Shopify
...
### <a name="customer-template-per-country"></a><a name="customer-template-per-country"></a>Plantilla de cliente por país
...
## <a name="export-customers-to-shopify"></a><a name="export-customers-to-shopify"></a>Exportar clientes a Shopify
...
### <a name="populate-customer-information-in-shopify"></a><a name="populate-customer-information-in-shopify"></a>Rellenar la información del cliente en Shopify
...
## <a name="sync-customers"></a><a name="sync-customers"></a>Sincronizar clientes
