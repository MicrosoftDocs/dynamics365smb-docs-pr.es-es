...
# <a name="run-tasks-in-the-background" />Ejecutar tareas en segundo plano
...
## <a name="run-tasks-in-the-background-for-a-specific-shop" />Ejecutar tareas en segundo plano para una tienda específica
...
## <a name="to-schedule-recurring-tasks" />Programar tareas recurrentes
