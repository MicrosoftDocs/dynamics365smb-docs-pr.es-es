...
> [!NOTE]
> Algunos elementos pueden actualizarse mediante varias tareas. Por ejemplo, cuando importa pedidos, dependiendo de la configuración en la página **Tarjeta de tienda de Shopify**, el sistema también puede importar y actualizar datos de clientes y/o productos. Para evitar conflictos, recuerde utilizar la misma categoría de cola de trabajos.
>
> Utilizar la acción **Página de solicitud de informe** para definir filtros. Por ejemplo, puede especificar que importe pedidos solo cuando su estado sea **Pagado totalmente**.
