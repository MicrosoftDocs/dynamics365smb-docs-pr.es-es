...
# <a name="create-and-set-up-a-shopify-account"></a><a name="create-and-set-up-a-shopify-account"></a>Crear y configurar una cuenta de Shopify
...
## <a name="trial-end-user"></a><a name="trial-end-user"></a>Prueba (usuario final)
...
## <a name="development-store"></a><a name="development-store"></a>Tienda de desarrollo
