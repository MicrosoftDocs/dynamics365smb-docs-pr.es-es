...
# <a name="walkthrough-set-up-and-use-the-shopify-connector"></a><a name="walkthrough-set-up-and-use-the-shopify-connector"></a>Tutorial: Configurar y usar el Shopify Connector
...
## <a name="connect-business-central-to-the-shopify-shop"></a><a name="connect-business-central-to-the-shopify-shop"></a>Conectar Business Central a la tienda de Shopify
...
## <a name="walkthrough-start-selling-products-online"></a><a name="walkthrough-start-selling-products-online"></a>Tutorial: Comienzar a vender productos en línea

### <a name="scenario"></a><a name="scenario"></a>Escenario
...
## <a name="walkthrough-invite-your-customers-to-your-new-online-store"></a><a name="walkthrough-invite-your-customers-to-your-new-online-store"></a>Tutorial: invitar a los clientes a una nueva tienda en línea

### <a name="scenario-1"></a><a name="scenario-1"></a>Escenario
...
### <a name="steps-1"></a><a name="steps-1"></a>Pasos
...
## <a name="walkthrough-fine-tuning-of-item-management"></a><a name="walkthrough-fine-tuning-of-item-management"></a>Tutorial: ajuste fino de la gestión de artículos

### <a name="scenario-2"></a><a name="scenario-2"></a>Escenario
...
### <a name="steps-2"></a><a name="steps-2"></a>Pasos
...
## <a name="walkthrough-import-items-from-shopify"></a><a name="walkthrough-import-items-from-shopify"></a>Tutorial: Importar artículos desde Shopify

### <a name="scenario-3"></a><a name="scenario-3"></a>Escenario
...
### <a name="steps-3"></a><a name="steps-3"></a>Pasos
...
#### <a name="prepare-data"></a><a name="prepare-data"></a>Preparar los datos
...
#### <a name="run-the-synchronization"></a><a name="run-the-synchronization"></a>Ejecutar la sincronización
