...
# <a name="walkthrough-set-up-and-use-the-shopify-connector" />Tutorial: Configurar y usar el Shopify Connector
...
## <a name="connect-business-central-to-the-shopify-shop" />Conectar Business Central a la tienda de Shopify
...
## <a name="walkthrough-start-selling-products-online" />Tutorial: Comienzar a vender productos en línea
...
#### <a name="prepare-data" />Preparar los datos
...
#### <a name="run-the-synchronization" />Ejecutar la sincronización
