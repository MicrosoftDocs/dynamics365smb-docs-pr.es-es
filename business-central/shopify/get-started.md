...
## <a name="install-the-dynamics--business-central-app-to-your-shopify-online-store" />Instalar la aplicación Dynamics 365 Business Central para su tienda en línea de Shopify
...
## <a name="see-related-microsoft-trainingtrainingpathsuse-shopify-connector-dynamics--business-central" />Consultar la [formación de Microsoft](/training/paths/use-shopify-connector-dynamics-365-business-central/) relacionada
