...
description: Primeros pasos al configurar una conexión entre Business Central y Shopify.
ms.date: 04/30/2024
ms.topic: article
...
# Introducción al conector de Shopify
...
Esta es probablemente la forma más segura de probar la integración. En lugar de usar un espacio aislado de Shopify, puede usar una suscripción de prueba o una Tienda de desarrollo. En [!INCLUDE[prod_short](../includes/prod_short.md)], también puede utilizar una empresa de prueba en un entorno de producción.
...
Esta *no* es una configuración recomendada para realizar pruebas porque el Conector de Shopify puede crear o modificar productos y clientes. También puede crear documentos de ventas, como pedidos y facturas. Estos documentos pueden ser difíciles de deshacer.
