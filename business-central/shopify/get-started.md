...
# <a name="get-started-with-the-shopify-connector" />Comenzar con el conector de Shopify
...
## <a name="prerequisites-for-shopify" />Requisitos previos para Shopify
...
## <a name="prerequisites-for-business-central" />Requisitos previos para Business Central
...
## <a name="install-the-dynamics-365-business-central-app-to-your-shopify-online-store" />Instalar la aplicación Dynamics 365 Business Central para su tienda en línea de Shopify
...
## <a name="connect-business-central-to-the-shopify-online-store" />Conectar Business Central a la tienda en línea de Shopify
...
## <a name="testing-strategies" />Estrategias de pruebas
...
### <a name="shopify-sandbox-and-business-central-sandbox" />Espacio aislado de Shopify y espacio aislado de Business Central
...
### <a name="shopify-sandbox-and-business-central-production" />Espacio aislado de Shopify y de producción de de Business Central
...
### <a name="shopify-production-and-business-central-sandbox" />Producción de Shopify y espacio aislado de Business Central
...
## <a name="see-related-microsoft-trainingtrainingpathsuse-shopify-connector-dynamics-365-business-central" />Consultar la [formación de Microsoft](/training/paths/use-shopify-connector-dynamics-365-business-central/) relacionada
