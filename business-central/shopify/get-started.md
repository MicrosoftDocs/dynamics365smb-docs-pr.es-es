...
## <a name="see-related-microsoft-training"></a>Consultar la [formación de Microsoft](/training/paths/use-shopify-connector-dynamics-365-business-central/) relacionada
