...
# <a name="synchronize-and-fulfill-sales-orders"></a><a name="synchronize-and-fulfill-sales-orders"></a>Sincronizar y cumplir con los pedidos de ventas
...
## <a name="set-the-import-of-orders-on-the-shopify-shop-card"></a><a name="set-the-import-of-orders-on-the-shopify-shop-card"></a>Configurar la importación de pedidos en la ficha de tienda Shopify
...
### <a name="shipment-method-mapping"></a><a name="shipment-method-mapping"></a>Asignación de método de envío
...
### <a name="location-mapping"></a><a name="location-mapping"></a>Asignación de ubicación
...
## <a name="run-the-order-synchronization"></a><a name="run-the-order-synchronization"></a>Ejecutar la sincronización de pedidos
...
## <a name="review-imported-orders"></a><a name="review-imported-orders"></a>Revisar pedidos importados
...
## <a name="create-sales-documents-in-business-central"></a><a name="create-sales-documents-in-business-central"></a>Crear documentos de ventas en Business Central
...
### <a name="to-create-sales-documents"></a><a name="to-create-sales-documents"></a>Para crear documentos de venta
...
### <a name="manage-missing-customers"></a><a name="manage-missing-customers"></a>Gestionar clientes perdidos
...
### <a name="how-the-connector-chooses-which-customer-to-use"></a><a name="how-the-connector-chooses-which-customer-to-use"></a>Cómo el conector elige qué cliente usar
...
### <a name="different-processing-rules-for-orders"></a><a name="different-processing-rules-for-orders"></a>Diferentes reglas de procesamiento para pedidos
...
### <a name="impact-of-order-editing"></a><a name="impact-of-order-editing"></a>Impacto de las modificaciones de pedidos
...
## <a name="synchronize-shipments-to-shopify"></a><a name="synchronize-shipments-to-shopify"></a>Sincronizar envíos a Shopify
...
### <a name="shipping-agents-and-tracking-url"></a><a name="shipping-agents-and-tracking-url"></a>Agentes de envío y URL de seguimiento
...
## <a name="returns-and-refunds"></a><a name="returns-and-refunds"></a>Devoluciones y reembolsos
...
## <a name="gift-cards"></a><a name="gift-cards"></a>Tarjetas regalo
