...
# <a name="synchronize-and-fulfill-sales-orders" />Sincronizar y cumplir con los pedidos de ventas
...
## <a name="set-the-import-of-orders-on-the-shopify-shop-card" />Configurar la importación de pedidos en la ficha de tienda Shopify
...
### <a name="shipment-method-mapping" />Asignación de método de envío
...
### <a name="location-mapping" />Asignación de ubicación
...
## <a name="run-the-order-synchronization" />Ejecutar la sincronización de pedidos
...
## <a name="review-imported-orders" />Revisar pedidos importados
...
## <a name="create-sales-documents-in-business-central" />Crear documentos de ventas en Business Central
...
### <a name="to-create-sales-documents" />Para crear documentos de venta
...
### <a name="manage-missing-customers" />Gestionar clientes perdidos
...
### <a name="how-the-connector-chooses-which-customer-to-use" />Cómo el conector elige qué cliente usar
...
### <a name="different-processing-rules-for-orders" />Diferentes reglas de procesamiento para pedidos
...
### <a name="impact-of-order-editing" />Impacto de las modificaciones de pedidos
...
## <a name="synchronize-shipments-to-shopify" />Sincronizar envíos a Shopify
...
### <a name="shipping-agents-and-tracking-url" />Agentes de envío y URL de seguimiento
...
## <a name="returns-and-refunds" />Devoluciones y reembolsos
...
## <a name="gift-cards" />Tarjetas regalo
