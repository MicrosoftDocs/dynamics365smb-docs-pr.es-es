...
## <a name="sales-ad-hoc-analysis-scenarios"></a>Escenarios de análisis ad hoc de ventas
...
## <a name="example-sales-expected-sales-volume"></a>Ejemplo: Ventas (volumen de ventas esperado)
...
## <a name="example-sales-customer-sales-by-volume"></a>Ejemplo: Ventas (ventas de clientes por volumen)
...
## <a name="data-foundation-for-ad-hoc-analysis-on-sales"></a>Base de datos para análisis ad hoc de ventas
