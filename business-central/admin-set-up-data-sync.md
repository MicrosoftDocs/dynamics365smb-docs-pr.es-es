...
# <a name="get-ready-to-synchronize-master-data"></a><a name="get-ready-to-synchronize-master-data"></a>Prepararse para sincronizar datos maestros
...
## <a name="uni-directional-synchronization-only"></a><a name="uni-directional-synchronization-only"></a>Solo sincronización unidireccional
...
## <a name="specify-the-source-company"></a><a name="specify-the-source-company"></a>Especificar la empresa de origen
...
## <a name="enable-or-disable-tables-and-fields"></a><a name="enable-or-disable-tables-and-fields"></a>Habilitar o deshabilitar tablas y campos
...
### <a name="use-match-based-coupling"></a><a name="use-match-based-coupling"></a>Usar emparejamiento basado en coincidencias
...
## <a name="synchronize-for-the-first-time"></a><a name="synchronize-for-the-first-time"></a>Sincronizar por primera vez
...
## <a name="add-or-delete-tables-from-the-synchronization-tables-list"></a><a name="add-or-delete-tables-from-the-synchronization-tables-list"></a>Agregar o eliminar tablas de la lista de tablas de sincronización

### <a name="add-a-table"></a><a name="add-a-table"></a>Agregar una tabla
...
### <a name="delete-a-table"></a><a name="delete-a-table"></a>Eliminar una tabla
...
## <a name="use-export-and-import-to-share-a-synchronization-setup"></a><a name="use-export-and-import-to-share-a-synchronization-setup"></a>Use exportar e importar para compartir una configuración de sincronización
