...
ms.author: edupont
---
# <a name="work-with-blanket-sales-orders-or-blanket-purchase-orders" />Trabajar con pedidos abiertos de venta o pedidos abiertos de compra
...
## <a name="to-create-a-blanket-sales-order" />Para crear un pedido abierto de venta
...
## <a name="to-create-a-sales-order-from-a-blanket-sales-order" />Para crear un pedido de venta a partir de un pedido abierto de venta
...
## <a name="to-view-the-status-of-a-blanket-sales-order" />Para ver el estado de un pedido abierto de venta
...
## <a name="to-view-unposted-and-posted-blanket-sales-order-lines" />Visualización de líneas de pedido abierto de venta registradas y no registradas
...
## <a name="see-related-microsoft-training" />Consultar la [formación de Microsoft](/training/modules/create-sales-documents-dynamics-365-business-central/) relacionada
