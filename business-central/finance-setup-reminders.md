...
Puede usar recordatorios para recordar a los clientes que tienen importes vencidos y solicitar pagos. [!INCLUDE [reminder-terms](includes/reminder-terms.md)]
