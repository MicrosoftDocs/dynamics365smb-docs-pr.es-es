...
ms.author: edupont
---
# <a name="accountant-experiences-in-"></a><a name="accountant-experiences-in-"></a><a name="accountant-experiences-in-"></a><a name="accountant-experiences-in-"></a>Experiencias contables en [!INCLUDE[prod_long](includes/prod_long.md)]
...
## <a name="accountant-role-center"></a><a name="accountant-role-center"></a><a name="accountant-role-center"></a><a name="accountant-role-center"></a>Área de trabajo Contable
...
## <a name="company-hub"></a><a name="company-hub"></a><a name="company-hub"></a><a name="company-hub"></a>Hub de empresas
...
## <a name="inviting-your-external-accountant-to-your-"></a><a name="inviting-your-external-accountant-to-your-"></a><a name="inviting-your-external-accountant-to-your-"></a><a name="inviting-your-external-accountant-to-your-"></a><a name="inviteaccountant"></a>Invitación del contable externo a [!INCLUDE[prod_short](includes/prod_short.md)]
...
### <a name="adding-your-accountant-to-your-microsoft-365-in-the-azure-portal"></a><a name="adding-your-accountant-to-your-microsoft-365-in-the-azure-portal"></a><a name="adding-your-accountant-to-your-microsoft-365-in-the-azure-portal"></a><a name="adding-your-accountant-to-your-microsoft-365-in-the-azure-portal"></a>Añadir su contable a su Microsoft 365 en Azure Portal
...
#### <a name="to-add-your-accountant-as-a-guest-user"></a><a name="to-add-your-accountant-as-a-guest-user"></a><a name="to-add-your-accountant-as-a-guest-user"></a><a name="to-add-your-accountant-as-a-guest-user"></a>Para añadir a su contable como usuario invitado
...
#### <a name="to-give-your-accountant-access-to-your-"></a><a name="to-give-your-accountant-access-to-your-"></a><a name="to-give-your-accountant-access-to-your-"></a><a name="to-give-your-accountant-access-to-your-"></a>Para darle acceso a su contable a su [!INCLUDE[prod_short](includes/prod_short.md)]
...
### <a name="importing-the-new-user-into-"></a><a name="importing-the-new-user-into-"></a><a name="importing-the-new-user-into-"></a><a name="importing-the-new-user-into-"></a>Importar al nuevo usuario a [!INCLUDE[prod_short](includes/prod_short.md)]
...
#### <a name="to-add-the-accountant-to-the-right-company"></a><a name="to-add-the-accountant-to-the-right-company"></a><a name="to-add-the-accountant-to-the-right-company"></a><a name="to-add-the-accountant-to-the-right-company"></a>Para añadir el contable a la empresa correcta
