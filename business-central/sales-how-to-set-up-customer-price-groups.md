...
# <a name="set-up-customer-price-groups" />Configurar los grupos de precio de clientes
...
## <a name="how-to-create-sales-prices-for-a-group-of-customers" />Cómo crear precios de venta para un grupo de clientes
...
### <a name="to-create-sales-prices-for-a-group-of-customers" />Para crear precios de venta para un grupo de clientes
...
## <a name="how-to-enter-customer-price-group-codes-on-customer-cards" />Cómo introducir los códigos de grupos de precio de cliente en las fichas de clientes

Después de configurar los grupos de precio de cliente, introduzca códigos respectivos en las fichas de clientes.

### <a name="to-enter-customer-price-group-codes-on-a-customer-card" />Para introducir los códigos de grupos de precio de cliente en la ficha de clientes
