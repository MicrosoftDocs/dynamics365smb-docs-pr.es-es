...
# <a name="handling-missing-option-values"></a><a name="handling-missing-option-values"></a>Administración de valores de opciones que faltan
> [!NOTE]
...
### <a name="extending-option-sets-in-"></a><a name="extending-option-sets-in-"></a>Extensión de conjuntos de opciones en [!INCLUDE[prod_short](includes/prod_short.md)]
...
### <a name="update--option-mapping"></a><a name="update--option-mapping"></a>Actualizar la asignación de opciones [!INCLUDE[prod_short](includes/cds_long_md.md)]
