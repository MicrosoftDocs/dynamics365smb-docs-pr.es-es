...
|Defina las entidades externas con las que tiene relaciones comerciales. Por ejemplo, clientes, clientes potenciales, proveedores, abogados y consultores, ya sea como tipo de persona o tipo de empresa.|[Gestionar contactos](marketing-contacts.md)|
...
|Use Dynamics 365 Sales para Customer Engagement y disfrute de una integración perfecta en el proceso de obtención de efectivo. Use [!INCLUDE [prod_short](includes/prod_short.md)] para actividades de backend como procesar pedidos, administrar inventario y hacer sus finanzas.|[Integración con Dynamics 365 Sales](marketing-integrate-dynamicscrm.md)|
