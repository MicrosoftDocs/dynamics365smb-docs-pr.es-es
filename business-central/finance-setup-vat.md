...
# <a name="set-up-calculations-and-posting-methods-for-value-added-tax" />Configurar los cálculos y los métodos de registro del impuesto sobre el valor añadido
...
## <a name="set-up-vat-using-the-assisted-setup-guide-recommended" />Configurar el IVA mediante la guía de configuración asistida (recomendado)
...
### <a name="check-the-vat-posting-setup" />Comprobar la configuración de registro de IVA
...
## <a name="set-up-a-default-vat-date-for-documents-and-journals" />Configurar una fecha de IVA predeterminada para documentos y diarios
...
### <a name="enabling-or-disabling-the-vat-date-feature" />Habilitación o deshabilitación de la función Fecha de IVA
...
### <a name="limiting-periods-for-posting-and-changing-the-vat-date" />Limitación de períodos para publicar y modificar la fecha del IVA
...
#### <a name="to-limit-posting-based-on-vat-return-period" />Para limitar la publicación según el período de devolución del IVA
...
#### <a name="to-limit-posting-based-on-allow-fromto-period" />Para limitar la publicación en función de Permitir desde/hasta el período
...
## <a name="set-up-vat-registration-numbers-for-your-country-or-region" />Configurar números CIF/NIF para su país o región
...
## <a name="set-up-vat-business-posting-groups" />Configuración de grupos de registro de IVA de negocio
...
## <a name="set-up-vat-product-posting-groups" />Configurar grupos de registro de IVA de producto
...
## <a name="combine-vat-posting-groups-in-vat-posting-setups" />Combinar grupos de registro de IVA en configuraciones de registro de IVA
...
## <a name="assign-vat-posting-groups-by-default-to-multiple-entities" />Asignar los grupos de registro de IVA de forma predeterminada a varias entidades
...
## <a name="assign-vat-posting-groups-to-accounts-customers-vendors-items-and-resources" />Asignar grupos de registro de IVA a cuentas, clientes, proveedores, artículos y recursos

En las secciones siguientes se describe cómo asignar los grupos de registro de IVA de negocio a los objetos individuales.

### <a name="to-assign-vat-posting-groups-to-individual-general-ledger-accounts" />Para asignar grupos de registro de IVA a cuentas contables individuales
...
### <a name="to-assign-vat-business-posting-groups-to-customers-and-vendors" />Para asignar grupos de registro de IVA a clientes y proveedores
...
### <a name="to-assign-vat-product-posting-groups-to-individual-items-and-resources" />Para asignar grupos de registro de IVA de producto a productos y recursos individuales
...
## <a name="set-up-clauses-to-explain-vat-exemption-or-non-standard-vat-rates" />Configurar cláusulas para explicar la exención del IVA o los tipos de IVA no estándar
...
### <a name="to-set-up-vat-clauses" />Para configurar las cláusulas de IVA
...
### <a name="to-assign-a-vat-clause-to-a-vat-posting-setup" />Para asignar una cláusula de IVA a una configuración de registro de IVA
...
### <a name="to-specify-translations-for-vat-clauses" />Para especificar las traducciones de las cláusulas de IVA
...
### <a name="to-specify-extended-text-for-vat-clauses" />Para especificar texto extendido para las cláusulas de IVA
...
## <a name="create-a-vat-posting-setup-to-handle-import-vat" />Crear una configuración de registro de IVA para usar el IVA de importación
...
## <a name="use-reverse-charge-vat-for-trade-between-eu-countries-or-regions" />Usar el IVA de reversión para las transacciones entre países o regiones de la UE
...
### <a name="sales-to-eu-countries-or-regions" />Ventas a países o regiones de la UE
...
## <a name="vat-rounding-for-documents" />Redondeo del IVA en los documentos
...
## <a name="set-up-vat-reporting" />Configurar informes de IVA
