...
---
# <a name="selling-inventory-items-in-assemble-to-order-flows" />Vender productos de inventario en flujos de ensamblar para pedido
...
## <a name="to-sell-inventory-items-in-assemble-to-order-flows" />Para vender productos de inventario en los flujos de ensamblar para pedido
