...
ms.author: bholtorf
---
# <a name="manage-notifications" />Administrar notificaciones
...
## <a name="to-turn-notifications-on-or-off-and-control-when-they-are-sent" />Para activar o desactivar notificaciones y controlar cuándo se envían
