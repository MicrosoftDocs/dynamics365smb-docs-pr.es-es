...
ms.author: bholtorf
---
# <a name="manage-notifications"></a><a name="manage-notifications"></a><a name="manage-notifications"></a><a name="manage-notifications"></a>Administrar notificaciones
...
## <a name="to-turn-notifications-on-or-off-and-control-when-they-are-sent"></a><a name="to-turn-notifications-on-or-off-and-control-when-they-are-sent"></a><a name="to-turn-notifications-on-or-off-and-control-when-they-are-sent"></a><a name="to-turn-notifications-on-or-off-and-control-when-they-are-sent"></a>Para activar o desactivar notificaciones y controlar cuándo se envían
