...
---
# <a name="walkthrough-receiving-and-putting-away-in-basic-warehouse-configurations" />Tutorial: recepción y ubicación en la configuración del almacenamiento básico
...
## <a name="setting-up-the-location" />Configuración del almacén

La configuración de la página **Ficha almacén** define los flujos de almacén de la empresa.  

### <a name="to-set-up-the-location" />Configurar el almacén
...
## <a name="create-the-purchase-order" />Crear el pedido de compra

Los pedidos de compra son el tipo más común de documento de origen de entrada.  

### <a name="to-create-the-purchase-order" />Crear el pedido de compra
...
## <a name="receive-and-put-the-items-away" />Recibir y establecer la ubicación de los productos
...
### <a name="to-receive-and-put-the-items-away" />Recibir y establecer la ubicación de los productos
