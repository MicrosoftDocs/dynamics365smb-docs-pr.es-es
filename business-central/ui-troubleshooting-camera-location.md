...
# <a name="troubleshooting-accessing-camera-and-location" />Solución de problemas: acceso a la cámara y a la ubicación
...
## <a name="device-must-have-camera-and-location-capabilities" />El dispositivo debe tener capacidades de cámara y ubicación
...
## <a name="access-permissions-not-enabled" />Permisos de acceso no habilitados
...
## <a name="web-client-connection-not-secure" />La conexión del cliente web no es segura
...
## <a name="work-with-virtualization-technologies" />Trabajar con tecnologías de virtualización
...
## <a name="antivirus-software" />Software antivirus
