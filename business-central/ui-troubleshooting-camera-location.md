...
# <a name="troubleshooting-accessing-camera-and-location"></a><a name="troubleshooting-accessing-camera-and-location"></a>Solución de problemas: acceso a la cámara y a la ubicación
...
## <a name="device-must-have-camera-and-location-capabilities"></a><a name="device-must-have-camera-and-location-capabilities"></a>El dispositivo debe tener capacidades de cámara y ubicación
...
## <a name="access-permissions-not-enabled"></a><a name="access-permissions-not-enabled"></a>Permisos de acceso no habilitados
...
## <a name="web-client-connection-not-secure"></a><a name="web-client-connection-not-secure"></a>La conexión del cliente web no es segura
...
## <a name="work-with-virtualization-technologies"></a><a name="work-with-virtualization-technologies"></a>Trabajar con tecnologías de virtualización
