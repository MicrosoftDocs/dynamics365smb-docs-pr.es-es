...
ms.author: edupont
---
# <a name="categorize-items" />Clasificar productos
...
## <a name="to-create-an-item-category" />Para crear una categoría de producto
...
## <a name="to-assign-an-item-category-to-an-item" />Para asignar una categoría de producto a un producto
