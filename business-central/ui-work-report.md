...
---
# <a name="run-and-print-reports-in-business-central"></a>Ejecutar e imprimir informes
...
## <a name="use-default-valuesmdashpredefined-settings"></a><a name="SavedSettings"></a>Uso de valores predeterminados&mdash;configuración predefinida
...
## <a name="specify-the-data-to-include-in-a-report"></a>Especificación de los datos que se van a incluir en un informe
...
## <a name="preview-a-report"></a>Vista preliminar de un informe
...
### <a name="print-reports-in-thai"></a>Impresión de informes en tailandés
