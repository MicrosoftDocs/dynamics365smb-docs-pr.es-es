...
---
# <a name="assemble-items"></a><a name="assemble-items"></a><a name="assemble-items"></a>Ensamblar artículos
...
## <a name="to-assemble-an-item-to-stock"></a><a name="to-assemble-an-item-to-stock"></a><a name="to-assemble-an-item-to-stock"></a>Para ensamblar un artículo para stock
