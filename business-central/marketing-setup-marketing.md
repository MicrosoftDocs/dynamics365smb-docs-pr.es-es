...
ms.author: edupont
---
# <a name="setting-up-relationship-management"></a><a name="setting-up-relationship-management"></a>Configurar la gestión de relaciones
...
## <a name="automatically-recording-interactions"></a><a name="automatically-recording-interactions"></a>Interacciones registradas automáticamente
...
## <a name="synchronizing-contacts-with-customers-and-more"></a><a name="synchronizing-contacts-with-customers-and-more"></a>Sincronizar contactos con clientes, etc.
...
## <a name="assigning-a-number-series-to-contacts-and-opportunities"></a><a name="assigning-a-number-series-to-contacts-and-opportunities"></a>Asignar una serie numérica a contactos y oportunidades
...
## <a name="searching-for-duplicate-contacts-when-contacts-are-created"></a><a name="searching-for-duplicate-contacts-when-contacts-are-created"></a>Buscar contactos duplicados al crear contactos
