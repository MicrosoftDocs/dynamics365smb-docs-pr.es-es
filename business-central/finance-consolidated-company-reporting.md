...
# <a name="consolidating-financial-data-from-multiple-companies" />Consolidar los datos financieros de varias empresas
...
## <a name="use-the-consolidated-trial-balance-report" />Utilizar el informe Balance de prueba consolidado
...
## <a name="consolidate-data" />Consolidar datos
...
### <a name="to-test-the-data-before-you-consolidate" />Para probar los datos antes de la consolidación:
...
### <a name="run-the-consolidation" />Ejecutar la consolidación
...
## <a name="eliminate-repeated-transactions" />Eliminar transacciones repetidas
...
## <a name="export-and-import-consolidated-data-between-databases" />Exportar e importar datos consolidados entre bases de datos
