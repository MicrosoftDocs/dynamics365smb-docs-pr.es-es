...
---
# <a name="pick-items-for-warehouse-shipment" />Realizar un picking de los artículos para el envío de almacén
...
## <a name="to-pick-items-for-a-warehouse-shipment" />Para realizar un picking de los envíos de almacén
