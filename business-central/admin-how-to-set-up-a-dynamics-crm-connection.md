...
ms.author: bholtorf
---
# <a name="connect-to-microsoft-dataverse" />Conectar a Microsoft Dataverse
...
### <a name="to-use-the-dataverse-connection-setup-assisted-setup-guide" />Para usar la guía de configuración asistida Configuración de conexión de Dataverse
...
### <a name="to-create-or-maintain-the-connection-manually" />Para crear o mantener la conexión manualmente
...
## <a name="customize-the-match-based-coupling" />Personalizar el emparejamiento basado en coincidencias
...
### <a name="view-the-results-of-the-coupling-job" />Ver los resultados del trabajo de emparejamiento
...
## <a name="upgrade-connections-from-business-central-online-to-use-certificate-based-authentication" />Actualice las conexiones de Business Central Online para usar autenticación basada en certificados
...
### <a name="to-upgrade-your-business-central-online-connection-to-use-certificate-based-authentication" />Para actualizar la conexión de Business Central Online para usar autenticación basada en certificados
...
## <a name="connecting-on-premises-versions" />Conectar versiones locales
...
### <a name="to-register-an-application-in-azure-ad-for-connecting-from-business-central-to-dataverse" />Para registrar una solicitud en Azure AD para conectarse desde Business Central a Dataverse
