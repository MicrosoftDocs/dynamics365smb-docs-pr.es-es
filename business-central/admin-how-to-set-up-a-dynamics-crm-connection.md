...
* La dirección URL del entorno de [!INCLUDE[cds_long_md](includes/cds_long_md.md)] al que desea conectarse. Si usa la guía de configuración asistida **Configuración de conexión de Common Data Service** para crear la conexión descubriremos los entornos, pero también puede introducir la URL de otro entorno en su suscriptor.  
...
### <a name="to-use-the-common-data-service-connection-setup-assisted-setup-guide"></a>Para usar la guía de configuración asistida Configuración de conexión de Common Data Service
...
2. Elija **Configurar la conexión de Dataverse** para iniciar la guía de configuración asistida.
...
El procedimiento siguiente describe cómo configurar la conexión manualmente en la página **Configuración de conexión de Common Data Service**. También es la página donde administra los valores para la integración.
...
Para conectar [!INCLUDE[prod_short](includes/prod_short.md)] local a [!INCLUDE[cds_long_md](includes/cds_long_md.md)], debe especificar alguna información en la página **Configuración de la conexión de Common Data Service**.
...
Se parte de la base que para los siguientes pasos está usando Azure AD para gestionar identidades y accesos. Para obtener más información sobre cómo registrar una aplicación en Azure AD, vea [Inicio rápido: Registrar una aplicación con la plataforma idtable de Microsoft](/azure/active-directory/develop/quickstart-register-app). Si no usa Azure AD, vea [Usar otro servicio de administración de Idtable y accesos](admin-how-to-set-up-a-dynamics-crm-connection.md#using-another-idtable-and-access-management-service).  

1. En el Portal de Azure, en **Administrar** en el oanel de navegación, elija **Autenticación**.  
2. En **Redirigir URL**, agregue la URL de redireccionamiento que se sugiere en la página **Configuración de la conexión de Common Data Service** en [!INCLUDE[prod_short](includes/prod_short.md)].
...
7. En [!INCLUDE[prod_short](includes/prod_short.md)], en la página **Configuración de la conexión de Common Data Service**, en el campo **URL del entorno**, especifique la URL para su entorno de [!INCLUDE[cds_long_md](includes/cds_long_md.md)].
...
#### <a name="using-another-idtable-and-access-management-service"></a>Usar otro servicio de administración de Idtable y accesos
...
1. Elija el icono ![Bombilla que abre la función Dígame](media/ui-search/search_small.png "Dígame qué desea hacer"), escriba **Configuración de la conexión de Common Data Service** y luego elija el enlace relacionado.
2. En la página **Configuración de conexión de Common Data Service**, desactive **Habilitado**.  
