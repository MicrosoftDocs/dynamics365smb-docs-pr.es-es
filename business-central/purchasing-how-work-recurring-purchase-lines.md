...
---
# <a name="create-recurring-purchase-lines" />Crear líneas de compra periódicas
...
## <a name="set-up-recurring-purchase-lines" />Configurar las líneas de compras periódicas
...
## <a name="assign-recurring-purchase-lines-to-a-vendor" />Asignar líneas de compra recurrentes a un proveedor
...
## <a name="insert-recurring-purchase-lines-on-a-purchase-invoice" />Insertar líneas de compra recurrentes en una factura de compra
