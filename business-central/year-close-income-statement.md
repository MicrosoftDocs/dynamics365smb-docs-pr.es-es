...
ms.author: jswymer
---
# <a name="closing-income-statement-accounts" />Cerrar cuentas de regularización
...
## <a name="to-run-the-close-income-statement-batch-job" />Para ejecutar el proceso Cerrar asiento de regularización
...
## <a name="about-the-close-income-statement-batch-job" />Acerca del proceso Cerrar asiento de regularización
