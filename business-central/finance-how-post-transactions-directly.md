...
ms.author: edupont
---
# <a name="post-transactions-directly-to-the-general-ledger" />Registrar transacciones directamente en la contabilidad
...
## <a name="to-post-a-transaction-directly-to-a-general-ledger-account" />Para registrar una transacción directamente en una cuenta contable
