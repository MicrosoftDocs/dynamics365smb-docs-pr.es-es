...
ms.author: edupont
---
# <a name="specify-posting-periods"></a><a name="specify-posting-periods"></a><a name="specify-posting-periods"></a><a name="specify-posting-periods"></a>Para especificar periodos de registro

Utilice los periodos de registro para especificar cuándo los usuarios pueden registrar en el libro mayor.  

## <a name="to-specify-posting-periods"></a><a name="to-specify-posting-periods"></a><a name="to-specify-posting-periods"></a><a name="to-specify-posting-periods"></a>Para especificar periodos de registro
