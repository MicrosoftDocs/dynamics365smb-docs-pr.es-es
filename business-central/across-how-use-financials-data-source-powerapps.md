...
## <a name="add--as-a-data-source-in-power-apps" />Agregar [!INCLUDE[prod_short](includes/prod_short.md)] como origen de datos de Power Apps
...
## <a name="see-related-microsoft-training" />Consultar la [formación de Microsoft](/training/paths/power-apps-power-automate-business-central/) relacionada
