...
ms.date: 06/15/2022
---
# <a name="database-wait-statistics-in-"></a><a name="database-wait-statistics-in-"></a><a name="database-wait-statistics-in-"></a><a name="database-wait-statistics-in-"></a>Estadísticas de espera de base de datos en [!INCLUDE[prod_long](includes/prod_long.md)]
