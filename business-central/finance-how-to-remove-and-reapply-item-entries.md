...
ms.author: edupont
---
# <a name="remove-and-reapply-item-ledger-entries" />Eliminar y liquidar de nuevo los movimientos contables de producto
...
## <a name="to-remove-an-item-application-by-using-the-application-worksheet" />Para eliminar una liquidación de producto con la Hoja de liquidación
...
## <a name="to-reapply-an-item-application-by-using-the-application-worksheet" />Para volver a liquidar un producto con la Hoja liquidación
