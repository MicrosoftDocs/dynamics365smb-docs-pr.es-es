...
# <a name="need-more-time-to-decide-whether-to-subscribe"></a><a name="need-more-time-to-decide-whether-to-subscribe"></a><a name="need-more-time-to-decide-whether-to-subscribe"></a>¿Necesita más tiempo para decidir si suscribirse?
...
## <a name="to-extend-your-trial-period"></a><a name="to-extend-your-trial-period"></a><a name="to-extend-your-trial-period"></a>Para ampliar su período de prueba
...
## <a name="what-happens-if-my-trial-period-is-expired"></a><a name="what-happens-if-my-trial-period-is-expired"></a><a name="what-happens-if-my-trial-period-is-expired"></a>¿Qué pasa si mi período de prueba ha expirado?
