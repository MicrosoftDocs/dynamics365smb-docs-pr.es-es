...
ms.author: edupont
---
# <a name="warnings-and-error-messages-in-dynamics-365-business-central"></a><a name="warnings-and-error-messages-in-dynamics-365-business-central"></a>Advertencias y mensajes de error en Dynamics 365 Business Central
...
## <a name="in-product-user-assistance"></a><a name="in-product-user-assistance"></a>Asistencia al usuario en el producto
...
## <a name="help-and-support-page"></a><a name="help-and-support-page"></a>Página Ayuda y soporte técnico
...
## <a name="help-others"></a><a name="help-others"></a>Ayuda a otros
