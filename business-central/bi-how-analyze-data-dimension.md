...
ms.author: edupont
---
# <a name="analyze-data-by-dimensions"></a><a name="analyze-data-by-dimensions"></a>Analizar datos por dimensiones
...
## <a name="set-up-an-analysis-view"></a><a name="set-up-an-analysis-view"></a>Configurar una vista de análisis
...
## <a name="analyze-by-dimensions"></a><a name="analyze-by-dimensions"></a>Analizar por dimensiones
...
## <a name="update-an-analysis-view"></a><a name="update-an-analysis-view"></a>Actualizar una vista de análisis
...
## <a name="see-related-training-at-microsoft-learn"></a><a name="see-related-training-at-microsoft-learn"></a>Consulte la formación relacionada en [Microsoft Learn](/learn/modules/dimensions-financial-reports-dynamics-365-business-central/index)
