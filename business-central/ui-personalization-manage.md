...
- No todos los campos de la tabla pueden estar disponibles para su personalización desde el panel **Agregar campo a la página**. El desarrollador de una tabla puede optar por evitar que un campo aparezca en la personalización estableciendo la propiedad [AllowInCustomization](/dynamics365/business-central/dev-itpro/developer/properties/devenv-allowincustomizations-property) del campo en `Never`.
