...
ms.author: edupont
---
# <a name="design-details-planning-assignment-table"></a><a name="design-details-planning-assignment-table"></a>Detalles de diseño: Tabla de asignación de planificación
