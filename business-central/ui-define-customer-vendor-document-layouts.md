...
## <a name="to-specify-which-contact-receives-which-document-layout-for-a-customer"></a>Para especificar qué contacto recibe qué documento diseño para un cliente
