...
4. En el campo **Cuenta liquidación grupo** especifique la cuenta de liquidación utilizada para los importes del impuesto del IVA de los miembros del grupo.
5. En el campo **Cuenta de liquidación de IVA**, especifique la cuenta que utiliza para liquidaciones de IVA.
