...
# <a name="the-vat-group-management-extension-for-the-united-kingdom" />La extensión de gestión de grupo de IVA para el Reino Unido
...
## <a name="forming-a-vat-group" />Formación de un grupo de IVA
...
### <a name="license-requirements" />Requisitos de licencia
...
## <a name="set-up-a-vat-group" />Configurar un grupo de IVA
...
### <a name="azure-active-directory-setup-for-group-members" />Configuración de Azure Active Directory para miembros del grupo
...
### <a name="group-api-setup" />Configuración del grupo de API
...
## <a name="set-up-vat-group-members" />Configurar los miembros de grupos de IVA
...
### <a name="vat-group-representative-uses-business-central-online" />Representante de grupo de IVA que usa Business Central Online
...
### <a name="vat-group-representative-uses-business-central-on-premises" />Representante de grupo de IVA que usa Business Central local
...
## <a name="set-up-the-vat-group-representative" />Configurar el representante del grupo de IVA
...
## <a name="use-the-vat-group-management-features" />Usar las características de gestión de grupos de IVA
...
### <a name="review-vat-member-submissions" />Revisar envíos de miembros de IVA
...
### <a name="create-a-group-vat-return" />Creación de una declaración de IVA de grupo
