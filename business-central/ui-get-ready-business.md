---
title: Prepararse para hacer negocios
description: 'Describe las guías de configuración asistida, los vídeos, los artículos de ayuda y las páginas que se usan para empezar a realizar operaciones empresariales en Business Central.'
author: brentholtorf
ms.author: bholtorf
...
---
# <a name="get-ready-for-doing-business"></a>Prepararse para hacer negocios

Enhorabuena, ya tiene su primera empresa en [!INCLUDE[prod_short](includes/prod_short.md)].

Para ayudarle a empezar a hacer negocios, puede visitar la página **Configuración asistida** donde puede iniciar guías de configuración asistida, vídeos o artículos de ayuda para determinadas tareas de configuración. Para tener acceso a la página, elija [este vínculo](https://businesscentral.dynamics.com/?page=1801).  
...
En función de su rol, la página de inicio proporciona una vista general del negocio. La barra de navegación le da un acceso sencillo a los clientes, proveedores, productos, etc. Los iconos **Actividades** muestra los datos actuales y proporcionan un acceso fácil al documento seleccionado.
...
En **Configuración de la empresa**, puede ver y editar información de configuración sobre la empresa actual. Gran parte de esta información se completó previamente si completó la configuración asistida **Configurar empresa** cuando se registró [!INCLUDE[prod_short](includes/prod_short.md)]. Si desea cambiar el logotipo de la empresa, la información de contacto, la configuración del banco o la información de los impuestos, puede hacerlo desde esta página.  

## <a name="adding-users-and-permissions"></a>Agregar usuarios y permisos

[!INCLUDE [2023rw1-sec-group-short](includes/2023rw1-sec-group-short.md)]

Agrega usuarios en el centro de administración de Microsoft 365. Para obtener más información, vea [Crear usuarios de acuerdo con las licencias](ui-how-users-permissions.md).
...
### <a name="set-up-your-company-in-"></a>Configure su empresa en [!INCLUDE[prod_short](includes/prod_short.md)]
...
La página **Configuración asistida** podría contener otras entradas. Cuando finaliza una configuración, su estado es **Completado**. Puede configurar otras áreas de la empresa mediante la configuración manual. Para obtener más información, consulte [Configurar [!INCLUDE[prod_short](includes/prod_short.md)]](setup.md).  
...
[Formación de Microsoft](/training/dynamics365/business-central?WT.mc_id=dyn365bc_landingpage-docs)  
