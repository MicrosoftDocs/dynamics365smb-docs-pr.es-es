...
ms.author: edupont
---
# <a name="get-ready-for-doing-business"></a><a name="get-ready-for-doing-business"></a><a name="get-ready-for-doing-business"></a>Prepárese para hacer negocios
...
## <a name="teaching-tips-and-tours"></a><a name="teaching-tips-and-tours"></a><a name="teaching-tips-and-tours"></a>Consejos didácticos y recorridos
...
## <a name="role-specific-home-pages"></a><a name="role-specific-home-pages"></a><a name="role-specific-home-pages"></a>Páginas de inicio específicas de rol
...
## <a name="company-information"></a><a name="company-information"></a><a name="company-information"></a>Información de empresa
...
## <a name="adding-users-and-permissions"></a><a name="adding-users-and-permissions"></a><a name="adding-users-and-permissions"></a>Agregar usuarios y permisos
...
## <a name="product-help"></a><a name="product-help"></a><a name="product-help"></a>Ayuda de productos
...
### <a name="set-up-your-company-in-"></a><a name="set-up-your-company-in-"></a><a name="set-up-your-company-in-"></a>Configure su empresa en [!INCLUDE[prod_short](includes/prod_short.md)]
