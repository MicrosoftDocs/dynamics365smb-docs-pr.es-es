...
ms.author: edupont
---
# <a name="track-document-lines"></a><a name="track-document-lines"></a><a name="track-document-lines"></a>Seguimiento de líneas de documentos
...
## <a name="to-track-documents-related-to-a-sales-order-line"></a><a name="to-track-documents-related-to-a-sales-order-line"></a><a name="to-track-documents-related-to-a-sales-order-line"></a>Para realizar un seguimiento de los documentos relacionados con una línea de pedido de venta
