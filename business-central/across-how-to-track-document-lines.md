...
ms.author: edupont
---
# <a name="track-document-lines" />Seguimiento de líneas de documentos
...
## <a name="to-track-documents-related-to-a-sales-order-line" />Para realizar un seguimiento de los documentos relacionados con una línea de pedido de venta
