...
ms.author: edupont
---
# <a name="enable-application-of-ledger-entries-in-different-currencies" />Permitir la liquidación de movimientos de cliente en distintas divisas
...
## <a name="to-enable-application-of-vendor-ledger-entries-in-different-currencies" />Para permitir la liquidación de movimientos de proveedor en divisas distintas
...
## <a name="to-set-up-gl-accounts-for-currency-application-rounding-differences" />Para configurar cuentas para liquidar diferencias de redondeo en divisa
...
## <a name="see-related-microsoft-trainingtrainingmodulesprocess-foreign-currency-payments-dynamics-365-business-central" />Consultar la [formación de Microsoft](/training/modules/process-foreign-currency-payments-dynamics-365-business-central/) relacionada
