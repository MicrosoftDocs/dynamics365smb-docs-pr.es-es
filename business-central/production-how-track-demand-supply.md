...
ms.author: edupont
---
# <a name="track-relations-between-demand-and-supply" />Realizar un seguimiento de las relaciones entre demanda y suministro
...
## <a name="to-track-linked-items" />Para seguir productos relacionados
...
## <a name="untracked-planning-elements" />Elementos planificación sin seguimiento
