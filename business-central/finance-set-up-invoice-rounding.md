...
ms.author: bholtorf
---
# <a name="set-up-invoice-rounding" />Configurar redondeo de factura
...
## <a name="set-up-general-ledger-accounts-for-invoice-rounding-differences" />Configurar cuentas para diferencias de redondeo de facturas
...
### <a name="to-set-up-general-ledger-accounts-for-invoice-rounding-differences" />Para configurar cuentas para diferencias de redondeo de facturas
...
## <a name="set-up-rounding-for-foreign-and-local-currencies" />Configurar redondeo para la divisa extranjera y local
...
### <a name="to-set-up-rounding-for-foreign-currencies" />Configurar redondeo para la divisa extranjera
...
### <a name="to-set-up-rounding-for-your-local-currency" />Configurar redondeo para la divisa local
...
## <a name="activate-the-invoice-rounding-function" />Activar la función de redondeo de factura
