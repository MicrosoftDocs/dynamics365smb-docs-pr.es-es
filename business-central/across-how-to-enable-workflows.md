...
ms.author: edupont
---
# <a name="enable-approval-workflows"></a><a name="enable-approval-workflows"></a><a name="enable-approval-workflows"></a><a name="enable-approval-workflows"></a>Habilitar flujos de trabajo de aprobación
...
## <a name="enable-a-workflow"></a><a name="enable-a-workflow"></a><a name="enable-a-workflow"></a><a name="enable-a-workflow"></a>Habilitar un flujo de trabajo
