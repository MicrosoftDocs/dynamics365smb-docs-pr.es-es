...
ms.author: edupont
---
# <a name="changing-language-and-region"></a><a name="changing-language-and-region"></a>Cambiar idioma y región
...
## <a name="changing-your-region-setting"></a><a name="changing-your-region-setting"></a>Cambiar la configuración de su región
...
## <a name="changing-the-region-setting-for-customers-contacts-and-vendors"></a><a name="changing-the-region-setting-for-customers-contacts-and-vendors"></a>Cambiar la configuración de región para clientes, contactos y proveedores
...
## <a name="application-version"></a><a name="application-version"></a>Versión de la aplicación
...
## <a name="languages-of-the--help"></a><a name="languages-of-the--help"></a>Idiomas de la Ayuda de [!INCLUDE[prod_short](includes/prod_short.md)]
...
### <a name="how-do-i-change-the-language-of-the-microsoft-learn-site"></a><a name="how-do-i-change-the-language-of-the-microsoft-learn-site"></a>¿Cómo cambio el idioma del sitio de Microsoft Learn?
