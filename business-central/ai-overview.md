...
---
# <a name="overview-of-ai-powered-item-marketing-text-preview-with-copilot" />Información general sobre el texto de marketing de productos impulsado por IA (versión preliminar) con Copilot
...
## <a name="what-is-ai-powered-item-marketing-text-with-copilot" />¿Qué es el texto de marketing de productos impulsado por IA con Copilot?
...
## <a name="where-its-used" />Dónde se usa
...
## <a name="why-and-how-to-use-it" />Por qué usarlo y cómo
...
## <a name="current-limitations" />¿Cuáles son las limitaciones actuales?
