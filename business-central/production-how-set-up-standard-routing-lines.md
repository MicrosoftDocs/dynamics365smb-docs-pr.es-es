...
description: Obtenga información sobre cómo configurar tareas estándar y agregar tareas estándar a las operaciones para simplificar el mantenimiento de las rutas.
author: SorenGP
ms.topic: conceptual
ms.devlang: na
ms.tgt_pltfrm: na
...
ms.author: edupont
---
# <a name="set-up-standard-routing-lines"></a><a name="set-up-standard-routing-lines"></a>Configurar de líneas de ruta estándar
...
## <a name="to-set-up-a-standard-task"></a><a name="to-set-up-a-standard-task"></a>Para configurar tareas estándar
...
## <a name="to-add-a-standard-task-to-an-operation"></a><a name="to-add-a-standard-task-to-an-operation"></a>Para añadir una tarea estándar a una operación
