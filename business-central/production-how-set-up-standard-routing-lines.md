...
ms.author: edupont
---
# <a name="set-up-standard-routing-lines" />Configurar de líneas de ruta estándar
...
## <a name="to-set-up-a-standard-task" />Para configurar tareas estándar
...
## <a name="to-add-a-standard-task-to-an-operation" />Para añadir una tarea estándar a una operación
