...
ms.author: bholtorf
---
# <a name="make-payments-with-the-amc-banking-365-fundamentals-extension-or-sepa-credit-transfer"></a><a name="make-payments-with-the-amc-banking-365-fundamentals-extension-or-sepa-credit-transfer"></a><a name="make-payments-with-the-amc-banking-365-fundamentals-extension-or-sepa-credit-transfer"></a>Efectúe pagos con la extensión AMC Banking 365 Fundamentals o transferencia de crédito SEPA
...
## <a name="setting-up-the-amc-banking-365-fundamentals-extension"></a><a name="setting-up-the-amc-banking-365-fundamentals-extension"></a><a name="setting-up-the-amc-banking-365-fundamentals-extension"></a>Configuración de la extensión de AMC Banking 365 Fundamentals
...
## <a name="setting-up-sepa-credit-transfer"></a><a name="setting-up-sepa-credit-transfer"></a><a name="setting-up-sepa-credit-transfer"></a>Configuración de la transferencia de crédito de SEPA
...
### <a name="to-set-up-a-bank-account-for-sepa-credit-transfer"></a><a name="to-set-up-a-bank-account-for-sepa-credit-transfer"></a><a name="to-set-up-a-bank-account-for-sepa-credit-transfer"></a>Para configurar un banco para la transferencia de crédito de SEPA
...
### <a name="to-set-up-a-vendor-card-for-sepa-credit-transfer"></a><a name="to-set-up-a-vendor-card-for-sepa-credit-transfer"></a><a name="to-set-up-a-vendor-card-for-sepa-credit-transfer"></a>Para configurar una ficha de proveedor para la transferencia de crédito de SEPA
...
### <a name="to-set-the-payment-journal-up-to-export-payment-files"></a><a name="to-set-the-payment-journal-up-to-export-payment-files"></a><a name="to-set-the-payment-journal-up-to-export-payment-files"></a>Para configurar el diario de pagos para exportar archivos de pagos
...
## <a name="preparing-the-payment-journal"></a><a name="preparing-the-payment-journal"></a><a name="preparing-the-payment-journal"></a>Preparación del diario de pagos
...
## <a name="exporting-payments-to-a-bank-file"></a><a name="exporting-payments-to-a-bank-file"></a><a name="exporting-payments-to-a-bank-file"></a>Exportación de pagos a un archivo bancario
...
### <a name="to-export-payments-to-a-bank-file"></a><a name="to-export-payments-to-a-bank-file"></a><a name="to-export-payments-to-a-bank-file"></a>Para exportar pagos a un archivo bancario
...
### <a name="to-plan-when-to-post-exported-payments"></a><a name="to-plan-when-to-post-exported-payments"></a><a name="to-plan-when-to-post-exported-payments"></a>Para planificar cuando registrar los pagos exportados
...
### <a name="to-re-export-payments-to-a-bank-file"></a><a name="to-re-export-payments-to-a-bank-file"></a><a name="to-re-export-payments-to-a-bank-file"></a>Para reexportar pagos a un archivo bancario
...
## <a name="posting-the-payments"></a><a name="posting-the-payments"></a><a name="posting-the-payments"></a>Registro de los pagos
