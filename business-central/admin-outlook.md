...
ms.author: jswymer
---
# <a name="get-the-business-central-add-in-for-outlook" />Obtener el complemento Business Central para Outlook
...
## <a name="about-the-business-central-add-in-for-outlook" />Acerca del complemento Business Central para Outlook
...
## <a name="deploy-the-add-in-by-using-centralized-deployment-as-an-admin" />Implementar el complemento mediante Implementación centralizada como administrador
...
### <a name="deploy-the-add-in" />Implementar el complemento
