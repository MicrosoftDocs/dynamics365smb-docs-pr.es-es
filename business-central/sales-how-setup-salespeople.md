...
ms.author: edupont
---
# <a name="set-up-salespeople"></a><a name="set-up-salespeople"></a><a name="set-up-salespeople"></a>Configurar vendedores
...
## <a name="to-set-up-a-salesperson-code"></a><a name="to-set-up-a-salesperson-code"></a><a name="to-set-up-a-salesperson-code"></a>Para configurar un código de vendedor
