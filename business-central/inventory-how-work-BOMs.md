...
Un L.M. de producción es los datos maestros que definen un producto y los componentes que entren ellos. Para los artículos de ensamblado, el L.M. de producción se debe certificar y asignar al producto antes de que se pueda utilizar en una orden de producción. Cuando introduzca el producto en una línea del orden de producción, manualmente o restaurando el pedido, el contenido del L.M. de producción se convertirá en los componentes de la orden de producción. Obtenga más información en [Crear L.M. de producción](production-how-to-create-production-boms.md).

El concepto de recursos de producción es mucho más avanzado que en administración de ensamblados. Los puestos de trabajo y los centros de máquinas actúan como recursos. Las operaciones asignadas a los recursos en las hojas de ruta para la producción representan los pasos de la producción. Obtenga más información en el artículo [Creación de rutas](production-how-to-create-routings.md).
