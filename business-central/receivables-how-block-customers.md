...
ms.author: edupont
---
# <a name="block-customers"></a><a name="block-customers"></a>Bloquear clientes
...
## <a name="to-block-a-customer"></a><a name="to-block-a-customer"></a>Para bloquear a un cliente
