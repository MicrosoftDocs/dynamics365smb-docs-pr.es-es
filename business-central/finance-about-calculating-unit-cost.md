...
---
# <a name="about-unit-cost-calculation" />Acerca del cálculo de coste unitario
...
## <a name="when-is-the-unit-cost-field-updated" />Cuando se actualiza el campo de coste unitario
...
### <a name="costing-method-fifo-lifo-specific-or-average" />Métodos de gestión de costes FIFO, LIFO, Específico o Promedio
