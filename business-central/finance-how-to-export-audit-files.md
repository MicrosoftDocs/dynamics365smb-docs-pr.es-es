...
# <a name="audit-file-export" />Exportación de archivo de auditoría
...
## <a name="set-up-audit-file-export" />Configurar la exportación de archivos de auditoría
...
## <a name="provide-the-gl-account-mapping-for-audit-file-export" />Proporcione la asignación de cuentas de mayor para la exportación de archivos de auditoría
...
## <a name="export-the-audit-file" />Exportar el archivo auditoría
