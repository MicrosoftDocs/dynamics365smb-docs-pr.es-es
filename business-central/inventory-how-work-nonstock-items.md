---
title: Crear y administrar artículos del catálogo
...
# <a name="work-with-catalog-items"></a>Trabajar con elementos del catálogo
...
2. En la página **Artículos del catálogo**, elija la acción **Nuevo** .
3. En la página  **Artículo de catálogo tarjeta**, complete los campos según sea necesario. [!INCLUDE[tooltip-inline-tip](includes/tooltip-inline-tip_md.md)]
