...
ms.author: edupont
---
# <a name="add-extended-text" />Agregar textos adicionales
...
## <a name="to-define-extended-text-for-an-description" />Para definir el texto adicional de una descripción
...
## <a name="to-add-an-extended-item-text-on-a-sales-order-line" />Para agregar un texto de producto adicional en un pedido de venta línea
