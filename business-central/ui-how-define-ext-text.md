...
ms.author: edupont
---
# <a name="add-extended-text"></a><a name="add-extended-text"></a>Agregar textos adicionales
...
## <a name="to-define-extended-text-for-an-description"></a><a name="to-define-extended-text-for-an-description"></a>Para definir el texto adicional de una descripción
...
## <a name="to-add-an-extended-item-text-on-a-sales-order-line"></a><a name="to-add-an-extended-item-text-on-a-sales-order-line"></a>Para agregar un texto de producto adicional en un pedido de venta línea
