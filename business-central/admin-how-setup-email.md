---
title: Configurar el correo electrónico en Business Central
...
>
> El problema se debe a las acciones vinculadas en las API de documentos que envían correo electrónico. Para obtener más información sobre las acciones vinculadas, vaya a [Acciones vinculadas](/dynamics365/business-central/dev-itpro/api-reference/v2.0/resources/dynamics_salesinvoice#bound-actions). 
>
...
## <a name="use-smtp"></a>Utilizar SMTP
...
> 
> Debe crear un registro de aplicación en Azure Portal y luego ejecutar la guía de configuración asistida **Configurar Microsoft Entra ID** en [!INCLUDE[prod_short](includes/prod_short.md)] para conectarse a Microsoft Entra ID. Para obtener más información, consulte [Crear un registro de aplicación para Business Central en Azure Portal](admin-how-setup-email.md#create-an-app-registration-for-business-central-in-azure-portal).
>
...
## <a name="use-the-set-up-email-assisted-setup-guide"></a>Utilizar la guía de configuración asistida Configurar correo electrónico
...
## <a name="specify-how-many-messages-an-account-can-send-per-minute"></a>Especificar cuántos mensajes puede enviar una cuenta por minuto
...
## <a name="set-up-reusable-email-texts-and-layouts"></a>Configure textos y diseños de correo electrónico reutilizables
...
## <a name="optional-monitor-email-usage-and-troubleshoot-email-failures-with-telemetry"></a>Opcional: supervise el uso del correo electrónico y resuelva los errores de correo electrónico con telemetría

Los administradores pueden activar la función de telemetría en [!INCLUDE[prod_short](includes/prod_short.md)] para obtener datos sobre el uso y los fallos de diferentes capacidades en el sistema. Para el correo electrónico, registramos las siguientes operaciones:
...
Puede usar estos datos para supervisar el uso del correo electrónico y solucionar errores de correo electrónico. Obtenga más información en [Análisis de la telemetría de correo electrónico (contenido de administración)](/dynamics365/business-central/dev-itpro/administration/telemetry-email-trace).  

## <a name="set-up-email-for-business-central-on-premises"></a>Configuración del correo electrónico para Business Central en las instalaciones
...
### <a name="create-an-app-registration-for-business-central-in-azure-portal"></a>Crear un registro de aplicación para Business Central en Azure Portal

Los pasos para registrar [!INCLUDE[prod_short](includes/prod_short.md)] en Azure Portal se describen en [Registrar una aplicación en Microsoft Entra ID](/dynamics365/business-central/dev-itpro/administration/register-app-azure#register-an-application-in-azure-active-directory).
...
### <a name="connect--to-your-app-registration"></a>Conectar [!INCLUDE[prod_short](includes/prod_short.md)] al registro de su aplicación

Después de registrar su aplicación en Azure Portal, en [!INCLUDE[prod_short](includes/prod_short.md)], utilice página **Registro de Microsoft Entra ID para aplicaciones de correo electrónico** para conectar [!INCLUDE[prod_short](includes/prod_short.md)].

1. En [!INCLUDE[prod_short](includes/prod_short.md)], elija el icono ![Bombilla que abre la función Dígame.](media/ui-search/search_small.png "Dígame qué desea hacer") , escriba **Registro de Microsoft Entra ID para aplicaciones de correo electrónico** y luego elija el enlace relacionado.
2. Rellene los campos según sea necesario. [!INCLUDE[tooltip-inline-tip](includes/tooltip-inline-tip_md.md)]
...
[Obtener [!INCLUDE[prod_short](includes/prod_short.md)] en mi dispositivo móvil](install-mobile-app.md)   
[Obtener [!INCLUDE[prod_short](includes/prod_short.md)] en mi dispositivo móvil](install-mobile-app.md)   
