...
# <a name="set-up-email"></a><a name="set-up-email"></a><a name="set-up-email"></a><a name="set-up-email"></a>Configurar correo electrónico
...
## <a name="requirements"></a><a name="requirements"></a><a name="requirements"></a><a name="requirements"></a>Requisitos
...
## <a name="adding-email-accounts"></a><a name="adding-email-accounts"></a><a name="adding-email-accounts"></a><a name="adding-email-accounts"></a>Agregar cuentas de correo electrónico
...
## <a name="using-smtp"></a><a name="using-smtp"></a><a name="using-smtp"></a><a name="using-smtp"></a>Uso de SMTP
...
## <a name="add-email-accounts"></a><a name="add-email-accounts"></a><a name="add-email-accounts"></a><a name="add-email-accounts"></a>Agregar cuentas de correo electrónico
...
is this still true?-->
## <a name="assign-email-scenarios-to-email-accounts"></a><a name="assign-email-scenarios-to-email-accounts"></a><a name="assign-email-scenarios-to-email-accounts"></a><a name="assign-email-scenarios-to-email-accounts"></a>Asignar escenarios de correo electrónico a cuentas de correo electrónico
...
<!--
## <a name="to-set-up-email"></a><a name="to-set-up-email"></a><a name="to-set-up-email"></a><a name="to-set-up-email"></a>To set up email
...
## <a name="set-up-view-policies"></a><a name="set-up-view-policies"></a><a name="set-up-view-policies"></a><a name="set-up-view-policies"></a>Configurar directivas de visualización
...
## <a name="specify-how-many-messages-an-account-can-send-per-minute"></a><a name="specify-how-many-messages-an-account-can-send-per-minute"></a><a name="specify-how-many-messages-an-account-can-send-per-minute"></a><a name="specify-how-many-messages-an-account-can-send-per-minute"></a>Especificar cuántos mensajes puede enviar una cuenta por minuto
...
## <a name="set-up-reusable-email-texts-and-layouts"></a><a name="set-up-reusable-email-texts-and-layouts"></a><a name="set-up-reusable-email-texts-and-layouts"></a><a name="set-up-reusable-email-texts-and-layouts"></a>Configure textos y diseños de correo electrónico reutilizables
...
## <a name="use-a-substitute-sender-address-on-outbound-email-messages"></a><a name="use-a-substitute-sender-address-on-outbound-email-messages"></a><a name="use-a-substitute-sender-address-on-outbound-email-messages"></a><a name="use-a-substitute-sender-address-on-outbound-email-messages"></a>Usar una dirección de remitente sustituta en los mensajes de correo electrónico salientes
...
### <a name="to-use-the-substitute-address-in-approval-workflows"></a><a name="to-use-the-substitute-address-in-approval-workflows"></a><a name="to-use-the-substitute-address-in-approval-workflows"></a><a name="to-use-the-substitute-address-in-approval-workflows"></a>To use the substitute address in approval workflows
...
## <a name="set-up-document-sending-profiles"></a><a name="set-up-document-sending-profiles"></a><a name="set-up-document-sending-profiles"></a><a name="set-up-document-sending-profiles"></a>Configurar perfiles de envío de documentos
...
## <a name="optional-set-up-email-logging-in-exchange-online"></a><a name="optional-set-up-email-logging-in-exchange-online"></a><a name="optional-set-up-email-logging-in-exchange-online"></a><a name="optional-set-up-email-logging-in-exchange-online"></a>Opcional: Configurar el registro de correo electrónico en Exchange Online
...
## <a name="setting-up-email-for-business-central-on-premises"></a><a name="setting-up-email-for-business-central-on-premises"></a><a name="setting-up-email-for-business-central-on-premises"></a><a name="setting-up-email-for-business-central-on-premises"></a>Configuración del correo electrónico para Business Central en las instalaciones
...
### <a name="create-an-app-registration-for-business-central-in-azure-portal"></a><a name="create-an-app-registration-for-business-central-in-azure-portal"></a><a name="create-an-app-registration-for-business-central-in-azure-portal"></a><a name="create-an-app-registration-for-business-central-in-azure-portal"></a>Crear un registro de aplicación para Business Central en Azure Portal
...
### <a name="connect--to-your-app-registration"></a><a name="connect--to-your-app-registration"></a><a name="connect--to-your-app-registration"></a><a name="connect--to-your-app-registration"></a>Conectar [!INCLUDE[prod_short](includes/prod_short.md)] al registro de su aplicación
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Consultar la [formación de Microsoft](/training/modules/set-up-email/) relacionada
