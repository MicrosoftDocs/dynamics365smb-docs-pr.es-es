...
# <a name="set-up-email" />Configurar correo electrónico
...
## <a name="requirements" />Requisitos
...
## <a name="adding-email-accounts" />Agregar cuentas de correo electrónico
...
## <a name="add-email-accounts" />Agregar cuentas de correo electrónico
...
is this still true?-->
## <a name="assign-email-scenarios-to-email-accounts" />Asignar escenarios de correo electrónico a cuentas de correo electrónico
...
## <a name="set-up-view-policies" />Configurar directivas de visualización
...
## <a name="specify-how-many-messages-an-account-can-send-per-minute" />Especificar cuántos mensajes puede enviar una cuenta por minuto
...
## <a name="set-up-reusable-email-texts-and-layouts" />Configure textos y diseños de correo electrónico reutilizables
...
## <a name="use-a-substitute-sender-address-on-outbound-email-messages" />Usar una dirección de remitente sustituta en los mensajes de correo electrónico salientes
...
## <a name="set-up-document-sending-profiles" />Configurar perfiles de envío de documentos
...
## <a name="optional-set-up-email-logging-in-exchange-online" />Opcional: Configurar el registro de correo electrónico en Exchange Online
...
## <a name="setting-up-email-for-business-central-on-premises" />Configuración del correo electrónico para Business Central en las instalaciones
...
### <a name="create-an-app-registration-for-business-central-in-azure-portal" />Crear un registro de aplicación para Business Central en Azure Portal
...
### <a name="connect-includeprodshortincludesprodshortmd-to-your-app-registration" />Conectar [!INCLUDE[prod_short](includes/prod_short.md)] al registro de su aplicación
...
## <a name="see-related-microsoft-trainingtrainingmodulesset-up-email" />Consultar la [formación de Microsoft](/training/modules/set-up-email/) relacionada
