...
ms.author: edupont
---
# <a name="export-and-import-approval-workflows"></a><a name="export-and-import-approval-workflows"></a>Importar y exportar flujos de trabajo de aprobación
...
## <a name="export-a-workflow"></a><a name="export-a-workflow"></a>Exportar un flujo de trabajo
...
## <a name="import-a-workflow"></a><a name="import-a-workflow"></a>Importar un flujo de trabajo
