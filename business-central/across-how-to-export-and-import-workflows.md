...
ms.author: edupont
---
# <a name="export-and-import-approval-workflows" />Importar y exportar flujos de trabajo de aprobación
...
## <a name="export-a-workflow" />Exportar un flujo de trabajo
...
## <a name="import-a-workflow" />Importar un flujo de trabajo
