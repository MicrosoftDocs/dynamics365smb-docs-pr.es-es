...
ms.author: edupont
---
# <a name="manage-saved-settings-for-reports-and-batch-jobs" />Administrar configuraciones guardadas para informes y trabajos por lotes
...
## <a name="manage-saved-settings" />Administrar la configuración guardada
...
## <a name="create-or-modify-saved-settings-for-all-users" />Crear o modificar la configuración guardada para todos los usuarios
