...
ms.author: edupont
---
# <a name="print-the-picking-list" />Imprimir la lista de picking
...
## <a name="to-print-a-picking-list-from-a-sales-order" />Para imprimir una lista de picking a partir de un pedido de venta
