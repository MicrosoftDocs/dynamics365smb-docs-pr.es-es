...
ms.author: edupont
---
# <a name="print-the-picking-list"></a><a name="print-the-picking-list"></a>Imprimir la lista de picking
...
## <a name="to-print-a-picking-list-from-a-sales-order"></a><a name="to-print-a-picking-list-from-a-sales-order"></a>Para imprimir una lista de picking a partir de un pedido de venta
