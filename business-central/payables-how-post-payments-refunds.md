...
ms.author: edupont
---
# <a name="record-payments-and-refunds-in-the-payment-journal"></a><a name="record-payments-and-refunds-in-the-payment-journal"></a>Registrar pagos y reembolsos en el diario de pagos
...
## <a name="to-make-payments-in-the-payment-journal"></a><a name="to-make-payments-in-the-payment-journal"></a>Realizar pagos en el diario de pagos.
...
## <a name="to-issue-a-refund-check"></a><a name="to-issue-a-refund-check"></a>Para emitir un cheque de reembolso
