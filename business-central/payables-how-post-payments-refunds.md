...
ms.author: edupont
---
# <a name="record-payments-and-refunds-in-the-payment-journal" />Registrar pagos y reembolsos en el diario de pagos
...
## <a name="to-make-payments-in-the-payment-journal" />Realizar pagos en el diario de pagos.
...
## <a name="to-issue-a-refund-check" />Para emitir un cheque de reembolso
