...
---
# <a name="design-details-balancing-supply-and-demand"></a><a name="design-details-balancing-supply-and-demand"></a><a name="design-details-balancing-supply-and-demand"></a><a name="design-details-balancing-supply-and-demand"></a>Detalles de diseño: Equilibrio de oferta y demanda
...
## <a name="supply-and-demand"></a><a name="supply-and-demand"></a><a name="supply-and-demand"></a><a name="supply-and-demand"></a>Oferta y demanda
...
## <a name="the-concept-of-balancing-in-brief"></a><a name="the-concept-of-balancing-in-brief"></a><a name="the-concept-of-balancing-in-brief"></a><a name="the-concept-of-balancing-in-brief"></a>El concepto del equilibrio en resumen
...
## <a name="process-orders-before-the-planning-start-date"></a><a name="process-orders-before-the-planning-start-date"></a><a name="process-orders-before-the-planning-start-date"></a><a name="process-orders-before-the-planning-start-date"></a>Procesar pedidos antes de la fecha de inicio de la planificación
...
### <a name="serial-and-lot-numbers-and-order-to-order-links-are-exempt-from-the-previous-period"></a><a name="serial-and-lot-numbers-and-order-to-order-links-are-exempt-from-the-previous-period"></a><a name="serial-and-lot-numbers-and-order-to-order-links-are-exempt-from-the-previous-period"></a><a name="serial-and-lot-numbers-and-order-to-order-links-are-exempt-from-the-previous-period"></a>Los números de serie y de lote y las conexiones de pedido contra pedido están exentos del periodo anterior
...
## <a name="load-inventory-profiles"></a><a name="load-inventory-profiles"></a><a name="load-inventory-profiles"></a><a name="load-inventory-profiles"></a>Cargar los perfiles de inventario
...
### <a name="item-dimensions-are-separated"></a><a name="item-dimensions-are-separated"></a><a name="item-dimensions-are-separated"></a><a name="item-dimensions-are-separated"></a>Las dimensiones de producto están separadas
...
### <a name="serial-and-lot-numbers-are-loaded-by-specification-level"></a><a name="serial-and-lot-numbers-are-loaded-by-specification-level"></a><a name="serial-and-lot-numbers-are-loaded-by-specification-level"></a><a name="serial-and-lot-numbers-are-loaded-by-specification-level"></a>Los números de serie y de lote se cargan por nivel de especificación
...
### <a name="order-to-order-links-are-never-broken"></a><a name="order-to-order-links-are-never-broken"></a><a name="order-to-order-links-are-never-broken"></a><a name="order-to-order-links-are-never-broken"></a>Las conexiones de pedido contra pedido nunca se rompen
...
### <a name="component-need-is-loaded-according-to-production-order-changes"></a><a name="component-need-is-loaded-according-to-production-order-changes"></a><a name="component-need-is-loaded-according-to-production-order-changes"></a><a name="component-need-is-loaded-according-to-production-order-changes"></a>La necesidad de componente se carga según los cambios de la orden de producción
...
### <a name="consume-safety-stock"></a><a name="consume-safety-stock"></a><a name="consume-safety-stock"></a><a name="consume-safety-stock"></a>Consumir el stock de seguridad
...
### <a name="forecast-demand-is-reduced-by-sales-orders"></a><a name="forecast-demand-is-reduced-by-sales-orders"></a><a name="forecast-demand-is-reduced-by-sales-orders"></a><a name="forecast-demand-is-reduced-by-sales-orders"></a>Los pedidos de ventas reducen la demanda de previsión
...
### <a name="blanket-order-demand-is-reduced-by-sales-orders"></a><a name="blanket-order-demand-is-reduced-by-sales-orders"></a><a name="blanket-order-demand-is-reduced-by-sales-orders"></a><a name="blanket-order-demand-is-reduced-by-sales-orders"></a>Los pedidos de venta reducen la demanda del pedido abierto
...
## <a name="prioritize-orders"></a><a name="prioritize-orders"></a><a name="prioritize-orders"></a><a name="prioritize-orders"></a>Prioridad de pedidos
...
### <a name="priorities-on-the-demand-side"></a><a name="priorities-on-the-demand-side"></a><a name="priorities-on-the-demand-side"></a><a name="priorities-on-the-demand-side"></a>Prioridades en la demanda
...
### <a name="priorities-on-the-supply-side"></a><a name="priorities-on-the-supply-side"></a><a name="priorities-on-the-supply-side"></a><a name="priorities-on-the-supply-side"></a>Prioridades en el suministro
...
### <a name="priority-related-to-the-state-of-supply-and-demand"></a><a name="priority-related-to-the-state-of-supply-and-demand"></a><a name="priority-related-to-the-state-of-supply-and-demand"></a><a name="priority-related-to-the-state-of-supply-and-demand"></a>Prioridad relacionada con el estado de la oferfta y la demanda
...
## <a name="balancing-supply-with-demand"></a><a name="balancing-supply-with-demand"></a><a name="balancing-supply-with-demand"></a><a name="balancing-supply-with-demand"></a>Equilibrio de oferta y demanda
...
### <a name="rules-for-actions-for-supply-events"></a><a name="rules-for-actions-for-supply-events"></a><a name="rules-for-actions-for-supply-events"></a><a name="rules-for-actions-for-supply-events"></a>Reglas de acciones para los eventos de oferta
...
### <a name="determine-the-supply-quantity"></a><a name="determine-the-supply-quantity"></a><a name="determine-the-supply-quantity"></a><a name="determine-the-supply-quantity"></a>Determinar la cantidad de aprovisionamiento
...
### <a name="order-tracking-links-during-planning"></a><a name="order-tracking-links-during-planning"></a><a name="order-tracking-links-during-planning"></a><a name="order-tracking-links-during-planning"></a>Conexiones de seguimiento de pedidos durante la planificación
...
## <a name="close-balanced-supply-and-demand"></a><a name="close-balanced-supply-and-demand"></a><a name="close-balanced-supply-and-demand"></a><a name="close-balanced-supply-and-demand"></a>Cerrar la oferta y demanda equilibradas
...
### <a name="create-the-planning-line-suggested-action"></a><a name="create-the-planning-line-suggested-action"></a><a name="create-the-planning-line-suggested-action"></a><a name="create-the-planning-line-suggested-action"></a>Crear la línea de planificación (acción sugerida)
