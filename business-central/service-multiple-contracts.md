...
ms.author: edupont
---
# <a name="multiple-contracts" />Contratos múltiples
...
## <a name="creating-multiple-contracts-per-service-item" />Creación de múltiples contratos por producto de servicio
...
## <a name="copying-documents" />Copiar documentos
...
## <a name="creating-service-orders-for-multiple-contracts" />Creación de pedidos de servicios para múltiples contratos
