...
# <a name="work-with-calendar-dates-and-times" />Trabajar con fechas y horas del calendario
...
## <a name="check-your-region-and-language-settings" />Compruebe su región y la configuración de idioma
...
### <a name="picking-dates-from-the-calendar" />Seleccionar fechas del calendario
...
### <a name="day-week-year-pattern" />Patrón día\-semana\-año
...
### <a name="digit-patterns" />Patrones de dígitos
...
### <a name="work-date" />Fecha de trabajo
...
### <a name="closing-date" />Fecha cierre
...
## <a name="a-namebkmksettingdaterangesa-setting-ranges" /><a name="BKMK_SettingDateRanges"></a> Configuración de rangos
...
## <a name="use-date-formulas" />Usar fórmulas de fecha
...
## <a name="entering-combined-dates-and-times" />Introducir fechas y horas combinadas
