...
# <a name="work-with-calendar-dates-and-times"></a><a name="work-with-calendar-dates-and-times"></a><a name="work-with-calendar-dates-and-times"></a><a name="work-with-calendar-dates-and-times"></a>Trabajar con fechas y horas del calendario
...
## <a name="check-your-region-and-language-settings"></a><a name="check-your-region-and-language-settings"></a><a name="check-your-region-and-language-settings"></a><a name="check-your-region-and-language-settings"></a>Compruebe su región y la configuración de idioma
...
### <a name="picking-dates-from-the-calendar"></a><a name="picking-dates-from-the-calendar"></a><a name="picking-dates-from-the-calendar"></a><a name="picking-dates-from-the-calendar"></a>Seleccionar fechas del calendario
...
### <a name="day-week-year-pattern"></a><a name="day-week-year-pattern"></a><a name="day-week-year-pattern"></a><a name="day-week-year-pattern"></a>Patrón día\-semana\-año
...
### <a name="digit-patterns"></a><a name="digit-patterns"></a><a name="digit-patterns"></a><a name="digit-patterns"></a>Patrones de dígitos
...
### <a name="today"></a><a name="today"></a><a name="today"></a><a name="today"></a>Hoy
...
### <a name="period"></a><a name="period"></a><a name="period"></a><a name="period"></a>Período
...
### <a name="work-date"></a><a name="work-date"></a><a name="work-date"></a><a name="work-date"></a>Fecha de trabajo
...
### <a name="closing-date"></a><a name="closing-date"></a><a name="closing-date"></a><a name="closing-date"></a>Fecha cierre
...
## <a name="setting-ranges"></a><a name="setting-ranges"></a><a name="setting-ranges"></a><a name="setting-ranges"></a><a name="BKMK_SettingDateRanges"></a> Configuración de rangos
...
## <a name="use-date-formulas"></a><a name="use-date-formulas"></a><a name="use-date-formulas"></a><a name="use-date-formulas"></a>Usar fórmulas de fecha
...
<!--
# <a name="entering-date-ranges"></a><a name="entering-date-ranges"></a><a name="entering-date-ranges"></a><a name="entering-date-ranges"></a>Entering Date Ranges
...
## <a name="use-date-formulas-1"></a><a name="use-date-formulas-1"></a><a name="use-date-formulas-1"></a><a name="use-date-formulas-1"></a>Use Date Formulas
...
## <a name="entering-combined-dates-and-times"></a><a name="entering-combined-dates-and-times"></a><a name="entering-combined-dates-and-times"></a><a name="entering-combined-dates-and-times"></a>Introducir fechas y horas combinadas
