...
ms.author: bholtorf
---
# <a name="design-details-costing-methods"></a><a name="design-details-costing-methods"></a>Detalles de diseño: Métodos de coste
...
### <a name="effect-of-costing-methods-on-valuing-inventory-increases"></a><a name="effect-of-costing-methods-on-valuing-inventory-increases"></a>Efecto de los métodos de coste en la valoración de entrada de existencias
...
#### <a name="standard"></a><a name="standard"></a>Estándar

En el caso de productos donde se use el método de costes **Estándar**, las entradas de existencias se calculan según el coste estándar actual.  

### <a name="effect-of-costing-methods-on-valuing-inventory-decreases"></a><a name="effect-of-costing-methods-on-valuing-inventory-decreases"></a>Efecto de los métodos de coste en la valoración de salidas de existencias
