...
ms.author: bholtorf
---
# <a name="design-details-costing-methods" />Detalles de diseño: Métodos de coste
...
### <a name="effect-of-costing-methods-on-valuing-inventory-increases" />Efecto de los métodos de coste en la valoración de entrada de existencias
...
#### <a name="standard" />Estándar

En el caso de productos donde se use el método de costes **Estándar**, las entradas de existencias se calculan según el coste estándar actual.  

### <a name="effect-of-costing-methods-on-valuing-inventory-decreases" />Efecto de los métodos de coste en la valoración de salidas de existencias
