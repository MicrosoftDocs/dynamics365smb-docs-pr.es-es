...
ms.author: bholtorf
---
# <a name="work-with-service-contracts-and-service-contract-quotes" />Trabajar con contratos de servicio y ofertas de contrato de servicio
...
## <a name="to-create-a-service-contract-or-service-contract-quote" />Para crear un contrato u oferta de contrato de servicio
...
## <a name="to-convert-a-service-contract-quote-to-service-contract" />Para convertir una oferta de contrato de servicio en un contrato de servicio
...
## <a name="to-create-contract-service-credit-memos" />Para crear abonos de servicio de contrato
...
## <a name="updating-and-evaluating-contracts" />Actualización y evaluación de los contratos
...
## <a name="to-add-a-contract-line-to-a-service-contract-or-contract-quote" />Para agregar una línea de contrato a una oferta de contrato o contrato de servicio
...
## <a name="to-remove-contract-lines" />Para eliminar líneas de contrato
...
## <a name="service-line-cost-and-value" />Coste y valor de la línea de servicio
...
## <a name="to-add-a-contract-discount-to-service-contract-quotes" />Para agregar un descuento de contrato a las ofertas de contrato de servicios
...
## <a name="to-change-the-owner-of-a-service-contract" />Para cambiar el propietario de contratos de servicio
...
## <a name="to-update-a-service-contract-price" />Para actualizar un precio de contrato de servicio
...
## <a name="to-post-prepaid-contract-entries" />Para registrar movimientos de contrato de prepago
...
## <a name="changing-the-service-contract-status" />Cambio del estado de contrato de servicio
...
## <a name="to-cancel-a-service-contract" />Para cancelar un contrato de servicio
...
## <a name="filing-a-service-contract-or-contract-quote" />Archivado de un contrato de servicio u oferta de contrato
