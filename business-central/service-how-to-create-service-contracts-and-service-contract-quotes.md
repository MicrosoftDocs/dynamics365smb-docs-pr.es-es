...
ms.author: bholtorf
---
# <a name="work-with-service-contracts-and-service-contract-quotes"></a><a name="work-with-service-contracts-and-service-contract-quotes"></a>Trabajar con contratos de servicio y ofertas de contrato de servicio
...
## <a name="to-create-a-service-contract-or-service-contract-quote"></a><a name="to-create-a-service-contract-or-service-contract-quote"></a>Para crear un contrato u oferta de contrato de servicio
...
## <a name="to-convert-a-service-contract-quote-to-service-contract"></a><a name="to-convert-a-service-contract-quote-to-service-contract"></a>Para convertir una oferta de contrato de servicio en un contrato de servicio
...
## <a name="to-create-contract-service-credit-memos"></a><a name="to-create-contract-service-credit-memos"></a>Para crear abonos de servicio de contrato
...
## <a name="updating-and-evaluating-contracts"></a><a name="updating-and-evaluating-contracts"></a>Actualización y evaluación de los contratos
...
## <a name="to-add-a-contract-line-to-a-service-contract-or-contract-quote"></a><a name="to-add-a-contract-line-to-a-service-contract-or-contract-quote"></a>Para agregar una línea de contrato a una oferta de contrato o contrato de servicio
...
## <a name="to-remove-contract-lines"></a><a name="to-remove-contract-lines"></a>Para eliminar líneas de contrato
...
## <a name="service-line-cost-and-value"></a><a name="service-line-cost-and-value"></a>Coste y valor de la línea de servicio
...
## <a name="to-add-a-contract-discount-to-service-contract-quotes"></a><a name="to-add-a-contract-discount-to-service-contract-quotes"></a>Para agregar un descuento de contrato a las ofertas de contrato de servicios
...
## <a name="to-change-the-owner-of-a-service-contract"></a><a name="to-change-the-owner-of-a-service-contract"></a>Para cambiar el propietario de contratos de servicio
...
## <a name="to-update-a-service-contract-price"></a><a name="to-update-a-service-contract-price"></a>Para actualizar un precio de contrato de servicio
...
## <a name="to-post-prepaid-contract-entries"></a><a name="to-post-prepaid-contract-entries"></a>Para registrar movimientos de contrato de prepago
...
## <a name="changing-the-service-contract-status"></a><a name="changing-the-service-contract-status"></a>Cambio del estado de contrato de servicio
...
## <a name="to-cancel-a-service-contract"></a><a name="to-cancel-a-service-contract"></a>Para cancelar un contrato de servicio
...
## <a name="filing-a-service-contract-or-contract-quote"></a><a name="filing-a-service-contract-or-contract-quote"></a>Archivado de un contrato de servicio u oferta de contrato
