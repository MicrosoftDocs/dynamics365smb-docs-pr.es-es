...
ms.author: soalex
---
# <a name="submit-alerts-about-countryregion-specific-regulatory-features"></a><a name="submit-alerts-about-countryregion-specific-regulatory-features"></a>Enviar alertas sobre las características normativas específicas del país/región
...
## <a name="to-submit-a-regulatory-alert-in-lcs"></a><a name="to-submit-a-regulatory-alert-in-lcs"></a>Para enviar una alerta normativa en LCS
