...
ms.author: edupont
---
# <a name="register-new-items" />Registro de productos nuevos
...
## <a name="to-create-a-new-item-card" />Para crear una nueva ficha de producto.
...
### <a name="to-save-the-item-card-as-a-template" />Para guardar la ficha de producto como plantilla
...
### <a name="items-used-in-production-orders" />Productos utilizados en órdenes de producción
...
## <a name="to-set-up-multiple-vendors-for-an-item" />Para configurar varios proveedores para un producto
...
## <a name="set-up-item-substitutions" />Configurar sustituciones de productos
...
### <a name="to-make-an-item-substitution" />Para identificar la sustitución de un producto
...
## <a name="categories-attributes-and-variants" />Categorías, atributos y variantes

[!INCLUDE[inventory_variant](includes/inventory_variant.md)]

Obtenga más información sobre las variantes en [Administrar variantes de productos](inventory-item-variants.md).  

## <a name="deleting-item-cards" />Eliminar fichas de producto
...
## <a name="manage-inventory-in-warehouses" />Administrar el inventario en almacenes
