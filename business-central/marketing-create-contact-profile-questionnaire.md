...
# <a name="use-profile-questionnaires-to-classify-business-contacts" />Use cuestionarios de perfil para clasificar contactos comerciales
...
## <a name="to-add-a-profile-questionnaire" />Para añadir un cuestionario de perfil
...
## <a name="to-add-questions-to-a-profile-questionnaire" />Para añadir preguntas a un cuestionario de perfil
...
## <a name="apply-questionnaires-to-contacts" />Aplicar cuestionarios a contactos
...
## <a name="the-automatic-classification-of-contacts" />la clasificación automática de los contactos
