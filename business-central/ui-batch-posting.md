...
ms.author: edupont
---
# <a name="post-multiple-documents-at-the-same-time" />Registrar varios documentos al mismo tiempo
...
## <a name="to-post-multiple-purchase-orders-immediately" />Para registrar varios pedidos de compra inmediatamente
...
## <a name="to-batch-post-multiple-purchase-orders" />Para registrar por lotes varios pedidos de compra
...
## <a name="to-set-up-background-posting-with-job-queues" />Para configurar el registro de fondo con colas de proyecto
...
### <a name="to-view-status-from-a-sales-or-purchase-document" />Para ver el estado de un documento de compra o de venta
...
## <a name="to-create-a-job-queue-entry-for-batch-posting-of-sales-orders" />Para crear un movimiento de la cola de proyectos para el registro por lotes de pedidos de ventas
...
## <a name="monitor-the-job-queue" />Supervisar la cola de proyectos
