...
ms.author: edupont
---
# <a name="dimension-set-entries-overview"></a><a name="dimension-set-entries-overview"></a>Información general de los movimientos del grupo dimensiones
...
## <a name="dimension-sets"></a><a name="dimension-sets"></a>Conjuntos de dimensiones
...
## <a name="dimension-set-entries"></a><a name="dimension-set-entries"></a>Movimientos de grupo de dimensiones
...
## <a name="codeunit-408-dimension-management"></a><a name="codeunit-408-dimension-management"></a>Gestión de dimensiones de codeunit 408
...
## <a name="performance-improvement"></a><a name="performance-improvement"></a>Mejora del rendimiento
