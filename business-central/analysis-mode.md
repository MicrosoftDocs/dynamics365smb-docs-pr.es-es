...
---
# <a name="analyze-list-data-using-data-analysis-mode" />Analizar datos en lista usando el modo de análisis de datos
...
## <a name="prerequisite" />Requisito previo
...
## <a name="work-with-data-analysis-mode" />Trabajar con el modo de análisis de datos
...
## <a name="pivot-mode" />Modo dinámico
...
## <a name="limitations" />Limitaciones
