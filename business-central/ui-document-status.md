...
ms.author: bholtorf
---
# <a name="status-field-on-documents"></a><a name="status-field-on-documents"></a><a name="status-field-on-documents"></a>Campo de estado en los documentos
...
## <a name="release-process"></a><a name="release-process"></a><a name="release-process"></a>Proceso de versión
...
### <a name="approval-procedures"></a><a name="approval-procedures"></a><a name="approval-procedures"></a>Procedimientos de aprobación
...
### <a name="warehouse-activities"></a><a name="warehouse-activities"></a><a name="warehouse-activities"></a>Actividades de almacén
...
## <a name="reopen-a-released-order"></a><a name="reopen-a-released-order"></a><a name="reopen-a-released-order"></a>Reapertura de un pedido lanzado
