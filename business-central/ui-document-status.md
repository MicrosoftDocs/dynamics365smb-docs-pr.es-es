...
ms.author: bholtorf
---
# <a name="status-field-on-documents" />Campo de estado en los documentos
...
## <a name="release-process" />Proceso de versión
...
### <a name="approval-procedures" />Procedimientos de aprobación
...
### <a name="warehouse-activities" />Actividades de almacén
...
## <a name="reopen-a-released-order" />Reapertura de un pedido lanzado
