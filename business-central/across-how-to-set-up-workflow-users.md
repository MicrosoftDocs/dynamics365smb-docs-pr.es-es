...
ms.author: bholtorf
---
# <a name="set-up-a-sequence-of-workflow-users"></a><a name="set-up-a-sequence-of-workflow-users"></a>Configurar una secuencia de usuarios de flujo de trabajo
...
## <a name="to-set-up-a-workflow-user-group"></a><a name="to-set-up-a-workflow-user-group"></a>Para configurar un grupo de usuarios de flujo de trabajo
