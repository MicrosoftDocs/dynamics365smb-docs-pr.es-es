...
## <a name="to-set-up-bank-accounts" />Para configurar bancos
...
## <a name="to-enter-an-opening-balance" />Para introducir un saldo inicial
...
## <a name="to-set-up-your-bank-account-for-import-or-export-of-bank-files" />Para configurar la cuenta para la importación o exportación de archivos bancarios
...
## <a name="to-set-up-vendor-bank-accounts-for-export-of-bank-files" />Para configurar cuentas bancarias de proveedor para exportar archivos bancarios
...
## <a name="changing-your-bank-account" />Cambiar su cuenta bancaria
