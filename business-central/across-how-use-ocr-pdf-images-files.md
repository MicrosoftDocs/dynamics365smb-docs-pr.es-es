...
ms.author: edupont
---
# <a name="use-ocr-to-turn-pdf-and-image-files-into-electronic-documents" />Utilizar el servicio OCR para convertir archivos PDF y de imagen en documentos electrónicos
...
## <a name="to-send-a-pdf-or-image-file-to-the-ocr-service-from-the-incoming-documents-page" />Para enviar un archivo PDF o de imagen al servicio OCR desde la página Documentos entrantes
...
## <a name="to-send-a-pdf-or-image-file-to-the-ocr-service-by-email" />Para enviar un archivo PDF o de imagen al servicio OCR por correo electrónico
...
## <a name="to-receive-the-resulting-electronic-document-from-the-ocr-service" />Para recibir el documento electrónico resultante desde el servicio OCR
...
## <a name="to-create-a-purchase-invoice-from-an-electronic-document-received-from-the-ocr-service" />Para crear una factura de compra desde un documento electrónico recibido del servicio de OCR
...
### <a name="to-map-text-on-an-incoming-document-to-a-specific-vendor-account" />Para asignar texto en un documento entrante a una cuenta de proveedor específica
...
## <a name="to-handle-errors-when-receiving-electronic-documents" />Para gestionar errores al recibir documentos electrónicos
...
## <a name="to-train-the-ocr-service-to-avoid-errors" />Para preparar al servicio OCR para evitar errores
