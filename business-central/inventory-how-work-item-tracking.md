---
title: 'Seguir productos con números de serie, de lote y de paquete'
...
---
# Seguir productos con números de serie, de lote y de paquete
...
Los campos de cantidad del encabezado de la página **Líns. seguim. prod.** muestra las cantidades y las sumas de los números de seguimiento de producto que se definen en las líneas. Las cantidades deben corresponder a las de las líneas del documento, lo que se indica con  *0* en los campos  **Indefinido** .
...
## Disponibilidad de seguimiento de productos
...
Si trabaja en la página  **Líneas de seguimiento de artículos**  durante mucho tiempo, o si hay muchas actividades con el artículo con el que está trabajando, puede elegir la acción  **Actualizar disponibilidad** . Además, el programa volverá a comprobar la disponibilidad del producto cuando cierre la página, con el fin de garantizar que no existe ningún problema de disponibilidad.

## Para asignar números de serie o lote en una transacción de entrada
...
### Para gestionar números de serie y de lote al obtener las líneas de recepción de una factura de compra
...
## Para asignar un número de serie o lote en una transacción de salida
...
### Para seleccionar los números de serie o de lote existentes  
...
### Para asignar números de lote o de serie nuevos  
...
### Asignar números de seguimiento en documentos de origen
...
## Para controlar números de serie y lote en los pedidos de transferencia
...
## Para registrar información adicional de números de serie o lote
...
## Para modificar la información relativa al número de serie o de lote actuales
...
3. En la página  **Elemento n.º tarjeta**, elija la acción  **Relacionado**, elija la acción  **Relacionado**, elija la acción  **Entradas**  y, luego, elija  **Entradas contables**.
...
## Para reclasificar números de lote o de serie
...
1. Elija el icono ![Bombilla que abre la característica Dígame](media/ui-search/search_small.png "Dígame qué desea hacer") Icono, ingrese **Diarios de reclasificación de artículos** y luego elija el vincular relacionado.  
...
4. En el campo **Números de serie** o **Números de lote**, Seleccionar el número de serie o lote actual.  
...
|Líneas de seguimiento de artículos de almacén     |* N.º serie<br><br>* Nuevo nº serie<br><br>* N.º lote<br><br>* Nuevo nº lote<br><br>* N.º paquete<br><br>* N.º de nuevo paquete|
