...
ms.author: jswymer
---
# <a name="viewing-and-editing-in-excel-from-business-central"></a><a name="viewing-and-editing-in-excel-from-business-central"></a>Ver y editar en Excel desde Business Central
...
## <a name="open-in-excel"></a><a name="open-in-excel"></a>Abrir en Excel
...
## <a name="edit-in-excel"></a><a name="edit-in-excel"></a>Editar en Excel
...
### <a name="first-time-sign-in"></a><a name="first-time-sign-in"></a>Primer inicio de sesión
...
### <a name="work-across-environments-and-companies"></a><a name="work-across-environments-and-companies"></a>Trabajar en entornos y empresas diferentes
...
### <a name="limits-when-using-excel-for-the-web"></a><a name="limits-when-using-excel-for-the-web"></a>Límites al usar Excel para la web
...
## <a name="see-the-differences-between-the-options"></a><a name="see-the-differences-between-the-options"></a>Consulte las diferencias entre las opciones
<br><br>  
