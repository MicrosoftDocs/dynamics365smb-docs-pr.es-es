...
ms.author: edupont
---
# <a name="view-the-availability-of-items" />Consultar la disponibilidad de los productos
...
## <a name="to-view-the-availability-of-an-item-according-to-when-it-will-be-received-or-shipped" />Para consultar la disponibilidad de un producto según cuándo se recibirá o enviará
...
## <a name="to-view-the-availability-of-an-item-in-different-periods" />Para consultar la disponibilidad de un producto en distintos periodos
...
## <a name="to-view-the-availability-of-an-item-at-the-locations-where-it-is-stored" />Para consultar la disponibilidad de un producto en las ubicaciones donde se almacena
...
## <a name="to-view-the-availability-of-all-items-by-the-location-where-they-are-stored" />Para consultar la disponibilidad de todos los productos en las ubicaciones donde se almacenan
...
## <a name="to-view-the-availability-of-an-item-by-its-use-in-assembly-or-production-boms" />Para consultar la disponibilidad de un producto por su uso en las L.M. de ensamblado o producción
...
### <a name="to-view-the-availability-of-an-item-according-to-demand-for-its-parent" />Para ver la disponibilidad de un producto según la demanda para su principal
...
## <a name="to-view-the-availability-of-an-item-by-its-units-of-measure" />Para ver la disponibilidad de un producto por sus unidades de medida
...
## <a name="to-view-the-availability-of-an-item-by-its-variants" />Para ver la disponibilidad de un producto por sus variantes
...
## <a name="assembly-availability-page" />Página Disponibilidad de ensamblado
