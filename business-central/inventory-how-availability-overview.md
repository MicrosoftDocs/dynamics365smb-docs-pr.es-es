...
## <a name="to-view-the-availability-of-an-item-at-the-locations-where-its-stored"></a>Para consultar la disponibilidad de un producto en las ubicaciones donde se almacena
...
## <a name="to-view-the-availability-of-all-items-by-the-location-where-theyre-stored"></a>Para consultar la disponibilidad de todos los productos en las ubicaciones donde se almacenan
