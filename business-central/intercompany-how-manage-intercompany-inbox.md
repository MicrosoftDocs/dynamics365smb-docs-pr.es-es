...
---
# <a name="manage-the-intercompany-inbox-and-outbox" />Administrar la bandeja de entrada y la bandeja de salida de empresas vinculadas
...
## <a name="organizing-the-inbox" />Organizar la bandeja de entrada
...
### <a name="transaction-source" />Origen de la transacción
...
#### <a name="created-by-intercompany-partner" />Creado por socio de empresas vinculadas
...
#### <a name="returned-from-intercompany-partner" />Devuelto por socio de empresas vinculadas
...
## <a name="recreating-inbox-entries" />Volver a crear movimientos en la bandeja de entrada
...
## <a name="get-an-overview-of-intercompany-transactions-for-a-period" />Obtener un panorama de transacciones de empresas vinculadas durante un periodo
...
## <a name="import-intercompany-transactions-from-a-file" />Importar transacciones entre empresas vinculadas desde un archivo
...
## <a name="process-incoming-intercompany-transactions" />Procesar transacciones entrantes entre empresas vinculadas
...
## <a name="to-process-outgoing-intercompany-transactions" />Procesar transacciones salientes entre empresas vinculadas
...
## <a name="recreate-intercompany-inbox-transactions" />Volver a crear transacciones entre empresas vinculadas en la bandeja de entrada
