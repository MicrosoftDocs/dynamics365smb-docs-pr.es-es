...
# <a name="sign-up-for-a-free-dynamics-365-business-central-trial" />Regístrese para obtener una versión de prueba de Dynamics 365 Business Central
...
## <a name="to-sign-up-for-the-trial" />Para registrarse para la versión de prueba

[!INCLUDE [trial-get](includes/trial-get.md)]

## <a name="what-to-try" />Qué probar
...
## <a name="get-started-with-a-subscription" />Introducción a una suscripción
