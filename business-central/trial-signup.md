...
# <a name="sign-up-for-a-free-dynamics-365-business-central-trial"></a><a name="sign-up-for-a-free-dynamics-365-business-central-trial"></a>Regístrese para obtener una versión de prueba de Dynamics 365 Business Central
...
## <a name="to-sign-up-for-the-trial"></a><a name="to-sign-up-for-the-trial"></a>Para registrarse para la versión de prueba

[!INCLUDE [trial-get](includes/trial-get.md)]

## <a name="what-to-try"></a><a name="what-to-try"></a>Qué probar
...
## <a name="get-started-with-a-subscription"></a><a name="get-started-with-a-subscription"></a>Introducción a una suscripción
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Consultar la [formación de Microsoft](/training/modules/trial-dynamics-365-business-central/) relacionada

## <a name="additional-resources"></a><a name="additional-resources"></a>Recursos adicionales
