...
---
# <a name="monitor-job-progress-and-performance" />Supervisar el progreso y el rendimiento del trabajo
...
## <a name="create-a-job-wip-method" />Crear un método de proyecto WIP
...
## <a name="define-a-wip-method-for-a-job" />Definir un método de WIP para un proyecto
...
### <a name="define-a-wip-method-for-a-job-task" />Definir un método de WIP para una tarea de proyecto
...
## <a name="calculate-wip" />Calcular WIP
...
## <a name="calculate-and-post-job-completion-entries" />Calcular y registrar los movimientos de finalización de proyecto
...
## <a name="view-job-ledger-entries" />Ver los movimientos del proyecto
