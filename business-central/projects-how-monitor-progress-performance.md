...
---
# <a name="monitor-job-progress-and-performance"></a><a name="monitor-job-progress-and-performance"></a>Supervisar el progreso y el rendimiento del trabajo
...
## <a name="create-a-job-wip-method"></a><a name="create-a-job-wip-method"></a>Crear un método de proyecto WIP
...
## <a name="define-a-wip-method-for-a-job"></a><a name="define-a-wip-method-for-a-job"></a>Definir un método de WIP para un proyecto
...
### <a name="define-a-wip-method-for-a-job-task"></a><a name="define-a-wip-method-for-a-job-task"></a>Definir un método de WIP para una tarea de proyecto
...
## <a name="calculate-wip"></a><a name="calculate-wip"></a>Calcular WIP
...
## <a name="post-wip"></a><a name="post-wip"></a>Registrar WIP
...
## <a name="calculate-and-post-job-completion-entries"></a><a name="calculate-and-post-job-completion-entries"></a>Calcular y registrar los movimientos de finalización de proyecto
...
## <a name="view-job-ledger-entries"></a><a name="view-job-ledger-entries"></a>Ver los movimientos del proyecto
...
## <a name="find-related-microsoft-training"></a><a name="find-related-microsoft-training"></a>Encontrar la [formación de Microsoft](/training/paths/calculate-post-job-wip/) relacionada
