...
---
# <a name="monitor-project-progress-and-performance"></a>Supervisar el progreso y el rendimiento del trabajo
...
## <a name="view-project-ledger-entries"></a>Ver los movimientos del proyecto
