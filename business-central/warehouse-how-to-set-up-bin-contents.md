...
ms.author: edupont
---
# <a name="create-bin-contents"></a><a name="create-bin-contents"></a><a name="create-bin-contents"></a>Crear contenido de ubicación
...
## <a name="to-create-bin-content-manually"></a><a name="to-create-bin-content-manually"></a><a name="to-create-bin-content-manually"></a>Para crear el contenido de ubicación manualmente
...
## <a name="to-create-bin-content-with-a-worksheet"></a><a name="to-create-bin-content-with-a-worksheet"></a><a name="to-create-bin-content-with-a-worksheet"></a>Para crear el contenido de una ubicación con una hoja de trabajo
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Consultar la [formación de Microsoft](/training/modules/set-up-zones-bins/) relacionada
