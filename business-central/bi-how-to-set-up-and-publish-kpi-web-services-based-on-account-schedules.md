...
---
# <a name="set-up-and-publish-kpi-web-services-based-on-financial-reports" />Configurar y publicar un servicio web KPI que se basa en informes financieros
...
## <a name="set-up-and-publish-a-kpi-web-service-based-on-financial-reports" />Configurar y publicar un servicio web de KPI que se basa en informes financieros
