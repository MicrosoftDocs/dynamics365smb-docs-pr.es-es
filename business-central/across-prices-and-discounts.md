...
ms.author: bholtorf
---
# <a name="set-up-prices-and-discounts"></a><a name="set-up-prices-and-discounts"></a>Establecer precios y descuentos
...
## <a name="setting-up-prices-and-discounts"></a><a name="setting-up-prices-and-discounts"></a>Establecimiento de precios y descuentos
...
## <a name="about-price-lists"></a><a name="about-price-lists"></a>Acerca de las listas de precios
...
## <a name="set-up-prices"></a><a name="set-up-prices"></a>Configurar precios
...
## <a name="work-with-invoice-discounts-and-service-charges"></a><a name="work-with-invoice-discounts-and-service-charges"></a>Trabajar con descuentos en factura y cargos por servicios
...
## <a name="calculating-the-best-price"></a><a name="calculating-the-best-price"></a>Cálculo del mejor precio
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Consultar la [formación de Microsoft](/training/modules/customer-discounts-dynamics-365-business-central/) relacionada
