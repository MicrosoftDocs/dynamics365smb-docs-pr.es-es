...
ms.author: bholtorf
---
# <a name="set-up-prices-and-discounts" />Establecer precios y descuentos
...
## <a name="setting-up-prices-and-discounts" />Establecimiento de precios y descuentos
...
## <a name="about-price-lists" />Acerca de las listas de precios
...
## <a name="set-up-prices" />Configurar precios
...
## <a name="work-with-invoice-discounts-and-service-charges" />Trabajar con descuentos en factura y cargos por servicios
...
## <a name="calculating-the-best-price" />Cálculo del mejor precio
...
## <a name="see-related-microsoft-trainingtrainingmodulescustomer-discounts-dynamics-365-business-central" />Consultar la [formación de Microsoft](/training/modules/customer-discounts-dynamics-365-business-central/) relacionada
