...
# <a name="set-up-fixed-assets-with-user-defined-depreciation-methods" />Configurar activos fijos con métodos de amortización definidos por el usuario
...
## <a name="to-assign-a-depreciation-book-to-a-fixed-asset-with-a-user-defined-depreciation-method" />Para asignar un libro de amortización a un activo fijo con un método de amortización definido por el usuario
...
## <a name="to-set-up-user-defined-depreciation-methods" />Para configurar métodos de amortización definidos por usuario
...
### <a name="depreciation-based-on-number-of-units" />Amortización según el número de unidades
...
### <a name="example---user-defined-depreciation" />Ejemplo: amortización definida por el usuario
