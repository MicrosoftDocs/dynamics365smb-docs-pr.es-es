...
# <a name="the-c5-data-migration-extension" />Extensión de migración de datos de C5
...
## <a name="what-data-is-migrated" />¿Qué datos se migran?

Se migran los datos siguientes para cada entidad:

### <a name="customers" />Clientes
...
### <a name="chart-of-accounts" />Plan de cuentas
...
## <a name="file-size-requirements" />Requisitos de tamaño del archivo
...
## <a name="to-migrate-data" />Para migrar datos
...
## <a name="viewing-the-status-of-the-migration" />Ver el estado de la migración
...
## <a name="how-to-avoid-double-posting" />Cómo evitar el doble registro
...
## <a name="correcting-errors" />Corrección de errores
...
## <a name="verifying-data-after-migrating" />Comprobar los datos después de la migración
...
## <a name="stopping-data-migration" />Detener la migración de datos
