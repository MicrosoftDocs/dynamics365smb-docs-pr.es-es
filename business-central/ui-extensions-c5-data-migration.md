...
# <a name="the-c5-data-migration-extension"></a><a name="the-c5-data-migration-extension"></a><a name="the-c5-data-migration-extension"></a>Extensión de migración de datos de C5
...
## <a name="what-data-is-migrated"></a><a name="what-data-is-migrated"></a><a name="what-data-is-migrated"></a>¿Qué datos se migran?

Se migran los datos siguientes para cada entidad:

### <a name="customers"></a><a name="customers"></a><a name="customers"></a>Clientes
...
### <a name="vendors"></a><a name="vendors"></a><a name="vendors"></a>Proveedores
...
### <a name="items"></a><a name="items"></a><a name="items"></a>Productos
...
### <a name="chart-of-accounts"></a><a name="chart-of-accounts"></a><a name="chart-of-accounts"></a>Plan de cuentas
...
## <a name="file-size-requirements"></a><a name="file-size-requirements"></a><a name="file-size-requirements"></a>Requisitos de tamaño del archivo
...
## <a name="to-migrate-data"></a><a name="to-migrate-data"></a><a name="to-migrate-data"></a>Para migrar datos
...
## <a name="viewing-the-status-of-the-migration"></a><a name="viewing-the-status-of-the-migration"></a><a name="viewing-the-status-of-the-migration"></a>Ver el estado de la migración
...
## <a name="how-to-avoid-double-posting"></a><a name="how-to-avoid-double-posting"></a><a name="how-to-avoid-double-posting"></a>Cómo evitar el doble registro
...
## <a name="correcting-errors"></a><a name="correcting-errors"></a><a name="correcting-errors"></a>Corrección de errores
...
## <a name="verifying-data-after-migrating"></a><a name="verifying-data-after-migrating"></a><a name="verifying-data-after-migrating"></a>Comprobar los datos después de la migración
...
## <a name="stopping-data-migration"></a><a name="stopping-data-migration"></a><a name="stopping-data-migration"></a>Detener la migración de datos
