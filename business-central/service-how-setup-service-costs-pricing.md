...
# <a name="set-up-pricing-and-additional-costs-for-services" />Configurar precios y costes adicionales de servicios
...
## <a name="to-set-up-a-service-price-group" />Para configurar un grupo de precio de servicio
...
## <a name="to-set-up-a-service-price-adjustment-group" />Para configurar un grupo de ajuste de precios de servicio
...
## <a name="to-set-up-additional-costs-for-services" />Para configurar costes adicionales de servicios
...
### <a name="to-set-up-service-costs" />Para configurar costes de servicio
...
### <a name="to-specify-a-default-cost-for-service-orders" />Para especificar un coste predeterminado de los pedidos de servicio
