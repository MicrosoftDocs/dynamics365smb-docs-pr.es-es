...
ms.author: jswymer
---
# <a name="set-up-a-colored-indicator-on-cues-for-the-company-or-individual-users" />Configurar un indicador de color en pilas para la empresa o usuarios individuales
...
### <a name="to-set-up-colored-indicators-on-cues" />Para configurar indicadores de color en las pilas
