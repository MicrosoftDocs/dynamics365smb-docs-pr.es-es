...
# <a name="control-access-to-business-central-using-security-groups"></a><a name="control-access-to-business-central-using-security-groups"></a>Controlar el acceso a Business Central mediante grupos de seguridad
...
## <a name="business-central-online-and-on-premises"></a><a name="business-central-online-and-on-premises"></a>Business Central online y local
...
## <a name="add-a-security-group-in-business-central"></a><a name="add-a-security-group-in-business-central"></a>Agregar un grupo de seguridad en Business Central
...
### <a name="assign-permissions-to-a-security-group"></a><a name="assign-permissions-to-a-security-group"></a>Asignación de permisos a un grupo de seguridad
...
## <a name="review-the-permissions-in-a-security-group"></a><a name="review-the-permissions-in-a-security-group"></a>Revisar los permisos de un grupo de seguridad
...
## <a name="security-groups-and-user-groups"></a><a name="security-groups-and-user-groups"></a>Grupos de seguridad y grupos de usuarios
...
### <a name="optional-convert-user-groups-to-permission-sets"></a><a name="optional-convert-user-groups-to-permission-sets"></a>Opcional: Convierta grupos de usuarios en conjuntos de permisos
