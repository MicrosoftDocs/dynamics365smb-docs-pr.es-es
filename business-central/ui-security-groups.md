...
# <a name="control-access-to-business-central-using-security-groups" />Controlar el acceso a Business Central mediante grupos de seguridad
...
## <a name="business-central-online-and-on-premises" />Business Central online y local
...
## <a name="add-a-security-group-in-business-central" />Agregar un grupo de seguridad en Business Central
...
### <a name="assign-permissions-to-a-security-group" />Asignación de permisos a un grupo de seguridad
...
## <a name="review-the-permissions-in-a-security-group" />Revisar los permisos de un grupo de seguridad
...
## <a name="security-groups-and-user-groups" />Grupos de seguridad y grupos de usuarios
...
### <a name="optional-convert-user-groups-to-permission-sets" />Opcional: Convierta grupos de usuarios en conjuntos de permisos
