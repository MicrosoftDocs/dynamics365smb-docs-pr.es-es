...
ms.author: edupont
---
# <a name="troubleshooting-self-service-sign-up"></a><a name="troubleshooting-self-service-sign-up"></a>Solución de problemas en el registro de autoservicio
...
## <a name="what-email-address-can-i-use-with-business-central"></a><a name="what-email-address-can-i-use-with-business-central"></a>¿Qué dirección de correo electrónico puedo usar en Business Central?
