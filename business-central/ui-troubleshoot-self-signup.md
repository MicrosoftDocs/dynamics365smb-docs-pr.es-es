...
ms.author: edupont
---
# <a name="troubleshooting-self-service-sign-up" />Solución de problemas en el registro de autoservicio
...
## <a name="what-email-address-can-i-use-with-business-central" />¿Qué dirección de correo electrónico puedo usar en Business Central?
...
## <a name="regional-availability" />Disponibilidad regional
