...
ms.author: edupont
---
# <a name="calculate-order-promising-dates" />Calcular fechas de compromiso de entrega de pedido
...
## <a name="about-order-promising" />Acerca del compromiso de entrega
...
### <a name="available-to-promise" />Neto no comprometido
...
### <a name="capable-to-promise" />Capaz de comprometer
...
## <a name="to-set-up-order-promising" />Para configurar compromisos de pedidos
...
### <a name="inbound-and-outbound-warehouse-handling-times-in-order-promising" />Tiempos de manipulación del almacén de entrada y salida en orden de acuerdo
...
#### <a name="to-enter-default-inbound-and-outbound-warehouse-handling-times-for-sales-and-purchase-documents" />Para introducir tiempos de administración de almacén de entrada y salida predeterminados para documentos de compra y venta
...
#### <a name="to-enter-inbound-and-outbound-warehouse-handling-times-on-locations" />Para especificar tiempos de manipulación en almacén de entrada y salida de almacén en almacenes
...
## <a name="to-make-an-item-critical" />Para identificar un producto como crítico
...
## <a name="to-calculate-an-order-promising-date" />Para calcular una fecha de compromiso de entrega de pedido
...
## <a name="see-related-microsoft-trainingtrainingmodulespromising-sales-order-delivery-dynamics-365-business-central" />Consultar la [formación de Microsoft](/training/modules/promising-sales-order-delivery-dynamics-365-business-central/) relacionada
