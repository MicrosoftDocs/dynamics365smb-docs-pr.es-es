...
ms.author: jswymer
---
# <a name="record-interactions-with-contacts"></a><a name="record-interactions-with-contacts"></a>Registrar interacciones con contactos
...
## <a name="setting-up-interaction-templates"></a><a name="setting-up-interaction-templates"></a>Configurar plantillas de interacción
...
## <a name="creating-interactions"></a><a name="creating-interactions"></a>Crear interacciones
...
## <a name="viewing-and-managing-recorded-interactions"></a><a name="viewing-and-managing-recorded-interactions"></a>Ver y administrar las interacciones registradas
