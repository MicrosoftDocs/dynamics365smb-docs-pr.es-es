...
ms.author: jswymer
---
# <a name="manage-interactions-for-segments" />Administrar interacciones para segmentos
...
## <a name="interactions" />Interacciones
