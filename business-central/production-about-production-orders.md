...
ms.author: edupont
---
# <a name="about-production-orders"></a><a name="about-production-orders"></a>Sobre los pedidos de producción
...
## <a name="production-order-creation"></a><a name="production-order-creation"></a>Creación de órdenes de producción
...
## <a name="limitations-on-production-order-creation"></a><a name="limitations-on-production-order-creation"></a>Limitaciones en la creación de órdenes de producción
...
## <a name="production-order-status"></a><a name="production-order-status"></a>Estado de las órdenes de producción
...
### <a name="simulated-production-order"></a><a name="simulated-production-order"></a>Orden de producción simulada
...
### <a name="planned-production-order"></a><a name="planned-production-order"></a>Orden de producción planificada
...
### <a name="firm-planned-production-order"></a><a name="firm-planned-production-order"></a>Orden de producción planificada en firme
...
### <a name="released-production-order"></a><a name="released-production-order"></a>Orden de producción lanzada
...
### <a name="finished-production-order"></a><a name="finished-production-order"></a>Orden de producción terminada
...
## <a name="production-order-execution"></a><a name="production-order-execution"></a>Ejecución de las órdenes de producción
...
### <a name="material-consumption"></a><a name="material-consumption"></a>Consumo de material
...
### <a name="production-output"></a><a name="production-output"></a>Salida de producción
...
### <a name="posting-consumption-and-output"></a><a name="posting-consumption-and-output"></a>Registro del consumo y la salida
...
### <a name="production-journal"></a><a name="production-journal"></a>Diario de producción
