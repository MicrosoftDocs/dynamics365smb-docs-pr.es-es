...
ms.author: edupont
---
# <a name="design-details-known-item-application-issue" />Detalles de diseño: Problema de liquidación de producto conocido
...
## <a name="symptoms-of-the-issue" />Síntomas del problema
...
## <a name="basics-of-item-application" />Conceptos básicos de la liquidación de producto
...
### <a name="quantity-application" />Liquidación de cantidad
...
### <a name="cost-application" />Coste liquidación
...
## <a name="illustration-of-a-basic-cost-flow" />Ejemplo de un flujo de costes básico
...
## <a name="reasons-for-the-issue" />Causas del problema
...
## <a name="identifying-the-issue" />Identificación del problema
...
## <a name="workaround-for-the-issue" />Solución del problema
