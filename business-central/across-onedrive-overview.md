...
# <a name="business-central-and-onedrive-for-business-integration" />Integración de Business Central y OneDrive para la Empresa
...
## <a name="get-started-with-onedrive-features" />Introducción a las características de OneDrive
...
### <a name="open-and-share-in-onedrive" />Abrir y compartir archivos en OneDrive
...
### <a name="save-excel-workbooks-and-report-files-in-onedrive" />Guarde libros de Excel y archivos de informes en OneDrive
