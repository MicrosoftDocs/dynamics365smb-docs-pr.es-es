...
ms.author: edupont
---
# <a name="incoming-documents" />Documentos entrantes
...
## <a name="usage-scenario" />Escenario de uso
...
## <a name="incoming-document-features" />Características de documentos entrantes
