...
### Configurar carpetas públicas y reglas para registro de correo electrónico en Exchange Online

[!INCLUDE[admin-setup-email-public-folder](includes/admin-setup-email-public-folder.md)]

Luego, te conectas [!INCLUDE[prod_short](includes/prod_short.md)] con Exchange Online.

### Configurar un buzón de correo compartido y las reglas para el registro de correo electrónico en Exchange Online
...
## Configurar [!INCLUDE[prod_short](includes/prod_short.md)] para registrar mensajes de correo electrónico
...
## Ver intercambios de mensajes de correo electrónico en el registro de interacciones
...
### Para registrar una solicitud en Microsoft Entra ID para conectarse desde Business Central a Exchange Online
