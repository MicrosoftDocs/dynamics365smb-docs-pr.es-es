...
### <a name="set-up-a-shared-mailbox-and-rules-for-email-logging-in-exchange-online"></a>Configurar un buzón compartido y las reglas para el registro de correo electrónico en Exchange Online
...
### <a name="prod_short-on-premises"></a>[!INCLUDE[prod_short](includes/prod_short.md)] Local
1. Elija el icono ![Bombilla que abre la característica Dígame.](media/ui-search/search_small.png "Dígame qué desea hacer") icono, escriba **Registro de correo electrónico** y luego elija el enlace relacionado. 
