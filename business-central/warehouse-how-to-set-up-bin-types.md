...
ms.author: edupont
---
# <a name="set-up-bin-types" />Configurar tipos de ubicación
...
## <a name="to-set-up-the-bin-types-you-want-to-use" />Para configurar los tipos de ubicaciones que desea utilizar
