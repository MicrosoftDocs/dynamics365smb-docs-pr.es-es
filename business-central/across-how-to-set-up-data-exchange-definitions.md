...
ms.author: bholtorf
---
# <a name="set-up-data-exchange-definitions" />Configurar definiciones de intercambio de datos
...
## <a name="create-a-data-exchange-definition" />Crear una definición de intercambio de datos
...
### <a name="a-nameformatlinescolumnsato-describe-the-formatting-of-lines-and-columns-in-the-file" /><a name=formatlinescolumns></a>Para describir el formato de las líneas y las columnas en el archivo
...
### <a name="a-namemapfieldsato-map-columns-in-the-data-file-to-fields-in-includeprodshortincludesprodshortmd" /><a name=mapfields></a>Para asignar las columnas en el archivo de datos a los campos de [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="transformation-rules" />Reglas de transformación
...
### <a name="tip-for-developers-example-of-the-custom-option" />Consejo para desarrolladores: ejemplo de la opción personalizada
...
## <a name="export-a-data-exchange-definition-as-an-xml-file-for-use-by-others" />Exportar una definición de intercambio de datos como un archivo XML para que lo utilicen otros usuarios
...
## <a name="import-an-existing-data-exchange-definition" />Importar una definición de intercambio de datos existente
