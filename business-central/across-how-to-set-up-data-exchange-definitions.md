...
ms.author: bholtorf
---
# <a name="set-up-data-exchange-definitions"></a><a name="set-up-data-exchange-definitions"></a><a name="set-up-data-exchange-definitions"></a>Configurar definiciones de intercambio de datos
...
## <a name="create-a-data-exchange-definition"></a><a name="create-a-data-exchange-definition"></a><a name="create-a-data-exchange-definition"></a>Crear una definición de intercambio de datos
...
### <a name="to-describe-the-formatting-of-lines-and-columns-in-the-file"></a><a name="to-describe-the-formatting-of-lines-and-columns-in-the-file"></a><a name="to-describe-the-formatting-of-lines-and-columns-in-the-file"></a><a name=formatlinescolumns></a>Para describir el formato de las líneas y las columnas en el archivo
...
### <a name="to-map-columns-in-the-data-file-to-fields-in-"></a><a name="to-map-columns-in-the-data-file-to-fields-in-"></a><a name="to-map-columns-in-the-data-file-to-fields-in-"></a><a name=mapfields></a>Para asignar las columnas en el archivo de datos a los campos de [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="transformation-rules"></a><a name="transformation-rules"></a><a name="transformation-rules"></a>Reglas de transformación
...
### <a name="tip-for-developers-example-of-the-custom-option"></a><a name="tip-for-developers-example-of-the-custom-option"></a><a name="tip-for-developers-example-of-the-custom-option"></a>Consejo para desarrolladores: ejemplo de la opción personalizada
...
## <a name="import-an-existing-data-exchange-definition"></a><a name="import-an-existing-data-exchange-definition"></a><a name="import-an-existing-data-exchange-definition"></a>Importar una definición de intercambio de datos existente
