...
También puede agrupar por cualquier campo, usar el índice clave para ordenar los resultados y los nuevos tipos de transformación **Redondeo** y **Búsqueda de campo**.
