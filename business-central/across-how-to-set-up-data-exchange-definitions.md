...
### <a name="to-map-columns-in-the-data-file-to-fields-in-prod_short"></a><a name=mapfields></a>Para asignar las columnas en el archivo de datos a los campos de [!INCLUDE[prod_short](includes/prod_short.md)]
