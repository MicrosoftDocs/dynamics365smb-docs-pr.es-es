...
ms.author: edupont
---
# <a name="update-standard-costs"></a><a name="update-standard-costs"></a>Actualizar costes estándar
...
## <a name="to-update-standard-costs"></a><a name="to-update-standard-costs"></a>Para actualizar los costes estándar
