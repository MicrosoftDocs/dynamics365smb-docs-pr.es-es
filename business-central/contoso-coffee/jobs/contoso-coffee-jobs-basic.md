...
## <a name="adding-a-job-task-to-a-job"></a>Agregar una tarea de trabajo a un trabajo
...
## <a name="record-time-and-material-expenses-to-a-job"></a>Registrar el tiempo y los gastos de material de un trabajo
...
## <a name="creating-a-sales-invoice-for-a-job"></a>Creación de una factura de venta para un trabajo
