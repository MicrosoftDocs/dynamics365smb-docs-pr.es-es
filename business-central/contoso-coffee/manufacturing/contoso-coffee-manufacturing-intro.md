...
# <a name="introduction-to-contoso-coffee-manufacturing" />Introducción a la fabricación de Contoso Coffee
...
## <a name="set-up-contoso-coffee-manufacturing-data" />Configuración de datos de demostración de Contoso Coffee para fabricación
