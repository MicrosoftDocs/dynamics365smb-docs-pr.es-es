...
ms.author: andreipa
---
# <a name="walkthrough-create-a-new-production-bom-and-bom-version"></a><a name="walkthrough-create-a-new-production-bom-and-bom-version"></a>Tutorial: Crear una nueva L.M. de producción y una versión de L.M.
