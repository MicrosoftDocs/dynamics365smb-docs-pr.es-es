...
# <a name="walkthrough-of-inbound-and-outbound-flow-in-basic-warehouse-configurations" />Tutorial de flujo entrante y saliente en las configuraciones de almacén básico
...
## <a name="outbound-flow-picking-and-shipping-in-basic-warehouse-configurations" />Flujo saliente: selección y envío en la configuración del almacenamiento básico
