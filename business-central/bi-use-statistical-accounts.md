...
---
# <a name="analyze-data-with-statistical-accounts" />Analice datos con cuentas estadísticas
...
## <a name="set-up-a-statistical-account" />Configurar una cuenta estadística
...
## <a name="post-amounts-to-a-statistical-account" />Contabilizar importes en una cuenta estadística
...
## <a name="verify-statistical-account-amounts" />Verificar importes de cuentas estadísticas
...
## <a name="include-the-statistical-account-in-a-financial-report" />Incluir la cuenta estadística en un informe financiero
