...
ms.author: edupont
---
# <a name="delete-cost-budget-entries"></a><a name="delete-cost-budget-entries"></a><a name="delete-cost-budget-entries"></a>Eliminar movs. ppto. costes
...
## <a name="to-delete-a-cost-budget-entry"></a><a name="to-delete-a-cost-budget-entry"></a><a name="to-delete-a-cost-budget-entry"></a>Para eliminar movimientos de presupuesto de costes
