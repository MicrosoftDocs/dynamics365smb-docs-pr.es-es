...
# <a name="building-power-bi-reports-to-display--data"></a><a name="building-power-bi-reports-to-display--data"></a><a name="building-power-bi-reports-to-display--data"></a><a name="building-power-bi-reports-to-display--data"></a>Crear informes de Power BI para mostrar datos de [!INCLUDE [prod_long](includes/prod_long.md)]
...
## <a name="add--as-a-data-source-in-power-bi-desktop"></a><a name="add--as-a-data-source-in-power-bi-desktop"></a><a name="add--as-a-data-source-in-power-bi-desktop"></a><a name="add--as-a-data-source-in-power-bi-desktop"></a><a name="getdata"></a>Agregar [!INCLUDE[prod_short](includes/prod_short.md)] como origen de datos de Power BI Desktop
...
## <a name="creating-accessible-reports"></a><a name="creating-accessible-reports"></a><a name="creating-accessible-reports"></a><a name="creating-accessible-reports"></a>Crear informes accesibles
...
## <a name="creating-reports-to-display-data-associated-with-a-list"></a><a name="creating-reports-to-display-data-associated-with-a-list"></a><a name="creating-reports-to-display-data-associated-with-a-list"></a><a name="creating-reports-to-display-data-associated-with-a-list"></a>Crear informes para mostrar datos asociados con una lista
...
## <a name="using-the--report-theme-optional"></a><a name="using-the--report-theme-optional"></a><a name="using-the--report-theme-optional"></a><a name="using-the--report-theme-optional"></a><a name="theme"></a>Usar el tema de informe [!INCLUDE [prod_short](includes/prod_short.md)] (optional)
...
### <a name="download-the-theme"></a><a name="download-the-theme"></a><a name="download-the-theme"></a><a name="download-the-theme"></a>Descargar el tema
...
### <a name="import-the-theme-on-a-report"></a><a name="import-the-theme-on-a-report"></a><a name="import-the-theme-on-a-report"></a><a name="import-the-theme-on-a-report"></a>Importar el tema en un informe
...
## <a name="publish-reports"></a><a name="publish-reports"></a><a name="publish-reports"></a><a name="publish-reports"></a>Publicar informes
...
## <a name="distribute-or-share-a-report"></a><a name="distribute-or-share-a-report"></a><a name="distribute-or-share-a-report"></a><a name="distribute-or-share-a-report"></a>Distribuir o compartir un informe
...
### <a name="cannot-insert-a-record-current-connection-intent-is-read-only-error-connecting-to-custom-api-page"></a><a name="cannot-insert-a-record-current-connection-intent-is-read-only-error-connecting-to-custom-api-page"></a><a name="cannot-insert-a-record-current-connection-intent-is-read-only-error-connecting-to-custom-api-page"></a><a name="cannot-insert-a-record-current-connection-intent-is-read-only-error-connecting-to-custom-api-page"></a>"No se puede insertar un registro. La intención de conexión actual es de solo lectura". error al conectarse a página API personalizada
