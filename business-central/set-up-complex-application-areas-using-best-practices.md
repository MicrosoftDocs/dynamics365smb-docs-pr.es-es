...
ms.author: edupont
---
# <a name="set-up-complex-application-areas-using-best-practices"></a><a name="set-up-complex-application-areas-using-best-practices"></a>Configurar áreas de aplicación complejas mediante procedimientos recomendados
