...
# <a name="set-up-non-deductible-vat"></a>Configurar el IVA no deducible
...
## <a name="use-the-non-deductible-vat-percentage"></a>Utilizar el porcentaje de IVA no deducible
