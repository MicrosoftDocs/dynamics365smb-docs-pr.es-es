...
ms.author: edupont
---
# <a name="modify-planning-suggestions-in-a-graphical-view"></a><a name="modify-planning-suggestions-in-a-graphical-view"></a>Modificar las sugerencias de planificación en una vista gráfica
