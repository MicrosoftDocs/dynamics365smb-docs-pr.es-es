...
ms.author: jswymer
---
# <a name="viewing-database-locks"></a><a name="viewing-database-locks"></a><a name="viewing-database-locks"></a><a name="viewing-database-locks"></a>Ver bloqueos de base de datos
...
## <a name="to-view-database-locks"></a><a name="to-view-database-locks"></a><a name="to-view-database-locks"></a><a name="to-view-database-locks"></a>Para ver bloqueos de base de datos
