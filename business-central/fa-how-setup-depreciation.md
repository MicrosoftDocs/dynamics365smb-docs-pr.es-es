...
# <a name="set-up-fixed-asset-depreciation"></a><a name="set-up-fixed-asset-depreciation"></a><a name="set-up-fixed-asset-depreciation"></a>Configurar la amortización de los activos fijos
...
## <a name="to-create-a-depreciation-book"></a><a name="to-create-a-depreciation-book"></a><a name="to-create-a-depreciation-book"></a>Para crear un libro de amortización
...
## <a name="to-assign-a-depreciation-book-to-a-fixed-asset"></a><a name="to-assign-a-depreciation-book-to-a-fixed-asset"></a><a name="to-assign-a-depreciation-book-to-a-fixed-asset"></a>Para asignar un libro de amortización a un activo fijo
...
## <a name="to-assign-a-depreciation-book-to-multiple-fixed-assets-with-a-batch-job"></a><a name="to-assign-a-depreciation-book-to-multiple-fixed-assets-with-a-batch-job"></a><a name="to-assign-a-depreciation-book-to-multiple-fixed-assets-with-a-batch-job"></a>Para asignar un libro de amortización a varios activos con un solo proceso
...
## <a name="to-set-up-depreciation-posting-types"></a><a name="to-set-up-depreciation-posting-types"></a><a name="to-set-up-depreciation-posting-types"></a>Para configurar los tipos de registro de amortización
...
## <a name="to-set-up-default-templates-and-batches-for-fixed-asset-depreciation"></a><a name="to-set-up-default-templates-and-batches-for-fixed-asset-depreciation"></a><a name="to-set-up-default-templates-and-batches-for-fixed-asset-depreciation"></a>Para configurar las plantillas y los procesos predeterminados para la amortización de activos
...
## <a name="fiscal-year-365-days-field-depreciation"></a><a name="fiscal-year-365-days-field-depreciation"></a><a name="fiscal-year-365-days-field-depreciation"></a>Amortización de campo Ejercicio 365 días
