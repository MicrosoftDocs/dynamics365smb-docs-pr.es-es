...
# <a name="set-up-fixed-asset-depreciation"></a>Configurar la amortización de los activos fijos
 ...
 Cuando cree los libros de amortización pertinentes, debe asignar uno o más a cada activo. Un libro de amortización que se asigna a un activo se le conoce como un libro de amortización de activo. Por consiguiente, la página de los libros asignados de amortización se denomina **Libros amortización A/F**.
