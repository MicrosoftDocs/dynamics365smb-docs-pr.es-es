...
# <a name="set-up-fixed-asset-depreciation" />Configurar la amortización de los activos fijos
...
## <a name="to-create-a-depreciation-book" />Para crear un libro de amortización
...
## <a name="to-assign-a-depreciation-book-to-a-fixed-asset" />Para asignar un libro de amortización a un activo fijo
...
## <a name="to-assign-a-depreciation-book-to-multiple-fixed-assets-with-a-batch-job" />Para asignar un libro de amortización a varios activos con un solo proceso
...
## <a name="to-set-up-depreciation-posting-types" />Para configurar los tipos de registro de amortización
...
## <a name="to-set-up-default-templates-and-batches-for-fixed-asset-depreciation" />Para configurar las plantillas y los procesos predeterminados para la amortización de activos
