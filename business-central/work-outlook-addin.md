...
ms.author: jswymer
---
# <a name="use-business-central-as-your-business-inbox-in-outlook"></a><a name="use-business-central-as-your-business-inbox-in-outlook"></a>Usar Business Central como su bandeja de entrada de empresa en Outlook
...
## <a name="work-with-contacts-and-documents-using-the-contact-insights-add-in"></a><a name="work-with-contacts-and-documents-using-the-contact-insights-add-in"></a>Trabajar con contactos y documentos mediante el complemento Información detallada de contactos
...
### <a name="look-up-a-business-contact-when-composing-an-email"></a><a name="look-up-a-business-contact-when-composing-an-email"></a>Buscar un contacto comercial al redactar un correo electrónico
...
### <a name="view-and-change-the-contact-details-or-switch-company"></a><a name="view-and-change-the-contact-details-or-switch-company"></a>Ver y cambiar los datos de contacto o cambiar de empresa
...
### <a name="track-incoming-documents"></a><a name="track-incoming-documents"></a>Hacer seguimiento de documentos entrantes
...
### <a name="create-and-send-new-document-to-a-contact"></a><a name="create-and-send-new-document-to-a-contact"></a>Crear y enviar un nuevo documento a un contacto
...
### <a name="attach-files-to-records"></a><a name="attach-files-to-records"></a>Adjuntar archivos a registros
...
#### <a name="how-to-attach-a-file"></a><a name="how-to-attach-a-file"></a>Cómo adjuntar un archivo
...
## <a name="view-a-document-from-an-email-using-the-document-view-add-in"></a><a name="view-a-document-from-an-email-using-the-document-view-add-in"></a>Ver un documento de un correo electrónico con el complemento Document View
