...
2. En la cinta, vaya a **[!INCLUDE[prod_short](includes/prod_short.md)]** y elija **Información detallada de contactos**. O si está usando Outlook en la web, en la parte superior o inferior del mensaje, seleccione **Aplicaciones** ![Muestra el botón de aplicaciones en Outlook.](media/apps-icon.png) > **Business Central** ![Icono del complemento de Business Central en Outlook.](media/outlook-business-central-icon.png) > **Información detallada de contactos**.
