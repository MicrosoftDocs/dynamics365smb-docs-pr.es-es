...
# <a name="design-details-change-the-costing-method-for-items"></a><a name="design-details-change-the-costing-method-for-items"></a><a name="design-details-change-the-costing-method-for-items"></a><a name="design-details-change-the-costing-method-for-items"></a>Detalles de diseño: Cambiar la valoración de existencias para productos
...
## <a name="about-costing-methods"></a><a name="about-costing-methods"></a><a name="about-costing-methods"></a><a name="about-costing-methods"></a>Acerca de la valoración de existencias
...
## <a name="use-assembly-orders-to-change-costing-method-assignments"></a><a name="use-assembly-orders-to-change-costing-method-assignments"></a><a name="use-assembly-orders-to-change-costing-method-assignments"></a><a name="use-assembly-orders-to-change-costing-method-assignments"></a>Usar pedidos de ensamblado para cambiar asignaciones de valoraciones de existencias
...
### <a name="define-a-default-costing-method"></a><a name="define-a-default-costing-method"></a><a name="define-a-default-costing-method"></a><a name="define-a-default-costing-method"></a>Definir una valoración de existencias predeterminada
...
### <a name="create-new-items-with-the-old-numbering-scheme-and-copy-the-master-data-in-a-batch"></a><a name="create-new-items-with-the-old-numbering-scheme-and-copy-the-master-data-in-a-batch"></a><a name="create-new-items-with-the-old-numbering-scheme-and-copy-the-master-data-in-a-batch"></a><a name="create-new-items-with-the-old-numbering-scheme-and-copy-the-master-data-in-a-batch"></a>Crear nuevos productos con el antiguo esquema de numeración y copiar los datos maestros en un lote
...
### <a name="manually-copy-related-master-data-from-the-original-item-to-the-new-item"></a><a name="manually-copy-related-master-data-from-the-original-item-to-the-new-item"></a><a name="manually-copy-related-master-data-from-the-original-item-to-the-new-item"></a><a name="manually-copy-related-master-data-from-the-original-item-to-the-new-item"></a>Copie manualmente los datos maestros relacionados desde el producto original al nuevo producto.
...
### <a name="transfer-the-inventory-to-the-new-item"></a><a name="transfer-the-inventory-to-the-new-item"></a><a name="transfer-the-inventory-to-the-new-item"></a><a name="transfer-the-inventory-to-the-new-item"></a>Transferir el inventario al nuevo producto
...
#### <a name="header"></a><a name="header"></a><a name="header"></a><a name="header"></a>Cabecera
...
#### <a name="lines"></a><a name="lines"></a><a name="lines"></a><a name="lines"></a>Líneas
...
### <a name="handle-inventory-quantities-that-are-allocated-to-demand"></a><a name="handle-inventory-quantities-that-are-allocated-to-demand"></a><a name="handle-inventory-quantities-that-are-allocated-to-demand"></a><a name="handle-inventory-quantities-that-are-allocated-to-demand"></a>Gestionar las cantidades de inventario que se asignan a la demanda
...
### <a name="block-the-original-item-from-further-use"></a><a name="block-the-original-item-from-further-use"></a><a name="block-the-original-item-from-further-use"></a><a name="block-the-original-item-from-further-use"></a>Bloquear el producto original para su uso posterior
...
## <a name="summary"></a><a name="summary"></a><a name="summary"></a><a name="summary"></a>Resumen
