...
# Detalles de diseño: Cambiar la valoración de existencias para productos
...
## Acerca de la valoración de existencias
...
## Usar pedidos de ensamblado para cambiar asignaciones de valoraciones de existencias
...
### Definir una valoración de existencias predeterminada
...
### Identificar los productos para los que cambiar la valoración de existencias y vuelva a numerarlos
...
### Crear nuevos productos con el antiguo esquema de numeración y copiar los datos maestros en un lote
...
### Copie manualmente los datos maestros relacionados desde el producto original al nuevo producto.
...
### Determinar la cantidad de inventario para convertir desde el producto original al nuevo producto
...
### Transferir el inventario al nuevo producto
...
### Gestionar las cantidades de inventario que se asignan a la demanda
...
### Bloquear el producto original para su uso posterior
