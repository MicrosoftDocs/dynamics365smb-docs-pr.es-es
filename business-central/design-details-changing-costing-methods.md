...
# <a name="design-details-change-the-costing-method-for-items" />Detalles de diseño: Cambiar la valoración de existencias para productos
...
## <a name="about-costing-methods" />Acerca de la valoración de existencias
...
## <a name="use-assembly-orders-to-change-costing-method-assignments" />Usar pedidos de ensamblado para cambiar asignaciones de valoraciones de existencias
...
### <a name="define-a-default-costing-method" />Definir una valoración de existencias predeterminada
...
### <a name="identify-the-items-to-change-the-costing-method-for-and-renumber-them" />Identificar los productos para los que cambiar la valoración de existencias y vuelva a numerarlos
...
### <a name="create-new-items-with-the-old-numbering-scheme-and-copy-the-master-data-in-a-batch" />Crear nuevos productos con el antiguo esquema de numeración y copiar los datos maestros en un lote
...
### <a name="manually-copy-related-master-data-from-the-original-item-to-the-new-item" />Copie manualmente los datos maestros relacionados desde el producto original al nuevo producto.
...
### <a name="determine-the-inventory-quantity-to-convert-from-the-original-item-to-the-new-item" />Determinar la cantidad de inventario para convertir desde el producto original al nuevo producto
...
### <a name="transfer-the-inventory-to-the-new-item" />Transferir el inventario al nuevo producto
...
### <a name="handle-inventory-quantities-that-are-allocated-to-demand" />Gestionar las cantidades de inventario que se asignan a la demanda
...
### <a name="block-the-original-item-from-further-use" />Bloquear el producto original para su uso posterior
