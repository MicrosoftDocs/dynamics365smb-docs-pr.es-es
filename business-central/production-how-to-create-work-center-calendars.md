...
ms.author: edupont
---
# <a name="set-up-shop-calendars"></a><a name="set-up-shop-calendars"></a>Configurar calendarios de planta
...
## <a name="to-create-work-shifts"></a><a name="to-create-work-shifts"></a>Para crear turnos de trabajo
...
## <a name="to-set-up-a-shop-calendar"></a><a name="to-set-up-a-shop-calendar"></a>Para configurar un calendario de planta
...
## <a name="to-calculate-a-work-center-calendar"></a><a name="to-calculate-a-work-center-calendar"></a>Para calcular un calendario de centro de trabajo
...
## <a name="to-record-work-center-absence"></a><a name="to-record-work-center-absence"></a>Para registrar las ausencias en el centro de trabajo
