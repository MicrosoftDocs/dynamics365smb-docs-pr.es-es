...
ms.author: edupont
---
# <a name="set-up-shop-calendars" />Configurar calendarios de planta
...
## <a name="to-create-work-shifts" />Para crear turnos de trabajo
...
## <a name="to-set-up-a-shop-calendar" />Para configurar un calendario de planta
...
## <a name="to-calculate-a-work-center-calendar" />Para calcular un calendario de centro de trabajo
...
## <a name="to-record-work-center-absence" />Para registrar las ausencias en el centro de trabajo
