...
ms.author: edupont
---
# <a name="transfer-split-or-combine-fixed-assets" />Permite transferir, dividir o combinar activos fijos
...
## <a name="to-transfer-a-fixed-asset-to-a-different-department" />Para transferir un activo fijo a otro departamento
...
## <a name="to-split-a-fixed-asset-into-three-fixed-assets" />Para dividir un activo en tres activos fijos
...
## <a name="to-combine-two-fixed-assets-into-one" />Para combinar dos activos fijos en uno
...
## <a name="to-view-changed-depreciation-book-values-due-to-fixed-asset-reclassification" />Para ver los cambios en los valores del libro de amortización debido a la reclasificación del activo
