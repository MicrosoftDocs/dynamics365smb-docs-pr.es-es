...
ms.author: edupont
---
# <a name="assign-default-bins-to-items" />Asignar las ubicaciones predefinidas a los productos
...
## <a name="to-assign-a-default-bin-to-an-item" />Asignar una ubicación predeterminada a un producto
...
## <a name="to-change-the-default-bin-for-an-item" />Para cambiar las ubicaciones predefinidas de los productos
