...
ms.author: edupont
---
# <a name="purchase-items-for-a-sale-by-creating-purchase-invoices" />Compra de artículos para una venta mediante la creación de facturas de compra
...
## <a name="to-create-one-or-more-purchase-orders-from-a-sales-order" />Para crear uno o más pedidos de compra a partir de un pedido de venta
...
## <a name="to-create-a-purchase-invoice-from-a-sales-order-or-sales-invoice" />Para crear una factura de compra a partir de un pedido o pedidos de venta
