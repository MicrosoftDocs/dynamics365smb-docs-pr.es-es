...
ms.author: jswymer
---
# <a name="managing-onedrive-integration-with-business-central" />Administrar la integración de OneDrive con Business Central
...
## <a name="configure-onedrive-for-integration-with-business-central" />Configurar OneDrive para la integración con Business Central
...
### <a name="managing-privacy" />Gestionar la privacidad
...
## <a name="configure-business-central" />Configurar Business Central
...
### <a name="about-multiple-environments" />Acerca de varios entornos
...
### <a name="configure-onedrive-using-onedrive-setup" />Configurar OneDrive usando la configuración de OneDrive
...
### <a name="switching-to-new-onedrive-integration-after-upgrade" />Cambiar a la nueva integración de OneDrive después de la actualización
