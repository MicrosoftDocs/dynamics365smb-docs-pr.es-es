...
ms.author: edupont
---
# <a name="set-up-currencies"></a><a name="set-up-currencies"></a>Configuración de divisas
...
## <a name="currencies"></a><a name="currencies"></a><a name="curr"></a>Divisas
...
### <a name="available-currency-functions"></a><a name="available-currency-functions"></a>Funciones de divisa disponibles
...
## <a name="lcy-and-other-currencies"></a><a name="lcy-and-other-currencies"></a>DL y otras divisas

[!INCLUDE [finance-currencies-lcy-def](includes/finance-currencies-lcy-def.md)]

## <a name="rounding-currencies"></a><a name="rounding-currencies"></a>Redondeo de divisas
...
### <a name="unit-amount-rounding"></a><a name="unit-amount-rounding"></a>Redondeo precio-producto
...
### <a name="amount-rounding"></a><a name="amount-rounding"></a>Redondeo de importe
...
## <a name="general-ledger-accounts"></a><a name="general-ledger-accounts"></a>Cuentas contables
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Consultar la [formación de Microsoft](/training/modules/currencies-exchange-rates-dynamics-365-business-central/) relacionada
