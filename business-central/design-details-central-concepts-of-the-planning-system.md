...
---
# <a name="design-details-central-concepts-of-the-planning-system" />Detalles de diseño: Conceptos centrales del sistema de planificación
...
## <a name="planning-starting-date" />Fecha inicial de la planificación
...
## <a name="dynamic-order-tracking-pegging" />Seguimiento dinámico de pedidos (fijación)
...
### <a name="dynamic-order-tracking-versus-the-planning-system" />Seguimiento dinámico de pedidos frente al sistema de planificación
...
## <a name="sequence-and-priority-in-planning" />Secuencia y prioridad en la planificación
...
### <a name="item-priority--low-level-code" />Prioridad de producto / Cód. nivel más bajo
...
#### <a name="optimizing-performance-for-low-level-calculations" />Optimización del rendimiento para cálculos de bajo nivel
...
### <a name="locations--transfer-level-priority" />Prioridad de ubicaciones o de nivel de transferencia
...
### <a name="order-priority" />Prioridad pedido
...
## <a name="demand-forecasts-and-blanket-orders" />Previsiones de demanda y pedidos abiertos
...
## <a name="planning-assignment" />Asignar planificación
...
## <a name="item-dimensions" />Dimensiones de producto
...
## <a name="item-attributes" />Atributos de artículo
...
### <a name="specific-attributes" />Atributos específicos
...
### <a name="non-specific-attributes" />Atributos no específicos
...
## <a name="order-to-order-links" />Vínculos de pedido a pedido
...
## <a name="error-logs" />Registros de errores
...
## <a name="order-planning" />Planificación de pedidos
...
## <a name="finite-loading" />Carga limitada
