...
---
# <a name="design-details-central-concepts-of-the-planning-system"></a><a name="design-details-central-concepts-of-the-planning-system"></a><a name="design-details-central-concepts-of-the-planning-system"></a><a name="design-details-central-concepts-of-the-planning-system"></a>Detalles de diseño: Conceptos centrales del sistema de planificación
...
## <a name="planning-starting-date"></a><a name="planning-starting-date"></a><a name="planning-starting-date"></a><a name="planning-starting-date"></a>Fecha inicial de la planificación
...
## <a name="dynamic-order-tracking-pegging"></a><a name="dynamic-order-tracking-pegging"></a><a name="dynamic-order-tracking-pegging"></a><a name="dynamic-order-tracking-pegging"></a>Seguimiento dinámico de pedidos (fijación)
...
### <a name="dynamic-order-tracking-versus-the-planning-system"></a><a name="dynamic-order-tracking-versus-the-planning-system"></a><a name="dynamic-order-tracking-versus-the-planning-system"></a><a name="dynamic-order-tracking-versus-the-planning-system"></a>Seguimiento dinámico de pedidos frente al sistema de planificación
...
## <a name="sequence-and-priority-in-planning"></a><a name="sequence-and-priority-in-planning"></a><a name="sequence-and-priority-in-planning"></a><a name="sequence-and-priority-in-planning"></a>Secuencia y prioridad en la planificación
...
### <a name="item-priority--low-level-code"></a><a name="item-priority--low-level-code"></a><a name="item-priority--low-level-code"></a><a name="item-priority--low-level-code"></a>Prioridad de producto / Cód. nivel más bajo
...
#### <a name="optimizing-performance-for-low-level-calculations"></a><a name="optimizing-performance-for-low-level-calculations"></a><a name="optimizing-performance-for-low-level-calculations"></a><a name="optimizing-performance-for-low-level-calculations"></a>Optimización del rendimiento para cálculos de bajo nivel
...
### <a name="locations--transfer-level-priority"></a><a name="locations--transfer-level-priority"></a><a name="locations--transfer-level-priority"></a><a name="locations--transfer-level-priority"></a>Prioridad de ubicaciones o de nivel de transferencia
...
### <a name="order-priority"></a><a name="order-priority"></a><a name="order-priority"></a><a name="order-priority"></a>Prioridad pedido
...
## <a name="demand-forecasts-and-blanket-orders"></a><a name="demand-forecasts-and-blanket-orders"></a><a name="demand-forecasts-and-blanket-orders"></a><a name="demand-forecasts-and-blanket-orders"></a>Previsiones de demanda y pedidos abiertos
...
## <a name="planning-assignment"></a><a name="planning-assignment"></a><a name="planning-assignment"></a><a name="planning-assignment"></a>Asignar planificación
...
## <a name="item-dimensions"></a><a name="item-dimensions"></a><a name="item-dimensions"></a><a name="item-dimensions"></a>Dimensiones de producto
...
## <a name="item-attributes"></a><a name="item-attributes"></a><a name="item-attributes"></a><a name="item-attributes"></a>Atributos de artículo
...
### <a name="specific-attributes"></a><a name="specific-attributes"></a><a name="specific-attributes"></a><a name="specific-attributes"></a>Atributos específicos
...
### <a name="non-specific-attributes"></a><a name="non-specific-attributes"></a><a name="non-specific-attributes"></a><a name="non-specific-attributes"></a>Atributos no específicos
...
## <a name="reservations"></a><a name="reservations"></a><a name="reservations"></a><a name="reservations"></a>Reservas
...
## <a name="warnings"></a><a name="warnings"></a><a name="warnings"></a><a name="warnings"></a>Advertencias
...
### <a name="emergency"></a><a name="emergency"></a><a name="emergency"></a><a name="emergency"></a>Emergencia
...
## <a name="error-logs"></a><a name="error-logs"></a><a name="error-logs"></a><a name="error-logs"></a>Registros de errores
...
## <a name="order-planning"></a><a name="order-planning"></a><a name="order-planning"></a><a name="order-planning"></a>Planificación de pedidos
...
## <a name="finite-loading"></a><a name="finite-loading"></a><a name="finite-loading"></a><a name="finite-loading"></a>Carga limitada
